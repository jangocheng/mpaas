...
@Entity
@Table(name= "nginx_ui_remote_b58f120b",
		indexes = {
...
public class Remote extends TableBase {
	private static final long serialVersionUID = 8152325411734739106L;
	String protocol;
	String ip;
	Integer port;
	Integer status = 0; // 0 掉线 1在线
	String creditKey;
	String name;
	String pass;
	String version;
