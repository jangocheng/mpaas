 ...
 */
package ghost.framework.tomcat.web.module.http.server.reactive;
...
public class TomcatHttpHandlerAdapter extends ServletHttpHandlerAdapter {
	public TomcatHttpHandlerAdapter(ghost.framework.web.module.server.reactive.HttpHandler httpHandler) {
		super(httpHandler);
	}
	@Override
