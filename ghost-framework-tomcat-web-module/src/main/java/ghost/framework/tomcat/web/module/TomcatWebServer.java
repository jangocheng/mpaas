...
import ghost.framework.web.module.server.PortInUseException;
...
public class TomcatWebServer implements WebServer {
	 ...
	 */
	public TomcatWebServer(ClassLoader classLoader, Tomcat tomcat) {
		this(classLoader, tomcat, true);
	}
	 ...
	 */
	public TomcatWebServer(ClassLoader classLoader, Tomcat tomcat, boolean autoStart) {
	...
	private void initialize() throws WebServerException {
		...
		synchronized (this.monitor) {
			try {
				...
				try {
					ContextBindings.bindClassLoader(context, context.getNamingToken(), this.classLoader);
	...
	private void startDaemonAwaitThread() {
		...
		awaitThread.setContextClassLoader(this.classLoader);
	...
	public void start() throws WebServerException {
		synchronized (this.monitor) {
			...
			try {
				...
				Context context = findContext();
				ContextBindings.unbindClassLoader(context, context.getNamingToken(), this.classLoader);
			}
		}
	}
