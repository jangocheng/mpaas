...
import ghost.framework.scheduling.TaskScheduler;
import ghost.framework.scheduling.Trigger;
import ghost.framework.scheduling.config.*;
import ghost.framework.scheduling.support.CronTrigger;
import ghost.framework.scheduling.support.ScheduledMethodRunnable;
...
//import ghost.framework.context.proxy.aop.AopProxyUtils;
//import ghost.framework.context.proxy.aop.AopUtils;
//import ghost.framework.context.proxy.aop.MethodIntrospector;

//import ghost.framework.aop.framework.AopInfrastructureBean;
//import ghost.framework.aop.framework.AopProxyUtils;
...
//import ghost.framework.beans.factory.config.DestructionAwareBeanPostProcessor;
//import ghost.framework.beans.factory.config.NamedBeanHolder;
//import ghost.framework.beans.factory.support.MergedBeanDefinitionPostProcessor;
 ...
 * to be invoked by a {@link ghost.framework.scheduling.TaskScheduler} according
 ...
 * @see ghost.framework.scheduling.TaskScheduler
 * @see ghost.framework.scheduling.config.ScheduledTaskRegistrar
 * @see AsyncAnnotationBeanPostProcessor
 */
public class ScheduledAnnotationBeanPostProcessor
		implements ScheduledTaskHolder, MergedBeanDefinitionPostProcessor, DestructionAwareBeanPostProcessor,
		Ordered, /*EmbeddedValueResolverAware,*/ BeanNameAware/*, BeanFactoryAware*//*, ApplicationContextAware*/,
		SmartInitializingSingleton, ApplicationEventListener<ContextRefreshedEvent>, AutoCloseable {
	...
	@Nullable
	private ICglibInstance applicationContext;
	...
	/**
	 * Set the {@link ghost.framework.scheduling.TaskScheduler} that will invoke
...
//	@Override
	...
	/**
	 * Setting an {@link ICglibInstance} is optional: If set, registered
	 ...
	 */
//	@Override
	public void setApplicationContext(ICglibInstance applicationContext) {
...
//		return bean;
	...
	protected Runnable createRunnable(Object target, Method method) {
		...
		Method invocableMethod = null;//AopUtils.selectInvocableMethod(method, target.getClass());
