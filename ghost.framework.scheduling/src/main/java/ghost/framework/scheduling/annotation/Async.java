 ...
 * {@link ghost.framework.context.annotation.Configuration @Configuration} class.
 *
 * <p>In terms of target method signatures, any parameter types are supported.
 * However, the return type is constrained to either {@code void} or
 * {@link java.util.concurrent.Future}. In the latter case, you may declare the
 * more specific {@link ghost.framework.util.concurrent.ListenableFuture} or
...
public @interface Async {
	 ...
	 * {@link ghost.framework.thread.task.TaskExecutor TaskExecutor}
	 * bean definition.
