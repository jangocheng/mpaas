...
package ghost.framework.scheduling.concurrent;

import ghost.framework.beans.annotation.constraints.Nullable;
import ghost.framework.scheduling.TaskScheduler;
import ghost.framework.scheduling.Trigger;
import ghost.framework.scheduling.support.SimpleTriggerContext;
import ghost.framework.scheduling.support.TaskUtils;
 ...
 * exposes a Spring {@link ghost.framework.scheduling.TaskScheduler} for it.
 * Extends {@link ConcurrentTaskExecutor} in order to implement the
 * {@link ghost.framework.scheduling.SchedulingTaskExecutor} interface as well.
 *
 ...
 * exposing it as a Spring {@link ghost.framework.scheduling.TaskScheduler} directly.
...
public class ConcurrentTaskScheduler extends ConcurrentTaskExecutor implements TaskScheduler {
	 ...
	 * to delegate to for {@link ghost.framework.scheduling.SchedulingTaskExecutor}
	 ...
	 * for {@link ghost.framework.scheduling.SchedulingTaskExecutor} invocations
	 * @param scheduledExecutor the {@link ScheduledExecutorService}
	 ...
	 * {@link ghost.framework.scheduling.SchedulingTaskExecutor} invocations
