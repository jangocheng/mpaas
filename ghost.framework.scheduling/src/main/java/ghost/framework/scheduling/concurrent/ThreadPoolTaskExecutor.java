...
import ghost.framework.scheduling.SchedulingTaskExecutor;
 ...
 * properties) and exposing it as a Spring {@link ghost.framework.thread.task.TaskExecutor}.
 ...
 * {@link ghost.framework.thread.task.TaskExecutor} interface as well as the
 ...
 * in particular regarding the {@link ghost.framework.thread.task.TaskRejectedException}.
 *
 ...
 * Spring {@link ghost.framework.thread.task.TaskExecutor}, simply wrap it with a
 * {@link ghost.framework.scheduling.concurrent.ConcurrentTaskExecutor} adapter.
 *
 * @author Juergen Hoeller
 * @since 2.0
 * @see ghost.framework.thread.task.TaskExecutor
