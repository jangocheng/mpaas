...
import ghost.framework.scheduling.concurrent.ConcurrentTaskScheduler;
 ...
 * ghost.framework.scheduling.annotation.EnableAsync @EnableAsync} annotation and its
 * {@link ghost.framework.scheduling.annotation.SchedulingConfigurer
 ...
 * @author Sam Brannen
 * @since 3.0
 * @see ghost.framework.scheduling.annotation.EnableAsync
 * @see ghost.framework.scheduling.annotation.SchedulingConfigurer
 */
public class ScheduledTaskRegistrar implements ScheduledTaskHolder, AutoCloseable {
	 ...
	 * {@link ghost.framework.core.env.Environment Environment}.
	 * @since 5.2
	 * @see ghost.framework.scheduling.annotation.Scheduled#CRON_DISABLED
	 */
