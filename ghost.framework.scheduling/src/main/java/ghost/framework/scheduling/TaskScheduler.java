...
package ghost.framework.scheduling;
 ...
 * {@link ghost.framework.scheduling.concurrent.ThreadPoolTaskScheduler},
 ...
 * environments but aligned with Spring's {@code TaskExecutor} entity.
 *
 * @author Juergen Hoeller
 * @since 3.0
 * @see ghost.framework.thread.task.TaskExecutor
 * @see java.util.concurrent.ScheduledExecutorService
 * @see ghost.framework.scheduling.concurrent.ThreadPoolTaskScheduler
 */
public interface TaskScheduler {
	 ...
	 * e.g. a {@link ghost.framework.scheduling.support.CronTrigger} object
	 * wrapping a cron expression
	 * @return a {@link ScheduledFuture} representing pending completion of the task,
	 * or {@code null} if the given Trigger object never fires (i.e. returns
	 * {@code null} from {@link Trigger#nextExecutionTime})
	 * @throws ghost.framework.thread.task.TaskRejectedException if the given task was not accepted
	 * for internal reasons (e.g. a pool overload handling policy or a pool shutdown in progress)
	 * @see ghost.framework.scheduling.support.CronTrigger
	 */
	@Nullable
