...
/**
 * A {@link ghost.framework.thread.task.TaskExecutor} extension exposing
 ...
 * implement the {@link ghost.framework.thread.task.AsyncListenableTaskExecutor}
 * interface. This is not required due to the dependency on Spring 4.0's new
 * {@link ghost.framework.context.concurrent.ListenableFuture} interface,
 ...
 * @see ghost.framework.scheduling.commonj.WorkManagerTaskExecutor
 */
