...
import ghost.framework.data.redis.cache.transaction.AbstractRedisCacheTransactionManager;
...
/**
 * {@link ghost.framework.cache.CacheManager} backed by a {@link RedisCache Redis} cache.
 * <p />
 ...
 */
public class RedisCacheManager extends AbstractRedisCacheTransactionManager {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.cache.support.AbstractCacheManager#loadCaches()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.cache.support.AbstractCacheManager#getMissingCache(java.lang.String)
	 */
	@Override
	...
	public static class RedisCacheManagerBuilder {
		...
		/**
		 * Disable in-flight {@link ghost.framework.cache.Cache} creation for unconfigured caches.
		 * <p />
		 * {@link RedisCacheManager#getMissingCache(String)} returns {@literal null} for any unconfigured
		 * {@link ghost.framework.cache.Cache} instead of a new {@link RedisCache} instance. This allows eg.
		 * {@link ghost.framework.cache.support.CompositeCacheManager} to chime in.
		 *
		 * @return this {@link RedisCacheManagerBuilder}.
		 * @since 2.0.4
		 */
