...
public class RedisCacheConfiguration {
	...
	private RedisCacheConfiguration(Duration ttl, Boolean cacheNullValues, Boolean usePrefix, CacheKeyPrefix keyPrefix,
									RedisSerializationContext.SerializationPair<String> keySerializationPair, RedisSerializationContext.SerializationPair<?> valueSerializationPair,
	 ...
	 * <dd>{@link ghost.framework.data.redis.serializer.StringRedisSerializer}</dd>
	 * <dt>value serializer</dt>
	 * <dd>{@link ghost.framework.data.redis.serializer.JdkSerializationRedisSerializer}</dd>
	 ...
	 *          {@link ghost.framework.data.redis.serializer.JdkSerializationRedisSerializer}.
	 * @return new {@link RedisCacheConfiguration}.
	 * @since 2.1
	 */
	public static RedisCacheConfiguration defaultCacheConfig(@Nullable ClassLoader classLoader) {
		...
		return new RedisCacheConfiguration(Duration.ZERO, true, true, CacheKeyPrefix.simple(),
				...
				RedisSerializationContext.SerializationPair.fromSerializer(RedisSerializer.java(classLoader)), conversionService);
	}
	 ...
	 * <strong>NOTE</strong> any {@link ghost.framework.cache.Cache#put(Object, Object)} operation involving
