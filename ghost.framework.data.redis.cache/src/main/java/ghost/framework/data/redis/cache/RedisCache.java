 ...
 */
package ghost.framework.data.redis.cache;

import com.sun.istack.internal.Nullable;
import ghost.framework.context.converter.ConverterContainer;
import ghost.framework.data.cache.transaction.AbstractValueAdaptingCache;
import ghost.framework.data.cache.transaction.NullValue;
import ghost.framework.data.cache.transaction.SimpleValueWrapper;
...
/**
 * {@link ghost.framework.cache.Cache} implementation using for Redis as underlying store.
 * <p/>
...
public class RedisCache extends AbstractValueAdaptingCache {
	private static final byte[] BINARY_NULL_VALUE = null;//RedisSerializer.java().serialize(NullValue.INSTANCE);
	...
	protected RedisCache(String name, RedisCacheWriter cacheWriter, RedisCacheConfiguration cacheConfig) {
		...
		this.converterContainer = cacheConfig.getConversionService();
	}

	/*
	 * (non-Javadoc)
	 * @see ghost.framework.cache.support.AbstractValueAdaptingCache#lookup(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.cache.Cache#getName()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.cache.Cache#getNativeCache()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.cache.Cache#get(java.lang.Object, java.util.concurrent.Callable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.cache.Cache#put(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.cache.Cache#putIfAbsent(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.cache.Cache#evict(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.cache.Cache#clear()
	 */
	@Override
	public void clear() {
...
//		cacheWriter.clean(name, pattern);
	 ...
	 * {@link ghost.framework.data.redis.serializer.RedisSerializer}.
	 *
