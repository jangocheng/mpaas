...
public class SslServerCustomizer implements NettyServerCustomizer {
	 ...
	 */
	public SslServerCustomizer(ClassLoader classLoader, Ssl ssl, Http2 http2, SslStoreProvider sslStoreProvider) {
	...
	private KeyStore loadStore(String type, String provider, String resource, String password) throws Exception {
		...
		try {
			URL url = ResourceUtils.getURL(this.classLoader, resource);
