...
public class UndertowWebServer implements WebServer {
	 ...
	 */
	public UndertowWebServer(IModule module, Undertow.Builder builder, boolean autoStart) {
		this(module, builder, autoStart, null);
	}
	 ...
	 * @since 2.0.4
	 */
	public UndertowWebServer(IModule module, Undertow.Builder builder, boolean autoStart, Closeable closeable) {
		this.module = module;
