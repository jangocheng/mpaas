...
import ghost.framework.data.core.DataBaseStatus;
import ghost.framework.data.core.IDataBaseProperties;
 ...
 * 数据库配置。
 */
public class DataBaseProperties implements IDataBaseProperties, IGetObjectId, IGetDataBaseCacheProperties {
    /**
     * 事务超时
     */
