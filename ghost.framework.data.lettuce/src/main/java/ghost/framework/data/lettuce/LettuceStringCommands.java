...
class LettuceStringCommands implements RedisStringCommands {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#set(byte[], byte[], ghost.framework.data.redis.core.types.Expiration, ghost.framework.data.redis.connection.RedisStringCommands.SetOption)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#bitPos(byte[], boolean, ghost.framework.data.domain.Range)
	 */
	@Nullable
	@Override
