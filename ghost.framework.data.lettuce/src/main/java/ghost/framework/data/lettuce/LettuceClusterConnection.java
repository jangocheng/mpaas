...
public class LettuceClusterConnection extends LettuceConnection implements DefaultedRedisClusterConnection {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#geoCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#hashCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#hyperLogLogCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#keyCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#listCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#stringCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#setCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#zSetCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#serverCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#ping()
	 */
	@Override
	public String ping() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#getClusterNodes()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#getClusterSlaves(ghost.framework.data.redis.connection.RedisClusterNode)
	 */
	@Override
	...
	public Map<RedisClusterNode, Collection<RedisClusterNode>> clusterGetMasterSlaveMap() {
		...
		List<ClusterCommandExecutor.NodeResult<Collection<RedisClusterNode>>> nodeResults = clusterCommandExecutor.executeCommandAsyncOnNodes(
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#getClusterNodeForSlot(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#getClusterNodeForKey(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#getClusterInfo()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#addSlots(ghost.framework.data.redis.connection.RedisClusterNode, int[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#countKeys(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#deleteSlots(ghost.framework.data.redis.connection.RedisClusterNode, int[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#getKeysInSlot(int, java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#watch(byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#unwatch()
	 */
	@Override
	public void unwatch() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#multi()
	 */
	@Override
	public void multi() {
	...
	/**
	 * Lettuce specific implementation of {@link ClusterCommandExecutor.ClusterCommandCallback}.
	 *
	 * @author Christoph Strobl
	 * @param <T>
	 * @since 1.7
	...
	/**
	 * Lettuce specific implementation of {@link ClusterCommandExecutor.MultiKeyClusterCommandCallback}.
	 *
	 * @author Christoph Strobl
	 * @param <T>
	 * @since 1.7
	 ...
	 * @since 1.7
	 */
	static class LettuceClusterNodeResourceProvider implements ClusterNodeResourceProvider, AutoCloseable {
