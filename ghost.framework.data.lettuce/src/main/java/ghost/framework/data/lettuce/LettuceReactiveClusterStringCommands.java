...
import ghost.framework.data.redis.connection.ReactiveClusterStringCommands;
...
class LettuceReactiveClusterStringCommands extends LettuceReactiveStringCommands
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceReactiveStringCommands#bitOp(org.reactivestreams.Publisher)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceReactiveStringCommands#mSetNX(org.reactivestreams.Publisher)
	 */
	@Override
