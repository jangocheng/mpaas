...
class LettuceClusterKeyCommands extends LettuceKeyCommands {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#randomKey()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#keys(byte[])
	 */
	@Override
	public Set<byte[]> keys(byte[] pattern) {
		...
		Collection<List<byte[]>> keysPerNode = connection.getClusterCommandExecutor()
				.executeCommandOnAllNodes((LettuceClusterConnection.LettuceClusterCommandCallback<List<byte[]>>) connection -> connection.keys(pattern))
				.resultsAsList();
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#rename(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#renameNX(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#move(byte[], int)
	*/
	@Override
	...
	*/
	...
	public byte[] randomKey(RedisClusterNode node) {
		...
		return connection.getClusterCommandExecutor()
				.executeCommandOnSingleNode((LettuceClusterConnection.LettuceClusterCommandCallback<byte[]>) client -> client.randomkey(), node)
				.getValue();
	}
	...
	public Set<byte[]> keys(RedisClusterNode node, byte[] pattern) {
		...
		return LettuceConverters.toBytesSet(connection.getClusterCommandExecutor()
				.executeCommandOnSingleNode((LettuceClusterConnection.LettuceClusterCommandCallback<List<byte[]>>) client -> client.keys(pattern), node)
				.getValue());
	}
	/**
	...
	Cursor<byte[]> scan(RedisClusterNode node, ScanOptions options) {
		...
		return connection.getClusterCommandExecutor()
				.executeCommandOnSingleNode((LettuceClusterConnection.LettuceClusterCommandCallback<ScanCursor<byte[]>>) client -> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnection#sort(byte[], ghost.framework.data.redis.connection.SortParameters, byte[])
	 */
	@Override
