...
import ghost.framework.data.redis.connection.PoolException;
...
public class DefaultLettucePool implements LettucePool {
	...
	private @Nullable
	GenericObjectPool<StatefulConnection<byte[], byte[]>> internalPool;
	...
	/**
	 * Uses the {@link LettuceClientConfiguration} and {@link RedisClient} defaults for configuring the connection pool
	 *
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.Pool#getResource()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.Pool#returnBrokenResource(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.Pool#returnResource(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.Pool#destroy()
	 */
	@Override
	public void destroy() {
