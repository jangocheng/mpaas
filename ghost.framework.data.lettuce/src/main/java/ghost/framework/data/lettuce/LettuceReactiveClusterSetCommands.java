...
import ghost.framework.data.redis.connection.ReactiveClusterSetCommands;
...
class LettuceReactiveClusterSetCommands extends LettuceReactiveSetCommands implements ReactiveClusterSetCommands {
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceReactiveSetCommands#sUnion(org.reactivestreams.Publisher)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceReactiveSetCommands#sUnionStore(org.reactivestreams.Publisher)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceReactiveSetCommands#sInter(org.reactivestreams.Publisher)
	 */
	@Override
	public Flux<ReactiveRedisConnection.CommandResponse<SInterCommand, Flux<ByteBuffer>>> sInter(Publisher<SInterCommand> commands) {
		...
		return getConnection().execute(cmd -> Flux.from(commands).concatMap(command -> {
			...
			return Mono.just(new ReactiveRedisConnection.CommandResponse<>(command, result.concatMap(v -> Flux.fromStream(v.stream()))));
		}));
	}

	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceReactiveSetCommands#sInterStore(org.reactivestreams.Publisher)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceReactiveSetCommands#sDiff(org.reactivestreams.Publisher)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceReactiveSetCommands#sDiffStore(org.reactivestreams.Publisher)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceReactiveSetCommands#sMove(org.reactivestreams.Publisher)
	 */
	@Override
	public Flux<ReactiveRedisConnection.BooleanResponse<SMoveCommand>> sMove(Publisher<SMoveCommand> commands) {
		...
		return getConnection().execute(cmd -> Flux.from(commands).concatMap(command -> {
			...
			return result.defaultIfEmpty(Boolean.FALSE).map(value -> new ReactiveRedisConnection.BooleanResponse<>(command, value));
		}));
	}
}
