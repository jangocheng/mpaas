...
class LettuceClusterServerCommands extends LettuceServerCommands implements RedisClusterServerCommands {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceServerCommands#dbSize()
	 */
	@Override
	public Long dbSize() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceServerCommands#flushDb()
	 */
	@Override
	public void flushDb() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceServerCommands#flushAll()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceServerCommands#info()
	 */
	@Override
	public Properties info() {
		...
		List<ClusterCommandExecutor.NodeResult<Properties>> nodeResults = executeCommandOnAllNodes(
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceServerCommands#info(java.lang.String)
	 */
	@Override
	...
	public void shutdown(RedisClusterNode node) {
		executeCommandOnSingleNode((LettuceClusterConnection.LettuceClusterCommandCallback<Void>) client -> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceServerCommands#getConfig(java.lang.String)
	 */
	@Override
	public Properties getConfig(String pattern) {
		...
		List<ClusterCommandExecutor.NodeResult<Map<String, String>>> mapResult = executeCommandOnAllNodes(client -> client.configGet(pattern))
				.getResults();

		Properties properties = new Properties();

		for (ClusterCommandExecutor.NodeResult<Map<String, String>> entry : mapResult) {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceServerCommands#setConfig(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceServerCommands#resetConfigStats()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceServerCommands#time()
	 */
	@Override
	public Long time() {

		return convertListOfStringToTime(connection.getClusterCommandExecutor()
				.executeCommandOnArbitraryNode((LettuceClusterConnection.LettuceClusterCommandCallback<List<byte[]>>) RedisServerCommands::time)
				.getValue());
	}
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceServerCommands#getClientList()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceServerCommands#slaveOf(java.lang.String, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.lettuce.LettuceServerCommands#slaveOfNoOne()
	 */
	@Override
	...
	private <T> ClusterCommandExecutor.NodeResult<T> executeCommandOnSingleNode(LettuceClusterConnection.LettuceClusterCommandCallback<T> command,
																				RedisClusterNode node) {
		return connection.getClusterCommandExecutor().executeCommandOnSingleNode(command, node);
	}

	private <T> ClusterCommandExecutor.MultiNodeResult<T> executeCommandOnAllNodes(final LettuceClusterConnection.LettuceClusterCommandCallback<T> cmd) {
