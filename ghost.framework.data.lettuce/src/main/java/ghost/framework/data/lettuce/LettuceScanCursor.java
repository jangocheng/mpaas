...
abstract class LettuceScanCursor<T> extends ScanCursor<T> {
	...
	private @Nullable
	io.lettuce.core.ScanCursor state;
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ScanCursor#doScan(long, ghost.framework.data.redis.core.ScanOptions)
	 */
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ScanCursor#isFinished(long)
	 */
	@Override
