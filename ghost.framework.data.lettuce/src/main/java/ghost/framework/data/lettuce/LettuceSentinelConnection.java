...
public class LettuceSentinelConnection implements RedisSentinelConnection {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSentinelCommands#failover(ghost.framework.data.redis.connection.NamedNode)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSentinelCommands#masters()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSentinelCommands#slaves(ghost.framework.data.redis.connection.NamedNode)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSentinelCommands#remove(ghost.framework.data.redis.connection.NamedNode)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSentinelCommands#monitor(ghost.framework.data.redis.connection.RedisServer)
	 */
	@Override
	...
	private static class DedicatedClientConnectionProvider implements LettuceConnectionProvider {
		...
		/* 
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.lettuce.LettuceConnectionProvider#releaseAsync(io.lettuce.core.api.StatefulConnection)
		 */
		@Override
