...
class LettuceReactiveRedisConnection implements ReactiveRedisConnection {
	...
	private @Nullable
	Mono<StatefulConnection<ByteBuffer, ByteBuffer>> sharedConnection;
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#keyCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#stringCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#numberCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#listCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#setCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#zSetCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#hashCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#geoCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#hyperLogLogCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#pubSubCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#scriptingCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#serverCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#streamCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#ping()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.ReactiveRedisConnection#closeLater()
	 */
	...
	static class AsyncConnect<T extends io.lettuce.core.api.StatefulConnection<?, ?>> {
		...
		Mono<Void> close() {
			...
			return Mono.defer(() -> {
				...
				if (state.compareAndSet(State.INITIAL, State.CLOSING) || state.compareAndSet(State.CONNECTION_REQUESTED, State.CLOSING)) {
