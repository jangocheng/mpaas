...
import ghost.framework.data.redis.connection.FutureResult;
...
class LettuceResult<T, R> extends FutureResult<RedisCommand<?, T, ?>> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.FutureResult#get()
	 */
	@Nullable
	@Override
	@SuppressWarnings("unchecked")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.FutureResult#conversionRequired()
	 */
	@Override
