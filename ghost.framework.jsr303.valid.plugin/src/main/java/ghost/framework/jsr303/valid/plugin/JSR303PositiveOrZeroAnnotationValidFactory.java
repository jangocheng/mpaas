...
public class JSR303PositiveOrZeroAnnotationValidFactory implements AnnotationValidBeanFactory {
    /**
     * 类型注释工厂注释
     */
    private final Class<? extends Annotation> annotation = PositiveOrZero.class;
