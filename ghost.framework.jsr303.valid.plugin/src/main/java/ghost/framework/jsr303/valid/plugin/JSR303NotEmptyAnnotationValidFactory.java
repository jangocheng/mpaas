...
public class JSR303NotEmptyAnnotationValidFactory implements AnnotationValidBeanFactory {
    /**
     * 类型注释工厂注释
     */
    private final Class<? extends Annotation> annotation = NotEmpty.class;
