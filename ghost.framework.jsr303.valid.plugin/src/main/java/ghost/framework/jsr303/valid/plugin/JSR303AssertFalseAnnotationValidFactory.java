...
public class JSR303AssertFalseAnnotationValidFactory implements AnnotationValidBeanFactory {
    /**
     * 类型注释工厂注释
     */
    private final Class<? extends Annotation> annotation = AssertFalse.class;
    /**
     * @return
     */
    @Override
