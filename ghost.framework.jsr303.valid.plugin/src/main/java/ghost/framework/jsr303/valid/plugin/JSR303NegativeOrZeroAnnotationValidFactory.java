...
public class JSR303NegativeOrZeroAnnotationValidFactory implements AnnotationValidBeanFactory {
    /**
     * 类型注释工厂注释
     */
    private final Class<? extends Annotation> annotation = NegativeOrZero.class;
