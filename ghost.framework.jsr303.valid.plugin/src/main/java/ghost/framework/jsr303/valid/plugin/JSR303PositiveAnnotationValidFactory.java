...
public class JSR303PositiveAnnotationValidFactory implements AnnotationValidBeanFactory {
    /**
     * 类型注释工厂注释
     */
    private final Class<? extends Annotation> annotation = Positive.class;
