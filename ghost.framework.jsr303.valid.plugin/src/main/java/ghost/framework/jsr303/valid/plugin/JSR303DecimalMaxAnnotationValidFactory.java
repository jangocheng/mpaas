...
public class JSR303DecimalMaxAnnotationValidFactory implements AnnotationValidBeanFactory {
    /**
     * 类型注释工厂注释
     */
    private final Class<? extends Annotation> annotation = DecimalMax.class;
