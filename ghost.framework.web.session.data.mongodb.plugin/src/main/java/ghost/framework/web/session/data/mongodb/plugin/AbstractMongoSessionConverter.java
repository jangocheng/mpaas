...
import ghost.framework.core.convert.converter.GenericConverter;
...
import ghost.framework.session.DelegatingIndexResolver;
import ghost.framework.session.FindByIndexNameSessionRepository;
import ghost.framework.session.IndexResolver;
import ghost.framework.session.PrincipalNameIndexResolver;
