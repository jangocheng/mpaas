...
import ghost.framework.data.commons.annotation.TableDescription;
...
@Entity
@Table(name= "ssh_region_707b0ef3",
        indexes = {
...
public class SshRegionEntity implements Serializable {
    private static final long serialVersionUID = 5227475714727949453L;
    /**
     * 主键id
     */
    @Id
