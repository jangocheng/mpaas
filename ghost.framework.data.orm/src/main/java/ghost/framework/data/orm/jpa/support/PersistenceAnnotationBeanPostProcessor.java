...
//import ghost.framework.beans.factory.annotation.InjectionMetadata;
...
import ghost.framework.data.orm.jpa.*;
import ghost.framework.jndi.JndiLocatorDelegate;
import ghost.framework.jndi.JndiTemplate;
...
//import ghost.framework.orm.jpa.*;
 ...
 * Typically, Spring's {@link ghost.framework.data.orm.jpa.LocalContainerEntityManagerFactoryBean}
 ...
 *
 * <pre class="code">
 * &lt;bean class="ghost.framework.orm.jpa.support.PersistenceAnnotationBeanPostProcessor"/&gt;</pre>
 *
 ...
 *
 * <pre class="code">
 * &lt;bean class="ghost.framework.orm.jpa.support.PersistenceAnnotationBeanPostProcessor"&gt;
 ...
 * and {@link ghost.framework.data.transaction.jta.JtaTransactionManager} as backend).
 *
...
public class PersistenceAnnotationBeanPostProcessor
	...
	private final ICoreInterface coreInterface;
	public PersistenceAnnotationBeanPostProcessor(ICoreInterface coreInterface){
	 ...
	 * @see ghost.framework.jndi.JndiAccessor#setJndiTemplate
	 */
	 ...
	 * @see ghost.framework.jndi.JndiAccessor#setJndiEnvironment
	 */
	 ...
	 * @see ghost.framework.jndi.JndiLocatorSupport#setResourceRef
	 */
		...
		do {
			...
			ReflectionUtils.doWithLocalMethods(targetClass, method -> {
				...
				if ((bridgedMethod.isAnnotationPresent(PersistenceContext.class) ||
					...
					PropertyDescriptor pd = null;//this.coreInterface.findPropertyForMethod(bridgedMethod, clazz);//BeanUtils.findPropertyForMethod(bridgedMethod, clazz);
