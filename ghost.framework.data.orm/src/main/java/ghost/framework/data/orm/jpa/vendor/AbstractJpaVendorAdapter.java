...
package ghost.framework.data.orm.jpa.vendor;

import ghost.framework.beans.annotation.constraints.Nullable;
import ghost.framework.data.orm.jpa.JpaDialect;
...
public abstract class AbstractJpaVendorAdapter implements JpaVendorAdapter {
	 ...
	 * @see ghost.framework.orm.jpa.AbstractEntityManagerFactoryBean#setJpaProperties
	 */
