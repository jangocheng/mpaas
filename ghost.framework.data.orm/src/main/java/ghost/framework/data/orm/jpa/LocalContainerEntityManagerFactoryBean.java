...
package ghost.framework.data.orm.jpa;
...
//import ghost.framework.jdbc.datasource.lookup.SingleDataSourceLookup;
//import ghost.framework.lang.Nullable;
//import ghost.framework.orm.jpa.persistenceunit.DefaultPersistenceUnitManager;
//import ghost.framework.orm.jpa.persistenceunit.PersistenceUnitManager;
//import ghost.framework.orm.jpa.persistenceunit.PersistenceUnitPostProcessor;
//import ghost.framework.orm.jpa.persistenceunit.SmartPersistenceUnitInfo;
...
import ghost.framework.data.jdbc.datasource.lookup.SingleDataSourceLookup;
import ghost.framework.data.orm.jpa.persistenceunit.DefaultPersistenceUnitManager;
import ghost.framework.data.orm.jpa.persistenceunit.PersistenceUnitManager;
import ghost.framework.data.orm.jpa.persistenceunit.PersistenceUnitPostProcessor;
import ghost.framework.data.orm.jpa.persistenceunit.SmartPersistenceUnitInfo;
...
/**
 * {@link ghost.framework.beans.factory.FactoryBean} that creates a JPA
 ...
 * {@link ghost.framework.instrument.classloading.LoadTimeWeaver} abstraction,
 ...
 * @see ghost.framework.data.orm.jpa.support.SharedEntityManagerBean
...
public class LocalContainerEntityManagerFactoryBean extends AbstractEntityManagerFactoryBean
	...
	public LocalContainerEntityManagerFactoryBean(@Autowired ICoreInterface coreInterface) {
		super(coreInterface);
	}
	 ...
	 * @see #setDataSource
	 * @see #setLoadTimeWeaver
	 * @see ghost.framework.data.orm.jpa.persistenceunit.DefaultPersistenceUnitManager
	 */
	 ...
	 * ({@link ghost.framework.context.annotation.ClassPathBeanDefinitionScanner}).
	 ...
	 * @see ghost.framework.instrument.classloading.InstrumentationLoadTimeWeaver
	 * @see ghost.framework.instrument.classloading.ReflectiveLoadTimeWeaver
	 */
//	@Override
...
//	@Override
	public void setResourceLoader(IResourceLoader IResourceLoader) {
		this.internalPersistenceUnitManager.setResourceLoader(IResourceLoader);
	}
	@Loader
	@Override
	...
	protected EntityManagerFactory createNativeEntityManagerFactory() throws PersistenceException {
		...
		if (provider == null) {
			...
			provider = (PersistenceProvider) this.coreInterface.newInstance(providerClass);//BeanUtils.instantiateClass(providerClass);
		}
