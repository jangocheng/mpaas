...
import ghost.framework.data.transaction.dao.annotation.PersistenceExceptionTranslationPostProcessor;
...
/**
 * Abstract {@link FactoryBean} that creates
 ...
 * {@link PersistenceExceptionTranslationPostProcessor},
...
public abstract class AbstractEntityManagerFactoryBean implements
		...
		/*InitializingBean*/ AutoCloseable, EntityManagerFactoryInfo, PersistenceExceptionTranslator, Serializable {
	/** Logger available to subclasses. */
	protected final Log logger = LogFactory.getLog(getClass());
	protected final ICoreInterface coreInterface;
	public AbstractEntityManagerFactoryBean(ICoreInterface coreInterface){
		Assert.notNull(coreInterface, "ICoreInterface must not be null");
		this.coreInterface = coreInterface;
		this.beanClassLoader = (ClassLoader) this.coreInterface.getClassLoader();
	}
	@Nullable
	...
	public void setPersistenceProviderClass(Class<? extends PersistenceProvider> persistenceProviderClass) {
		this.persistenceProvider = (PersistenceProvider)this.coreInterface.newInstance(persistenceProviderClass);// BeanUtils.instantiateClass(persistenceProviderClass);
	}
	 ...
	 * @see javax.persistence.spi.PersistenceProvider#createContainerEntityManagerFactory(javax.persistence.spi.PersistenceUnitInfo, Map)
	 */
