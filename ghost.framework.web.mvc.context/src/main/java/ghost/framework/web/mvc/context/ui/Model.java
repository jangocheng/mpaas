...
/**
 * Java-5-specific interface that defines a holder for entity attributes.
 * Primarily designed for adding attributes to the entity.
 * Allows for accessing the overall entity as a {@code java.util.Map}.
 *
...
public interface Model {
	...
	/**
	 * Return the current set of entity attributes as a Map.
	 */
