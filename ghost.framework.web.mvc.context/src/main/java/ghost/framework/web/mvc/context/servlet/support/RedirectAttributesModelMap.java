...
package ghost.framework.web.mvc.context.servlet.support;
...
public class RedirectAttributesModelMap extends ModelMap implements RedirectAttributes {
	...
	@Nullable
	private final Object dataBinder;
	 ...
	 */
	public RedirectAttributesModelMap(@Nullable Object dataBinder) {
	...
	private String formatValue(@Nullable Object value) {
		...
		return null;//(this.dataBinder != null ? this.dataBinder.convertIfNecessary(value, String.class) : value.toString());
	}
