 ...
 * variables in {@code ghost.framework.web.servlet.view.RedirectView}.
 *
 ...
 * </pre>
 *
 * <p>A RedirectAttributes entity is empty when the method is called and is never
 * used unless the method returns a redirect view name or a RedirectView.
 *
 * <p>After the redirect, flash attributes are automatically added to the entity
