...
//import ghost.framework.web.context.http.server.ServerHttpRequest;
//import ghost.framework.web.context.http.server.reactive.ServerHttpResponse;
//import ghost.framework.web.module.server.ServerWebExchange;
//import ghost.framework.web.module.servlet.HandlerMapping;
//import ghost.framework.web.context.utils.UriComponentsBuilder;
//import ghost.framework.web.context.utils.UriUtils;
...
// * values from the entity or with URI variables from the current request.
// *
...
//	}
//
//	public RedirectView(String redirectUrl, boolean redirectContextRelative, boolean redirectHttp10Compatible) {
//	}
//
//
//	/**
...
//
//	/**
//	 * Convert entity to request parameters and redirect to the given URL.
//	 */
////	@Override
//	protected Mono<Void> renderInternal(
//			Map<String, Object> entity, @Nullable MediaType contentType, ServerWebExchange exchange) {
//
//		String targetUrl = createTargetUrl(entity, exchange);
...
//	 */
//	protected final String createTargetUrl(Map<String, Object> entity, ServerWebExchange exchange) {
//		String url = getUrl();
...
//			targetUrl = expandTargetUrlTemplate(targetUrl.toString(), entity, uriVars);
//		}
//
//		if (isPropagateQuery()) {
...
//		return null;//(processor != null ? processor.processUrl(exchange, result) : result);
//	}
//
...
//
//	/**
//	 * Expand URI template variables in the target URL with either entity
...
//			Map<String, Object> entity, Map<String, String> uriVariables) {
//
...
//			Object value = (entity.containsKey(name) ? entity.get(name) : uriVariables.get(name));
...
//
//	@Override
//	protected void renderMergedOutputModel(Map<String, Object> entity, HttpServletRequest request, HttpServletResponse response) throws Exception {
//
//	}
//}
