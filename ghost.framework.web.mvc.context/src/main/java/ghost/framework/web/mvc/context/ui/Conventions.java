...
//import ghost.framework.web.module.SerializableTypeWrapper.ResolvableType;
//import ghost.framework.web.module.servlet.MethodParameter;
...
//			valueClass = null;//ResolvableType.forMethodParameter(parameter).asCollection().resolveGeneric();
//			if (valueClass == null) {
//				throw new IllegalArgumentException(
...
//	}
	...
	public static String getVariableNameForReturnType(Method method, Class<?> resolvedType, @Nullable Object value) {
		...
		if (resolvedType.isArray()) {
			...
			valueClass = null;//ResolvableType.forMethodReturnType(method).asCollection().resolveGeneric();
			if (valueClass == null) {
