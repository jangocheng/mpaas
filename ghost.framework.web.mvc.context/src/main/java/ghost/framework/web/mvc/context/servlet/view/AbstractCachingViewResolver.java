...
// * @see #loadView
// */
//public abstract class AbstractCachingViewResolver implements IViewResolver {
//
//	/** Default maximum number of entries for the view cache: 1024. */
//	public static final int DEFAULT_CACHE_LIMIT = 1024;
//
//	/** Dummy marker object for unresolved views in the cache Maps. */
//	private static final IView UNRESOLVED_VIEW = new IView() {
//		@Override
//		@Nullable
...
//		}
//		@Override
//		public void render(@Nullable Map<String, ?> entity, HttpServletRequest request, HttpServletResponse response) {
//		}
//	};
//
...
//	private final Map<Object, IView> viewAccessCache = new ConcurrentHashMap<>(DEFAULT_CACHE_LIMIT);
//
//	/** Map from view key to View instance, synchronized for View creation. */
//	@SuppressWarnings("serial")
//	private final Map<Object, IView> viewCreationCache =
//			new LinkedHashMap<Object, IView>(DEFAULT_CACHE_LIMIT, 0.75f, true) {
//				@Override
//				protected boolean removeEldestEntry(Map.Entry<Object, IView> eldest) {
...
//	@Override
//	@Nullable
//	public IView resolveViewName(String viewName, Locale locale) throws Exception {
//		if (!isCache()) {
//			return createView(viewName, locale);
//		}
//		else {
//			Object cacheKey = getCacheKey(viewName, locale);
//			IView view = this.viewAccessCache.get(cacheKey);
//			if (view == null) {
...
//	 */
//	@Nullable
//	protected IView createView(String viewName, Locale locale) throws Exception {
...
//	 */
//	@Nullable
//	protected abstract IView loadView(String viewName, Locale locale) throws Exception;
//
//
//	/**
...
//		 */
//		boolean filter(IView view, String viewName, Locale locale);
//	}
//
//}
