...
// * Exposes entity objects as request attributes and forwards the request to
...
// *
// * <pre class="code">&lt;bean id="viewResolver" class="ghost.framework.web.servlet.view.InternalResourceViewResolver"&gt;
...
//
//	/**
//	 * Render the internal resource given the specified entity.
//	 * This includes setting the entity as request attributes.
//	 */
//	@Override
//	protected void renderMergedOutputModel(
//            Map<String, Object> entity, HttpServletRequest request, HttpServletResponse response) throws Exception {
//
//		// Expose the entity object as request attributes.
//		exposeModelAsRequestAttributes(entity, request);
//
...
//	 * @see ghost.framework.web.util.WebUtils#isIncludeRequest
//	 */
