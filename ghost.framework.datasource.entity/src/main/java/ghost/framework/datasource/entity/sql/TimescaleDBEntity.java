 ...
 */
@Entity
@Table(name="8a4987aa3038476f9681693d50c322a8",
        indexes = {
...
public class TimescaleDBEntity implements Serializable {
    private static final long serialVersionUID = 5980433825286908360L;
    /**
     * 主键id
     */
    @Id
