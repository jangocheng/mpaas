 ...
 */
@Entity
@Table(name="2b67e8a2ffc147278abf7e429702fea7",
        indexes = {
...
public class SQLServeEntity implements Serializable {
    private static final long serialVersionUID = -7212868603923494429L;
    /**
     * 主键id
     */
    @Id
