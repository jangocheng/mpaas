 ...
 * {@link ghost.framework.context.config.SpringConfiguredBeanDefinitionParser}
...
class SpringConfiguredBeanDefinitionParser implements BeanDefinitionParser {
	...
	public static final String BEAN_CONFIGURER_ASPECT_BEAN_NAME =
			"ghost.framework.context.config.internalBeanConfigurerAspect";

	private static final String BEAN_CONFIGURER_ASPECT_CLASS_NAME =
			"ghost.framework.beans.factory.aspectj.AnnotationBeanConfigurerAspect";
