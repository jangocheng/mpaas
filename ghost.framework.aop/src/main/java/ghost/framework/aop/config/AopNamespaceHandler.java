...
import ghost.framework.context.xml.NamespaceHandlerSupport;
//import ghost.framework.beans.factory.xml.BeanDefinitionParser;
//import ghost.framework.beans.factory.xml.NamespaceHandlerSupport;

/**
 * {@code NamespaceHandler} for the {@code aop} namespace.
 *
 * <p>Provides a {@link ghost.framework.beans.factory.xml.BeanDefinitionParser} for the
 ...
 * </pre>
 *
 * <p>Using the {@code advisor} tag you can configure an {@link ghost.framework.aop.Advisor}
 * and have it applied to all relevant beans in you {@link ghost.framework.beans.factory.BeanFactory}
 * automatically. The {@code advisor} tag supports both in-line and referenced
 * {@link ghost.framework.aop.Pointcut Pointcuts}:
 *
 * <pre class="code">
