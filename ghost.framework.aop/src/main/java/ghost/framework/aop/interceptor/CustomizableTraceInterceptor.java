...
//import ghost.framework.core.Constants;
...
public class CustomizableTraceInterceptor extends AbstractTraceInterceptor {
	 ...
	 */
	private static final Set<Object> ALLOWED_PLACEHOLDERS = null;//new Constants(CustomizableTraceInterceptor.class).getValues("PLACEHOLDER_");
