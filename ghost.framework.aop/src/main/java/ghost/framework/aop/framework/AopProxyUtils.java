...
import ghost.framework.aop.SpringProxy;
...
//import ghost.framework.core.DecoratingProxy;

/**
 * Utility methods for AOP proxy factories.
 * Mainly for internal use within the AOP framework.
 *
 * <p>See {@link ghost.framework.aop.support.AopUtils} for a collection of
 * generic AOP utility methods which do not depend on AOP framework internals.
 *
 * @author Rod Johnson
 * @author Juergen Hoeller
 * @see ghost.framework.aop.support.AopUtils
 */
public abstract class AopProxyUtils {
	 ...
	 * {@link ghost.framework.aop.SpringProxy} marker interface.
