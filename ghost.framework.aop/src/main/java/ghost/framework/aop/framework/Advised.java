 ...
 * @since 13.03.2003
 * @see ghost.framework.aop.framework.AdvisedSupport
 */
public interface Advised extends TargetClassAware {
	 ...
	 * @see ghost.framework.aop.ClassFilter
	 */
	 ...
	 * <p>The Advisor may be an {@link ghost.framework.aop.IntroductionAdvisor},
	 ...
	 * <p><b>Note:</b> If the advisor is an {@link ghost.framework.aop.IntroductionAdvisor}
	 ...
	 * @see ghost.framework.aop.support.DefaultPointcutAdvisor
	 */
	void addAdvice(Advice advice) throws AopConfigException;

	/**
	 * Add the given AOP Alliance Advice at the specified position in the advice chain.
	 * <p>This will be wrapped in a {@link ghost.framework.aop.support.DefaultPointcutAdvisor}
