...
package ghost.framework.aop.aspectj;

import ghost.framework.aop.ClassFilter;
import ghost.framework.aop.IntroductionAwareMethodMatcher;
import ghost.framework.aop.MethodMatcher;
import ghost.framework.aop.ProxyMethodInvocation;
import ghost.framework.aop.framework.autoproxy.ProxyCreationContext;
import ghost.framework.aop.interceptor.ExposeInvocationInterceptor;
import ghost.framework.aop.support.AbstractExpressionPointcut;
...
/**
 * Spring {@link ghost.framework.aop.Pointcut} implementation
 ...
 *
 * <p>Naturally, as this is to be processed by Spring AOP's proxy-based entity,
