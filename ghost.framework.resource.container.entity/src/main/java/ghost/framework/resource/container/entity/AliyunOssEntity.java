...
//@Application
@Entity
@Table(name= "d20fcc5301194e4b831438d1dada33d0",
        indexes = {
...
public class AliyunOssEntity implements Serializable {
    private static final long serialVersionUID = -7850579900440029397L;
    /**
     * 主键id
     */
    @Id
