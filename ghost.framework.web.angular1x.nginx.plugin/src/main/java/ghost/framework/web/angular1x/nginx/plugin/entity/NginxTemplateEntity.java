 ...
 */
@Entity
@Table(name= "nginx_template_06bcc029",
        indexes = {
...
public class NginxTemplateEntity implements Serializable {
    private static final long serialVersionUID = -2106182797953968888L;
    /**
     * 主键id
     */
    @Id
