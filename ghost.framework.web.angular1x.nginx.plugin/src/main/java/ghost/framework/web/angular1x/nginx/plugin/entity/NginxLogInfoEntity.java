 ...
 */
@Entity
@Table(name= "nginx_loginfo_7bbe8ba2",
        indexes = {
...
public class NginxLogInfoEntity implements Serializable {
    private static final long serialVersionUID = -6325672359469102809L;
    /**
     * 主键id
     */
    @Id
