 ...
 * @Description:
 * @Date: 2020/8/21:13:04
 */
@Entity
@Table(name= "nginx_reverse_proxy_722571b2",
        indexes = {
...
public class NginxReverseProxyEntity implements Serializable {
    private static final long serialVersionUID = 2328919501222207577L;
    /**
     * 主键id
     */
    @Id
