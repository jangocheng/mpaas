 ...
 * @Description:
 * @Date: 2020/8/21:13:05
 */
@Entity
@Table(name= "nginx_static_web_01387a91",
        indexes = {
...
public class NginxStaticWebEntity implements Serializable {
    private static final long serialVersionUID = 783071748765068561L;
    /**
     * 主键id
     */
    @Id
