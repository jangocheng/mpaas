 ...
 * @Description:
 * @Date: 2020/8/21:17:57
 */
@Entity
@Table(name= "nginx_param_6bc0ae99",
        indexes = {
...
public class NginxParamEntity implements Serializable {
    private static final long serialVersionUID = -2114993739507354309L;
    /**
     * 主键id
     */
    @Id
