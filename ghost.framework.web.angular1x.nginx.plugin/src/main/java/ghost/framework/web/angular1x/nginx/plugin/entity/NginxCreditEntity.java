 ...
 * @Description:
 * @Date: 2020/8/21:17:55
 */
@Entity
@Table(name= "nginx_credit_f7eb5cfc}",
        indexes = {
...
public class NginxCreditEntity implements Serializable {
    private static final long serialVersionUID = -7543026752224150168L;
    /**
     * 主键id
     */
    @Id
