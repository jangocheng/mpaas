 ...
 */
@Entity
@Table(name= "nginx_upstream_server_352c9686",
        indexes = {
...
public class NginxUpstreamServerEntity implements Serializable {
    private static final long serialVersionUID = -4955605564984690754L;
    /**
     * 主键id
     */
    @Id
