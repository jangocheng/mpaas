 ...
 */
@Entity
@Table(name= "nginx_upstream_81724666",
        indexes = {
...
public class NginxUpstreamEntity implements Serializable {
    private static final long serialVersionUID = -199759258913622823L;
    /**
     * 主键id
     */
    @Id
