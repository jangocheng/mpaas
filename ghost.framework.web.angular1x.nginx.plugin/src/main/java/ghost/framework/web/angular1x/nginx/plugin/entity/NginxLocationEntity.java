 ...
 */
@Entity
@Table(name= "nginx_location_7ebfb0de",
        indexes = {
...
public class NginxLocationEntity implements Serializable {
    private static final long serialVersionUID = 2484074078149029856L;
    /**
     * 主键id
     */
    @Id
