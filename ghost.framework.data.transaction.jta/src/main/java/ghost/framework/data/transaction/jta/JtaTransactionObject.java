...
import ghost.framework.transaction.support.SmartTransactionObject;
import ghost.framework.transaction.support.TransactionSynchronizationUtils;
...
public class JtaTransactionObject implements SmartTransactionObject {
	 ...
	 * @see ghost.framework.transaction.support.TransactionSynchronization#flush()
	 */
	@Override
	public void flush() {
