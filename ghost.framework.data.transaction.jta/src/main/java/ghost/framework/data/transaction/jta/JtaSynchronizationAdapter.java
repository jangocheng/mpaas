...
package ghost.framework.data.transaction.jta;

import ghost.framework.beans.annotation.constraints.Nullable;
import ghost.framework.transaction.support.TransactionSynchronization;
 ...
 * {@link ghost.framework.transaction.support.TransactionSynchronization}.
 *
 ...
 * @see ghost.framework.transaction.support.TransactionSynchronization
 */
public class JtaSynchronizationAdapter implements Synchronization {

	protected static final Log logger = LogFactory.getLog(JtaSynchronizationAdapter.class);
	...
	/**
	 * Create a new JtaSynchronizationAdapter for the given Spring
	 ...
	 * @see ghost.framework.transaction.support.TransactionSynchronization#beforeCommit
	 */
	@Override
	 ...
	 * callback with JTA.
	 * @see ghost.framework.transaction.support.TransactionSynchronization#beforeCompletion
	 * @see ghost.framework.transaction.support.TransactionSynchronization#afterCompletion
	 */
	@Override
