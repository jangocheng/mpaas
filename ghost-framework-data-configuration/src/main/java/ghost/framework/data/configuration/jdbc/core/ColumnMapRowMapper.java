 ...
 * for each row, representing all columns as value-value pairs: one
 * entry for each column, with the column value as value.
 *
 * <p>The Map implementation to use and the value to use for each column
...
public class ColumnMapRowMapper implements RowMapper<Map<String, Object>> {
	 ...
	 * @see ghost.framework.util.LinkedCaseInsensitiveMap
	 */
	...
	/**
	 * Determine the value to use for the given column in the column Map.
	 * @param columnName the column value as returned by the ResultSet
	 ...
	 * @see ghost.framework.jdbc.support.JdbcUtils#getResultSetValue
	 */
