...
package ghost.framework.data.configuration.jdbc.datasource;

import ghost.framework.data.configuration.jdbc.CannotGetJdbcConnectionException;
import ghost.framework.data.configuration.transaction.TransactionDefinition;
import ghost.framework.data.configuration.transaction.support.TransactionSynchronizationAdapter;
import ghost.framework.data.configuration.transaction.support.TransactionSynchronizationManager;
...
public abstract class DataSourceUtils {
	...
	/**
	 * Callback for resource cleanup at the After of a non-native JDBC transaction
