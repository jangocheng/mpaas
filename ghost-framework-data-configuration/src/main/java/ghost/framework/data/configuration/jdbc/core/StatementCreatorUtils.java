...
import ghost.framework.data.configuration.jdbc.support.SqlValue;
 ...
 * @see SqlParameter
 * @see SqlTypeValue
 * @see ghost.framework.jdbc.core.support.SqlLobValue
 */
public abstract class StatementCreatorUtils {
	 ...
	 * @param paramIndex index of the parameter we are setting
	 * @param sqlType the SQL type of the parameter
	 * @param typeName the type value of the parameter
		...
		if (inValue instanceof SqlParameterValue) {
			...
			if (logger.isDebugEnabled()) {
				logger.debug("Overriding type info with runtime info from SqlParameterValue: column index " + paramIndex +
						", SQL type " + parameterValue.getSqlType() + ", type value " + parameterValue.getTypeName());
			}
	 ...
	 * @see ghost.framework.jdbc.core.support.SqlLobValue#cleanup()
	 */
