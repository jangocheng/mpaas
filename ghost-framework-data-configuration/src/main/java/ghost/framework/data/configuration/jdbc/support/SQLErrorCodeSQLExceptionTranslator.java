...
import ghost.framework.data.configuration.dao.*;
import ghost.framework.data.configuration.jdbc.BadSqlGrammarException;
 ...
 * this package. It can be overridden through a file of the same value in the root
...
public class SQLErrorCodeSQLExceptionTranslator extends AbstractFallbackSQLExceptionTranslator {
	...
	/**
	 * Create an SQL error code translator for the given database product value.
	...
	/**
	 * Set the database product value for this translator.
