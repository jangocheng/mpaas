...
/**
 * Base class for {@link ghost.framework.jdbc.core.JdbcTemplate} and
 * other JDBC-accessing DAO helpers, defining common properties such as
 * DataSource and exception translator.
 *
 * <p>Not intended to be used directly.
 * See {@link ghost.framework.jdbc.core.JdbcTemplate}.
 *
...
public abstract class JdbcAccessor {
	...
	/**
	 * Specify the database product value for the DataSource that this accessor uses.
	 ...
	 * @param dbName the database product value that identifies the error codes entry
	 ...
	 * @see ghost.framework.jdbc.support.SQLErrorCodeSQLExceptionTranslator
	 * @see ghost.framework.jdbc.support.SQLStateSQLExceptionTranslator
	 */
