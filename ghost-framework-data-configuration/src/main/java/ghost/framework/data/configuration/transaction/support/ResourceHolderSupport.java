...
import ghost.framework.data.configuration.transaction.TransactionTimedOutException;
 ...
 * @since 02.02.2004
 * @see ghost.framework.jdbc.datasource.DataSourceTransactionManager#doBegin
...
public abstract class ResourceHolderSupport implements ResourceHolder {
	 ...
	 * @since 5.0
	 * @see ghost.framework.transaction.SavepointManager#rollbackToSavepoint
	 */
