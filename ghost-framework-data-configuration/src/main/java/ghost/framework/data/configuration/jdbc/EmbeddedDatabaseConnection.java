...
import ghost.framework.data.configuration.jdbc.core.ConnectionCallback;
import ghost.framework.data.configuration.jdbc.core.JdbcTemplate;
import ghost.framework.data.configuration.jdbc.datasource.embedded.EmbeddedDatabaseType;
...
public enum EmbeddedDatabaseConnection {
	...
	/**
	 * Returns the driver class value.
	 * @return the driver class value
	 */
	 ...
	 * @param databaseName the value of the database
	...
	/**
	 * Convenience method to determine if a given driver class value represents an embedded
	 * database type.
