...
import ghost.framework.data.configuration.jdbc.IncorrectResultSetColumnCountException;
...
//	}
	 ...
	 * @see ghost.framework.jdbc.support.JdbcUtils#getResultSetValue(ResultSet, int, Class)
	 ...
	 * @return the Object value
	 * @throws SQLException in case of extraction failure
	 * @see ghost.framework.jdbc.support.JdbcUtils#getResultSetValue(ResultSet, int)
	 */
...
//		}
	 ...
	 * @since 5.0.4
	 */
//	public static <T> SingleColumnRowMapper<T> newModuleInstance(Class<T> requiredType,  ConversionService conversionService) {
//		SingleColumnRowMapper<T> rowMapper = newModuleInstance(requiredType);
