...
import ghost.framework.data.configuration.jdbc.support.rowset.ResultSetWrappingSqlRowSet;
 ...
 * @since 1.2
 * @see #newCachedRowSet
 * @see ghost.framework.jdbc.support.rowset.SqlRowSet
...
public class SqlRowSetResultSetExtractor implements ResultSetExtractor<SqlRowSet> {
	 ...
	 * @see #newCachedRowSet()
	 * @see ghost.framework.jdbc.support.rowset.ResultSetWrappingSqlRowSet
	 */
