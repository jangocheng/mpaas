 ...
 *
 * <p>Most applications only use one value per row and process only one row at a
 * time in an insert statement. In these cases, just call {@code getName}
 * to retrieve the value. The returned value is a Number here, which is the
 ...
 * @see ghost.framework.jdbc.object.SqlUpdate
 */
public interface KeyHolder {
	 ...
	 * This is the typical case: a single, numeric generated value.
	 ...
	 * @return the generated value as a number
	 ...
	 * an individual row through a Map of column names and value values
	 */
