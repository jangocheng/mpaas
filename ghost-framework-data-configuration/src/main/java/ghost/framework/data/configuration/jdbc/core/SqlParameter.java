 ...
 *
 * <p>Parameters may be anonymous, in which case "value" is {@code null}.
...
public class SqlParameter {
	 ...
	 * Create a new anonymous SqlParameter, supplying the SQL type.
	 * @param sqlType the SQL type of the parameter according to {@code java.sql.Types}
	 * @param typeName the type value of the parameter (optional)
	 */
	...
	/**
	 * Create a new SqlParameter, supplying value and SQL type.
	 * @param name value of the parameter, as used in input and output maps
	 * @param sqlType the SQL type of the parameter according to {@code java.sql.Types}
	 */
	...
	/**
	 * Return the value of the parameter, or {@code null} if anonymous.
	 */
	...
	/**
	 * Return the type value of the parameter, if any.
	 */
