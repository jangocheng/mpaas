...
package ghost.framework.data.configuration.jdbc.core;

import ghost.framework.data.configuration.dao.DataAccessException;
import ghost.framework.data.configuration.dao.InvalidDataAccessApiUsageException;
import ghost.framework.data.configuration.dao.support.DataAccessUtils;
import ghost.framework.data.configuration.jdbc.SQLWarningException;
import ghost.framework.data.configuration.jdbc.UncategorizedSQLException;
import ghost.framework.data.configuration.jdbc.datasource.ConnectionProxy;
import ghost.framework.data.configuration.jdbc.datasource.DataSourceUtils;
import ghost.framework.data.configuration.jdbc.support.JdbcAccessor;
import ghost.framework.data.configuration.jdbc.support.JdbcUtils;
import ghost.framework.data.configuration.jdbc.support.KeyHolder;
import ghost.framework.data.configuration.jdbc.support.rowset.SqlRowSet;
import ghost.framework.util.Assert;
import ghost.framework.util.LinkedCaseInsensitiveMap;
 ...
 * {@code ghost.framework.dao} package.
 *
 ...
 * the {@link ghost.framework.jdbc.support.SQLExceptionTranslator}
 * interface, there should be no need to subclass it.
 *
 * <p>All SQL operations performed by this class are logged at debug level,
 * using "ghost.framework.jdbc.core.JdbcTemplate" as log category.
 *
 ...
 * @see RowMapper
 * @see ghost.framework.jdbc.support.SQLExceptionTranslator
 */
public class JdbcTemplate extends JdbcAccessor implements JdbcOperations {
	 ...
	 * @see SQLWarning
	 * @see ghost.framework.jdbc.SQLWarningException
	 * @see #handleWarnings
	 */
	...
	protected Map<String, Object> extractReturnedResults(CallableStatement cs,
			 List<SqlParameter> updateCountParameters,  List<SqlParameter> resultSetParameters,
	...
	protected Map<String, Object> processResultSet(
			 ResultSet rs, ResultSetSupportingSqlParameter param) throws SQLException {
	...
	/**
	 * Create a new RowMapper for reading columns as value-value pairs.
	 ...
	 * @see #setMaxRows
	 * @see #setQueryTimeout
	 * @see ghost.framework.jdbc.datasource.DataSourceUtils#applyTransactionTimeout
	 */
