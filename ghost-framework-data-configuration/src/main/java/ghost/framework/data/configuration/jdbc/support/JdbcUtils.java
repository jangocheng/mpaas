...
public abstract class JdbcUtils {
	 ...
	 * @param dataSource the DataSource to extract meta-data for
	 * @param metaDataMethodName the value of the DatabaseMetaData method to call
	...
	/**
	 * Extract a common value for the target database in use even if
	 * various drivers/platforms provide varying names at runtime.
	 * @param source the value as provided in database meta-data
	 * @return the common value to be used (e.g. "DB2" or "Sybase")
	 */
	...
	/**
	 * Resolve the standard type value for the given SQL type, if possible.
	 * @param sqlType the SQL type to resolve
	 * @return the corresponding constant value in {@link Types}
	...
	/**
	 * Determine the column value to use. The column value is determined based on a
	 * lookup using ResultSetMetaData.
	 * <p>This method implementation takes into account recent clarifications
	 * expressed in the JDBC 4.0 specification:
	 * <p><i>columnLabel - the label for the column specified with the SQL AS clause.
	 * If the SQL AS clause was not specified, then the label is the value of the column</i>.
	 * @param resultSetMetaData the current meta-data to use
	 * @param columnIndex the index of the column for the look up
	 * @return the column value to use
	...
	/**
	 * Convert a column value with underscores to the corresponding property value using "camel case".
	 * A value like "customer_number" would match a "customerNumber" property value.
	 * @param name the column value to be converted
	 * @return the value using "camel case"
	 */
