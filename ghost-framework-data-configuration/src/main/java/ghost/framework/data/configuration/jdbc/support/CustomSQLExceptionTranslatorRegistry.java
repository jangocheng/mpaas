...
/**
 * Registry for custom {@link ghost.framework.jdbc.support.SQLExceptionTranslator} instances associated with
...
public final class CustomSQLExceptionTranslatorRegistry {
	 ...
	 * Key is the database product value as defined in the
	 * {@link ghost.framework.jdbc.support.SQLErrorCodesFactory}.
	 */
	...
	/**
	 * Register a new custom translator for the specified database value.
