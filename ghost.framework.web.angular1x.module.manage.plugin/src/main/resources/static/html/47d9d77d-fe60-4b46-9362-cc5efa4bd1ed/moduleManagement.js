app.controller('249613f8-c3be-45f5-ad64-27170aa8fbf5', ['$scope', '$http', '$state', '$rootScope', '$compile', '$modal',
    function($scope, $http, $state, $rootScope, $compile, locals, $modal) {
        ...
        $scope.init = function() {
            ...
            var sr = localStorage.getItem("6828b32b-86f7-4822-b8f4-87906f0673e1");
        ...
        $scope.search = function(clean) {
            if(clean) {
                //清理搜索条件
                localStorage.removeItem("6828b32b-86f7-4822-b8f4-87906f0673e1");
            ...
            localStorage.setItem("6828b32b-86f7-4822-b8f4-87906f0673e1", JSON.stringify($scope.selectRequest));
            $scope.select();
        };
        //更新状态
