app.controller('0fa99dad-79a6-438a-860e-8e66344c43f2', ['$scope', '$http', '$state', '$rootScope', '$compile', '$modal',
	function($scope, $http, $state, $rootScope, $compile, locals, $modal) {
		...
		$scope.init = function() {
			...
			var sr = localStorage.getItem("e579ef2d-242f-41a8-a9b5-a94103b78f59");
		...
		$scope.search = function(clean) {
			if(clean) {
				//清理搜索条件
				localStorage.removeItem("e579ef2d-242f-41a8-a9b5-a94103b78f59");
			...
			localStorage.setItem("e579ef2d-242f-41a8-a9b5-a94103b78f59", JSON.stringify($scope.selectRequest));
			$scope.select();
		};
		//更新状态
