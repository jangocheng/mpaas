app.controller('249613f8-c3be-45f5-ad64-27170aa8fbf5', ['$scope', '$http', '$state', '$rootScope', '$compile', '$modal',
    function($scope, $http, $state, $rootScope, $compile, locals, $modal) {
        ...
        $scope.init = function() {
            ...
            var sr = localStorage.getItem("099453df-31c1-4ec1-beaf-14f7c1fa256c");
        ...
        $scope.search = function(clean) {
            if(clean) {
                //清理搜索条件
                localStorage.removeItem("099453df-31c1-4ec1-beaf-14f7c1fa256c");
            ...
            localStorage.setItem("099453df-31c1-4ec1-beaf-14f7c1fa256c", JSON.stringify($scope.selectRequest));
            $scope.select();
        };
        //更新状态
