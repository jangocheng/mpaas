...
package ghost.framework.data.transaction.jta.weblogic;

import ghost.framework.beans.annotation.constraints.Nullable;
import ghost.framework.data.transaction.jta.JtaTransactionManager;
import ghost.framework.data.transaction.jta.JtaTransactionObject;
...
public class WebLogicJtaTransactionManager extends JtaTransactionManager {
	...
	public TransactionManager obtainTransactionManager() {
