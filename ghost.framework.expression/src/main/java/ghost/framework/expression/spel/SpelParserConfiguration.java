...
import ghost.framework.context.GhostFrameworkProperties;
 ...
 * @author Andy Clement
 * @since 3.0
 * @see ghost.framework.expression.spel.standard.SpelExpressionParser#SpelExpressionParser(SpelParserConfiguration)
 */
public class SpelParserConfiguration {
	...
	static {
		String compilerMode = GhostFrameworkProperties.getProperty("ghost.framework.expression.compiler.mode");
