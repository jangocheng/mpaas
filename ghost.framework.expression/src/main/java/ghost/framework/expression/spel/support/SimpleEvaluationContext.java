 ...
 * {@link ghost.framework.expression.Expression} with both an
 * {@code EvaluationContext} and a root object as arguments:
 * {@link ghost.framework.expression.Expression#getValue(EvaluationContext, Object)}.
 *
...
public final class SimpleEvaluationContext implements EvaluationContext {
	...
	public static class Builder {
		 ...
		 * {@link ghost.framework.core.convert.support.DefaultConversionService} is used.
		 * @see #withTypeConverter
		 * @see StandardTypeConverter#StandardTypeConverter(ConverterContainer)
		 */
		public Builder withConversionService(ConverterContainer converterContainer) {
			this.typeConverter = new StandardTypeConverter(converterContainer);
			return this;
		}
		/**
		 ...
		 * @see ghost.framework.expression.Expression#getValue(EvaluationContext)
		 * @see ghost.framework.expression.Expression#getValue(EvaluationContext, Object)
		 */
