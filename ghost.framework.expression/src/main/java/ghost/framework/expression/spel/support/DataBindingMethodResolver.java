...
import ghost.framework.expression.AccessException;
import ghost.framework.expression.EvaluationContext;
import ghost.framework.expression.MethodExecutor;
...
/**
 * A {@link ghost.framework.expression.MethodResolver} variant for data binding
