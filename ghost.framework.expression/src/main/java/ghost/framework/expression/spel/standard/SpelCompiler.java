...
import ghost.framework.expression.spel.CodeFlow;
import ghost.framework.expression.spel.CompiledExpression;
import ghost.framework.expression.spel.SpelParserConfiguration;
import ghost.framework.expression.spel.ast.SpelNodeImpl;
...
public final class SpelCompiler implements Opcodes {
	...
	private Class<? extends CompiledExpression> createExpressionClass(SpelNodeImpl expressionToCompile) {
		// Create class outline 'spel/ExNNN extends ghost.framework.expression.spel.CompiledExpression'
