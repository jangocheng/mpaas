...
import ghost.framework.jmx.access.ConnectorDelegate;
import ghost.framework.jmx.access.MBeanInfoRetrievalException;
...
public class MBeanClientInterceptor implements AutoCloseable {
