 ...
 * {@link ghost.framework.transaction.support.TransactionSynchronizationManager#getCurrentTransactionIsolationLevel()}.
 ...
 *
 * <pre class="code">
 * &lt;bean id="myDataSource" class="ghost.framework.jdbc.datasource.WebSphereDataSourceAdapter"&gt;
 *   &lt;property name="targetDataSource"&gt;
 *     &lt;bean class="ghost.framework.jndi.JndiObjectFactoryBean"&gt;
 ...
 * @see ghost.framework.transaction.support.TransactionSynchronizationManager#getCurrentTransactionIsolationLevel()
