...
import ghost.framework.data.dao.LobRetrievalFailureException;
...
public abstract class AbstractLobStreamingResultSetExtractor<T> implements ResultSetExtractor<T> {
	 ...
	 * @see ghost.framework.data.jdbc.support.lob.LobHandler#getBlobAsBinaryStream
	 * @see ghost.framework.util.FileCopyUtils
	 */
