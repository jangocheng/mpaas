...
import ghost.framework.data.jdbc.core.metadata.CallMetaDataContext;
...
public abstract class AbstractJdbcCall {
	...
	/**
	 * Add a {@link ghost.framework.jdbc.core.RowMapper} for the specified parameter or column.
