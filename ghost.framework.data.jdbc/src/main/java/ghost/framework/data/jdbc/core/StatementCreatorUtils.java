...
import ghost.framework.data.jdbc.support.SqlValue;
...
public abstract class StatementCreatorUtils {
	...
	static boolean shouldIgnoreGetParameterType = false;//GhostFrameworkProperties.getFlag(IGNORE_GETPARAMETERTYPE_PROPERTY_NAME);
