...
package ghost.framework.data.jdbc.support.incrementer;
 ...
 * using a {@link ghost.framework.data.jdbc.core.simple.SimpleJdbcInsert} or utilizing
 * a {@link ghost.framework.data.jdbc.support.KeyHolder} when calling the with the
