 ...
 * {@link ghost.framework.jdbc.core.JdbcOperations} interface,
 ...
 * @see ghost.framework.jdbc.core.JdbcOperations
 */
public interface NamedParameterJdbcOperations {
	 ...
	 * one column in that row
	 * @throws DataAccessException if the query fails
	 * @see ghost.framework.jdbc.core.JdbcTemplate#queryForObject(String, Class)
	 */
	@Nullable
	 ...
	 * @throws DataAccessException if the query fails
	 * @see ghost.framework.jdbc.core.JdbcTemplate#queryForMap(String)
	 * @see ghost.framework.jdbc.core.ColumnMapRowMapper
	 */
	 ...
	 * when you don't have a domain entity. Otherwise, consider using
	 ...
	 * @throws DataAccessException if the query fails
	 * @see ghost.framework.jdbc.core.JdbcTemplate#queryForList(String, Class)
	 * @see ghost.framework.jdbc.core.SingleColumnRowMapper
	 */
	 ...
	 * @throws DataAccessException if the query fails
	 * @see ghost.framework.jdbc.core.JdbcTemplate#queryForList(String)
	 */
	 ...
	 * @see ghost.framework.jdbc.core.JdbcTemplate#queryForRowSet(String)
	 * @see ghost.framework.jdbc.core.SqlRowSetResultSetExtractor
	 ...
	 * @see ghost.framework.jdbc.support.GeneratedKeyHolder
	 */
