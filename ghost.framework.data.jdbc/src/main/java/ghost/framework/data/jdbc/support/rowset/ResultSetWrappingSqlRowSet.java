...
package ghost.framework.data.jdbc.support.rowset;

import ghost.framework.data.dao.InvalidResultSetAccessException;
 ...
 * {@link JdbcTemplate} when working with RowSets.
 *
 ...
 * @see JdbcTemplate#queryForRowSet
 */
