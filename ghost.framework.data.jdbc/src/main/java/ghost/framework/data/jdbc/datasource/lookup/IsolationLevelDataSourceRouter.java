 ...
 * (typically through Spring's {@link ghost.framework.transaction.jta.JtaTransactionManager}).
 ...
 *
 * <pre class="code">
 * &lt;bean id="dataSourceRouter" class="ghost.framework.jdbc.datasource.lookup.IsolationLevelDataSourceRouter"&gt;
 ...
 *
 * <pre class="code">
 * &lt;bean id="transactionManager" class="ghost.framework.transaction.jta.JtaTransactionManager"&gt;
...
//			}
			return null;//constants.asNumber(constantName);
		} else {
	...
	protected Object determineCurrentLookupKey() {
		return null;//ReactiveTransactionSynchronizationManager.getCurrentTransactionIsolationLevel();
	}
}