 ...
 *
 * <pre class="code">
 * &lt;bean id="myTargetDataSource" class="ghost.framework.jndi.JndiObjectFactoryBean"&gt;
 *   &lt;property name="jndiName" value="java:comp/env/jdbc/myds"/&gt;
 * &lt;/bean&gt;
 *
 * &lt;bean id="myDataSource" class="ghost.framework.jdbc.datasource.UserCredentialsDataSourceAdapter"&gt;
