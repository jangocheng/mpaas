...
package ghost.framework.data.jdbc.datasource;

import ghost.framework.beans.annotation.constraints.Nullable;
import ghost.framework.data.dao.CannotGetJdbcConnectionException;
import ghost.framework.transaction.TransactionDefinition;
import ghost.framework.transaction.support.TransactionSynchronizationAdapter;
 ...
 * or {@link ghost.framework.transaction.jta.JtaTransactionManager}.
 *
 * <p>Used internally by Spring's {@link ghost.framework.jdbc.core.JdbcTemplate},
...
public abstract class DataSourceUtils {
	...
	/**
	 * Order value for ReactiveTransactionSynchronization objects that clean up JDBC Connections.
	 */
	 ...
	 * {@link ghost.framework.transaction.jta.JtaTransactionManager JTA} transaction).
	 * @param dataSource the DataSource to obtain Connections from
	 * @return a JDBC Connection from the given DataSource
	 * @throws ghost.framework.jdbc.CannotGetJdbcConnectionException
...
//		ConnectionHolder conHolder = (ConnectionHolder) ReactiveTransactionSynchronizationManager.getResource(dataSource);
//		return (conHolder != null && connectionEquals(conHolder, con));
	...
	public static void applyTimeout(Statement stmt, @Nullable DataSource dataSource, int timeout) throws SQLException {
		...
		if (dataSource != null) {
			//holder = (ConnectionHolder) ReactiveTransactionSynchronizationManager.getResource(dataSource);
		}
