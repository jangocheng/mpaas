...
package ghost.framework.data.jdbc;
...
import ghost.framework.data.jdbc.core.ConnectionCallback;
import ghost.framework.data.jdbc.datasource.embedded.EmbeddedDatabaseType;
