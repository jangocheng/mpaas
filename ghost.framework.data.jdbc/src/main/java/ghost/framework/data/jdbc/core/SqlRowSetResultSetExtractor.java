...
import ghost.framework.data.jdbc.support.rowset.ResultSetWrappingSqlRowSet;
 ...
 * @since 1.2
 * @see #newCachedRowSet
 * @see ghost.framework.data.jdbc.support.rowset.SqlRowSet
...
public class SqlRowSetResultSetExtractor implements ResultSetExtractor<SqlRowSet> {
	 ...
	 * @see #newCachedRowSet()
	 * @see ghost.framework.data.jdbc.support.rowset.ResultSetWrappingSqlRowSet
	 */
