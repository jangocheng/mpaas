...
package ghost.framework.data.jdbc.template;
import ghost.framework.beans.annotation.constraints.Nullable;
import ghost.framework.data.dao.*;
import ghost.framework.data.jdbc.core.*;
import ghost.framework.data.jdbc.datasource.ConnectionProxy;
import ghost.framework.data.jdbc.datasource.DataSourceUtils;
import ghost.framework.data.jdbc.support.JdbcUtils;
import ghost.framework.data.jdbc.support.KeyHolder;
 ...
 * the {@link ghost.framework.data.jdbc.support.SQLExceptionTranslator}
 * interface, there should be no need to subclass it.
 *
 * <p>All SQL operations performed by this class are logged at debug level,
 * using "ghost.framework.data.jdbc.template.JdbcTemplate" as log category.
 *
 ...
 * @see RowMapper
 * @see ghost.framework.data.jdbc.support.SQLExceptionTranslator
 */
public class JdbcTemplate extends JdbcAccessor implements JdbcOperations {
	...
	public <T> T execute(ConnectionCallback<T> action) throws DataAccessException {
		...
		Connection con = null;// = obtainDataSource().getConnection();
		try {
...
//			throw translateException("ConnectionCallback", sql, ex);
	...
	public <T> T execute(StatementCallback<T> action) throws DataAccessException {
		...
		Connection con = null;// DataSourceUtils.getConnection(obtainDataSource());
		Statement stmt = null;
		try {
			con = obtainDataSource().getConnection();
...
//			throw translateException("CallableStatementCallback", sql, ex);
	 ...
	 * @see #setMaxRows
	 * @see #setQueryTimeout
	 * @see ghost.framework.data.jdbc.datasource.DataSourceUtils#applyTransactionTimeout
	 */
...
//	}
	 ...
	 */
	public String getProductName() throws MetaDataAccessException {
		return JdbcUtils.extractDatabaseMetaData(this.getDataSource(), "getDatabaseProductName").toString().toLowerCase();
	}
}