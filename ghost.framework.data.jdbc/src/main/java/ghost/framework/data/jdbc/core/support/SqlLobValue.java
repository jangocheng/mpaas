...
import ghost.framework.data.jdbc.core.DisposableSqlTypeValue;
import ghost.framework.data.jdbc.object.StoredProcedure;
import ghost.framework.data.jdbc.support.lob.DefaultLobHandler;
import ghost.framework.data.jdbc.support.lob.LobCreator;
 ...
 * @since 1.1
 * @see ghost.framework.data.jdbc.support.lob.LobHandler
 * @see ghost.framework.data.jdbc.support.lob.LobCreator
 * @see JdbcTemplate#update(String, Object[], int[])
 * @see ghost.framework.data.jdbc.object.SqlUpdate#update(Object[])
...
public class SqlLobValue implements DisposableSqlTypeValue {
	 ...
	 * @see ghost.framework.data.jdbc.support.lob.DefaultLobHandler
	 */
