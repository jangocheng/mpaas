...
import ghost.framework.data.jdbc.core.SqlParameter;
 ...
 * {@code ghost.framework.dao} package (and as thrown by the
 * {@code ghost.framework.data.jdbc.core} package, which the classes
...
public abstract class RdbmsOperation {
	 ...
	 * {@link ghost.framework.data.jdbc.support.SQLExceptionTranslator} to be reused.
	 */
