...
import ghost.framework.data.jdbc.datasource.AbstractDataSource;
...
public abstract class AbstractRoutingDataSource extends AbstractDataSource {
	...
	private DataSourceLookup dataSourceLookup = null;//new JndiDataSourceLookup();
	...
	public void setDataSourceLookup(@Nullable DataSourceLookup dataSourceLookup) {
		this.dataSourceLookup = null;// (dataSourceLookup != null ? dataSourceLookup : new JndiDataSourceLookup());
	}
