...
import ghost.framework.data.dao.IncorrectResultSetColumnCountException;
import ghost.framework.data.dao.TypeMismatchDataAccessException;
...
//	@Nullable
//	private ConversionService conversionService = DefaultConverterContainer.getSharedInstance();
	...
	public void setRequiredType(Class<T> requiredType) {
		this.requiredType = null;//ClassUtils.resolvePrimitiveIfNecessary(requiredType);
	}

//	/**
//	 * Set a {@link ConversionService} for converting a fetched value.
//	 * <p>Default is the {@link DefaultConverterContainer}.
//	 * @since 5.0.4
//	 * @see DefaultConverterContainer#getSharedInstance
//	 */
...
//	}
	 ...
	 * @see ghost.framework.data.jdbc.support.JdbcUtils#getResultSetValue(ResultSet, int, Class)
	 ...
	 * @return the Object value
	 * @throws SQLException in case of extraction failure
	 * @see ghost.framework.data.jdbc.support.JdbcUtils#getResultSetValue(ResultSet, int)
	 */
	@Nullable
