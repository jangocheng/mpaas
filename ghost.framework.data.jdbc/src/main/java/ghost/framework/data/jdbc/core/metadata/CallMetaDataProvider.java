...
package ghost.framework.data.jdbc.core.metadata;
 ...
 * {@link ghost.framework.data.jdbc.core.simple.SimpleJdbcCall}.
 *
...
public interface CallMetaDataProvider {
	 ...
	 * @throws SQLException in case of initialization failure
	 * @see	ghost.framework.jdbc.core.simple.SimpleJdbcCall#withoutProcedureColumnMetaDataAccess()
	 */
