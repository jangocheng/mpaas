...
import ghost.framework.data.jdbc.datasource.init.DatabasePopulatorUtils;
 ...
 * @author Sam Brannen
 * @since 3.0
 * @see ghost.framework.data.jdbc.datasource.init.ScriptUtils
 * @see ghost.framework.data.jdbc.datasource.init.ResourceDatabasePopulator
...
//	/**
//	 * Create a new embedded database builder with a {@link DefaultIResourceLoader}.
//	 */
//	public EmbeddedDatabaseBuilder() {
//		this(new DefaultIResourceLoader());
//	}

	/**
	 * Create a new embedded database builder with the given {@link IResourceLoader}.
	 * @param IResourceLoader the {@code IResourceLoader} to delegate to
	 */
	public EmbeddedDatabaseBuilder(IResourceLoader IResourceLoader) {
...
//		this.databasePopulator.addScript(this.IResourceLoader.getResource(script));
		return this;
	}
