...
import ghost.framework.data.jdbc.datasource.init.DatabasePopulator;
 ...
 * @since 3.0
 */
public class EmbeddedDatabaseFactoryBean extends EmbeddedDatabaseFactory /*implements FactoryBean<DataSource>*/ {
	 ...
	 * @see ghost.framework.data.jdbc.datasource.init.DataSourceInitializer#setDatabaseCleaner
	 */
