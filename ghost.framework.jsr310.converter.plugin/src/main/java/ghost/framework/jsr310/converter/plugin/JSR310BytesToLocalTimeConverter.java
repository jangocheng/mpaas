...
import ghost.framework.jsr310.converter.BytesToLocalTimeConverter;
 ...
 * @Description: {@link byte[]} to {@link LocalTime}
 * @Date: 2020/6/26:1:22
 */
@ConverterFactory
public class JSR310BytesToLocalTimeConverter implements BytesToLocalTimeConverter<byte[], LocalTime> {

    public JSR310BytesToLocalTimeConverter(@Autowired(required = false) ICoreInterface domain) {
        this.domain = domain;
    }
    ...
    public boolean equals(Object o) {
        ...
        JSR310BytesToLocalTimeConverter that = (JSR310BytesToLocalTimeConverter) o;
    ...
    public String toString() {
        return "JSR310BytesToLocalTimeConverter{" +
    ...
    @Override
    public LocalTime convert(byte[] source, String characterEncoding) throws ConverterException {
        try {
            return LocalTime.parse(Jsr310Converter.StringBasedConverter.toString(source, characterEncoding));
    ...
    @Override
    public LocalTime convert(byte[] source) throws ConverterException {
        return LocalTime.parse(Jsr310Converter.StringBasedConverter.toString(source));
    }
}
