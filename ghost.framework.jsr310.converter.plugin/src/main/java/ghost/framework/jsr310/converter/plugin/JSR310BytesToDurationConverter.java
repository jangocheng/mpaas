...
import ghost.framework.jsr310.converter.BytesToDurationConverter;
 ...
 * @Description: {@link byte[]} to {@link Duration}
 * @Date: 2020/6/26:1:23
 */
@ConverterFactory
public class JSR310BytesToDurationConverter implements BytesToDurationConverter<byte[], Duration> {
    public JSR310BytesToDurationConverter(@Autowired(required = false) ICoreInterface domain) {
        this.domain = domain;
    }
    ...
    public boolean equals(Object o) {
        ...
        JSR310BytesToDurationConverter that = (JSR310BytesToDurationConverter) o;
    ...
    public String toString() {
        return "JSR310BytesToDurationConverter{" +
    ...
    @Override
    public Duration convert(byte[] source, String characterEncoding) throws ConverterException {
        try {
            return Duration.parse(Jsr310Converter.StringBasedConverter.toString(source, characterEncoding));
    ...
    @Override
    public Duration convert(byte[] source) throws ConverterException {
        return Duration.parse(Jsr310Converter.StringBasedConverter.toString(source));
    }
}
