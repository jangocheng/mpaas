...
import ghost.framework.jsr310.converter.PeriodToBytesConverter;
 ...
 * @Description: {@link Period} to {@link byte[]}
 * @Date: 2020/6/26:1:23
 */
@ConverterFactory
public class JSR310PeriodToBytesConverter implements PeriodToBytesConverter<Period, byte[]> {
    public JSR310PeriodToBytesConverter(@Autowired(required = false) ICoreInterface domain) {
        this.domain = domain;
    }
    ...
    public boolean equals(Object o) {
        ...
        JSR310PeriodToBytesConverter that = (JSR310PeriodToBytesConverter) o;
    ...
    public String toString() {
        return "JSR310PeriodToBytesConverter{" +
    ...
    @Override
    public boolean canConvert(Period source) {
        try {
            //判断是否可以转换
            if (source == null) {
                return false;
    ...
    @Override
    public byte[] convert(Period source, String characterEncoding) throws ConverterException {
        try {
    ...
    @Override
    public byte[] convert(Period source) throws ConverterException {
