...
import ghost.framework.jsr310.converter.InstantToBytesConverter;
 ...
 * @Description: {@link Instant} to {@link byte[]}
 * @Date: 2020/6/26:1:22
 */
@ConverterFactory
public class JSR310InstantToBytesConverter implements InstantToBytesConverter<Instant, byte[]> {
    public JSR310InstantToBytesConverter(@Autowired(required = false) ICoreInterface domain) {
        this.domain = domain;
    }
    ...
    public boolean equals(Object o) {
        ...
        JSR310InstantToBytesConverter that = (JSR310InstantToBytesConverter) o;
    ...
    public String toString() {
        return "JSR310InstantToBytesConverter{" +
    ...
    @Override
    public boolean canConvert(Instant source) {
        try {
            //判断是否可以转换
            if (source == null) {
                return false;
    ...
    @Override
    public byte[] convert(Instant source, String characterEncoding) throws ConverterException {
        try {
    ...
    @Override
    public byte[] convert(Instant source) throws ConverterException {
