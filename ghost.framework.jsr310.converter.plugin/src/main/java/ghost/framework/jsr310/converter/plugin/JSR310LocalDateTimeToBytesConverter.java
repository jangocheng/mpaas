...
import ghost.framework.jsr310.converter.LocalDateTimeToBytesConverter;
 ...
 * @Description: {@link LocalDateTime} to {@link byte[]}
 * @Date: 2020/6/26:1:22
 */
@ConverterFactory
public class JSR310LocalDateTimeToBytesConverter implements LocalDateTimeToBytesConverter<LocalDateTime, byte[]> {
    public JSR310LocalDateTimeToBytesConverter(@Autowired(required = false) ICoreInterface domain) {
        this.domain = domain;
    }
    ...
    public boolean equals(Object o) {
        ...
        JSR310LocalDateTimeToBytesConverter that = (JSR310LocalDateTimeToBytesConverter) o;
    ...
    public String toString() {
        return "JSR310LocalDateTimeToBytesConverter{" +
    ...
    @Override
    public boolean canConvert(LocalDateTime source) {
        try {
            //判断是否可以转换
            if (source == null) {
                return false;
    ...
    @Override
    public byte[] convert(LocalDateTime source, String characterEncoding) throws ConverterException {
        try {
    ...
    @Override
    public byte[] convert(LocalDateTime source) throws ConverterException {
