...
import ghost.framework.jsr310.converter.BytesToPeriodConverter;
 ...
 * @Description: {@link byte[]} to {@link Period}
 * @Date: 2020/6/26:1:23
 */
@ConverterFactory
public class JSR310BytesToPeriodConverter implements BytesToPeriodConverter<byte[], Period> {

    public JSR310BytesToPeriodConverter(@Autowired(required = false) ICoreInterface domain) {
        this.domain = domain;
    }
    ...
    public boolean equals(Object o) {
        ...
        JSR310BytesToPeriodConverter that = (JSR310BytesToPeriodConverter) o;
    ...
    public String toString() {
        return "JSR310BytesToPeriodConverter{" +
    ...
    @Override
    public Period convert(byte[] source, String characterEncoding) throws ConverterException {
        try {
            return Period.parse(Jsr310Converter.StringBasedConverter.toString(source, characterEncoding));
    ...
    @Override
    public Period convert(byte[] source) throws ConverterException {
        return Period.parse(Jsr310Converter.StringBasedConverter.toString(source));
    }
}
