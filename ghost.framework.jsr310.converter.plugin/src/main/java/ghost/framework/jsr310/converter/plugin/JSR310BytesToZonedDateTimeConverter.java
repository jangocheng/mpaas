...
import ghost.framework.jsr310.converter.BytesToZonedDateTimeConverter;
 ...
 */
@ConverterFactory
public class JSR310BytesToZonedDateTimeConverter implements BytesToZonedDateTimeConverter<byte[], ZonedDateTime> {

    public JSR310BytesToZonedDateTimeConverter(@Autowired(required = false) ICoreInterface domain) {
        this.domain = domain;
    }
    ...
    public boolean equals(Object o) {
        ...
        JSR310BytesToZonedDateTimeConverter that = (JSR310BytesToZonedDateTimeConverter) o;
    ...
    public String toString() {
        return "JSR310BytesToZonedDateTimeConverter{" +
    ...
    @Override
    public ZonedDateTime convert(byte[] source, String characterEncoding) throws ConverterException {
        try {
            return ZonedDateTime.parse(Jsr310Converter.StringBasedConverter.toString(source, characterEncoding));
    ...
    @Override
    public ZonedDateTime convert(byte[] source) throws ConverterException {
        return ZonedDateTime.parse(Jsr310Converter.StringBasedConverter.toString(source));
    }
}
