...
import ghost.framework.data.commons.mapping.callback.ReactiveEntityCallbacks;
...
import ghost.framework.data.dao.OptimisticLockingFailureException;
...
import ghost.framework.data.mongodb.ReactiveMongoDatabaseUtils;
import ghost.framework.data.mongodb.SessionSynchronization;
import ghost.framework.data.mongodb.core.EntityOperations.AdaptibleEntity;
import ghost.framework.data.mongodb.core.QueryOperations.*;
...
import ghost.framework.data.mongodb.core.convert.*;
import ghost.framework.data.mongodb.core.index.MongoMappingEventPublisher;
import ghost.framework.data.mongodb.core.index.ReactiveIndexOperations;
import ghost.framework.data.mongodb.core.index.ReactiveMongoPersistentEntityIndexCreator;
...
import ghost.framework.data.mongodb.core.mapping.event.*;
import ghost.framework.data.mongodb.core.mapreduce.MapReduceOptions;
import ghost.framework.data.mongodb.core.query.Collation;
import ghost.framework.data.mongodb.core.query.*;
import ghost.framework.data.mongodb.core.query.Meta.CursorOption;
import ghost.framework.data.mongodb.core.query.UpdateDefinition.ArrayFilter;
import ghost.framework.data.mongodb.core.validation.Validator;
 ...
 * ghost.framework.dao package. Can be used within a service implementation via direct instantiation with a
...
public class ReactiveMongoTemplate implements ReactiveMongoOperations {
	...
	private final ApplicationEventListener<MappingContextEvent<?, ?>> indexCreatorListener;
...
/*
	...
	public void setApplicationContext(IApplication applicationContext) throws BeanException {
		...
		if (mappingContext instanceof ApplicationEventPublisher) {
//			((ApplicationEventPublisher) mappingContext).setApplicationEventPublisher(eventPublisher);
		}
...
//		projectionFactory.setBeanClassLoader(applicationContext.getClassLoader());
	 ...
	 * {@link ghost.framework.data.commons.mapping.callback.EntityCallback callbacks} like the
	...
	/**
	 * Inspects the given {@link IApplication} for {@link ReactiveMongoPersistentEntityIndexCreator} and those in
	 * turn if they were registered for the current {@link MappingContext}. If no creator for the current
	 * {@link MappingContext} can be found we manually add the internally created one as {@link ApplicationEventListener} to
	 * make sure indexes get created appropriately for entity types persisted through this {@link ReactiveMongoTemplate}
	 * instance.
	 *
	 * @param context must not be {@literal null}.
	 */
	private void prepareIndexCreator(IApplication context) {
/*
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#reactiveIndexOps(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#reactiveIndexOps(java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#executeCommand(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#executeCommand(org.bson.Document)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#executeCommand(org.bson.Document, com.mongodb.ReadPreference)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#execute(java.lang.Class, ghost.framework.data.mongodb.core.ReactiveCollectionCallback)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#execute(ghost.framework.data.mongodb.core.ReactiveDbCallback)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#execute(java.lang.String, ghost.framework.data.mongodb.core.ReactiveCollectionCallback)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#withSession(org.reactivestreams.Publisher, java.util.function.Consumer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#inTransaction()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#inTransaction(org.reactivestreams.Publisher)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#withSession(com.mongodb.session.ClientSession)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#withSession(com.mongodb.ClientSessionOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#createCollection(java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#createCollection(java.lang.Class, ghost.framework.data.mongodb.core.CollectionOptions)
	 */
	public <T> Mono<MongoCollection<Document>> createCollection(Class<T> entityClass,
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#createCollection(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#createCollection(java.lang.String, ghost.framework.data.mongodb.core.CollectionOptions)
	 */
	public Mono<MongoCollection<Document>> createCollection(String collectionName,
			@Nullable CollectionOptions collectionOptions) {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#getCollection(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#collectionExists(java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#collectionExists(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#dropCollection(java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#dropCollection(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#getCollectionNames()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findOne(ghost.framework.data.mongodb.core.query.Query, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findOne(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#exists(ghost.framework.data.mongodb.core.query.Query, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#exists(ghost.framework.data.mongodb.core.query.Query, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#exists(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#find(ghost.framework.data.mongodb.core.query.Query, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#find(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findById(java.lang.Object, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findById(java.lang.Object, java.lang.Class, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findDistinct(ghost.framework.data.mongodb.core.query.Query, java.lang.String, java.lang.Class, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findDistinct(ghost.framework.data.mongodb.core.query.Query, java.lang.String, java.lang.String, java.lang.Class, java.lang.Class)
	 */
...
/*
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#aggregate(ghost.framework.data.mongodb.core.aggregation.TypedAggregation, java.lang.String, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#aggregate(ghost.framework.data.mongodb.core.aggregation.TypedAggregation, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#aggregate(ghost.framework.data.mongodb.core.aggregation.Aggregation, java.lang.Class, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#aggregate(ghost.framework.data.mongodb.core.aggregation.Aggregation, java.lang.String, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#geoNear(ghost.framework.data.mongodb.core.query.NearQuery, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#geoNear(ghost.framework.data.mongodb.core.query.NearQuery, java.lang.Class, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findAndModify(ghost.framework.data.mongodb.core.query.Query, ghost.framework.data.mongodb.core.query.UpdateDefinition, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findAndModify(ghost.framework.data.mongodb.core.query.Query, ghost.framework.data.mongodb.core.query.UpdateDefinition, java.lang.Class, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findAndModify(ghost.framework.data.mongodb.core.query.Query, ghost.framework.data.mongodb.core.query.UpdateDefinition, ghost.framework.data.mongodb.core.FindAndModifyOptions, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findAndModify(ghost.framework.data.mongodb.core.query.Query, ghost.framework.data.mongodb.core.query.UpdateDefinition, ghost.framework.data.mongodb.core.FindAndModifyOptions, java.lang.Class, java.lang.String)
	 */
	public <T> Mono<T> findAndModify(Query query, UpdateDefinition update, FindAndModifyOptions options,
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findAndReplace(ghost.framework.data.mongodb.core.query.Query, java.lang.Object, ghost.framework.data.mongodb.core.FindAndReplaceOptions, java.lang.Class, java.lang.String, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findAndRemove(ghost.framework.data.mongodb.core.query.Query, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findAndRemove(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#count(ghost.framework.data.mongodb.core.query.Query, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#count(ghost.framework.data.mongodb.core.query.Query, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#count(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#insert(reactor.core.publisher.Mono)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#insert(reactor.core.publisher.Mono, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#insert(reactor.core.publisher.Mono, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#insert(java.lang.Object)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#insert(java.lang.Object, java.lang.String)
	 */
	...
	protected <T> Mono<T> doInsert(String collectionName, T objectToSave, MongoWriter<Object> writer) {
		...
		return Mono.just(PersistableEntityModel.of(objectToSave, collectionName)) //
				...
				.map(it -> {
					...
					AdaptibleEntity<T> entity = operations.forEntity(it.getSource(), mongoConverter.getConverterContainer());
				...
				.flatMap(it -> {
					...
					return insertDocument(it.getCollection(), it.getTarget(), it.getSource().getClass()).flatMap(id -> {
						...
						T saved = operations.forEntity(it.getSource(), mongoConverter.getConverterContainer())
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#insert(java.util.Collection, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#insert(java.util.Collection, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#insertAll(java.util.Collection)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#insertAll(reactor.core.publisher.Mono)
	 */
	@Override
		...
		Mono<List<Tuple2<AdaptibleEntity<T>, Document>>> prepareDocuments = Flux.fromIterable(batchToSave)
				.flatMap(uninitialized -> {
					...
					return maybeCallBeforeConvert(toConvert, collectionName).flatMap(it -> {
						...
						AdaptibleEntity<T> entity = operations.forEntity(it, mongoConverter.getConverterContainer());
						entity.assertUpdateableIdIfNotSet();
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#save(reactor.core.publisher.Mono)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#save(reactor.core.publisher.Mono, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#save(java.lang.Object)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#save(java.lang.Object, java.lang.String)
	 */
	public <T> Mono<T> save(T objectToSave, String collectionName) {
		...
		AdaptibleEntity<T> source = operations.forEntity(objectToSave, mongoConverter.getConverterContainer());
	...
	protected <T> Mono<T> doSave(String collectionName, T objectToSave, MongoWriter<Object> writer) {
		...
		return createMono(collectionName, collection -> {
			...
			return maybeCallBeforeConvert(toSave, collectionName).flatMap(toConvert -> {
				...
				AdaptibleEntity<T> entity = operations.forEntity(toConvert, mongoConverter.getConverterContainer());
				Document dbDoc = entity.toMappedDocument(writer).getDocument();
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#upsert(ghost.framework.data.mongodb.core.query.Query, ghost.framework.data.mongodb.core.query.UpdateDefinition, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#upsert(ghost.framework.data.mongodb.core.query.Query, ghost.framework.data.mongodb.core.query.UpdateDefinition, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#upsert(ghost.framework.data.mongodb.core.query.Query, ghost.framework.data.mongodb.core.query.UpdateDefinition, java.lang.Class, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc))
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#updateFirst(ghost.framework.data.mongodb.core.query.Query, ghost.framework.data.mongodb.core.query.UpdateDefinition, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#updateFirst(ghost.framework.data.mongodb.core.query.Query, ghost.framework.data.mongodb.core.query.UpdateDefinition, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#updateFirst(ghost.framework.data.mongodb.core.query.Query, ghost.framework.data.mongodb.core.query.UpdateDefinition, java.lang.Class, java.lang.String)
	 */
	public Mono<UpdateResult> updateFirst(Query query, UpdateDefinition update, Class<?> entityClass,
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#updateMulti(ghost.framework.data.mongodb.core.query.Query, ghost.framework.data.mongodb.core.query.UpdateDefinition, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#updateMulti(ghost.framework.data.mongodb.core.query.Query, ghost.framework.data.mongodb.core.query.UpdateDefinition, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#updateMulti(ghost.framework.data.mongodb.core.query.Query, ghost.framework.data.mongodb.core.query.UpdateDefinition, java.lang.Class, java.lang.String)
	 */
	public Mono<UpdateResult> updateMulti(Query query, UpdateDefinition update, Class<?> entityClass,
			String collectionName) {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#remove(reactor.core.publisher.Mono)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#remove(reactor.core.publisher.Mono, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#remove(java.lang.Object)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#remove(java.lang.Object, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#remove(ghost.framework.data.mongodb.core.query.Query, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#remove(ghost.framework.data.mongodb.core.query.Query, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#remove(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findAll(java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findAll(java.lang.Class, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findAllAndRemove(ghost.framework.data.mongodb.core.query.Query, java.lang.String)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findAllAndRemove(ghost.framework.data.mongodb.core.query.Query, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#findAllAndRemove(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#tail(ghost.framework.data.mongodb.core.query.Query, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#tail(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#mapReduce(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.Class, java.lang.String, java.lang.String, ghost.framework.data.mongodb.core.mapreduce.MapReduceOptions)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMongoOperations#mapReduce(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.String, java.lang.Class, java.lang.String, java.lang.String, ghost.framework.data.mongodb.core.mapreduce.MapReduceOptions)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveRemoveOperation#remove(java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveMapReduceOperation#mapReduce(java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ReactiveChangeStreamOperation#changeStream(java.lang.Class)
	 */
	@Override
	...
	private static class FindAndReplaceCallback implements ReactiveCollectionCallback<Document> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveCollectionCallback#doInCollection(com.mongodb.reactivestreams.client.MongoCollection)
		 */
		@Override
		public Publisher<Document> doInCollection(MongoCollection<Document> collection)
				throws MongoException, DataAccessException {
	...
	static class ReactiveSessionBoundMongoTemplate extends ReactiveMongoTemplate {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveMongoTemplate#getCollection(java.lang.String)
		 */
		@Override
		public Mono<MongoCollection<Document>> getCollection(String collectionName) {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveMongoTemplate#getMongoDatabase()
		 */
		@Override
		public Mono<MongoDatabase> getMongoDatabase() {
	...
	class IndexCreatorEventListener implements ApplicationEventListener<MappingContextEvent<?, ?>> {
