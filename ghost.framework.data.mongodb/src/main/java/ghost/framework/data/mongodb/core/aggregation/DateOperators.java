...
public class DateOperators {
	...
	public static class DateToString extends TimezonedDateAggregationExpression {
		...
		private static Map<String, Object> argumentMap(Object date, @Nullable String format, Timezone timezone) {
		...
		protected Map<String, Object> append(String key, Object value) {
			...
			Map<String, Object> clone = new LinkedHashMap<>(argumentMap());
