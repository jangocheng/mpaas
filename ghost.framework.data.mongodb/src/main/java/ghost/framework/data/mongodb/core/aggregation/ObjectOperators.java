...
public class ObjectOperators {
	...
	public static class MergeObjects extends AbstractAggregationExpression {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.AbstractAggregationExpression#toDocument(java.lang.Object, ghost.framework.data.mongodb.core.aggregation.AggregationOperationContext)
		 */
		@Override
