...
import ghost.framework.data.mongodb.core.MongoClientSettingsFactoryBean;
...
*/
	...
	/**
	 * Returns the {@link BeanDefinitionBuilder} to build a {@link IBeanDefinition} for a
...
//		return builder;
	...
	static BeanDefinitionBuilder getServerAddressPropertyEditorBuilder() {
		...
		customEditors.put("com.mongodb.ServerAddress[]",
				"ghost.framework.data.mongodb.config.ServerAddressPropertyEditor");
