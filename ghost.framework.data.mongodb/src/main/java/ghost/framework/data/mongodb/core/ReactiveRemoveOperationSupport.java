...
class ReactiveRemoveOperationSupport implements ReactiveRemoveOperation {
	...
	static class ReactiveRemoveSupport<T> implements ReactiveRemove<T>, RemoveWithCollection<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveRemoveOperation.RemoveWithCollection#inCollection(String)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveRemoveOperation.RemoveWithQuery#matching(ghost.framework.data.mongodb.core.Query)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveRemoveOperation.TerminatingRemove#all()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveRemoveOperation.TerminatingRemove#findAndRemove()
		 */
		@Override
