 ...
 */
public abstract class MongoDatabaseFactorySupport<C> implements MongoDatabaseFactory, AutoCloseable {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.MongoDbFactory#getMongoDatabase()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.MongoDbFactory#getMongoDatabase(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.MongoDbFactory#getExceptionTranslator()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.MongoDbFactory#withSession(com.mongodb.session.Session)
	 */
	...
	static final class ClientSessionBoundMongoDbFactory implements MongoDatabaseFactory {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.MongoDbFactory#getSession(com.mongodb.ClientSessionOptions)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.MongoDbFactory#withSession(com.mongodb.session.ClientSession)
		 */
		@Override
		public MongoDatabaseFactory withSession(ClientSession session) {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.MongoDbFactory#isTransactionActive()
		 */
		@Override
...
//			factory.addAdvice(new SessionAwareMethodInterceptor<>(session, target, ClientSession.class, MongoDatabase.class, this::proxyDatabase, MongoCollection.class, this::proxyCollection));
//
