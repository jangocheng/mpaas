...
public class AccumulatorOperators {
	...
	public static class Sum extends AbstractAggregationExpression {
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.AccumulatorOperators.AbstractAggregationExpression#toDocument(java.lang.Object, ghost.framework.data.mongodb.core.aggregation.AggregationOperationContext)
		 */
		@Override
