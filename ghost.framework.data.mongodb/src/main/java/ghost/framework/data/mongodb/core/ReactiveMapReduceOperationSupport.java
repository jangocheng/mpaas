...
class ReactiveMapReduceOperationSupport implements ReactiveMapReduceOperation {
	...
	static class ReactiveMapReduceSupport<T>
		...
		/*
		 * (non-Javascript)
		 * @see in ghost.framework.data.mongodb.core.ReactiveMapReduceOperation.MapReduceWithCollection#inCollection(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javascript)
		 * @see in ghost.framework.data.mongodb.core.ReactiveMapReduceOperation.MapReduceWithQuery#query(ghost.framework.data.mongodb.core.query.Query)
		 */
		@Override
		...
		/*
		 * (non-Javascript)
		 * @see in ghost.framework.data.mongodb.core.ReactiveMapReduceOperation.MapReduceWithProjection#as(java.lang.Class)
		 */
		@Override
		...
		/*
		 * (non-Javascript)
		 * @see in ghost.framework.data.mongodb.core.ReactiveMapReduceOperation.MapReduceWithOptions#with(ghost.framework.data.mongodb.core.mapreduce.MapReduceOptions)
		 */
		@Override
		...
		/*
		 * (non-Javascript)
		 * @see in ghost.framework.data.mongodb.core.ReactiveMapReduceOperation.MapReduceWithMapFunction#map(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javascript)
		 * @see in ghost.framework.data.mongodb.core.ReactiveMapReduceOperation.MapReduceWithReduceFunction#reduce(java.lang.String)
		 */
		@Override
