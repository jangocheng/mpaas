...
//		return iterator;
	...
	static class ExposedField implements Field {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.Field#getKey()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.Field#getTarget()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.Field#isAliased()
		 */
		@Override
	...
	static class DirectFieldReference implements FieldReference {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.ExposedFields.FieldReference#getRaw()
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.ExposedFields.FieldReference#getReferenceValue()
		 */
