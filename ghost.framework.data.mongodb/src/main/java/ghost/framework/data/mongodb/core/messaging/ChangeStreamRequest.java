...
public class ChangeStreamRequest<T>
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.monitor.SubscriptionRequest#getMessageListener()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.monitor.SubscriptionRequest#getRequestOptions()
	 */
	@Override
	...
	public static class ChangeStreamRequestOptions implements SubscriptionRequest.RequestOptions {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.monitor.SubscriptionRequest.RequestOptions#getCollectionName()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.monitor.SubscriptionRequest.RequestOptions#getDatabaseName()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.monitor.SubscriptionRequest.RequestOptions#maxAwaitTime()
		 */
		@Override
	...
	public static class ChangeStreamRequestBuilder<T> {
		 ...
		 * <p/>
		 * Use {@link ghost.framework.data.mongodb.core.aggregation.TypedAggregation} to ensure filter expressions are
