...
import ghost.framework.data.mongodb.core.spel.*;
import ghost.framework.data.mongodb.core.spel.MethodReferenceNode.AggregationMethodReference;
import ghost.framework.data.mongodb.core.spel.MethodReferenceNode.AggregationMethodReference.ArgumentType;
import ghost.framework.expression.spel.ExpressionState;
import ghost.framework.expression.spel.SpelNode;
import ghost.framework.expression.spel.SpelParserConfiguration;
import ghost.framework.expression.spel.ast.*;
...
class SpelExpressionTransformer implements AggregationExpressionTransformer {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.spel.ExpressionTransformer#transform(ghost.framework.data.mongodb.core.spel.ExpressionTransformationContextSupport)
	 */
	...
	private static abstract class ExpressionNodeConversion<T extends ExpressionNode>
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.SpelExpressionTransformer.NodeConversion#transform(ghost.framework.data.mongodb.core.aggregation.AggregationExpressionTransformer.AggregationExpressionTransformationContext)
		 */
		@Override
		public Object transform(AggregationExpressionTransformationContext<ExpressionNode> context) {
	...
	private static class OperatorNodeConversion extends ExpressionNodeConversion<OperatorNode> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.SpelExpressionTransformer.SpelNodeWrapper#convertSpelNodeToMongoObjectExpression(ghost.framework.data.mongodb.core.aggregation.SpelExpressionTransformer.ExpressionConversionContext)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.SpelExpressionTransformer.SpelNodeWrapper#supports(java.lang.Class)
		 */
		@Override
		protected boolean supports(ExpressionNode node) {
	...
	private static class IndexerNodeConversion extends ExpressionNodeConversion<ExpressionNode> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.SpelExpressionTransformer.NodeConversion#supports(ghost.framework.data.mongodb.core.spel.ExpressionNode)
		 */
		@Override
		protected boolean supports(ExpressionNode node) {
	...
	private static class PropertyOrFieldReferenceNodeConversion extends ExpressionNodeConversion<ExpressionNode> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.SpelExpressionTransformer.NodeConversion#convert(ghost.framework.data.mongodb.core.aggregation.SpelExpressionTransformer.ExpressionTransformationContext)
		 */
		@Override
		protected Object convert(AggregationExpressionTransformationContext<ExpressionNode> context) {
	...
	private static class LiteralNodeConversion extends ExpressionNodeConversion<LiteralNode> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.SpelExpressionTransformer.SpelNodeWrapper#supports(ghost.framework.expression.spel.SpelNode)
		 */
		@Override
		protected boolean supports(ExpressionNode node) {
