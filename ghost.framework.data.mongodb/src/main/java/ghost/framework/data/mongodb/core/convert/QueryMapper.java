...
import ghost.framework.data.mongodb.core.convert.MappingMongoConverter.NestedDocument;
...
import ghost.framework.data.mongodb.core.mapping.MongoPersistentProperty.PropertyToFieldNameConverter;
...
public class QueryMapper {
	...
	public QueryMapper(MongoConverter converter) {
		...
		this.converterContainer = converter.getConverterContainer();
	...
	public Document getMappedSort(Document sortObject, @Nullable MongoPersistentEntity<?> entity) {
		...
		for (Entry<String, Object> entry : BsonUtils.asMap(sortObject).entrySet()) {
	 ...
	 * requires conversion to a {@link ghost.framework.data.mongodb.core.mapping.DBRef} object. We check whether the
	 ...
	 * {@link ghost.framework.data.mongodb.core.mapping.Field#targetType() target type} before applying further
	...
	private Object applyFieldTargetTypeHintToValue(Field documentField, Object value) {
		...
		if (!converterContainer.canConvert(value.getClass(), documentField.getProperty().getFieldType())) {
			return value;
		}
		...
		if (value instanceof Collection) {
			...
			for (Object o : source) {
				converted.add(converterContainer.convert(o, documentField.getProperty().getFieldType()));
			}

			return converted;
		}

		return converterContainer.convert(value, documentField.getProperty().getFieldType());
	}
	...
	protected static class Field {
		...
		/**
		 * Returns whether the field references a {@link Map}.
		 *
		 * @return {@literal true} if property information is available and references a {@link Map}.
		...
		public TypeInformation<?> getTypeHint() {
			return null;//ClassTypeInformation.OBJECT;
		}
	}
	...
	protected static class MetadataBackedField extends Field {
		...
		PersistentPropertyPath<MongoPersistentProperty> path;
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.convert.QueryMapper.Field#with(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.convert.QueryMapper.Field#isIdField()
		 */
		@Override
		public boolean isIdField() {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.convert.QueryMapper.Field#getProperty()
		 */
		@Override
		public MongoPersistentProperty getProperty() {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.convert.QueryMapper.Field#getEntity()
		 */
		@Override
		public MongoPersistentEntity<?> getPropertyEntity() {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.convert.QueryMapper.Field#isAssociation()
		 */
		@Override
		public boolean isAssociation() {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.convert.QueryMapper.Field#getAssociation()
		 */
		@Override
		public Association<MongoPersistentProperty> getAssociation() {
			return association;
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.convert.QueryMapper.Field#getTargetKey()
		 */
		@Override
		public String getMappedKey() {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.convert.QueryMapper.Field#getTypeHint()
		 */
		@Override
		public TypeInformation<?> getTypeHint() {
