...
import ghost.framework.data.transaction.support.TransactionSynchronization;
import ghost.framework.data.transaction.support.TransactionSynchronizationManager;
...
public class MongoDatabaseUtils {
	...
	private static class MongoSessionSynchronization extends ResourceHolderSynchronization<MongoResourceHolder, Object> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.transaction.support.ResourceHolderSynchronization#shouldReleaseBeforeCompletion()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.transaction.support.ResourceHolderSynchronization#processResourceAfterCommit(java.lang.Object)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.transaction.support.ResourceHolderSynchronization#afterCompletion(int)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.transaction.support.ResourceHolderSynchronization#releaseResource(java.lang.Object, java.lang.Object)
		 */
		@Override
