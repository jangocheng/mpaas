...
/**
 * Used to resolve associations annotated with {@link ghost.framework.data.mongodb.core.mapping.DBRef}.
 *
...
public interface DbRefResolver {
	...
	/**
	 * Creates a {@link DBRef} instance for the given {@link ghost.framework.data.mongodb.core.mapping.DBRef}
	 ...
	 */
	default DBRef createDbRef(@Nullable ghost.framework.data.mongodb.core.mapping.DBRef annotation,
