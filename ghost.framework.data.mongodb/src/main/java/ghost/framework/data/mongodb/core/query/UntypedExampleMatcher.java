...
public class UntypedExampleMatcher implements ExampleMatcher {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#matching()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#matchingAny()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#matchingAll()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#withIgnorePaths(java.lang.String...)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#withStringMatcher(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#withIgnoreCase()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#withIgnoreCase(boolean)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#withMatcher(java.lang.String, ghost.framework.data.domain.ExampleMatcher.MatcherConfigurer)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#withMatcher(java.lang.String, ghost.framework.data.domain.ExampleMatcher.GenericPropertyMatcher)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#withTransformer(java.lang.String, ghost.framework.data.domain.ExampleMatcher.PropertyValueTransformer)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#withIgnoreCase(java.lang.String...)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#withIncludeNullValues()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#withIgnoreNullValues()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#withNullHandler(ghost.framework.data.domain.ExampleMatcher.NullHandler)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#getNullHandler()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#getDefaultStringMatcher()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#isIgnoreCaseEnabled()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#isIgnoredPath()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#getIgnoredPaths()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#getPropertySpecifiers()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#isAllMatching()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#isAnyMatching()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.domain.ExampleMatcher#getMatchMode()
	 */
