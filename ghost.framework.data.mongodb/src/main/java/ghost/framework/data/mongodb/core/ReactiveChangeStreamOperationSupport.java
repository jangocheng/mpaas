...
import ghost.framework.data.mongodb.core.ChangeStreamOptions.ChangeStreamOptionsBuilder;
import ghost.framework.data.mongodb.core.aggregation.Aggregation;
import ghost.framework.data.mongodb.core.aggregation.MatchOperation;
...
class ReactiveChangeStreamOperationSupport implements ReactiveChangeStreamOperation {
	...
	static class ReactiveChangeStreamSupport<T>
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveChangeStreamOperation.ChangeStreamWithCollection#watchCollection(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveChangeStreamOperation.ChangeStreamWithCollection#watchCollection(java.lang.Class)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveChangeStreamOperation.ResumingChangeStream#resumeAt(java.lang.Object)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveChangeStreamOperation.ResumingChangeStream#resumeAfter(java.lang.Object)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveChangeStreamOperation.ResumingChangeStream#startAfter(java.lang.Object)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveChangeStreamOperation.ChangeStreamWithOptions#withOptions(java.util.function.Consumer)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveChangeStreamOperation.ChangeStreamWithProjection#as(java.lang.Class)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveChangeStreamOperation.ChangeStreamWithFilter#filter(ghost.framework.data.mongodb.core.aggregation.Aggregation)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveChangeStreamOperation.ChangeStreamWithFilter#filter(ghost.framework.data.mongodb.core.query.CriteriaDefinition)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ReactiveChangeStreamOperation.TerminatingChangeStream#listen()
		 */
		@Override
