...
class InheritingExposedFieldsAggregationOperationContext extends ExposedFieldsAggregationOperationContext {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.aggregation.ExposedFieldsAggregationOperationContext#resolveExposedField(ghost.framework.data.mongodb.core.aggregation.Field, java.lang.String)
	 */
	@Override
