...
import ghost.framework.data.commons.converter.TypeMapper;
...
import ghost.framework.data.commons.mapping.model.*;
...
import ghost.framework.data.mongodb.core.mapping.event.AfterConvertCallback;
import ghost.framework.data.mongodb.core.mapping.event.AfterConvertEvent;
import ghost.framework.data.mongodb.core.mapping.event.AfterLoadEvent;
import ghost.framework.data.mongodb.core.mapping.event.MongoMappingEvent;
...
public class MappingMongoConverter extends AbstractMongoConverter {
	...
	protected @Nullable IApplication applicationContext;
	...
	public MappingMongoConverter(DbRefResolver dbRefResolver,
		...
		super(new CustomConverterContainer());
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.convert.MongoConverter#getTypeMapper()
	 */
	@Override
	 ...
	 * {@link ghost.framework.data.commons.mapping.callback.EntityCallback callbacks} like the {@link AfterConvertCallback}.
	 * <p />
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.core.MongoReader#read(java.lang.Class, com.mongodb.Document)
	 */
	...
	private <S extends Object> S read(TypeInformation<S> type, Bson bson, ObjectPath path) {
		...
		if (conversions.hasCustomReadTarget(bson.getClass(), rawType)) {
			return (S)converterContainer.convert(bson, rawType);
		}
	...
	private ParameterValueProvider<MongoPersistentProperty> getParameterProvider(MongoPersistentEntity<?> entity,
		...
		return new ConverterAwareSpELExpressionParameterValueProvider(evaluator, converterContainer, parameterProvider,
				path);
	}
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.convert.MongoWriter#toDBRef(java.lang.Object, ghost.framework.data.mongodb.core.mapping.MongoPersistentProperty)
	 */
	public DBRef toDBRef(Object object, @Nullable MongoPersistentProperty referringProperty) {

		ghost.framework.data.mongodb.core.mapping.DBRef annotation;
	 ...
	 * nested conversions.
	 *
	 * @see ghost.framework.data.mongodb.core.convert.MongoWriter#write(Object, Object)
	 */
	...
	protected void writeInternal(@Nullable Object obj, Bson bson, @Nullable TypeInformation<?> typeHint) {
		...
		if (customTarget.isPresent()) {
			Document result = (Document)converterContainer.convert(obj, Document.class);
	...
	protected void writePropertyInternal(@Nullable Object obj, DocumentAccessor accessor, MongoPersistentProperty prop) {
		...
		if (basicTargetType.isPresent()) {
			...
			accessor.put(prop, converterContainer.convert(obj, basicTargetType.get()));
			return;
		}
	...
	private Object getPotentiallyConvertedSimpleWrite(@Nullable Object value, @Nullable Class<?> typeHint) {
		...
		if (typeHint != null && Object.class != typeHint) {
			...
			if (converterContainer.canConvert(value.getClass(), typeHint)) {
				value = converterContainer.convert(value, typeHint);
			}
		}
		...
		if (customTarget.isPresent()) {
			return converterContainer.convert(value, customTarget.get());
		}
	...
	private Object getPotentiallyConvertedSimpleRead(@Nullable Object value, @Nullable Class<?> target) {
		...
		if (conversions.hasCustomReadTarget(value.getClass(), target)) {
			return converterContainer.convert(value, target);
		}
	...
	protected Map<Object, Object> readMap(TypeInformation<?> type, Bson bson, ObjectPath path) {
		...
		for (Entry<String, Object> entry : sourceMap.entrySet()) {
			...
			if (rawKeyType != null && !rawKeyType.isAssignableFrom(key.getClass())) {
				key = converterContainer.convert(key, rawKeyType);
			}
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.convert.MongoWriter#convertToMongoType(java.lang.Object, ghost.framework.data.util.TypeInformation)
	 */
	@Nullable
	@SuppressWarnings("unchecked")
	@Override
	public Object convertToMongoType(@Nullable Object obj, TypeInformation<?> typeInformation) {
		...
		if (target.isPresent()) {
			return converterContainer.convert(obj, target.get());
		}
	...
	class MongoDbPropertyValueProvider implements PropertyValueProvider<MongoPersistentProperty> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.convert.PropertyValueProvider#getPropertyValue(ghost.framework.data.mapping.PersistentProperty)
		 */
		@Nullable
	...
	private class ConverterAwareSpELExpressionParameterValueProvider
		...
		public ConverterAwareSpELExpressionParameterValueProvider(SpELExpressionEvaluator evaluator,
																  ConverterContainer converterContainer, ParameterValueProvider<MongoPersistentProperty> delegate,
																  ObjectPath path) {

			super(evaluator, converterContainer, delegate);
			this.path = path;
		}

		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mapping.entity.SpELExpressionParameterValueProvider#potentiallyConvertSpelValue(java.lang.Object, ghost.framework.data.mapping.PreferredConstructor.Parameter)
		 */
		@Override
	...
	<T> T readValue(Object value, TypeInformation<?> type, ObjectPath path) {
		...
		if (conversions.hasCustomReadTarget(value.getClass(), rawType)) {
			return (T) converterContainer.convert(value, rawType);
		} else if (value instanceof DBRef) {
