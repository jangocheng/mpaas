...
import ghost.framework.data.mongodb.core.aggregation.FieldsExposingAggregationOperation.InheritsFieldsAggregationOperation;
...
public class GraphLookupOperation implements InheritsFieldsAggregationOperation {
	...
	static final class GraphLookupOperationFromBuilder
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.GraphLookupOperation.FromBuilder#from(java.lang.String)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.GraphLookupOperation.StartWithBuilder#startWith(java.lang.String[])
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.GraphLookupOperation.StartWithBuilder#startWith(ghost.framework.data.mongodb.core.aggregation.AggregationExpression[])
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.GraphLookupOperation.ConnectFromBuilder#connectFrom(java.lang.String)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.GraphLookupOperation.ConnectToBuilder#connectTo(java.lang.String)
		 */
		@Override
