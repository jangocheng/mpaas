...
public interface JsonSchemaObject {
	...
	interface Type {
		...
		class JsonType implements Type {
			...
			/*
			 * (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.schema.JsonSchemaObject.Type#representation()
			 */
			@Override
			...
			/*
			 * (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.schema.JsonSchemaObject.Type#value()
			 */
			@Override
			public String value() {
				return name;
