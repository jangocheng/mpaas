...
/**
 * MongoDB specific {@link ghost.framework.data.mapping.PersistentProperty} implementation.
 *
...
public class BasicMongoPersistentProperty extends AnnotationBasedPersistentProperty<MongoPersistentProperty>
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.MongoPersistentProperty#isExplicitIdProperty()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.MongoPersistentProperty#getFieldType()
	 */
	@Override
	...
	/**
	 * @return true if {@link ghost.framework.data.mongodb.core.mapping.Field} having non blank
	 *         {@link ghost.framework.data.mongodb.core.mapping.Field#value()} present.
	 * @since 1.7
	 */
	...
	private String getAnnotatedFieldName() {
		...
		ghost.framework.data.mongodb.core.mapping.Field annotation = findAnnotation(
				ghost.framework.data.mongodb.core.mapping.Field.class);
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.MongoPersistentProperty#getFieldOrder()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.MongoPersistentProperty#isDbReference()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.MongoPersistentProperty#getDBRef()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.MongoPersistentProperty#isLanguageProperty()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.MongoPersistentProperty#isExplicitLanguageProperty()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.MongoPersistentProperty#isTextScoreProperty()
	 */
	@Override
