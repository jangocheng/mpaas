...
/**
 * A {@link JsonSchemaObject} of a given {@link ghost.framework.data.mongodb.core.schema.JsonSchemaObject.Type}.
 *
...
public class TypedJsonSchemaObject extends UntypedJsonSchemaObject {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.schema.JsonSchemaObject#getTypes()
	 */
	@Override
	...
	public static class ObjectJsonSchemaObject extends TypedJsonSchemaObject {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.UntypedJsonSchemaObject#possibleValues(java.util.Collection)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.UntypedJsonSchemaObject#allOf(java.util.Collection)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.UntypedJsonSchemaObject#anyOf(java.util.Collection)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.UntypedJsonSchemaObject#oneOf(java.util.Collection)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.UntypedJsonSchemaObject#notMatch(ghost.framework.data.mongodb.core.schema.JsonSchemaObject)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.UntypedJsonSchemaObject#description(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.UntypedJsonSchemaObject#generatedDescription()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.JsonSchemaObject#toDocument()
		 */
		@Override
		public Document toDocument() {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.TypedJsonSchemaObject#generateDescription()
		 */
		@Override
		protected String generateDescription() {
	...
	public static class NumericJsonSchemaObject extends TypedJsonSchemaObject {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.TypedJsonSchemaObject#possibleValues(java.util.Collection)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.TypedJsonSchemaObject#allOf(java.util.Collection)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.TypedJsonSchemaObject#anyOf(java.util.Collection)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.TypedJsonSchemaObject#oneOf(java.util.Collection)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.TypedJsonSchemaObject#notMatch(ghost.framework.data.mongodb.core.schema.JsonSchemaObject)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.TypedJsonSchemaObject#description(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.TypedJsonSchemaObject#generatedDescription()
		 */
		@Override
	...
	public static class ArrayJsonSchemaObject extends TypedJsonSchemaObject {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.TypedJsonSchemaObject#toDocument()
		 */
		@Override
		public Document toDocument() {
