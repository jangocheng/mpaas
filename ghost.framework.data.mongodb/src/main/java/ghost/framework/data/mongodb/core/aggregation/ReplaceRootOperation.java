...
public class ReplaceRootOperation implements FieldsExposingAggregationOperation {
	...
	private static class AggregationExpressionReplacement implements Replacement {
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.ReplaceRootOperation.Replacement#toObject(ghost.framework.data.mongodb.core.aggregation.AggregationOperationContext)
		 */
		@Override
	...
	private static class DocumentContributor implements ReplacementContributor {
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.ReplaceRootOperation.ReplacementContributor#toDocument(ghost.framework.data.mongodb.core.aggregation.AggregationOperationContext)
		 */
		@Override
		public Document toDocument(AggregationOperationContext context) {
