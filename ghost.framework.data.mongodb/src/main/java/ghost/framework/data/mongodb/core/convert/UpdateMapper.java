...
import ghost.framework.data.mongodb.core.query.Update.Modifier;
import ghost.framework.data.mongodb.core.query.Update.Modifiers;
...
public class UpdateMapper extends QueryMapper {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.convert.QueryMapper#getMappedObject(Bson, MongoPersistentEntity)
	 */
	@Override
	 ...
	 * mongo type.
	 *
	 * @see ghost.framework.data.mongodb.core.convert.QueryMapper#delegateConvertToMongoType(Object,
	 *      ghost.framework.data.mongodb.core.mapping.MongoPersistentEntity)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.convert.QueryMapper#getMappedObjectForField(ghost.framework.data.mongodb.core.convert.QueryMapper.Field, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.convert.QueryMapper#isAssociationConversionNecessary(ghost.framework.data.mongodb.core.convert.QueryMapper.Field, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.convert.QueryMapper#createPropertyField(ghost.framework.data.mongodb.core.mapping.MongoPersistentEntity, java.lang.String, ghost.framework.data.mapping.context.MappingContext)
	 */
	@Override
	...
	private static class MetadataBackedUpdateField extends MetadataBackedField {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.convert.QueryMapper.MetadataBackedField#getMappedKey()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.convert.QueryMapper.MetadataBackedField#getPropertyConverter()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.convert.QueryMapper.MetadataBackedField#getAssociationConverter()
		 */
		@Override
