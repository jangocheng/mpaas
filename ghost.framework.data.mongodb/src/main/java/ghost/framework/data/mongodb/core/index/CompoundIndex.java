...
public @interface CompoundIndex {
	...
	/**
	 * The actual index definition in JSON format or a {@link ghost.framework.expression.spel.standard.SpelExpression
	 ...
	 * {@link ghost.framework.expression.spel.standard.SpelExpression template expression}. <br />
	 * <br />
