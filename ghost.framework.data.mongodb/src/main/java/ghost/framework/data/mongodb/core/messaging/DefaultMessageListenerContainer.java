...
public class DefaultMessageListenerContainer implements MessageListenerContainer {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.context.SmartLifecycle#isAutoStartup()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.context.SmartLifecycle#stop(java.lang.Runnable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.context.Lifecycle#start()
	 */
	@Override
	public void start() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.context.Lifecycle#stop()
	 */
	@Override
	public void stop() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.context.Lifecycle#isRunning()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.context.Phased#getPhase()
	 */
	@Override
	public int getPhase() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.monitor.MessageListenerContainer#register(ghost.framework.data.mongodb.monitor.SubscriptionRequest, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.monitor.MessageListenerContainer#register(ghost.framework.data.mongodb.monitor.SubscriptionRequest, java.lang.Class, ghost.framework.util.ErrorHandler)
	 */
	@Override
	public <S, T> Subscription register(SubscriptionRequest<S, ? super T, ? extends RequestOptions> request,
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.monitor.MessageListenerContainer#lookup(ghost.framework.data.mongodb.monitor.SubscriptionRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.monitor.MessageListenerContainer#remove(ghost.framework.data.mongodb.monitor.Subscription)
	 */
	@Override
