...
public class CachingMongoPersistentProperty extends BasicMongoPersistentProperty {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.BasicMongoPersistentProperty#isIdProperty()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.BasicMongoPersistentProperty#isAssociation()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.BasicMongoPersistentProperty#getFieldName()
	 */
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.BasicMongoPersistentProperty#getFieldType()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.BasicMongoPersistentProperty#isDbReference()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.BasicMongoPersistentProperty#getDBRef()
	 */
	@Override
