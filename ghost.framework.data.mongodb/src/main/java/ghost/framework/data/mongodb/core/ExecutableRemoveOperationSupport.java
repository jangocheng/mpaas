...
class ExecutableRemoveOperationSupport implements ExecutableRemoveOperation {
	...
	static class ExecutableRemoveSupport<T> implements ExecutableRemove<T>, RemoveWithCollection<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ExecutableRemoveOperation.RemoveWithCollection#inCollection(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ExecutableRemoveOperation.RemoveWithQuery#matching(ghost.framework.data.mongodb.core.query.Query)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ExecutableRemoveOperation.TerminatingRemove#all()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ExecutableRemoveOperation.TerminatingRemove#one()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ExecutableRemoveOperation.TerminatingRemove#findAndRemove()
		 */
		@Override
