 ...
 */
package ghost.framework.data.mongodb.core.geo;
...
public class GeoJsonModule extends SimpleModule {
	...
	private static class GeoJsonPointDeserializer extends GeoJsonDeserializer<GeoJsonPoint> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.geo.GeoJsonModule.GeoJsonDeserializer#doDeserialize(com.fasterxml.jackson.databind.node.ArrayNode)
		 */
		@Nullable
		@Override
