...
//				throw new ConversionFailedException(SOURCE, TARGET, source, e);
	 ...
	 */
	@WritingConverter
	enum NumberToNumberConverterFactory implements ConverterFactory<Number, Number> {
		INSTANCE;

		/*
		 * (non-Javadoc)
		 * @see ghost.framework.core.convert.converter.ConverterFactory#getConverter(java.lang.Class)
		 */
//		@Override
...
//		@Override
		...
		@Override
		public Converter<Number, Number> getConverter(Class<Number> c) {
			return null;
		}
