...
import ghost.framework.data.commons.mapping.IdentifierAccessor;
...
import ghost.framework.data.commons.mapping.model.ConvertingPropertyAccessor;
...
class EntityOperations {
	...
	/**
	 * Creates a new {@link AdaptibleEntity} for the given bean and {@link ConverterContainer}.
	 *
	 * @param entity must not be {@literal null}.
	 ...
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	<T> AdaptibleEntity<T> forEntity(T entity, ConverterContainer converterContainer) {
		...
		return AdaptibleMappedEntity.of(entity, context, converterContainer);
	}
	...
	private static class UnmappedEntity<T extends Map<String, Object>> implements AdaptibleEntity<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.PersistableSource#getIdPropertyName()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.PersistableSource#getId()
		 */
		@Override
		public Object getId() {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.PersistableSource#getByIdQuery()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.MutablePersistableSource#populateIdIfNecessary(java.lang.Object)
		 */
		@Nullable
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.PersistableSource#getQueryForVersion()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.PersistableSource#toMappedDocument(ghost.framework.data.mongodb.core.convert.MongoWriter)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.MutablePersistableSource#initializeVersionProperty()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.MutablePersistableSource#getVersion()
		 */
		@Override
		@Nullable
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.MutablePersistableSource#incrementVersion()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.PersistableSource#getBean()
		 */
		@Override
		public T getBean() {
			return map;
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.Entity#isNew()
		 */
		@Override
	...
	private static class MappedEntity<T> implements Entity<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.PersistableSource#getQueryForVersion(java.lang.Object)
		 */
		@Override
		public Query getQueryForVersion() {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.Entity#assertUpdateableIdIfNotSet()
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.PersistableSource#isVersionedEntity()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.PersistableSource#getVersion()
		 */
		@Override
		@Nullable
	...
	private static class AdaptibleMappedEntity<T> extends MappedEntity<T> implements AdaptibleEntity<T> {
		...
		private static <T> AdaptibleEntity<T> of(T bean,
			...
			return new AdaptibleMappedEntity<>(entity, identifierAccessor,
					new ConvertingPropertyAccessor<>(propertyAccessor, converterContainer));
		}

		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.AdaptibleEntity#populateIdIfNecessary(java.lang.Object)
		 */
		@Nullable
		@Override
		public T populateIdIfNecessary(@Nullable Object id) {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.MappedEntity#getVersion()
		 */
		@Override
		@Nullable
		public Number getVersion() {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.AdaptibleEntity#initializeVersionProperty()
		 */
		@Override
		public T initializeVersionProperty() {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.AdaptibleEntity#incrementVersion()
		 */
		@Override
		public T incrementVersion() {
	...
	enum UntypedOperations implements TypedOperations<Object> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.TypedOperations#getCollation()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.EntityOperations.TypedOperations#getCollation(ghost.framework.data.mongodb.core.query.Query)
		 */
		@Override
