...
import ghost.framework.data.mongodb.core.aggregation.VariableOperators.Let;
...
public class MergeOperation implements FieldsExposingAggregationOperation, InheritsFieldsAggregationOperation {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.aggregation.Aggregation#toDocument(ghost.framework.data.mongodb.core.aggregation.AggregationOperationContext)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.aggregation.FieldsExposingAggregationOperation.InheritsFieldsAggregationOperation#inheritsFields()
	 */
	@Override
