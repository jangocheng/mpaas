...
import ghost.framework.data.mongodb.core.index.MongoPersistentEntityIndexResolver.CycleGuard.Path;
import ghost.framework.data.mongodb.core.index.MongoPersistentEntityIndexResolver.TextIndexIncludeOptions.IncludeStrategy;
import ghost.framework.data.mongodb.core.index.TextIndexDefinition.TextIndexDefinitionBuilder;
import ghost.framework.data.mongodb.core.index.TextIndexDefinition.TextIndexedFieldSpec;
import ghost.framework.data.mongodb.core.mapping.BasicMongoPersistentEntity;
...
public class MongoPersistentEntityIndexResolver implements IndexResolver {
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.index.IndexResolver#resolveIndexForClass(ghost.framework.data.util.TypeInformation)
	 */
	@Override
	 ...
	 * {@link ghost.framework.expression.spel.standard.SpelExpression expressions}.
	 *
	 ...
	 * {@link ghost.framework.expression.spel.standard.SpelExpression} and parsing the final value.
	 *
	...
	public static class IndexDefinitionHolder implements IndexDefinition {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.index.IndexDefinition#getIndexKeys()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.index.IndexDefinition#getIndexOptions()
		 */
		@Override
