...
abstract class CursorReadingTask<T, R> implements Task {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.messaging.Cancelable#cancel()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.messaging.Task#getState()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.messaging.Task#awaitStart(java.time.Duration)
	 */
	@Override
	 ...
	 * {@link ghost.framework.data.mongodb.core.MongoExceptionTranslator} rethrowing the potentially translated
	 * exception.
	 *
