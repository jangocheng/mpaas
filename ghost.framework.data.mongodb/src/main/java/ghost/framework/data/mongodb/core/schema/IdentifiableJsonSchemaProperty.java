...
public class IdentifiableJsonSchemaProperty<T extends JsonSchemaObject> implements JsonSchemaProperty {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.schema.JsonSchemaProperty#getIdentifier()
	 */
	@Override
	...
	public static class RequiredJsonSchemaProperty implements JsonSchemaProperty {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.schema.JsonSchemaProperty#isRequired()
		 */
		@Override
