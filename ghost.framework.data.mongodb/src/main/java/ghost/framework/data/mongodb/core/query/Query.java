...
public class Query {
	...
	/**
	 * @return this.
	 * @see ghost.framework.data.mongodb.core.query.Meta.CursorOption#NO_TIMEOUT
	 * @since 1.10
	 */
	...
	/**
	 * @return this.
	 * @see ghost.framework.data.mongodb.core.query.Meta.CursorOption#EXHAUST
	 * @since 1.10
	 */
	 ...
	 *
	 * @return this.
	 * @see ghost.framework.data.mongodb.core.query.Meta.CursorOption#SLAVE_OK
	 * @since 1.10
	 ...
	 *
	 * @return this.
	 * @see ghost.framework.data.mongodb.core.query.Meta.CursorOption#SECONDARY_READS
	 * @since 3.0.2
	 */
	...
	/**
	 * @return this.
	 * @see ghost.framework.data.mongodb.core.query.Meta.CursorOption#PARTIAL
	 * @since 1.10
	 */
