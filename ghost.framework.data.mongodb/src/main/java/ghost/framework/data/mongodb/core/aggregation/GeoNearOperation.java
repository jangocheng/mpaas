...
public class GeoNearOperation implements AggregationOperation {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.aggregation.AggregationOperation#toPipelineStages(ghost.framework.data.mongodb.core.aggregation.AggregationOperationContext)
	 */
	@Override
