...
import ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Cond;
import ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.IfNull;
import ghost.framework.data.mongodb.core.aggregation.ExposedFields.ExposedField;
import ghost.framework.data.mongodb.core.aggregation.Fields.AggregationField;
import ghost.framework.data.mongodb.core.aggregation.ProjectionOperation.ProjectionOperationBuilder.FieldProjection;
import ghost.framework.data.mongodb.core.aggregation.VariableOperators.Let.ExpressionVariable;
...
public class ProjectionOperation implements FieldsExposingAggregationOperation {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.aggregation.FieldsExposingAggregationOperation#inheritsFields()
	 */
	@Override
	...
	public static class ExpressionProjectionOperationBuilder extends ProjectionOperationBuilder {
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.ProjectionOperation.ProjectionOperationBuilder#project(java.lang.String, java.lang.Object[])
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.ProjectionOperation.AbstractProjectionOperationBuilder#as(java.lang.String)
		 */
		@Override
	...
	public static class ProjectionOperationBuilder extends AbstractProjectionOperationBuilder {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.ProjectionOperation.AbstractProjectionOperationBuilder#transform(ghost.framework.data.mongodb.core.aggregation.ConditionalOperator)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.ProjectionOperation.AbstractProjectionOperationBuilder#transform(ghost.framework.data.mongodb.core.aggregation.IfNullOperator)
		 */
		@Override
		...
		static class OperationProjection extends Projection {
			...
			/*
			 * (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ProjectionOperation.Projection#getExposedField()
			 */
			@Override
			...
			OperationProjection withAlias(String alias) {
				...
				return new OperationProjection(aliasedField, operation, values.toArray()) {
					...
					/*
					 * (non-Javadoc)
					 * @see ghost.framework.data.mongodb.core.aggregation.ProjectionOperation.ProjectionOperationBuilder.OperationProjection#getField()
					 */
					@Override
					protected Field getField() {
						return aliasedField;
