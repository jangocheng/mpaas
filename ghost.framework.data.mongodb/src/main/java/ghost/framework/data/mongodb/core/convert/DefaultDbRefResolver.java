...
import ghost.framework.data.mongodb.LazyLoadingException;
...
import static ghost.framework.util.ReflectionUtils.isObjectMethod;

/**
 * A {@link DbRefResolver} that resolves {@link ghost.framework.data.mongodb.core.mapping.DBRef}s by delegating to a
...
//	private final Object objenesis;
	/**
...
//		this.objenesis = new ObjenesisStd(true);
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.convert.DbRefResolver#resolveDbRef(ghost.framework.data.mongodb.core.mapping.MongoPersistentProperty, ghost.framework.data.mongodb.core.convert.DbRefResolverCallback)
	 */
	@Override
...
//		enhancer.setCallbackType(ghost.framework.cglib.proxy.MethodInterceptor.class);
...
//		return enhancer.createClass();
	...
	static class LazyLoadingInterceptor
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.cglib.proxy.MethodInterceptor#intercept(java.lang.Object, java.lang.reflect.Method, java.lang.Object[], ghost.framework.cglib.proxy.MethodProxy)
		 */
		@Nullable
//		@Override
