...
import ghost.framework.data.mongodb.core.index.IndexDefinition;
import ghost.framework.data.mongodb.core.index.IndexInfo;
...
public class DefaultReactiveIndexOperations implements ReactiveIndexOperations {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.index.ReactiveIndexOperations#ensureIndex(ghost.framework.data.mongodb.core.index.IndexDefinition)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.index.ReactiveIndexOperations#dropIndex(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.index.ReactiveIndexOperations#dropAllIndexes()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.index.ReactiveIndexOperations#getIndexInfo()
	 */
