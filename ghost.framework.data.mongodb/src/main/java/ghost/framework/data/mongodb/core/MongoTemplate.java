...
import ghost.framework.data.commons.mapping.callback.EntityCallbacks;
...
import ghost.framework.data.mongodb.MongoDatabaseUtils;
import ghost.framework.data.mongodb.SessionSynchronization;
import ghost.framework.data.mongodb.core.BulkOperations.BulkMode;
import ghost.framework.data.mongodb.core.DefaultBulkOperations.BulkOperationContext;
...
import ghost.framework.data.mongodb.core.index.MongoPersistentEntityIndexCreator;
...
import ghost.framework.data.mongodb.core.mapreduce.GroupBy;
import ghost.framework.data.mongodb.core.mapreduce.GroupByResults;
import ghost.framework.data.mongodb.core.mapreduce.MapReduceOptions;
import ghost.framework.data.mongodb.core.mapreduce.MapReduceResults;
...
//		this.propertyOperations = new PropertyOperations(this.mongoConverter.getMappingContext());
		this.queryOperations = new QueryOperations(queryMapper, updateMapper, null, null,
				mongoDbFactory);
/*
...
*/
	 ...
	 * {@link ghost.framework.data.mapping.callback.EntityCallback callbacks} like the {@link BeforeSaveCallback}.
	 * <p />
...
*/
	/**
	 * Returns the default {@link ghost.framework.data.mongodb.core.convert.MongoConverter}.
	 *
	 * @return
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#executeAsStream(ghost.framework.data.mongodb.core.query.Query, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#stream(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.String)
	 */
	@Override
...
////					new ProjectingReadCallback<>(mongoConverter, entityType, returnType, collectionName));
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#executeCommand(java.lang.String)
	 */
	@Override
	@SuppressWarnings("ConstantConditions")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#executeCommand(org.bson.Document)
	 */
	@Override
	@SuppressWarnings("ConstantConditions")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#executeCommand(org.bson.Document, com.mongodb.ReadPreference)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#executeQuery(ghost.framework.data.mongodb.core.query.Query, java.lang.String, ghost.framework.data.mongodb.core.DocumentCallbackHandler)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#execute(ghost.framework.data.mongodb.core.DbCallback)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#execute(java.lang.Class, ghost.framework.data.mongodb.core.DbCallback)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#execute(java.lang.String, ghost.framework.data.mongodb.core.DbCallback)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#withSession(com.mongodb.ClientSessionOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#withSession(com.mongodb.session.ClientSession)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#createCollection(java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#createCollection(java.lang.Class, ghost.framework.data.mongodb.core.CollectionOptions)
	 */
	public <T> MongoCollection<Document> createCollection(Class<T> entityClass,
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#createCollection(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#createCollection(java.lang.String, ghost.framework.data.mongodb.core.CollectionOptions)
	 */
	public MongoCollection<Document> createCollection(String collectionName,
			@Nullable CollectionOptions collectionOptions) {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#getCollection(java.lang.String)
	 */
	@SuppressWarnings("ConstantConditions")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation#getCollection(java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation#getCollection(java.lang.String)
	 */
	@SuppressWarnings("ConstantConditions")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation#dropCollection(java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation#dropCollection(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation#indexOps(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation#indexOps(java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation#bulkOps(ghost.framework.data.mongodb.core.BulkMode, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation#bulkOps(ghost.framework.data.mongodb.core.BulkMode, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation#bulkOps(ghost.framework.data.mongodb.core.BulkMode, java.lang.Class, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#scriptOps()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#findOne(ghost.framework.data.mongodb.core.query.Query, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#findOne(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#findDistinct(ghost.framework.data.mongodb.core.query.Query, java.lang.String, java.lang.Class, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#findDistinct(ghost.framework.data.mongodb.core.query.Query, java.lang.String, java.lang.String, java.lang.Class, java.lang.Class)
	 */
	@Override
...
//					distinctQueryContext.getMostSpecificConversionTargetType(resultClass, entityClass), dbRefResolver));
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#findAndReplace(ghost.framework.data.mongodb.core.query.Query, java.lang.Object, ghost.framework.data.mongodb.core.FindAndReplaceOptions, java.lang.Class, java.lang.String, java.lang.Class)
	 */
	@Override
	public <S, T> T findAndReplace(Query query, S replacement, FindAndReplaceOptions options, Class<S> entityType,
		...
		Document mappedFields = queryContext.getMappedFields(entity, resultType, null);
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#count(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#insert(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#insert(java.lang.Object, java.lang.String)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	private <T> T doSaveVersioned(AdaptibleEntity<T> source, String collectionName) {
		...
		if (source.getBean() != toSave) {
			source = operations.forEntity(toSave, mongoConverter.getConverterContainer());
		}
	...
	protected <T> T doSave(String collectionName, T objectToSave, MongoWriter<T> writer) {
		...
		AdaptibleEntity<T> entity = operations.forEntity(objectToSave, mongoConverter.getConverterContainer());
		entity.assertUpdateableIdIfNotSet();
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#aggregate(ghost.framework.data.mongodb.core.aggregation.TypedAggregation, java.lang.Class)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#aggregate(ghost.framework.data.mongodb.core.aggregation.TypedAggregation, java.lang.String, java.lang.Class)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#aggregate(ghost.framework.data.mongodb.core.aggregation.Aggregation, java.lang.Class, java.lang.Class)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#aggregate(ghost.framework.data.mongodb.core.aggregation.Aggregation, java.lang.String, java.lang.Class)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#aggregateStream(ghost.framework.data.mongodb.core.aggregation.TypedAggregation, java.lang.String, java.lang.Class)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#aggregateStream(ghost.framework.data.mongodb.core.aggregation.TypedAggregation, java.lang.Class)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#aggregateStream(ghost.framework.data.mongodb.core.aggregation.Aggregation, java.lang.Class, java.lang.Class)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#aggregateStream(ghost.framework.data.mongodb.core.aggregation.Aggregation, java.lang.String, java.lang.Class)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#findAllAndRemove(ghost.framework.data.mongodb.core.query.Query, java.lang.String)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#findAllAndRemove(ghost.framework.data.mongodb.core.query.Query, java.lang.Class)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.MongoOperations#findAllAndRemove(ghost.framework.data.mongodb.core.query.Query, java.lang.Class, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ExecutableRemoveOperation#remove(java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation#insert(java.lang.Class)
	 */
	@Override
	...
	protected String replaceWithResourceIfNecessary(String function) {
		...
		if (this.resourceLoader != null && ResourceUtils.isUrl(function)) {
			...
			IResource functionResource = resourceLoader.getResource(func);
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation#getCollectionNames()
	 */
	@SuppressWarnings("ConstantConditions")
...
//		}
	...
	protected <T> T doFindOne(String collectionName, Document query, Document fields, CursorPreparer preparer,
		...
		Document mappedFields = queryContext.getMappedFields(entity, entityClass, null);
		Document mappedQuery = queryContext.getMappedQuery(entity);
	...
	<S, T> List<T> doFind(String collectionName, Document query, Document fields, Class<S> sourceClass,
		...
		QueryContext queryContext = queryOperations.createQueryContext(new BasicQuery(query, fields));
		Document mappedFields = queryContext.getMappedFields(entity, targetClass, null);
		Document mappedQuery = queryContext.getMappedQuery(entity);
	...
	protected <T> T populateIdIfNecessary(T savedObject, Object id) {
		...
		return operations.forEntity(savedObject, mongoConverter.getConverterContainer()) //
...
//		converter.afterPropertiesSet();
	...
	private static class FindAndReplaceCallback implements CollectionCallback<Document> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.CollectionCallback#doInCollection(com.mongodb.client.MongoCollection)
		 */
		@Override
		public Document doInCollection(MongoCollection<Document> collection) throws MongoException, DataAccessException {
	...
	private class ProjectingReadCallback<S, T> implements DocumentCallback<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.MongoTemplate.DocumentCallback#doWith(org.bson.Document)
		 */
		@SuppressWarnings("unchecked")
		@Nullable
		public T doWith(@Nullable Document document) {
...
//			return (T) result;
	...
	class QueryCursorPreparer implements CursorPreparer {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.CursorPreparer#prepare(com.mongodb.DBCursor)
		 */
	...
	static class SessionBoundMongoTemplate extends MongoTemplate {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.MongoTemplate#getCollection(java.lang.String)
		 */
		@Override
		public MongoCollection<Document> getCollection(String collectionName) {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.MongoTemplate#getDb()
		 */
		@Override
		public MongoDatabase getDb() {
