 ...
 * the {@link ghost.framework.data.mongodb.core.query.Update} via {@code apply} into the MongoDB specific
 * representations. The collection to operate on is by default derived from the initial {@literal domainType} and can be
 * defined there via {@link ghost.framework.data.mongodb.core.mapping.Document}. Using {@code inCollection} allows
...
public interface ReactiveUpdateOperation {
	...
	/**
	 * Declare the {@link ghost.framework.data.mongodb.core.query.Update} to apply.
	 */
	...
	/**
	 * Define a filter query for the {@link ghost.framework.data.mongodb.core.query.Update} (optional).
	 */
	...
	interface FindAndModifyWithOptions<T> {
		 ...
		 * {@link ghost.framework.data.mongodb.core.query.Update}.
		 *
