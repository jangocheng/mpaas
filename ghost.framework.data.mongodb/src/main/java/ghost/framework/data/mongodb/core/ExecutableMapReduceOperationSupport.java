...
class ExecutableMapReduceOperationSupport implements ExecutableMapReduceOperation {
	...
	/*
	 * (non-Javascript)
	 * @see in ghost.framework.data.mongodb.core.ExecutableMapReduceOperation#mapReduce(java.lang.Class)
	 */
	@Override
	...
	static class ExecutableMapReduceSupport<T>
		...
		/*
		 * (non-Javascript)
		 * @see in ghost.framework.data.mongodb.core.ExecutableMapReduceOperation.TerminatingMapReduce#all()
		 */
		@Override
		public List<T> all() {
		...
		/*
		 * (non-Javascript)
		 * @see in ghost.framework.data.mongodb.core.ExecutableMapReduceOperation.MapReduceWithCollection#inCollection(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javascript)
		 * @see in ghost.framework.data.mongodb.core.ExecutableMapReduceOperation.MapReduceWithQuery#query(ghost.framework.data.mongodb.core.query.Query)
		 */
		@Override
		...
		/*
		 * (non-Javascript)
		 * @see in ghost.framework.data.mongodb.core.ExecutableMapReduceOperation.MapReduceWithProjection#as(java.lang.Class)
		 */
		@Override
		...
		/*
		 * (non-Javascript)
		 * @see in ghost.framework.data.mongodb.core.ExecutableMapReduceOperation.MapReduceWithOptions#with(ghost.framework.data.mongodb.core.mapreduce.MapReduceOptions)
		 */
		@Override
		...
		/*
		 * (non-Javascript)
		 * @see in ghost.framework.data.mongodb.core.ExecutableMapReduceOperation.MapReduceWithMapFunction#map(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javascript)
		 * @see in ghost.framework.data.mongodb.core.ExecutableMapReduceOperation.MapReduceWithReduceFunction#reduce(java.lang.String)
		 */
		@Override
