...
/**
 * {@link GridFSFile} based {@link IResource} implementation.
 *
...
public class GridFsResource extends InputStreamResource implements GridFsObject<Object, InputStream> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.core.io.InputStreamResource#getInputStream()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.core.io.AbstractResource#contentLength()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.core.io.AbstractResource#getFilename()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.core.io.AbstractResource#exists()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.core.io.AbstractResource#lastModified()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.core.io.AbstractResource#getDescription()
	 */
	@Override
	...
	/**
	 * Returns the {@link IResource}'s id.
	 *
	 * @return never {@literal null}.
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.gridfs.GridFsObject#getFileId()
	 */
	@Override
	...
	/**
	 * Returns the {@link IResource}'s content type.
	 *
	 * @return never {@literal null}.
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.gridfs.GridFsObject#getContent()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.gridfs.GridFsObject#getOptions()
	 */
	@Override
