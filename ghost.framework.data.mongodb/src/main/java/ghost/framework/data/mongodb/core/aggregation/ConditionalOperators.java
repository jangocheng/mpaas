...
import ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Cond.OtherwiseBuilder;
import ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Cond.ThenBuilder;
import ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Switch.CaseOperator;
...
public class ConditionalOperators {
	...
	public static class IfNull implements AggregationExpression {
		...
		static final class IfNullOperatorBuilder implements IfNullBuilder, ThenBuilder {
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.IfNull.IfNullBuilder#ifNull(java.lang.String)
			 */
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.IfNull.IfNullBuilder#ifNull(ghost.framework.data.mongodb.core.aggregation.AggregationExpression)
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.IfNull.ThenBuilder#then(java.lang.Object)
			 */
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.IfNull.ThenBuilder#thenValueOf(java.lang.String)
			 */
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.IfNull.ThenBuilder#thenValueOf(ghost.framework.data.mongodb.core.aggregation.AggregationExpression)
			 */
	...
	public static class Cond implements AggregationExpression {
		...
		static class ConditionalExpressionBuilder implements WhenBuilder, ThenBuilder, OtherwiseBuilder {
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Cond.WhenBuilder#when(org.bson.Document)
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Cond.WhenBuilder#when(ghost.framework.data.mongodb.core.query.CriteriaDefinition)
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Cond.WhenBuilder#when(ghost.framework.data.mongodb.core.aggregation.AggregationExpression)
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Cond.WhenBuilder#when(java.lang.String)
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Cond.ThenBuilder#then(java.lang.Object)
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Cond.ThenBuilder#thenValueOf(java.lang.String)
			 */
			@Override
			public OtherwiseBuilder thenValueOf(String fieldReference) {
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Cond.ThenBuilder#thenValueOf(ghost.framework.data.mongodb.core.aggregation.AggregationExpression)
			 */
			@Override
			public OtherwiseBuilder thenValueOf(AggregationExpression expression) {
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Cond.OtherwiseBuilder#otherwise(java.lang.Object)
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Cond.OtherwiseBuilder#otherwiseValueOf(java.lang.String)
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ConditionalOperators.Cond.OtherwiseBuilder#otherwiseValueOf(ghost.framework.data.mongodb.core.aggregation.AggregationExpression)
			 */
			@Override
