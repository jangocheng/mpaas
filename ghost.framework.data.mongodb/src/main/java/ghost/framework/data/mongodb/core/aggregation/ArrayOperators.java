...
import ghost.framework.data.mongodb.core.aggregation.ArrayOperators.Filter.AsBuilder;
import ghost.framework.data.mongodb.core.aggregation.ArrayOperators.Reduce.PropertyExpression;
...
public class ArrayOperators {
	...
	public static class Filter implements AggregationExpression {
		...
		static final class FilterExpressionBuilder implements InputBuilder, AsBuilder, ConditionBuilder {
			...
			/*
			 * (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ArrayOperators.Filter.InputBuilder#filter(java.util.List)
			 */
			@Override
			...
			/*
			 * (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ArrayOperators.Filter.InputBuilder#filter(ghost.framework.data.mongodb.core.aggregation.Field)
			 */
			@Override
			...
			/*
			 * (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ArrayOperators.Filter.AsBuilder#as(java.lang.String)
			 */
			@Override
			...
			/*
			 * (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ArrayOperators.Filter.ConditionBuilder#by(ghost.framework.data.mongodb.core.aggregation.AggregationExpression)
			 */
			@Override
			...
			/*
			 * (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ArrayOperators.Filter.ConditionBuilder#by(java.lang.String)
			 */
			@Override
			...
			/*
			 * (non-Javadoc)
			 * @see ghost.framework.data.mongodb.core.aggregation.ArrayOperators.Filter.ConditionBuilder#by(org.bson.Document)
			 */
			@Override
	...
	public static class ArrayToObject extends AbstractAggregationExpression {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.aggregation.AbstractAggregationExpression#getMongoMethod()
		 */
		@Override
		protected String getMongoMethod() {
