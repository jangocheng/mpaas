...
public class Update implements UpdateDefinition {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.query.UpdateDefinition#inc()
	 */
	@Override
	 ...
	 * Use with {@link ghost.framework.data.mongodb.core.MongoOperations#updateMulti(Query, UpdateDefinition, Class)}.
	 *
	 * @return this.
	 * @since 2.0
	 */
	...
	private static class Each extends AbstractModifier {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.query.Update.Modifier#getKey()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.query.Update.Modifier#getValue()
		 */
		@Override
