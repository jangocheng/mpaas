 ...
 * {@literal domainType} and can be defined there via {@link ghost.framework.data.mongodb.core.mapping.Document}.
...
public interface ExecutableRemoveOperation {
	...
	interface TerminatingRemove<T> {
		 ...
		 * Also, {@link ghost.framework.context.ApplicationEvent}s will be published for each and every delete
		 * operation.
		 *
