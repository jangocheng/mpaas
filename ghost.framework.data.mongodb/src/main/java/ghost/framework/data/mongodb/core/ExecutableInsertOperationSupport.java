...
class ExecutableInsertOperationSupport implements ExecutableInsertOperation {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.coreExecutableInsertOperation#insert(java.lan.Class)
	 */
	@Override
	...
	static class ExecutableInsertSupport<T> implements ExecutableInsert<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation.TerminatingInsert#insert(java.lang.Class)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation.TerminatingInsert#all(java.util.Collection)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation.TerminatingBulkInsert#bulk(java.util.Collection)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation.InsertWithCollection#inCollection(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.core.ExecutableInsertOperation.InsertWithBulkMode#withBulkMode(ghost.framework.data.mongodb.core.BulkMode)
		 */
		@Override
