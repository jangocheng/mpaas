...
import ghost.framework.data.mongodb.gridfs.GridFsUpload.GridFsUploadBuilder;
...
public interface GridFsOperations extends ResourcePatternResolver {
	 ...
	 * @return the resource. Use {@link ghost.framework.core.io.Resource#exists()} to check if the returned
