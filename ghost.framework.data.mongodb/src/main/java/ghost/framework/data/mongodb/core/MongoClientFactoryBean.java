 ...
 * @author Mark Paluch
 */
public class MongoClientFactoryBean implements PersistenceExceptionTranslator {
	...
	public DataAccessException translateExceptionIfPossible(RuntimeException ex) {
		return null;//exceptionTranslator.translateExceptionIfPossible(ex);
	}
...
//	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.beans.factory.config.AbstractFactoryBean#destroyInstance(java.lang.Object)
	 */
//	@Override
