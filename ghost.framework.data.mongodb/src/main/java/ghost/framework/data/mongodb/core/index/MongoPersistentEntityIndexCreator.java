...
import ghost.framework.data.mongodb.core.index.MongoPersistentEntityIndexResolver.IndexDefinitionHolder;
 ...
 * @author Mark Paluch
 */
public class MongoPersistentEntityIndexCreator implements ApplicationEventListener<MappingContextEvent<?, ?>> {
