...
public class HelloOSS {
    static Log logger = LogFactory.getLog(HelloOSS.class);
    ...
    private static String accessKeyId = "3xc9XGK9POqHecuV";
    private static String accessKeySecret = "vi61kGy0cwoGJN06FGqCJTh8wMoQWm";

    // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
    private static String bucketName = "guoshucan";
...
//        PropertyConfigurator.configure("log4j.properties");
        ...
        try {
            ...
            //写入图片
            fileKey = UUID.randomUUID().toString() + ".jpg";
            try (InputStream stream = HelloOSS.class.getResourceAsStream("/jpg.jpg")){
