...
import ghost.framework.data.mongodb.core.ExecutableFindOperation.FindWithProjection;
...
abstract class QuerydslFetchableMongodbQuery<K, Q extends QuerydslFetchableMongodbQuery<K, Q>>
	...
	public CloseableIterator<K> iterate() {
		...
		ghost.framework.data.util.CloseableIterator<? extends K> stream = mongoOperations.stream(createQuery(),
	...
	protected ghost.framework.data.mongodb.core.query.Query createQuery() {
	...
	protected ghost.framework.data.mongodb.core.query.Query createQuery(@Nullable Predicate filter,
