...
import ghost.framework.data.mongodb.core.ExecutableFindOperation;
import ghost.framework.data.mongodb.core.ExecutableFindOperation.FindWithQuery;
import ghost.framework.data.mongodb.core.ExecutableFindOperation.TerminatingFind;
 ...
 * {@link ghost.framework.data.repository.query.QueryMethod} a {@link AbstractMongoQuery} can be executed in various
 * flavors.
 *
...
interface MongoQueryExecution {
	...
	final class SlicedExecution implements MongoQueryExecution {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.jpa.repository.query.MongoQueryExecution#execute(ghost.framework.data.mongodb.core.query.Query)
		 */
		@Override
	...
	final class PagingGeoNearExecution extends GeoNearExecution {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mongodb.jpa.repository.query.MongoQueryExecution.GeoNearExecution#execute(ghost.framework.data.mongodb.core.query.Query)
		 */
		@Override
		public Object execute(Query query) {
