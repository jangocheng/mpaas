...
public class MappingMongoEntityInformation<T, ID> extends PersistentEntityInformation<T, ID>
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.jpa.repository.MongoEntityInformation#getCollectionName()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.jpa.repository.MongoEntityInformation#getIdAttribute()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.core.support.PersistentEntityInformation#getIdType()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.jpa.repository.MongoEntityInformation#isVersioned()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.jpa.repository.MongoEntityInformation#getVersion(Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.jpa.repository.MongoEntityInformation#getCollation()
	 */
	@Nullable
