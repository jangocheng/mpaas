...
import ghost.framework.data.repository.query.ReactiveQueryByExampleExecutor;
import ghost.framework.data.repository.reactive.ReactiveSortingRepository;
import reactor.core.publisher.Flux;
import reactor.core.publisher.Mono;

/**
 * Mongo specific {@link ghost.framework.data.repository.Repository} interface with reactive support.
 *
 * @author Mark Paluch
 * @since 2.0
 */
