...
import ghost.framework.data.geo.GeoPage;
...
import ghost.framework.data.mongodb.jpa.repository.Aggregation;
import ghost.framework.data.mongodb.jpa.repository.Meta;
import ghost.framework.data.mongodb.jpa.repository.Query;
import ghost.framework.data.mongodb.jpa.repository.Tailable;
...
public class MongoQueryMethod extends QueryMethod {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.query.QueryMethod#getParameters(java.lang.reflect.Method)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.query.QueryMethod#getEntityInformation()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.query.QueryMethod#getDomainClass()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.query.QueryMethod#getParameters()
	 */
	@Override
	...
	/**
	 * Returns the {@link ghost.framework.data.mongodb.core.query.Meta} attributes to be applied.
	 *
	 * @return never {@literal null}.
	 * @since 1.6
	 */
	public ghost.framework.data.mongodb.core.query.Meta getQueryMetaAttributes() {

		Meta meta = getMetaAnnotation();
		if (meta == null) {
			return new ghost.framework.data.mongodb.core.query.Meta();
		}

		ghost.framework.data.mongodb.core.query.Meta metaAttributes = new ghost.framework.data.mongodb.core.query.Meta();
		...
		if (!ObjectUtils.isEmpty(meta.flags())) {
			...
			for (ghost.framework.data.mongodb.core.query.Meta.CursorOption option : meta.flags()) {
