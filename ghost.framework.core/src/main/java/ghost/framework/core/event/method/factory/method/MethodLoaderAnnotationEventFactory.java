 ...
 * @Date: 2020/2/14:8:36
 */
public class MethodLoaderAnnotationEventFactory<O extends ICoreInterface, T extends Object, E extends IMethodBeanTargetHandle<O, T, Method>>
        implements IMethodLoaderAnnotationBeanFactory<O, T, E> {
    public MethodLoaderAnnotationEventFactory(@Autowired IApplication app) {
        this.app = app;
    }

    @Override
    public String toString() {
        return "MethodLoaderAnnotationEventFactory{" +
     ...
     * 类型注释工厂注释
     */
    private Class<? extends Annotation> annotation = Loader.class;
    ...
    public void loader(E event) {
        ...
        //获取注释
        Loader lo = this.getAnnotation(event);
        for (Class<?> c : lo.depend()) {
