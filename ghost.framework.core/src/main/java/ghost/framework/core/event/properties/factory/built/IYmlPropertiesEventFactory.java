...
// * @Description:默认yml事件工接口
// * @Date: 17:34 2020/1/14
// */
//public interface IYmlPropertiesEventFactory<O extends ICoreInterface, T extends Resource, P extends Properties, E extends IPropertiesEventTargetHandle<O, T, P>>
