...
// * @Description:类型 {@link ghost.framework.beans.configuration.environment.bind.annotation.BindEnvironmentProperties} 注释事件工厂接口
...
// * @param <V> 返回类型
// */
//public interface IClassBindEnvironmentPropertiesAnnotationEventFactory<
