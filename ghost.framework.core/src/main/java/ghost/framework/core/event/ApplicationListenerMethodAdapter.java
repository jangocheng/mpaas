...
import ghost.framework.context.event.GenericApplicationListener;
...
//import ghost.framework.context.PayloadApplicationEvent;
...
public class ApplicationListenerMethodAdapter implements GenericApplicationListener {
	...
	private List<ResolvableType> declaredEventTypes;
	...
	private int order;
	@Nullable
	private IApplication applicationContext;
	@Nullable
	...
	public ApplicationListenerMethodAdapter(String beanName, Class<?> targetClass, Method method) {
		...
		this.targetMethod = null;// (!Proxy.isProxyClass(targetClass) ? AopUtils.getMostSpecificMethod(method, targetClass) : this.method);
...
//			}
	 ...
	 */
	void init(IApplication applicationContext, Object evaluator) {
