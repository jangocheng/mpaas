...
// * @Description:Properties配置文件事件工厂接口
// * @Date: 17:34 2020/1/14
// */
//public interface IPropertiesEventFactory<O extends ICoreInterface, T extends Resource, P extends Properties, E extends IPropertiesEventTargetHandle<O, T, P>>
//        extends IAbstractPropertiesEventFactory<O, T, E> {
//}