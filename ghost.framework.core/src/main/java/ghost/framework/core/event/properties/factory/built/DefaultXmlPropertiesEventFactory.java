...
//@Order(3)
//public class DefaultXmlPropertiesEventFactory<O extends ICoreInterface, T extends Resource, P extends Properties, E extends IPropertiesEventTargetHandle<O, T, P>>
//        extends AbstractPropertiesEventFactory<O, T, E>
//        implements IXmlPropertiesEventFactory<O, T, P, E> {
//    /**
//     * 初始化默认xml配置文件事件工厂类
//     * @param app 应用接口
//     */
//    public DefaultXmlPropertiesEventFactory(@Application @Autowired IApplication app) {
//        super(app);
//    }
//
//    /**
