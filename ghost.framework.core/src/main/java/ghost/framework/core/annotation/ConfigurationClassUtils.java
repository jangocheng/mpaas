...
public abstract class ConfigurationClassUtils {
	...
	public static final String CONFIGURATION_CLASS_ATTRIBUTE = null;//Conventions.getQualifiedAttributeName(ConfigurationClassPostProcessor.class, "configurationClass");

	private static final String ORDER_ATTRIBUTE = null;//Conventions.getQualifiedAttributeName(ConfigurationClassPostProcessor.class, "order");
...
//		candidateIndicators.add(ImportResource.class.getName());
	...
	public static boolean checkConfigurationClassCandidate(
			IBeanDefinition beanDef, MetadataReaderFactory metadataReaderFactory) {
...
//		}
		...
		if (beanDef instanceof AnnotatedBeanDefinition &&
			...
			// Can reuse the pre-parsed metadata from the given IBeanDefinition...
	 ...
	 * @since 4.2
	 */
	public static int getOrder(IBeanDefinition beanDef) {
