...
//import ghost.framework.beans.factory.annotation.InitDestroyAnnotationBeanPostProcessor;
...
//import ghost.framework.jndi.support.SimpleJndiBeanFactory;
...
import ghost.framework.context.annotation.InitDestroyAnnotationBeanPostProcessor;
import ghost.framework.context.annotation.InjectionMetadata;
import ghost.framework.context.annotation.Lazy;
...
import ghost.framework.context.factory.EmbeddedValueResolver;
...
/**
 * {@link ghost.framework.beans.factory.config.BeanPostProcessor} implementation
 ...
 *
 * <pre class="code">
 * &lt;bean class="ghost.framework.context.annotation.CommonAnnotationBeanPostProcessor"/&gt;</pre>
 *
 * For direct JNDI access, resolving resource names as JNDI resource references
 * within the Java EE application's "java:comp/env/" namespace, use the following:
 *
 * <pre class="code">
 * &lt;bean class="ghost.framework.context.annotation.CommonAnnotationBeanPostProcessor"&gt;
 ...
 * @see ghost.framework.beans.factory.annotation.InitDestroyAnnotationBeanPostProcessor
...
public class CommonAnnotationBeanPostProcessor extends InitDestroyAnnotationBeanPostProcessor
	...
	private transient BeanFactory jndiFactory = null;//new SimpleJndiBeanFactory();
	 ...
	 * @see ghost.framework.beans.factory.config.AutowireCapableBeanFactory#resolveDependency
	 */
	 ...
	 * <p>The default is a {@link ghost.framework.jndi.support.SimpleJndiBeanFactory}
	 ...
	 * <p>Specifying Spring's {@link ghost.framework.jndi.support.SimpleJndiBeanFactory}
			...
			ReflectionUtils.doWithLocalMethods(targetClass, method -> {
				...
				if (method.equals(ClassUtils.getMostSpecificMethod(method, clazz))) {
					if (webServiceRefClass != null && bridgedMethod.isAnnotationPresent(webServiceRefClass)) {
						...
						PropertyDescriptor pd = null;//BeanUtils.findPropertyForMethod(bridgedMethod, clazz);
			...
			try {
				...
				if (StringUtils.hasLength(this.wsdlLocation)) {
					try {
						...
						service = null;//(Service) BeanUtils.instantiateClass(ctor, new URL(this.wsdlLocation), new QName(clientAnn.targetNamespace(), clientAnn.name()));
					}
...
//					}
					...
					service = null;// (Service) BeanUtils.instantiateClass(this.lookupType);
				}
			}
