...
import ghost.framework.context.converter.primitive.ConverterFloat;
...
public class DefaultConverterFloat<S extends Object, T extends Float>
        extends AbstractConverter<S, T>
        implements ConverterFloat<S, T> {
    @Constructor
    public DefaultConverterFloat(@Autowired(required = false) ICoreInterface domain) {
        super(domain);
    }

    public DefaultConverterFloat() {
        super();
    }

    @Override
    public String toString() {
        return "DefaultConverterFloat{" +
    ...
    public boolean equals(Object o) {
        ...
        DefaultConverterFloat<?, ?> that = (DefaultConverterFloat<?, ?>) o;
    ...
    private final Class<?>[] targetType = {Float.class, float.class};
