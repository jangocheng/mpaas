...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    public ConcurrentReferenceHashMap(
        ...
        Assert.isFalse(initialCapacity >= 0, "Initial capacity must not be negative");
        Assert.isFalse(loadFactor > 0f, "Load factor must be positive");
        Assert.isFalse(concurrencyLevel > 0, "Concurrency level must be positive");
