 ...
 * @Description:类型注释事件工厂注释，注释该类将自动安装入 {@see ghost.framework.context.bean.factory.IClassAnnotationBeanFactoryContainer} 容器中
 * @Date: 14:41 2020/1/31
 */
@Target({ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Component
@BeanClassNameContainer("ghost.framework.context.bean.factory.IClassAnnotationBeanFactoryContainer")
public @interface ClassAnnotationBeanFactory {
    /**
     * 该类型注释是否为单实例
     * 默认为是
     *
