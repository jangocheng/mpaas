app.controller('675d6f8a', ['$scope', '$http', '$state', '$rootScope', '$compile', '$modal',
    function($scope, $http, $state, $rootScope, $compile, locals, $modal) {
        ...
        $scope.init = function() {
            ...
            var sr = localStorage.getItem("5ad05bac-0995-4ccb-a67f-ce3b49eeb655");
        ...
        $scope.search = function(clean) {
            if(clean) {
                //清理搜索条件
                localStorage.removeItem("5ad05bac-0995-4ccb-a67f-ce3b49eeb655");
            ...
            localStorage.setItem("5ad05bac-0995-4ccb-a67f-ce3b49eeb655", JSON.stringify($scope.selectRequest));
            $scope.select();
        };
        //更新状态
