...
package ghost.framework.transaction.interceptor;


import ghost.framework.transaction.support.NoRollbackRuleAttribute;
import ghost.framework.transaction.support.RollbackRuleAttribute;
import ghost.framework.transaction.support.RuleBasedTransactionAttribute;
 ...
 * @since 24.04.2003
 * @see ghost.framework.transaction.TransactionDefinition
 * @see ghost.framework.core.Constants
 */
