 ...
 * {@link ghost.framework.transaction.TransactionStatus} interface.
 *
 * <p>Pre-implements the handling of local rollback-only and completed flags, and
 * delegation to an underlying {@link ghost.framework.transaction.SavepointManager}.
...
public abstract class AbstractTransactionStatus implements TransactionStatus {
	 ...
	 * @see ghost.framework.transaction.TransactionDefinition#PROPAGATION_NESTED
	 */
