 ...
 *
 * <p>ReactiveTransactionSynchronization implementations can implement the Ordered interface
...
public interface TransactionSynchronization extends Flushable {
	 ...
	 * Supposed to unbind resources from ReactiveTransactionSynchronizationManager if managing any.
	 ...
	 * Supposed to rebind resources to ReactiveTransactionSynchronizationManager if managing any.
	 ...
	 * @see ghost.framework.transaction.TransactionStatus#flush()
	 */
	@Override
	default void flush() {
	}
