 ...
 * ReactiveTransactionCallback implementation nor the calling code needs to explicitly
 * handle transactions.
 *
 ...
 * @see ghost.framework.transaction.PlatformTransactionManager
 */
	...
	public <T> T execute(TransactionCallback<T> action) throws TransactionException {
		...
		if (this.transactionManager instanceof CallbackPreferringPlatformTransactionManager) {
			...
			try {
				...
				rollbackOnException(status, ex);
				throw new UndeclaredThrowableException(ex, "ReactiveTransactionCallback threw undeclared checked exception");
			}
