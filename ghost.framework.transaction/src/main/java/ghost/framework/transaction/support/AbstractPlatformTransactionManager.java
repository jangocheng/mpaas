...
public abstract class AbstractPlatformTransactionManager implements PlatformTransactionManager, Serializable {
	 ...
	 * @see ghost.framework.transaction.TransactionDefinition#PROPAGATION_SUPPORTS
	 * @see ghost.framework.transaction.TransactionDefinition#PROPAGATION_NOT_SUPPORTED
	 * @see ghost.framework.transaction.TransactionDefinition#PROPAGATION_NEVER
	 */
	 ...
	 * @see ghost.framework.transaction.TransactionDefinition#PROPAGATION_REQUIRED
	 * @see ghost.framework.transaction.TransactionDefinition#PROPAGATION_MANDATORY
	 * @see ghost.framework.transaction.TransactionDefinition#PROPAGATION_REQUIRES_NEW
	 */
...
//		setTransactionSynchronization(constants.asNumber(constantName).intValue());
	 ...
	 * @see ghost.framework.transaction.TransactionDefinition#TIMEOUT_DEFAULT
	 */
	 ...
	 * @since 2.0
	 * @see ghost.framework.transaction.UnexpectedRollbackException
	 */
...
//									"(unknown)"));
	 ...
	 * @see ghost.framework.transaction.TransactionDefinition#getTimeout()
	 ...
	 * and {@code rollback}.
	 * @see ghost.framework.transaction.TransactionStatus#isRollbackOnly()
	 * @see #doCommit
	 * @see #rollback
	 */
	@Override
	 ...
	 * @throws ghost.framework.transaction.CannotCreateTransactionException
	 ...
	 * @throws ghost.framework.transaction.TransactionSuspensionNotSupportedException
	 ...
	 * @see ghost.framework.transaction.TransactionStatus#setRollbackOnly()
	 * @see ghost.framework.transaction.UnexpectedRollbackException
