...
import ghost.framework.transaction.NestedTransactionNotSupportedException;
import ghost.framework.transaction.SavepointManager;
import ghost.framework.util.Assert;

/**
 * Default implementation of the {@link ghost.framework.transaction.TransactionStatus}
 ...
 * {@link ghost.framework.transaction.TransactionStatus} interface instead.
 *
 * @author Juergen Hoeller
 * @since 19.01.2004
 * @see AbstractPlatformTransactionManager
 * @see ghost.framework.transaction.SavepointManager
 * @see #getTransaction
 * @see #createSavepoint
