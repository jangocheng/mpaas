...
angular.module('app')
  ...
  .constant('JQ_CONFIG', {
      ...
      moment:         [   'libs/jquery/moment/moment.js',
                          'libs/jquery/moment/moment-with-locales.js',
                          'libs/jquery/moment/moment-use-zhcn.js'],
