...
public class ClassWebNavMenuAnnotationBeanFactory
        <
     ...
     * 注释类型
     */
    private final Class<? extends Annotation> annotation = WebNavMenu.class;
    ...
    public void loader(E event) {
        //获取注入注释对象
        WebNavMenu navMenu = this.getAnnotation(event);
        //获取web路由容器接口
