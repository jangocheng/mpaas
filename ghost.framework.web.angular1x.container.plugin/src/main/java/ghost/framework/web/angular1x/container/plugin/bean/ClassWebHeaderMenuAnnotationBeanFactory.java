...
public class ClassWebHeaderMenuAnnotationBeanFactory
        <
     ...
     * 注释类型
     */
    private final Class<? extends Annotation> annotation = WebHeaderMenu.class;
    ...
    public void loader(E event) {
        //获取注入注释对象
        WebHeaderMenu headerMenu = this.getAnnotation(event);
        //获取web顶部菜单容器接口
