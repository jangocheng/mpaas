...
//
///**
// * package: ghost.framework.web.mvc.thymeleaf.js.plugin
// *
// * @Author: 郭树灿{gsc-e590}
// * @link: 手机:13715848993, QQ 27048384
// * @Description:thymeleaf js解析器
// * @Date: 2020/6/7:14:39
// */
//@Component
//public class TemplateJsResolver extends ThymeleafTemplateResourceResolver {
//    /**
//     * 注入模板解析容器
//     */
//    @Autowired
...
//     */
//    public TemplateJsResolver(@Autowired WebIResourceLoader<IResourceDomain> resourceLoader) {
...
//        this.setPrefix("/");
//        this.setSuffix(".js");
//        this.setTemplateMode(TemplateMode.JAVASCRIPT);
////        resolver.setOrder(2);
