 ...
 * {@link ghost.framework.scheduling.concurrent.CustomizableThreadFactory}.
 *
 * @author Juergen Hoeller
 * @since 2.0.3
 * @see ghost.framework.scheduling.concurrent.CustomizableThreadFactory
 */
...
public class CustomizableThreadCreator implements Serializable {
	...
	protected String getDefaultThreadNamePrefix() {
		return null;//ClassUtils.getShortName(getClass()) + "-";
	}
