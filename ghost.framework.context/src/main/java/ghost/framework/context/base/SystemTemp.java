...
public class SystemTemp {
	...
	/**
	 * Create a new {@link SystemTemp} instance.
	 */
	public SystemTemp() {
		this(null);
	}
	...
	/**
	 * Create a new {@link SystemTemp} instance for the specified source class.
	 * @param sourceClass the source class or {@code null}
	 */
	public SystemTemp(Class<?> sourceClass) {
	 ...
	 * @param subDir the sub-directory value
