 ...
 */
public final class GhostProperties {

	private static final String PROPERTIES_RESOURCE_LOCATION = "spring.properties";

	private static final Log logger = LogFactory.getLog(GhostProperties.class);
	...
	static {
		try {
			ClassLoader cl = GhostProperties.class.getClassLoader();
