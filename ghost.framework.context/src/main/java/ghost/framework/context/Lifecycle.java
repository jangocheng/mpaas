 ...
 * In the latter case, the {@link ghost.framework.jmx.plugin.export.MBeanExporter}
 * will typically be defined with an
 * {@link ghost.framework.jmx.plugin.export.assembler.InterfaceBasedMBeanInfoAssembler},
 ...
 * @see ghost.framework.jms.listener.AbstractMessageListenerContainer
 * @see ghost.framework.scheduling.quartz.SchedulerFactoryBean
 */
