...
package ghost.framework.context.instrument.classloading;
 ...
 * @since 2.0
 * @see #addTransformer
 * @see ghost.framework.core.OverridingClassLoader
 */
public class ShadowingClassLoader extends DecoratingClassLoader {
	...
	public static final String[] DEFAULT_EXCLUDED_PACKAGES =
			new String[] {"java.", "javax.", "jdk.", "sun.", "oracle.", "com.sun.", "com.ibm.", "COM.ibm.",
					...
					"ghost.framework.cglib", "org.apache.xerces.", "org.apache.commons.logging."};
