 ...
 * @since 3.2.7
 * @see ghost.framework.core.env.AbstractEnvironment#IGNORE_GETENV_PROPERTY_NAME
 * @see ghost.framework.beans.CachedIntrospectionResults#IGNORE_BEANINFO_PROPERTY_NAME
 * @see ghost.framework.jdbc.core.StatementCreatorUtils#IGNORE_GETPARAMETERTYPE_PROPERTY_NAME
 * @see ghost.framework.test.context.cache.ContextCache#MAX_CONTEXT_CACHE_SIZE_PROPERTY_NAME
 */
public final class GhostFrameworkProperties {

	private static final String PROPERTIES_RESOURCE_LOCATION = "ghost.framework.properties";

	private static final Log logger = LogFactory.getLog(GhostFrameworkProperties.class);
	...
	static {
		try {
			ClassLoader cl = GhostFrameworkProperties.class.getClassLoader();
	...
	private GhostFrameworkProperties() {
	}
