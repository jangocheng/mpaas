...
public class ImportDefinition implements BeanMetadataElement {
	...
	@Nullable
	private final IResource[] actualResources;
	 ...
	 * @param source the source object (may be {@code null})
	 */
	public ImportDefinition(String importedResource, @Nullable IResource[] actualResources, @Nullable Object source) {
	...
	@Nullable
	public final IResource[] getActualResources() {
