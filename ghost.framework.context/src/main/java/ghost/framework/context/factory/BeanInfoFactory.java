 ...
 * by using the {@link ghost.framework.core.io.support.SpringFactoriesLoader}
 * utility class.
 *
 ...
 *
 * <p>Note that the {@link ghost.framework.core.io.support.SpringFactoriesLoader}
 * sorts the {@code BeanInfoFactory} instances by
 * {@link ghost.framework.core.annotation.Order @Order}, so that ones with a
 * higher precedence come first.
 *
 * @author Arjen Poutsma
 * @since 3.2
 * @see CachedIntrospectionResults
 * @see ghost.framework.core.io.support.SpringFactoriesLoader
 */
