 ...
 * @see ghost.framework.beans.factory.xml.DefaultBeanDefinitionDocumentReader
 */
public abstract class BeanDefinitionReaderUtils {
	 ...
	 * @see #generateBeanName(IBeanDefinition, BeanDefinitionRegistry, boolean)
	 */
	public static String generateBeanName(IBeanDefinition beanDefinition, BeanDefinitionRegistry registry)
	...
	public static String generateBeanName(
			IBeanDefinition definition, BeanDefinitionRegistry registry, boolean isInnerBean)
			throws BeanDefinitionStoreException {

		String generatedBeanName = null;//definition.getBeanClassName();
