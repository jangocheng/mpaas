...
public interface BeanDefinitionReader {
	 ...
	 * Can be checked for the <b>IResourcePatternResolver</b> interface and cast
	 ...
	 * This is a convenience to avoid explicit IResourceLoader handling.
	 ...
	 */
	int loadBeanDefinitions(IResource resource) throws BeanDefinitionStoreException;
	 ...
	 * @throws BeanDefinitionStoreException in case of loading or parsing errors
	 */
	int loadBeanDefinitions(IResource... resources) throws BeanDefinitionStoreException;
	 ...
	 * @param locations the resource locations, to be loaded with the IResourceLoader
	 * (or IResourcePatternResolver) of this bean definition reader
	 * @return the number of bean definitions found
	 * @throws BeanDefinitionStoreException in case of loading or parsing errors
	 */
