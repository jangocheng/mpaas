 ...
 * to {@link IBeanDefinition#getPropertyValues()} for a specific bean property.
 *
 ...
 * @see IBeanDefinition#getPropertyValues()
 * @see ghost.framework.beans.factory.support.BeanDefinitionBuilder#addAutowiredProperty
 */
