...
import ghost.framework.context.GhostProperties;
...
//import ghost.framework.core.SpringProperties;
//import ghost.framework.core.convert.TypeDescriptor;
//import ghost.framework.core.io.support.GhostFactoriesLoader;
 ...
 * {@link ghost.framework.web.util.IntrospectorCleanupListener} in {@code web.xml}
 * in case of a multi-ClassLoader layout, which will allow for effective caching as well.
 *
 * <p>In case of a non-clean ClassLoader arrangement without a cleanup listener having
 * been set up, this class will fall back to a weak-reference-based caching entity that
...
public final class CachedIntrospectionResults {
	...
	private static final boolean shouldIntrospectorIgnoreBeaninfoClasses =
			GhostProperties.getFlag(IGNORE_BEANINFO_PROPERTY_NAME);

	/** Stores the BeanInfoFactory instances. */
	private static List<BeanInfoFactory> beanInfoFactories = GhostFactoriesLoader.loadFactories(
	...
	public static CachedIntrospectionResults forClass(Class<?> beanClass) throws BeanException {
	 ...
	 * @throws BeansException in case of introspection failure
	 */
	private CachedIntrospectionResults(Class<?> beanClass) throws BeanException {
		try {
...
//			}
	...
	public PropertyDescriptor buildGenericTypeAwarePropertyDescriptor(Class<?> beanClass, PropertyDescriptor pd) {
		try {
