...
import ghost.framework.context.bean.InjectionPoint;
...
public class UnsatisfiedDependencyException extends BeanCreationException {
	 ...
	 */
	public UnsatisfiedDependencyException(
			@Nullable String resourceDescription, @Nullable String beanName, String propertyName, BeanException ex) {
	 ...
	 */
	public UnsatisfiedDependencyException(
			@Nullable String resourceDescription, @Nullable String beanName, @Nullable InjectionPoint injectionPoint, BeanException ex) {
