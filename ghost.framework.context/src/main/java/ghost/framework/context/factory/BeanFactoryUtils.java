...
public abstract class BeanFactoryUtils {
	 ...
	 * @see ghost.framework.beans.factory.support.BeanDefinitionReaderUtils#generateBeanName
	 * @see ghost.framework.beans.factory.support.DefaultBeanNameGenerator
	 */
	 ...
	 * @see ListableBeanFactory#getBeansOfType(Class)
	 */
	public static <T> T beanOfType(ListableBeanFactory lbf, Class<T> type) throws BeanException {
		Assert.notNull(lbf, "ListableBeanFactory must not be null");
