 ...
 *
 * <p>{@link ghost.framework.context.ApplicationContext} implementations
 * such as a {@link ghost.framework.web.context.WebApplicationContext}
 * may register additional standard scopes specific to their environment,
 * e.g. {@link ghost.framework.web.context.WebApplicationContext#SCOPE_REQUEST "request"}
 * and {@link ghost.framework.web.context.WebApplicationContext#SCOPE_SESSION "session"},
 ...
 * @see ghost.framework.aop.scope.ScopedProxyFactoryBean
 * @see ghost.framework.web.context.request.RequestScope
 * @see ghost.framework.web.context.request.SessionScope
 */
public interface Scope {

	/**
	 * Return the object with the given name from the underlying scope,
	 * {@link ghost.framework.beans.factory.ObjectFactory#getObject() creating it}
	 ...
	 * @see ghost.framework.beans.factory.support.AbstractBeanDefinition#getDestroyMethodName()
