 ...
 * {@link ghost.framework.context.event.ContextRefreshedEvent} but doesn't
 * require an implementation of {@link ghost.framework.context.ApplicationListener},
 ...
 * not just in an {@link ghost.framework.context.ApplicationContext} environment.
 *
 * <p><b>NOTE:</b> If you intend to start/manage asynchronous tasks, preferably
 * implement {@link ghost.framework.context.Lifecycle} instead which offers
 * a richer entity for runtime management and allows for phased startup/shutdown.
 *
 * @author Juergen Hoeller
 * @since 4.1
 * @see ghost.framework.beans.factory.config.ConfigurableListableBeanFactory#preInstantiateSingletons()
 */
