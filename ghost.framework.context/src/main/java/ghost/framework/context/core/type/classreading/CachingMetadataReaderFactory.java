 ...
 * caching a {@link MetadataReader} instance per Spring {@link IResource} handle
 * (i.e. per ".class" file).
 *
...
public class CachingMetadataReaderFactory extends SimpleMetadataReaderFactory {
	...
	/** MetadataReader cache: either local or shared at the IResourceLoader level. */
	@Nullable
	private Map<IResource, MetadataReader> metadataReaderCache;
	...
	/**
	 * Create a new CachingMetadataReaderFactory for the given {@link IResourceLoader},
	 ...
	 */
	public CachingMetadataReaderFactory(@Nullable IResourceLoader IResourceLoader) {
		super(IResourceLoader);
		if (IResourceLoader instanceof IResourceLoader) {
//			this.metadataReaderCache = ((DefaultIResourceLoader) IResourceLoader).getResourceCache(MetadataReader.class);
		}
		else {
			setCacheLimit(DEFAULT_CACHE_LIMIT);
		}
	 ...
	 * even if the {@link IResourceLoader} supports a shared resource cache.
	 */
	...
	private static class LocalResourceCache extends LinkedHashMap<IResource, MetadataReader> {
		...
		@Override
		protected boolean removeEldestEntry(Map.Entry<IResource, MetadataReader> eldest) {
