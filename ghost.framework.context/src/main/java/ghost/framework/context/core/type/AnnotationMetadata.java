 ...
 * @see ghost.framework.core.type.classreading.MetadataReader#getAnnotationMetadata()
...
public interface AnnotationMetadata extends ClassMetadata, AnnotatedTypeMetadata {
	...
	default Set<String> getMetaAnnotationTypes(String annotationName) {
		...
		return MergedAnnotations.from(annotation.getType(), MergedAnnotations.SearchStrategy.INHERITED_ANNOTATIONS).stream()
