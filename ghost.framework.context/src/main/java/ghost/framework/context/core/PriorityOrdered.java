 ...
 * {@link ghost.framework.context.ApplicationContext}.
 *
 ...
 * @author Sam Brannen
 * @since 2.5
 * @see ghost.framework.beans.factory.config.PropertyOverrideConfigurer
 * @see ghost.framework.beans.factory.config.PropertyPlaceholderConfigurer
 */
