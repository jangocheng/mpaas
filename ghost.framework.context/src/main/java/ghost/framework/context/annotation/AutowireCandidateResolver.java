...
public interface AutowireCandidateResolver {
	 ...
	 * {@link ghost.framework.beans.factory.config.IBeanDefinition#isAutowireCandidate()}.
	 * @param bdHolder the bean definition including bean name and aliases
	 * @param descriptor the descriptor for the target method parameter or field
	 * @return whether the bean definition qualifies as autowire candidate
	 * @see ghost.framework.beans.factory.config.IBeanDefinition#isAutowireCandidate()
	 */
	 ...
	 * @since 5.1
	 * @see ghost.framework.beans.factory.annotation.QualifierAnnotationAutowireCandidateResolver#hasQualifier
	 */
