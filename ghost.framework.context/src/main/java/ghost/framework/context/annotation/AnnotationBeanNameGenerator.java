...
/**
 * {@link ghost.framework.beans.factory.support.BeanNameGenerator}
 * implementation for bean classes annotated with the
 * {@link ghost.framework.stereotype.Component @Component} annotation
 * or with another annotation that is itself annotated with
 * {@link ghost.framework.stereotype.Component @Component} as a
 * meta-annotation. For example, Spring's stereotype annotations (such as
 * {@link ghost.framework.stereotype.Repository @Repository}) are
 * themselves annotated with
 * {@link ghost.framework.stereotype.Component @Component}.
 *
 ...
 * @author Mark Fisher
 * @since 2.5
 * @see ghost.framework.stereotype.Component#value()
 * @see ghost.framework.stereotype.Repository#value()
 * @see ghost.framework.stereotype.Service#value()
 * @see ghost.framework.stereotype.Controller#value()
...
public class AnnotationBeanNameGenerator implements BeanNameGenerator {
	...
	private static final String COMPONENT_ANNOTATION_CLASSNAME = "ghost.framework.stereotype.Component";
	 ...
	 * <p>The default implementation delegates to {@link #buildDefaultBeanName(IBeanDefinition)}.
	 * @param definition the bean definition to build a bean name for
	 * @param registry the registry that the given bean definition is being registered with
	 * @return the default bean name (never {@code null})
	 */
	protected String buildDefaultBeanName(IBeanDefinition definition, BeanDefinitionRegistry registry) {
