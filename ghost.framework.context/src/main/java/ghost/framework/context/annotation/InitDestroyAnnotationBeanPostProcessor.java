...
import ghost.framework.context.bean.BeanCreationException;
import ghost.framework.context.bean.DestructionAwareBeanPostProcessor;
...
import ghost.framework.context.factory.MergedBeanDefinitionPostProcessor;
 ...
 * alternative to Spring's {@link ghost.framework.beans.factory.InitializingBean}
 * and {@link ghost.framework.beans.factory.DisposableBean} callback interfaces.
 *
 ...
 *
 * <p>Spring's {@link ghost.framework.context.annotation.CommonAnnotationBeanPostProcessor}
