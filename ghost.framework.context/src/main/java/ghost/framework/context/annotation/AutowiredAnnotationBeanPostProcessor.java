...
//import ghost.framework.beans.factory.config.InstantiationAwareBeanPostProcessorAdapter;
//import ghost.framework.beans.factory.support.LookupOverride;
...
/**
 * {@link ghost.framework.beans.factory.config.BeanPostProcessor BeanPostProcessor}
...
//	@Override
		...
		if (candidateConstructors == null) {
			...
			synchronized (this.candidateConstructorsCache) {
				...
				if (candidateConstructors == null) {
					...
					Constructor<?> primaryConstructor = null;//BeanUtils.findPrimaryConstructor(beanClass);
	 ...
	 * @throws BeanException if bean retrieval failed
	 */
	protected <T> Map<String, T> findAutowireCandidates(Class<T> type) throws BeanException {
