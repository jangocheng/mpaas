...
import ghost.framework.context.factory.BeanDefinitionReader;
...
//import ghost.framework.beans.factory.annotation.Autowire;
...
//import ghost.framework.beans.factory.groovy.GroovyBeanDefinitionReader;
//import ghost.framework.beans.factory.parsing.SourceExtractor;
//import ghost.framework.beans.factory.support.*;
//import ghost.framework.beans.factory.xml.XmlBeanDefinitionReader;
//import ghost.framework.context.annotation.ConfigurationCondition.ConfigurationPhase;
...
//import ghost.framework.core.type.StandardAnnotationMetadata;
//import ghost.framework.core.type.StandardMethodMetadata;
...
public class ConfigurationClassBeanDefinitionReader {
	...
	ConfigurationClassBeanDefinitionReader(BeanDefinitionRegistry registry, SourceExtractor sourceExtractor,
                                           IResourceLoader IResourceLoader, Environment environment, BeanNameGenerator importBeanNameGenerator,
		...
		this.conditionEvaluator = new ConditionEvaluator(registry, environment, IResourceLoader);
	}
...
//		beanDef.setAttribute(ghost.framework.beans.factory.annotation.RequiredAnnotationBeanPostProcessor.
...
//		IBeanDefinition beanDefToRegister = beanDef;
...
//		this.registry.registerBeanDefinition(beanName, beanDefToRegister);
	...
	protected boolean isOverriddenByExistingDefinition(BeanMethod beanMethod, String beanName) {
		...
		IBeanDefinition existingBeanDef = this.registry.getBeanDefinition(beanName);
...
//		if (existingBeanDef.getRole() > IBeanDefinition.ROLE_APPLICATION) {
//			return false;
//		}
...
//				}
			...
			if (reader == null) {
				try {
					...
					// Delegate the current IResourceLoader to it if possible
					if (reader instanceof AbstractBeanDefinitionReader) {
						AbstractBeanDefinitionReader abdr = ((AbstractBeanDefinitionReader) reader);
						abdr.setIResourceLoader(this.IResourceLoader);
