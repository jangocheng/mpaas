 ...
 * ghost.framework.stereotype.Component @Component} or on methods annotated with
 * {@link Bean @Bean}.
 *
 ...
 * retrieved from the enclosing {@link ghost.framework.beans.factory.BeanFactory
 ...
 * on injection points marked with {@link ghost.framework.beans.factory.annotation.Autowired}
 * or {@link javax.inject.Inject}: In that context, it leads to the creation of a
 * lazy-resolution proxy for all affected dependencies, as an alternative to using
 * {@link ghost.framework.beans.factory.ObjectFactory} or {@link javax.inject.Provider}.
 *
 * @author Chris Beams
 ...
 * @see Bean
 * @see Configuration
 * @see ghost.framework.stereotype.Component
 */
