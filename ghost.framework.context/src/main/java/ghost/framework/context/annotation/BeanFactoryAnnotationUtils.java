...
public abstract class BeanFactoryAnnotationUtils {
	...
	public static <T> Map<String, T> qualifiedBeansOfType(
			ListableBeanFactory beanFactory, Class<T> beanType, String qualifier) throws BeanException {
		...
		if (beanFactory != null) {
			...
			try {
				...
				if (beanFactory instanceof ConfigurableBeanFactory) {
					IBeanDefinition bd = ((ConfigurableBeanFactory) beanFactory).getMergedBeanDefinition(beanName);
