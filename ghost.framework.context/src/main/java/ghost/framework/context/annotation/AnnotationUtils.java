...
//import ghost.framework.core.annotation.AnnotationTypeMapping.MirrorSets.MirrorSet;
//import ghost.framework.core.annotation.MergedAnnotation.Adapt;
...
import ghost.framework.context.core.annotation.*;
import ghost.framework.util.ConcurrentReferenceHashMap;
import ghost.framework.util.ReflectionUtils;
import ghost.framework.util.StringUtils;
...
public abstract class AnnotationUtils {
	 ...
	 * @return the first matching annotation, or {@code null} if not found
	 * @see ghost.framework.core.BridgeMethodResolver#findBridgedMethod(Method)
	 ...
	 * @see ghost.framework.core.BridgeMethodResolver#findBridgedMethod
	 ...
	 * compatibility with {@link ghost.framework.core.type.AnnotationMetadata})
	 ...
	 * the reflection-based {@link ghost.framework.core.type.StandardAnnotationMetadata}.
	 * @param annotation the annotation to retrieve the attributes for
	 * @param classValuesAsString whether to convert Class references into Strings (for
	 * compatibility with {@link ghost.framework.core.type.AnnotationMetadata})
	 * or to preserve them as Class references
	 ...
	 * {@link ghost.framework.core.type.AnnotationMetadata}) or to preserve them as
