 ...
 * @author Mark Fisher
 * @since 2.5
 * @see ghost.framework.context.annotation.Scope
 */
@FunctionalInterface
public interface ScopeMetadataResolver {
	 ...
	 * present on {@link IBeanDefinition#getBeanClassName() the class} of the
	 * supplied {@code definition}, or to use metadata present in the
	 * {@link IBeanDefinition#attributeNames()} of the supplied {@code definition}.
	 * @param definition the target bean definition
	 * @return the relevant scope metadata; never {@code null}
	 */
	ScopeMetadata resolveScopeMetadata(IBeanDefinition definition);
