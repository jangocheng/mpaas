...
import ghost.framework.context.io.DescriptiveResource;
...
/**
 * Base class for concrete, full-fledged {@link IBeanDefinition} classes,
 * factoring out common properties of {@link GenericBeanDefinition},
 * {@link RootBeanDefinition}, and {@link ChildBeanDefinition}.
 *
 * <p>The autowire constants match the ones defined in the
 * {@link ghost.framework.beans.factory.config.AutowireCapableBeanFactory}
 * interface.
 *
 * @author Rod Johnson
...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
		implements IBeanDefinition, Cloneable {
	...
	private int role = 0;//IBeanDefinition.ROLE_APPLICATION;
	 ...
	 */
	protected AbstractBeanDefinition(IBeanDefinition original) {
...
//			setResourceDescription(original.getResourceDescription());
	 ...
	 * </ul>
	 */
	public void overrideFrom(IBeanDefinition other) {
...
//	@Override
	public boolean isSingleton() {
		return false;//SCOPE_SINGLETON.equals(this.scope) || SCOPE_DEFAULT.equals(this.scope);
	}
...
//	@Override
	public boolean isPrototype() {
		return false;//SCOPE_PROTOTYPE.equals(this.scope);
	}
...
//	@Override
	...
	/**
	 * Set the role hint for this {@code IBeanDefinition}.
	 */
//	@Override
	...
	/**
	 * Return the role hint for this {@code IBeanDefinition}.
	 */
//	@Override
	public int getRole() {
		return this.role;
...
//	@Override
	 ...
	 */
	public void setResource(@Nullable IResource resource) {
...
//	@Override
	...
	/**
	 * Set the originating (e.g. decorated) IBeanDefinition, if any.
	 */
	public void setOriginatingBeanDefinition(IBeanDefinition originatingBd) {
		this.resource = new BeanDefinitionResource(originatingBd);
	}
	/**
	 * Return the originating IBeanDefinition, or {@code null} if none.
	 * Allows for retrieving the decorated bean definition, if any.
	 * <p>Note that this method returns the immediate originator. Iterate through the
	 * originator chain to find the original IBeanDefinition as defined by the user.
	 */
//	@Override
	@Nullable
	public IBeanDefinition getOriginatingBeanDefinition() {
