 ...
 * {@link ghost.framework.beans.factory.config.CustomScopeConfigurer
 ...
 * @see ghost.framework.context.annotation.Bean
 */
...
public @interface Scope {
	 ...
	 * @see ghost.framework.web.context.WebApplicationContext#SCOPE_REQUEST
	 * @see ghost.framework.web.context.WebApplicationContext#SCOPE_SESSION
	 * @see #value
	 */
	@AliasFor("value")
