 ...
 * @since 3.0
 */
public final class ArrayToCollectionTypeDescriptorConverter implements ConditionalGenericTypeDescriptorConverter {

	private final ConverterContainer converterContainer;


	public ArrayToCollectionTypeDescriptorConverter(@Autowired ConverterContainer converterContainer) {
