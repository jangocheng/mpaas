 ...
 * @author Sam Brannen
 * @since 3.0
 * @see ObjectToObjectTypeDescriptorConverter
 */
public final class FallbackObjectToStringTypeDescriptorConverter implements ConditionalGenericTypeDescriptorConverter {
	...
	public boolean matches(TypeDescriptor sourceType, TypeDescriptor targetType) {
		...
		return (CharSequence.class.isAssignableFrom(sourceClass) ||
				...
				ObjectToObjectTypeDescriptorConverter.hasConversionMethodOrConstructor(sourceClass, String.class));
	}
