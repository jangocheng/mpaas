 ...
 * @since 3.0
 */
public final class CollectionToObjectTypeDescriptorConverter implements ConditionalGenericTypeDescriptorConverter {

	private final ConverterContainer converterContainer;

	public CollectionToObjectTypeDescriptorConverter(@Autowired ConverterContainer converterContainer) {
