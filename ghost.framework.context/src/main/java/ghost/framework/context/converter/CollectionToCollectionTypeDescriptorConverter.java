 ...
 * @since 3.0
 */
public final class CollectionToCollectionTypeDescriptorConverter implements ConditionalGenericTypeDescriptorConverter {

	private final ConverterContainer converterContainer;


	public CollectionToCollectionTypeDescriptorConverter(@Autowired ConverterContainer converterContainer) {
	...
	public boolean matches(TypeDescriptor sourceType, TypeDescriptor targetType) {
		return ConversionUtils.canConvertElements(
				sourceType.getElementTypeDescriptor(), targetType.getElementTypeDescriptor(), this.converterContainer);
	}
	...
	public Object convert(@Nullable Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
		...
		if (elementDesc == null) {
			...
			for (Object sourceElement : sourceCollection) {
				Object targetElement = this.converterContainer.convert(sourceElement,
