 ...
 * @since 3.0
 */
public final class IdToEntityTypeDescriptorConverter implements ConditionalGenericTypeDescriptorConverter {

	private final ConverterContainer converterContainer;


	public IdToEntityTypeDescriptorConverter(@Autowired ConverterContainer converterContainer) {
	...
	public boolean matches(TypeDescriptor sourceType, TypeDescriptor targetType) {
		...
		return (finder != null &&
				this.converterContainer.canConvert(sourceType, TypeDescriptor.valueOf(finder.getParameterTypes()[0])));
	}
	...
	public Object convert(@Nullable Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
		...
		Object id = this.converterContainer.convert(
