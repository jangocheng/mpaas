 ...
 * @since 3.0
 */
public final class ObjectToArrayTypeDescriptorConverter implements ConditionalGenericTypeDescriptorConverter {

	private final ConverterContainer converterContainer;


	public ObjectToArrayTypeDescriptorConverter(@Autowired ConverterContainer converterContainer) {
	...
	public Object convert(@Nullable Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
		...
		Object targetElement = this.converterContainer.convert(source, sourceType, targetElementType);
