 ...
 * @since 3.0
 */
public interface TypeDescriptorConverter extends Converter {
	/**
	 ...
	 */
	@Nullable
	<R> R convert(@Nullable Object value, @Nullable TypeDescriptor sourceType, TypeDescriptor targetType);
}