...
////import org.springframework.core.convert.converter.GenericTypeDescriptorConverter.ConvertiblePair;
...
// * @since 3.0
// */
//public class GenericConversionService implements ConverterContainer<TypeConverter<?,?>> {
//	/**
//	 * General NO-OP converter used when conversion is not required.
//	 */
//	private static final GenericTypeDescriptorConverter NO_OP_CONVERTER = new NoOpConverter("NO_OP");
//
//	/**
//	 * Used as a cache entry when no converter is available.
//	 * This converter is never returned.
//	 */
//	private static final GenericTypeDescriptorConverter NO_MATCH = new NoOpConverter("NO_MATCH");
//
//
...
//		ResolvableType[] typeInfo = getRequiredTypeInfo(converter.getClass(), TypeConverter.class);
//		if (typeInfo == null && converter instanceof DecoratingProxy) {
//			typeInfo = getRequiredTypeInfo(((DecoratingProxy) converter).getDecoratedClass(), TypeConverter.class);
//		}
//		if (typeInfo == null) {
//			throw new IllegalArgumentException("Unable to determine source type <S> and target type <T> for your " +
//					"TypeConverter [" + converter.getClass().getName() + "]; does the class parameterize those types?");
//		}
//		addConverter(new ConverterAdapter(converter, typeInfo[0], typeInfo[1]));
//	}
//
//	@Override
//	public <S, T> void addConverter(Class<S> sourceType, Class<T> targetType, TypeConverter<? super S, ? extends T> converter) {
...
//	 */
//	@SuppressWarnings("unchecked")
//	private final class ConverterAdapter implements ConditionalGenericTypeDescriptorConverter {
//
...
//
//		public ConverterAdapter(TypeConverter<?, ?> converter, ResolvableType sourceType, ResolvableType targetType) {
...
//	 */
//	@SuppressWarnings("unchecked")
//	private final class ConverterFactoryAdapter implements ConditionalGenericTypeDescriptorConverter {
//
...
//			}
//			if (matches) {
//				TypeConverter<?, ?> converter = this.converterFactory.getConverter(targetType.getType());
...
//	 */
//	private static class NoOpConverter implements GenericTypeDescriptorConverter {
//
