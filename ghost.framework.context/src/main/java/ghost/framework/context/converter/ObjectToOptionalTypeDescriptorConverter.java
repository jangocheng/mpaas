 ...
 * @since 4.1
 */
public final class ObjectToOptionalTypeDescriptorConverter implements ConditionalGenericTypeDescriptorConverter {

	private final ConverterContainer converterContainer;


	public ObjectToOptionalTypeDescriptorConverter(@Autowired ConverterContainer converterContainer) {
	...
	public boolean matches(TypeDescriptor sourceType, TypeDescriptor targetType) {
		if (targetType.getResolvableType().hasGenerics()) {
			return this.converterContainer.canConvert(sourceType, new GenericTypeDescriptor(targetType));
		}
		else {
			return true;
		}
	...
	public Object convert(@Nullable Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
		if (source == null) {
			...
			Object target = this.converterContainer.convert(source, sourceType, new GenericTypeDescriptor(targetType));
