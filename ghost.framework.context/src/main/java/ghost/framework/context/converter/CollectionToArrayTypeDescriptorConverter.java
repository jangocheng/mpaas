 ...
 * @since 3.0
 */
public final class CollectionToArrayTypeDescriptorConverter implements ConditionalGenericTypeDescriptorConverter {
	private final ConverterContainer converterContainer;
	public CollectionToArrayTypeDescriptorConverter(@Autowired ConverterContainer converterContainer) {
	...
	public boolean matches(TypeDescriptor sourceType, TypeDescriptor targetType) {
		return ConversionUtils.canConvertElements(sourceType.getElementTypeDescriptor(),
				targetType.getElementTypeDescriptor(), this.converterContainer);
	}
