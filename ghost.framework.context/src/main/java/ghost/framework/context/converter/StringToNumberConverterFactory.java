...
public final class StringToNumberConverterFactory implements ConverterFactory<String, Number> {
	...
	@Override
	public <T extends Number> TypeConverter<String, T> getConverter(Class<T> targetType) {
		return new StringToNumber<>(targetType);
	}


	private static final class StringToNumber<T extends Number> implements TypeConverter<String, T> {
