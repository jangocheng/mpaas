...
/**
 * Extension of {@link ghost.framework.beans.factory.parsing.ReaderContext},
...
public class XmlReaderContext extends ReaderContext {
	...
	public XmlReaderContext(
			IResource resource, ProblemReporter problemReporter,
	 ...
	 * @see XmlBeanDefinitionReader#setIResourceLoader
	 * @see IResourceLoader#getClassLoader()
	 */
	@Nullable
	public final IResourceLoader getResourceLoader() {
		return this.reader.getIResourceLoader();
	}
	 ...
	 * @see ghost.framework.beans.factory.support.BeanNameGenerator#generateBeanName
	 */
	public String generateBeanName(IBeanDefinition beanDefinition) {
		return null;//this.reader.getBeanNameGenerator().generateBeanName(beanDefinition, getRegistry());
	}
	 ...
	 */
	public String registerWithGeneratedName(IBeanDefinition beanDefinition) {
