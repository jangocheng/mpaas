 ...
 * need to parse and define just a <i>single</i> {@code IBeanDefinition}.
 *
 ...
 *
 * <p>The resulting {@code IBeanDefinition} will be automatically registered
 * with the {@link ghost.framework.beans.factory.support.BeanDefinitionRegistry}.
 * Your job simply is to {@link #doParse parse} the custom XML {@link Element}
 * into a single {@code IBeanDefinition}.
 *
 * @author Rob Harrop
...
public abstract class AbstractSingleBeanDefinitionParser extends AbstractBeanDefinitionParser {
	 ...
	 * @param element the element that is to be parsed into a single IBeanDefinition
	 * @param parserContext the object encapsulating the current state of the parsing process
	 * @return the IBeanDefinition resulting from the parsing of the supplied {@link Element}
...
//			builder.getRawBeanDefinition().setParentName(parentName);
		...
		IBeanDefinition containingBd = parserContext.getContainingBeanDefinition();
