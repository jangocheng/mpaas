 ...
 * {@link IBeanDefinition BeanDefinitions}. If you just want to parse some
 * XML into a single {@code IBeanDefinition}, you may wish to consider
...
public abstract class AbstractBeanDefinitionParser implements BeanDefinitionParser {
	...
	@Override
	@Nullable
	public final IBeanDefinition parse(Element element, ParserContext parserContext) {
...
//					parserContext.registerComponent(componentDefinition);
	...
	/**
	 * Resolve the ID for the supplied {@link IBeanDefinition}.
	 ...
	 * provides access to a {@link ghost.framework.beans.factory.support.BeanDefinitionRegistry}
	 ...
	 */
	protected void registerBeanDefinition(BeanDefinitionHolder definition, Object registry) {
//		BeanDefinitionReaderUtils.registerBeanDefinition(definition, registry);
	 ...
	 * into one or more {@link IBeanDefinition BeanDefinitions}.
	 * @param element the element that is to be parsed into one or more {@link IBeanDefinition BeanDefinitions}
	 * @param parserContext the object encapsulating the current state of the parsing process;
	 * provides access to a {@link ghost.framework.beans.factory.support.BeanDefinitionRegistry}
	 * @return the primary {@link IBeanDefinition} resulting from the parsing of the supplied {@link Element}
	 * @see #parse(Element, ParserContext)
	 * @see #postProcessComponentDefinition(ghost.framework.beans.factory.parsing.BeanComponentDefinition)
	 */
	@Nullable
	 ...
	 * {@link ghost.framework.beans.factory.parsing.BeanComponentDefinition}
	 ...
	 * @see ghost.framework.beans.factory.parsing.ReaderContext#fireComponentRegistered
	 */
	 ...
	 */
	protected void postProcessComponentDefinition(Object componentDefinition) {
	}
}
