...
import ghost.framework.context.parsing.AbstractBeanDefinitionReader;
import ghost.framework.context.parsing.ProblemReporter;
import ghost.framework.context.parsing.ReaderEventListener;
 ...
 * or a {@link ghost.framework.context.support.GenericApplicationContext}.
 *
 * <p>This class loads a DOM document and applies the BeanDefinitionDocumentReader to it.
 * The document reader will register each bean definition with the given bean factory,
 * talking to the latter's implementation of the
 * {@link ghost.framework.beans.factory.support.BeanDefinitionRegistry} interface.
 *
 ...
 * @see ghost.framework.beans.factory.support.DefaultListableBeanFactory
 * @see ghost.framework.context.support.GenericApplicationContext
 */
...
//	private final XmlValidationModeDetector validationModeDetector = new XmlValidationModeDetector();
	 ...
	 */
	public XmlBeanDefinitionReader(Object registry) {
		super(registry);
	}
...
//		this.validationMode = validationMode;
	...
	/**
	 * Specify which {@link ghost.framework.beans.factory.parsing.ProblemReporter} to use.
	 * <p>The default implementation is {@link ghost.framework.beans.factory.parsing.FailFastProblemReporter}
...
//		this.sourceExtractor = (sourceExtractor != null ? sourceExtractor : new NullSourceExtractor());
	 ...
	 */
	public void setNamespaceHandlerResolver(@Nullable Object namespaceHandlerResolver) {
//		this.namespaceHandlerResolver = namespaceHandlerResolver;
	 ...
	 */
	public void setDocumentLoader(@Nullable Object documentLoader) {
...
//			IResourceLoader resourceLoader = getIResourceLoader();
...
//		this.errorHandler = errorHandler;
	 ...
	 */
	public void setDocumentReaderClass(Class<? extends Object> documentReaderClass) {
//		this.documentReaderClass = documentReaderClass;
	 ...
	 */
//	@Override
	public int loadBeanDefinitions(IResource resource) throws BeanDefinitionStoreException {
	...
	public int loadBeanDefinitions(EncodedResource encodedResource) throws BeanDefinitionStoreException {
		...
		try {
			...
			try {
				...
				return 0;//doLoadBeanDefinitions(inputSource, encodedResource.getResource());
			}
			finally {
				inputStream.close();
			}
...
//		return doLoadBeanDefinitions(inputSource, new DescriptiveResource(resourceDescription));
	 ...
	 */
	protected int doLoadBeanDefinitions(InputSource inputSource, IResource resource)
			throws BeanDefinitionStoreException {
...
//				getValidationModeForResource(resource), isNamespaceAware());
	 ...
	 */
	protected int getValidationModeForResource(IResource resource) {
...
//		}
	 ...
	 */
	protected int detectValidationMode(IResource resource) {
		if (resource.isOpen()) {
			throw new BeanDefinitionStoreException(
...
//		try {
			return 0;//this.validationModeDetector.detectValidationMode(inputStream);
//		}
//		catch (IOException ex) {
...
//		}
	 ...
	 */
	public int registerBeanDefinitions(Document doc, IResource resource) throws BeanDefinitionStoreException {
...
//		return getRegistry().getBeanDefinitionCount() - countBefore;
	 ...
	 * @see #setDocumentReaderClass
	 */
	protected Object createBeanDefinitionDocumentReader() {
//		return BeanUtils.instantiateClass(this.documentReaderClass);
	 ...
	 */
	public XmlReaderContext createReaderContext(IResource resource) {
...
//		return this.namespaceHandlerResolver;
	 ...
	 */
	protected Object createDefaultNamespaceHandlerResolver() {
//		ClassLoader cl = (getIResourceLoader() != null ? getIResourceLoader().getClassLoader() : getBeanClassLoader());
