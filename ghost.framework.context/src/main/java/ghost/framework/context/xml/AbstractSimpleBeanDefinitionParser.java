 ...
 * resulting {@code IBeanDefinition} will be automatically
 ...
 * {@link #postProcess(ghost.framework.beans.factory.support.BeanDefinitionBuilder, Element)}
 ...
 * {@link ghost.framework.beans.factory.xml.UtilNamespaceHandler.PropertiesBeanDefinitionParser};
 ...
 * {@link ghost.framework.beans.factory.config.PropertiesFactoryBean#setLocation(ghost.framework.core.io.Resource)}
...
public abstract class AbstractSimpleBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {
	 ...
	 * supplied element to {@link ghost.framework.beans.PropertyValue}
	 * instances, and
	 * {@link BeanDefinitionBuilder#addPropertyValue(String, Object) adds them}
	 * to the
	 * {@link ghost.framework.beans.factory.config.IBeanDefinition builder}.
	 ...
	 * @param builder used to define the {@code IBeanDefinition}
