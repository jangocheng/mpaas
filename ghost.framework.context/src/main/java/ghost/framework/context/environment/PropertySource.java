 ...
 * ghost.framework.context.annotation.Configuration Configuration} classes that
 * the @{@link ghost.framework.context.annotation.PropertySource PropertySource}
 ...
 * @see ghost.framework.context.annotation.PropertySource
 */
public abstract class PropertySource<T> {
	 ...
	 * from {@lin
	public T getSouk #getProperty(String)}. Subclasses may wish to implement
	 ...
	 * @see ghost.framework.context.support.AbstractApplicationContext#initPropertySources()
	 * @see ghost.framework.web.context.support.StandardServletEnvironment
	 * @see ghost.framework.web.context.support.ServletContextPropertySource
	 */
