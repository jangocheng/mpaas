 ...
 * @see Number
 * @see NumberFormat
 * @see ghost.framework.validation.DataBinder#registerCustomEditor
 */
public class CustomNumberEditor extends PropertyEditorSupport {
	 ...
	 * @see ghost.framework.util.NumberUtils#parseNumber(String, Class)
	 * @see Integer#valueOf
	 ...
	 * @param allowEmpty if empty strings should be allowed
	 * @throws IllegalArgumentException if an invalid numberClass has been specified
	 * @see ghost.framework.util.NumberUtils#parseNumber(String, Class, NumberFormat)
