 ...
 * {@link ghost.framework.beans.factory.config.IBeanDefinition BeanDefinitions}
 * using the builder pattern. Intended primarily for use when implementing Spring 2.0
 * {@link ghost.framework.beans.factory.xml.NamespaceHandler NamespaceHandlers}.
 *
 * @author Rod Johnson
 * @author Rob Harrop
...
//		builder.beanDefinition.setFactoryMethodName(factoryMethodName);
	...
	public static BeanDefinitionBuilder childBeanDefinition(String parentName) {
		return null;//new BeanDefinitionBuilder(new ChildBeanDefinition(parentName));
	}


	/**
	 * The {@code IBeanDefinition} instance we are creating.
	 */
	...
	/**
	 * Return the current IBeanDefinition object in its raw (unvalidated) form.
	...
	/**
	 * Validate and return the created IBeanDefinition object.
	 */
...
//		this.beanDefinition.getPropertyValues().add(name, AutowiredPropertyMarker.INSTANCE);
	 ...
	 * @see ghost.framework.beans.factory.config.IBeanDefinition#SCOPE_SINGLETON
	 * @see ghost.framework.beans.factory.config.IBeanDefinition#SCOPE_PROTOTYPE
	 */
	 ...
	 * @since 5.0
	 */
	public BeanDefinitionBuilder applyCustomizers(Object... customizers) {
