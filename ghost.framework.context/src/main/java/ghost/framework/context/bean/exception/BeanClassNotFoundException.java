 ...
 */
public class BeanClassNotFoundException extends BeanClassException {
    private static final long serialVersionUID = -3947074932598534129L;
     ...
     * @since 1.7
     */
    protected BeanClassNotFoundException(String message, Throwable cause,
