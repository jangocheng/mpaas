...
public class DependencyDescriptor extends InjectionPoint implements Serializable {
	 ...
	 * @throws BeanException in case of the not-unique scenario being fatal
	 * @since 5.1
	 */
	@Nullable
	public Object resolveNotUnique(ResolvableType type, Map<String, Object> matchingBeans) throws BeanException {
	...
	@Deprecated
	@Nullable
	public Object resolveNotUnique(Class<?> type, Map<String, Object> matchingBeans) throws BeanException {
		throw new NoUniqueBeanDefinitionException(type, matchingBeans.keySet());
	}
	 ...
	 * @throws BeanException if the shortcut could not be obtained
	 * @since 4.3.1
	 */
	@Nullable
	public Object resolveShortcut(ICoreInterface beanFactory) throws BeanException {
		return null;
	}
	 ...
	 * <p>The default implementation calls {@link ICoreInterface#getBean(String)}.
	 ...
	 * @since 4.3.2
	 * @see ICoreInterface#getBean(String)
	 */
	public Object resolveCandidate(String beanName, Class<?> requiredType, ICoreInterface beanFactory)
	 ...
	 * to suggest to an {@link ghost.framework.beans.factory.support.AutowireCandidateResolver}
