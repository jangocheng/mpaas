...
//import ghost.framework.beans.factory.BeanCurrentlyInCreationException;
 ...
 * {@link ghost.framework.beans.factory.FactoryBean} instances,
...
//			object = new NullBean();
	 ...
	 * @throws ghost.framework.beans.BeansException if any post-processing failed
	 */
	protected Object postProcessObjectFromFactoryBean(Object object, String beanName) throws BeanException {
		return object;
	}
