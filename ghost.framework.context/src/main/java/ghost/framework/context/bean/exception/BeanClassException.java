 ...
 * @Description:绑定类型错误
 * @Date: 12:04 2020/1/10
 */
public class BeanClassException extends BeanException {
    private static final long serialVersionUID = 5644409526472019890L;
    /** Constructs a new runtime exception with {@code null} as its
     * detail message.  The cause is not initialized, and may subsequently be
     * initialized by a call to {@link #initCause}.
     */
    public BeanClassException() {
        super();
    }
     ...
     * @since 1.7
     */
    protected BeanClassException(String message, Throwable cause,
