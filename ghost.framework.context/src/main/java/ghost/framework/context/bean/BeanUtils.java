...
import ghost.framework.beans.FatalBeanException;
import ghost.framework.beans.annotation.constraints.Nullable;
import ghost.framework.context.base.ICoreInterface;
import ghost.framework.context.core.MethodParameter;
import ghost.framework.context.factory.CachedIntrospectionResults;
import ghost.framework.context.factory.GenericTypeAwarePropertyDescriptor;
...
//	}
	 ...
	 * @throws BeanException if PropertyDescriptor look fails
	 */
	 ...
	 * @throws BeanException if PropertyDescriptor lookup fails
	 */
	@Nullable
	 ...
	 */
	@Nullable
	public static PropertyDescriptor findPropertyForMethod(Method method) throws BeanException {
	 ...
	 */
	@Nullable
	public static PropertyDescriptor findPropertyForMethod(Method method, Class<?> clazz) throws BeanException {
	 ...
	 */
	@Nullable
	public static PropertyEditor findEditorByConvention(ICoreInterface coreInterface,  @Nullable Class<?> targetType) {
		...
		try {
			...
			return (PropertyEditor) coreInterface.newInstance(editorClass);
		}
	 ...
	 * @see ghost.framework.beans.factory.support.RootBeanDefinition#DEPENDENCY_CHECK_SIMPLE
	 * @see ghost.framework.beans.factory.support.AbstractAutowireCapableBeanFactory#checkDependencies
	 ...
	 * @throws BeanException if the copying failed
	 * @see BeanWrapper
	 */
	public static void copyProperties(Object source, Object target) throws BeanException {
	 ...
	 * @see BeanWrapper
	 */
	public static void copyProperties(Object source, Object target, Class<?> editable) throws BeanException {
	...
	private static void copyProperties(Object source, Object target, @Nullable Class<?> editable,
			@Nullable String... ignoreProperties) throws BeanException {
