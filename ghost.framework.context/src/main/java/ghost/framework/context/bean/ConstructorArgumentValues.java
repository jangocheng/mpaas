 ...
 * @since 09.11.2003
 * @see IBeanDefinition#getConstructorArgumentValues
 */
public class ConstructorArgumentValues {
	 ...
	 * if demanded: see {@link ghost.framework.beans.Mergeable}.
	 ...
	 * with the current value if demanded: see {@link ghost.framework.beans.Mergeable}.
	 * @param newValue the argument value in the form of a ValueHolder
	 */
