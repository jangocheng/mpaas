...
import ghost.framework.context.io.IInputStreamSource;
 ...
 * @see Charset
 */
public class EncodedResource implements IInputStreamSource {
	 ...
	 */
	public EncodedResource(IResource resource, @Nullable String encoding) {
	 ...
	 */
	public EncodedResource(IResource resource, @Nullable Charset charset) {
		this(resource, null, charset);
	}

	private EncodedResource(IResource resource, @Nullable String encoding, @Nullable Charset charset) {
		super();
