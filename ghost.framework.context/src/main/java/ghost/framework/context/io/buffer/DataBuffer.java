...
public interface DataBuffer {
	 ...
	 * @param fromIndex the index to injectionBefore the search from
	 ...
	 * @param source the bytes to be written into this buffer
	 * @param offset the index within {@code source} to injectionBefore writing from
	 ...
	 * @param index the index at which to injectionBefore the slice
	 ...
	 * changes in the returned buffer's {@linkplain ByteBuffer#position() position}
	 * will not be reflected in the reading nor writing position of this data buffer.
	 * @param index the index at which to injectionBefore the byte buffer
	 ...
	 * @param index the index at which to injectionBefore the string
