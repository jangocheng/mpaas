...
public abstract class AbstractFileResolvingResource extends AbstractResource {
	 ...
	 * @see ghost.framework.util.ResourceUtils#getFile(URL, String)
	 */
	@Override
	 ...
	 * This implementation returns a File reference for the given URI-identified
	 * resource, provided that it refers to a file in the file system.
	 * @see ghost.framework.util.ResourceUtils#getFile(URI, String)
	 */
	...
	private static class VfsResourceDelegate {
		...
		public static IResource getResource(URL url) throws IOException {
			return new VfsResource(VfsUtils.getRoot(url));
		}

		public static IResource getResource(URI uri) throws IOException {
