...
import ghost.framework.util.DefaultPropertiesPersister;
import ghost.framework.util.PropertiesPersister;
...
public abstract class PropertiesLoaderSupport {
	 ...
	 */
	public void setLocation(IResource location) {
		this.locations = new IResource[] {location};
	}
	 ...
	 */
	public void setLocations(IResource... locations) {
	 ...
	 * @see ghost.framework.util.PropertiesPersister#load
	 */
	 ...
	 * @see ghost.framework.util.DefaultPropertiesPersister
	 */
	...
	protected void loadProperties(Properties props) throws IOException {
		if (this.locations != null) {
			for (IResource location : this.locations) {
