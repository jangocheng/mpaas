 ...
 * {@link IResourceLoader} (typically the ApplicationContext) that it runs in.
 ...
 *
 * <p>You typically need a {@link IResourceLoader} when your application object has to
 ...
 * for an example.
 *
 * <p>A passed-in {@code IResourceLoader} can also be checked for the
 ...
 * (since the context interface extends the IResourcePatternResolver interface). Use a
 ...
 *
 * <p>As an alternative to a {@code IResourcePatternResolver} dependency, consider
...
public interface ResourceLoaderAware {
	...
	/**
	 * Set the IResourceLoader that this object runs in.
	 * <p>This might be a IResourcePatternResolver, which can be checked
	 * through {@code instanceof IResourcePatternResolver}. See also the
	 * {@code ResourcePatternUtils.getResourcePatternResolver} method.
	 * <p>Invoked after population of normal bean properties but before an init callback
	 * like InitializingBean's {@code afterPropertiesSet} or a custom init-method.
	 * Invoked before ApplicationContextAware's {@code setApplicationContext}.
	 * @param IResourceLoader the IResourceLoader object to be used by this object
	 * @see org.springframework.core.io.support.ResourcePatternResolver
