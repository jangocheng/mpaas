...
package ghost.framework.context.proxy.aop.config;
...
public abstract class AopNamespaceUtils {
	...
	public static void registerAutoProxyCreatorIfNecessary(
		...
		IBeanDefinition beanDefinition = AopConfigUtils.registerAutoProxyCreatorIfNecessary(
	...
	public static void registerAspectJAutoProxyCreatorIfNecessary(
		...
		IBeanDefinition beanDefinition = AopConfigUtils.registerAspectJAutoProxyCreatorIfNecessary(
				parserContext.getRegistry(), parserContext.extractSource(sourceElement));
		useClassProxyingIfNecessary(parserContext.getRegistry(), sourceElement);
		registerComponentIfNecessary(beanDefinition, parserContext);
	}
	...
	public static void registerAspectJAnnotationAutoProxyCreatorIfNecessary(
		...
		IBeanDefinition beanDefinition = AopConfigUtils.registerAspectJAnnotationAutoProxyCreatorIfNecessary(
				parserContext.getRegistry(), parserContext.extractSource(sourceElement));
		useClassProxyingIfNecessary(parserContext.getRegistry(), sourceElement);
		registerComponentIfNecessary(beanDefinition, parserContext);
	}
	...
	private static void registerComponentIfNecessary(@Nullable IBeanDefinition beanDefinition, ParserContext parserContext) {
