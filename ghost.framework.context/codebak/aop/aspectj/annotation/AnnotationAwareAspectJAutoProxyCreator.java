...
import ghost.framework.context.proxy.aop.autoproxy.AspectJAwareAdvisorAutoProxyCreator;
import ghost.framework.util.Assert;
 ...
 * advice applied if Spring AOP's proxy-based entity is capable of applying it.
 ...
 * @since 2.0
 * @see ghost.framework.aop.aspectj.annotation.AspectJAdvisorFactory
 */
