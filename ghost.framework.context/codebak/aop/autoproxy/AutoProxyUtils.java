...
import ghost.framework.context.core.Conventions;
...
public abstract class AutoProxyUtils {
	...
	public static boolean shouldProxyTargetClass(
		...
		if (beanName != null && beanFactory.containsBeanDefinition(beanName)) {
			IBeanDefinition bd = beanFactory.getBeanDefinition(beanName);
	 ...
	 * @since 4.2.3
	 * @see ghost.framework.beans.factory.BeanFactory#getType(String)
	 */
	@Nullable
	public static Class<?> determineTargetClass(
		...
		if (beanFactory.containsBeanDefinition(beanName)) {
			IBeanDefinition bd = beanFactory.getMergedBeanDefinition(beanName);
