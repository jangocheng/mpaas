...
public class InfrastructureAdvisorAutoProxyCreator extends AbstractAdvisorAutoProxyCreator {
	...
	protected boolean isEligibleAdvisorBean(String beanName) {
		return (this.beanFactory != null && this.beanFactory.containsBeanDefinition(beanName))/* &&this.beanFactory.getBeanDefinition(beanName).getRole() == IBeanDefinition.ROLE_INFRASTRUCTURE)*/;
	}
