...
import ghost.framework.context.bean.FactoryBeanNotInitializedException;
...
import ghost.framework.context.proxy.aop.adapter.UnknownAdviceTypeException;
...
//import ghost.framework.aop.framework.adapter.UnknownAdviceTypeException;
...
/**
 * {@link ghost.framework.beans.factory.FactoryBean} implementation that builds an
 * AOP proxy based on beans in Spring {@link ghost.framework.beans.factory.BeanFactory}.
 *
 * <p>{@link org.aopalliance.intercept.MethodInterceptor MethodInterceptors} and
 * {@link ghost.framework.aop.Advisor Advisors} are identified by a list of bean
 ...
 * {@link ghost.framework.aop.TargetSource}; however, it is normally preferable
 ...
 * the {@link ghost.framework.core.Ordered} interface.
 *
...
public class ProxyFactoryBean extends ProxyCreatorSupport
	 ...
	 * @see ghost.framework.aop.target.SingletonTargetSource
	 */
	 ...
	 * @see #setTargetSource(ghost.framework.aop.TargetSource)
	 */
...
//	@Override
	 ...
	 */
	private synchronized void initializeAdvisorChain() throws AopConfigException, BeanException {
