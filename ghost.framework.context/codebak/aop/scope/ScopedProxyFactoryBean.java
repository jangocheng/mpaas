...
import ghost.framework.context.proxy.aop.ProxyConfig;
import ghost.framework.context.proxy.aop.ProxyFactory;
import ghost.framework.context.proxy.aop.autoproxy.target.SimpleBeanTargetSource;
import ghost.framework.util.Assert;
import ghost.framework.util.ClassUtils;
