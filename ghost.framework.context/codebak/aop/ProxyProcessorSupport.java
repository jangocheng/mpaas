...
//
//import ghost.framework.beans.factory.Aware;
 ...
 * @see ghost.framework.aop.framework.autoproxy.AbstractAutoProxyCreator
 */
...
public class ProxyProcessorSupport extends ProxyConfig implements Ordered, BeanClassLoaderAware, AopInfrastructureBean {
	 ...
	 * {@link ghost.framework.beans.factory.BeanFactory} for loading all bean classes.
	...
	protected boolean isConfigurationCallbackInterface(Class<?> ifc) {
		return (AutoCloseable.class == ifc || Closeable.class == ifc ||
