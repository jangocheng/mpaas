...
package ghost.framework.jmx.export.assembler;
...
public abstract class AbstractReflectiveMBeanInfoAssembler extends AbstractMBeanInfoAssembler {
	 ...
	 * @see ghost.framework.jmx.export.metadata.AbstractJmxAttribute#setCurrencyTimeLimit
	...
	protected ModelMBeanAttributeInfo[] getAttributeInfo(Object managedBean, String beanKey) throws JMException {
		PropertyDescriptor[] props = null;//BeanUtils.getPropertyDescriptors(getClassToExpose(managedBean));
	...
	protected ModelMBeanOperationInfo[] getOperationInfo(Object managedBean, String beanKey) {
		...
		for (Method method : methods) {
			...
			PropertyDescriptor pd = null;//BeanUtils.findPropertyForMethod(method);
	 ...
	 * @see ghost.framework.aop.framework.AopProxyUtils#proxiedUserInterfaces(Object)
	 */
