...
package ghost.framework.jmx.support;

import ghost.framework.beans.annotation.constraints.Nullable;
import ghost.framework.jmx.MBeanServerNotFoundException;
...
public abstract class JmxUtils {
	 ...
	 * {@link ghost.framework.jmx.export.naming.ObjectNamingStrategy}.
	 ...
	 * @see ghost.framework.util.ObjectUtils#getIdentityHexString(Object)
	 */
	 ...
	 * @see ghost.framework.util.ClassUtils#getUserClass(Object)
	 */
	 ...
	 * @return the bean class to expose
	 * @see ghost.framework.util.ClassUtils#getUserClass(Class)
	 */
	 ...
	 * @see ghost.framework.jmx.export.MBeanExporter#isMBean(Class)
	 */
