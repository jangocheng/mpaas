...
import ghost.framework.context.proxy.aop.autoproxy.target.AbstractLazyCreationTargetSource;
 ...
 * @see ghost.framework.jmx.access.MBeanClientInterceptor#setServer
 * @see ghost.framework.jmx.access.NotificationListenerRegistrar#setServer
 */
