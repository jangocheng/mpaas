...
//import ghost.framework.beans.SimpleTypeConverter;
//import ghost.framework.beans.TypeDescriptorConverter;
//import ghost.framework.beans.TypeMismatchException;
...
/**
 * {@link ghost.framework.beans.factory.FactoryBean} that looks up a
 ...
 * {@link ghost.framework.jdbc.datasource.DriverManagerDataSource} definition!
 *
...
//	@Override
	public void setBeanFactory(BeanFactory beanFactory) {
		if (beanFactory instanceof ConfigurableBeanFactory) {
			// Just optional - for getting a specifically configured TypeDescriptorConverter if needed.
