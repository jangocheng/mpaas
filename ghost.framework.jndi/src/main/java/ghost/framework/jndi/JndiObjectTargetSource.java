...
/**
 * AOP {@link ghost.framework.aop.TargetSource} that provides
 ...
 *
 * <pre class="code">
 * &lt;bean id="queueConnectionFactoryTarget" class="ghost.framework.jndi.JndiObjectTargetSource"&gt;
 *   &lt;property name="jndiName" value="JmsQueueConnectionFactory"/&gt;
 *   &lt;property name="lookupOnStartup" value="false"/&gt;
 * &lt;/bean&gt;
 *
 * &lt;bean id="queueConnectionFactory" class="ghost.framework.aop.framework.ProxyFactoryBean"&gt;
 ...
 * @see #setCache
 * @see ghost.framework.aop.framework.ProxyFactoryBean#setTargetSource
