...
import ghost.framework.data.dao.NonTransientDataAccessException;
import ghost.framework.util.Assert;
import ghost.framework.util.NestedExceptionUtils;
import ghost.framework.web.session.core.*;
import ghost.framework.web.session.core.events.SessionCreatedEvent;
import ghost.framework.web.session.core.events.SessionDeletedEvent;
import ghost.framework.web.session.core.events.SessionExpiredEvent;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
//import ghost.framework.context.ApplicationEvent;
//import ghost.framework.context.ApplicationEventPublisher;
//import ghost.framework.core.NestedExceptionUtils;
//import ghost.framework.dao.NonTransientDataAccessException;
...
//import ghost.framework.session.events.SessionDestroyedEvent;
//import ghost.framework.session.events.SessionExpiredEvent;
...
/**
 * <p>
 * A {@link ghost.framework.session.SessionRepository} that is implemented using
 * Spring Data's {@link ghost.framework.data.redis.core.RedisOperations}. In a web
...
public class RedisIndexedSessionRepository
	...
	/**
	 * Sets the redis flush mode. Default flush mode is {@link FlushMode#NotTimely}.
