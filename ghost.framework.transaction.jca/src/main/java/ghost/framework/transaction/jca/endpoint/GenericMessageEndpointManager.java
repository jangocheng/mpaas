...
package ghost.framework.transaction.jca.endpoint;
 ...
 *
 * <pre class="code">
 * &lt;bean class="ghost.framework.jca.endpoint.GenericMessageEndpointManager"&gt;
 * 	 &lt;property name="resourceAdapter" ref="resourceAdapter"/&gt;
 * 	 &lt;property name="messageEndpointFactory"&gt;
 *     &lt;bean class="ghost.framework.jca.endpoint.GenericMessageEndpointFactory"&gt;
 ...
 *
 * <pre class="code">
 * &lt;bean id="resourceAdapter" class="ghost.framework.jca.support.ResourceAdapterFactoryBean"&gt;
 ...
 *     &lt;bean class="ghost.framework.jca.work.SimpleTaskWorkManager"/&gt;
 *   &lt;/property&gt;
 * &lt;/bean&gt;</pre>
 *
 ...
 * Check out {@link ghost.framework.transaction.jca.work.SimpleTaskWorkManager}'s
 ...
 * typically with a Spring {@link ghost.framework.transaction.jta.JtaTransactionManager}
 ...
 * &lt;/bean&gt;
 *
 * &lt;bean id="transactionManager" class="ghost.framework.transaction.jta.JtaTransactionManager"/&gt;</pre>
 *
 ...
 */
public class GenericMessageEndpointManager implements SmartLifecycle, AutoCloseable {
