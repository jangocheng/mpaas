...
import ghost.framework.context.factory.BeanNameAware;
import ghost.framework.transaction.support.SimpleTransactionFactory;
...
public abstract class AbstractMessageEndpointFactory implements MessageEndpointFactory, BeanNameAware {
	 ...
	 * Spring's {@link ghost.framework.transaction.jta.TransactionFactory}
	...
	public void setTransactionManager(Object transactionManager) {
		if (transactionManager instanceof TransactionFactory) {
			...
			throw new IllegalArgumentException("Transaction manager [" + transactionManager +
					"] is neither a [ghost.framework.transaction.jta.TransactionFactory} nor a " +
