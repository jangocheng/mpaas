...
package ghost.framework.transaction.jca.cci.core;
...
import ghost.framework.transaction.jca.cci.CannotCreateRecordException;
import ghost.framework.transaction.jca.cci.CciOperationNotSupportedException;
import ghost.framework.transaction.jca.cci.InvalidResultSetAccessException;
import ghost.framework.transaction.jca.cci.RecordTypeNotSupportedException;
import ghost.framework.transaction.jca.cci.connection.ConnectionFactoryUtils;
import ghost.framework.transaction.jca.cci.connection.NotSupportedRecordFactory;
 ...
 * hierarchy defined in the {@code ghost.framework.dao} package.
 *
...
public class CciTemplate implements CciOperations {
	 ...
	 * @see ghost.framework.transaction.jca.cci.connection.NotSupportedRecordFactory
	 */
