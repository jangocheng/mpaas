 ...
 * @since 1.2.4
 * @see ghost.framework.transaction.jca.cci.core.RecordCreator#createRecord(javax.resource.cci.RecordFactory)
 * @see ghost.framework.transaction.jca.cci.core.CciTemplate#getRecordFactory(javax.resource.cci.ConnectionFactory)
