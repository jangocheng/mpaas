...
import ghost.framework.scheduling.SchedulingException;
...
import ghost.framework.thread.task.TaskTimeoutException;
import ghost.framework.transaction.jca.context.BootstrapContextAware;
...
/**
 * {@link ghost.framework.thread.task.TaskExecutor} implementation
...
public class WorkManagerTaskExecutor extends JndiLocatorSupport
		implements AsyncListenableTaskExecutor, SchedulingTaskExecutor, WorkManager, BootstrapContextAware {
	@Nullable
