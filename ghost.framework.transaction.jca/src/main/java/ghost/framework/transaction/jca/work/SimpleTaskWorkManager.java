...
package ghost.framework.transaction.jca.work;

import ghost.framework.beans.annotation.constraints.Nullable;
import ghost.framework.thread.task.*;
 ...
 * delegates to a Spring {@link ghost.framework.thread.task.TaskExecutor}.
 ...
 *
 * <p>Uses a {@link ghost.framework.thread.task.SyncTaskExecutor} for {@link #doWork}
 * calls and a {@link ghost.framework.thread.task.SimpleAsyncTaskExecutor}
 ...
 * Specify a {@link ghost.framework.scheduling.concurrent.ThreadPoolTaskExecutor}
 ...
 * {@link ghost.framework.thread.task.AsyncTaskExecutor} implementation
...
public class SimpleTaskWorkManager implements WorkManager {
	 ...
	 * <p>Default is a {@link ghost.framework.thread.task.SyncTaskExecutor}.
	 */
	 ...
	 * {@link ghost.framework.thread.task.AsyncTaskExecutor} implementation.
	 * Default is a {@link ghost.framework.thread.task.SimpleAsyncTaskExecutor}.
	 */
