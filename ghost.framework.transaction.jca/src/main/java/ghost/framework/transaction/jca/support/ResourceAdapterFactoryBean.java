...
package ghost.framework.transaction.jca.support;
...
/**
 * {@link ghost.framework.beans.factory.FactoryBean} that bootstraps
 ...
 */
public class ResourceAdapterFactoryBean extends BeanDefinition implements AutoCloseable {
	@Autowired
	...
	public ResourceAdapterFactoryBean(String name, Object object) throws IllegalArgumentException {
		super(name, object);
	}

	public ResourceAdapterFactoryBean(Object object) {
		super(object);
	}
	...
	public void setResourceAdapterClass(Class<? extends ResourceAdapter> resourceAdapterClass) {
		this.resourceAdapter = (ResourceAdapter)this.coreInterface.newInstance(resourceAdapterClass);//BeanUtils.instantiateClass(resourceAdapterClass);
	}
