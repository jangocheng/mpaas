...
package ghost.framework.transaction.jca.cci.core.support;

import ghost.framework.beans.annotation.constraints.Nullable;
import ghost.framework.data.dao.support.DaoSupport;
import ghost.framework.transaction.jca.cci.CannotGetCciConnectionException;
import ghost.framework.transaction.jca.cci.connection.ConnectionFactoryUtils;
 ...
 * providing a {@link ghost.framework.transaction.jca.cci.core.CciTemplate} based
 ...
 * {@code ghost.framework.jca.cci.object} classes.
 *
 ...
 * @see #getCciTemplate
 * @see ghost.framework.transaction.jca.cci.core.CciTemplate
 */
public abstract class CciDaoSupport extends DaoSupport {
	 ...
	 * @see ghost.framework.transaction.jca.cci.core.CciTemplate#getDerivedTemplate(javax.resource.cci.ConnectionSpec)
	 */
	 ...
	 * @throws ghost.framework.transaction.jca.cci.CannotGetCciConnectionException
	 * if the attempt to get a Connection failed
	 * @see ghost.framework.transaction.jca.cci.connection.ConnectionFactoryUtils#getConnection(javax.resource.cci.ConnectionFactory)
	 */
	 ...
	 * @see ghost.framework.transaction.jca.cci.connection.ConnectionFactoryUtils#releaseConnection
	 */
