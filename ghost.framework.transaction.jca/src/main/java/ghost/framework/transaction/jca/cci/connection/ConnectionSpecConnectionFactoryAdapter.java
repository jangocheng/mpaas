 ...
 *
 * <pre class="code">
 * &lt;bean id="myTargetConnectionFactory" class="ghost.framework.jndi.JndiObjectFactoryBean"&gt;
 *   &lt;property name="jndiName" value="java:comp/env/cci/mycf"/&gt;
 * &lt;/bean>
 *
 * &lt;bean id="myConnectionFactory" class="ghost.framework.jca.cci.connection.ConnectionSpecConnectionFactoryAdapter"&gt;
