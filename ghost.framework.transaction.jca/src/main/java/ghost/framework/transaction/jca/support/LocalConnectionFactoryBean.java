...
/**
 * {@link ghost.framework.beans.factory.FactoryBean} that creates
 ...
 * to a {@link ghost.framework.jndi.JndiObjectFactoryBean} definition that
 ...
 * (e.g. {@link ghost.framework.jca.cci.connection.CciLocalTransactionManager})
 ...
 * @see ghost.framework.jca.cci.connection.CciLocalTransactionManager
 */
public class LocalConnectionFactoryBean implements FactoryBean<Object> {
