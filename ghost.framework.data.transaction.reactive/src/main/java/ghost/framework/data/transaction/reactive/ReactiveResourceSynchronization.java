 ...
 * resource object bound through {@link ReactiveTransactionSynchronizationManager}.
 *
 * @author Mark Paluch
 ...
 */
public abstract class ReactiveResourceSynchronization<O, K> implements ReactiveTransactionSynchronization {
	...
	public ReactiveResourceSynchronization(
			O resourceObject, K resourceKey, ReactiveTransactionSynchronizationManager synchronizationManager) {
