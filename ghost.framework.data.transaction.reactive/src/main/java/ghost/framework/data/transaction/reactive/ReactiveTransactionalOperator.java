...
import ghost.framework.data.transaction.reactive.support.ReactiveTransactionalOperatorImpl;
 ...
 */
public interface ReactiveTransactionalOperator {
	 ...
	 * @throws RuntimeException if thrown by the ReactiveTransactionCallback
	 */
	...
	/**
	 * Create a new {@link ReactiveTransactionalOperator} using {@link ReactiveTransactionManager},
	 * using a default transaction.
	 * @param transactionManager the transaction management strategy to be used
	 * @return the transactional operator
	 */
	static ReactiveTransactionalOperator create(ReactiveTransactionManager transactionManager){
	 ...
	 * @return the transactional operator
	 */
	static ReactiveTransactionalOperator create(
            ReactiveTransactionManager transactionManager, TransactionDefinition transactionDefinition){
		return new ReactiveTransactionalOperatorImpl(transactionManager, transactionDefinition);
	}
}