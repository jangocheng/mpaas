 ...
 */
public class ReactiveTransactionAspectSupport /*implements BeanFactoryAware */{
    ...
    private static final boolean vavrPresent = ClassUtils.isPresent(
            "io.vavr.control.Try", ReactiveTransactionAspectSupport.class.getClassLoader());
    /**
     * Reactive Streams API present on the classpath?
     */
    private static final boolean reactiveStreamsPresent =
            ClassUtils.isPresent("org.reactivestreams.Publisher", ReactiveTransactionAspectSupport.class.getClassLoader());
    ...
    protected ReactiveTransactionAspectSupport() {
...
//							". Use ReactiveTransactionalOperator.transactional extensions instead.");
//				}
