...
import ghost.framework.data.transaction.reactive.support.ReactiveTransactionContextHolder;
 ...
 * held by an outer {@link ReactiveTransactionContextHolder} or referenced directly within
 * from the subscriber context.
 *
 * @author Mark Paluch
 * @author Juergen Hoeller
 * @since 5.2
 * @see ReactiveTransactionContextManager
 * @see reactor.util.context.Context
 */
public class ReactiveTransactionContext {

	private final @Nullable
	ReactiveTransactionContext parent;
	...
	public ReactiveTransactionContext() {
		this(null);
	}

	public ReactiveTransactionContext(@Nullable ReactiveTransactionContext parent) {
		this.parent = parent;
	}


	@Nullable
	public ReactiveTransactionContext getParent() {
		return this.parent;
	}
