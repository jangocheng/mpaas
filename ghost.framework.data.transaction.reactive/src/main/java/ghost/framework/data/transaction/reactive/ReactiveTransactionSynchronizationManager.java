...
public class ReactiveTransactionSynchronizationManager {
	...
	public ReactiveTransactionSynchronizationManager(ReactiveTransactionContext transactionContext) {
		this.transactionContext = transactionContext;
	}


	/**
	 * Get the {@link ReactiveTransactionSynchronizationManager} that is associated with
	 ...
	 */
	public static Mono<ReactiveTransactionSynchronizationManager> forCurrentTransaction() {
		return ReactiveTransactionContextManager.currentContext().map(ReactiveTransactionSynchronizationManager::new);
	}
	...
	public void registerSynchronization(ReactiveTransactionSynchronization synchronization)
		...
		Assert.notNull(synchronization, "ReactiveTransactionSynchronization must not be null");
	 ...
	 * @return unmodifiable List of ReactiveTransactionSynchronization instances
