app.controller('63a9e086-2f82-44ca-896c-85305ecf552d', ['$scope', '$http', '$state', '$rootScope', '$compile', '$modal',
	function($scope, $http, $state, $rootScope, $compile, locals, $modal) {
		...
		$scope.init = function() {
			...
			var sr = localStorage.getItem("784903c8-ea08-441f-b965-7bc37a4b45c4|selectRequest");
		...
		$scope.search = function(clean) {
			if(clean) {
				//清理搜索条件
				localStorage.removeItem("784903c8-ea08-441f-b965-7bc37a4b45c4|selectRequest");
			...
			localStorage.setItem("784903c8-ea08-441f-b965-7bc37a4b45c4|selectRequest", JSON.stringify($scope.selectRequest));
			$scope.select();
		};
		//更新状态
