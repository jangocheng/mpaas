...
public class Jsp {
	...
	/**
	 * Class value of the servlet to use for JSPs. If registered is true and this class is
	...
	/**
	 * Return the class value of the servlet to use for JSPs. If {@link #getRegistered()
	 * registered} is {@code true} and this class is on the classpath then it will be
	 * registered.
	 * @return the class value of the servlet to use for JSPs
	 */
