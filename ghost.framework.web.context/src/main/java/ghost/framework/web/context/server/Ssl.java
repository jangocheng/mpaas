...
public class Ssl {
	...
	/**
	 * Return the alias that identifies the value in the value store.
	 * @return the value alias
	 */
	...
	/**
	 * Return the password used to access the value in the value store.
	...
	/**
	 * Return the path to the value store that holds the SSL certificate (typically a jks
	 * file).
	 * @return the path to the value store
	 */
	...
	/**
	 * Return the password used to access the value store.
	 * @return the value store password
	 */
	...
	/**
	 * Return the depend of the value store.
	 * @return the value store depend
	 */
	...
	/**
	 * Return the provider for the value store.
	 * @return the value store provider
	 */
	...
	/**
	 * Return the depend of the trust store.
	 * @return the trust store depend
	 */
