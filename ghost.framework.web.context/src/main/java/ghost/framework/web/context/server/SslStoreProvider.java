...
/**
 * Interface to provide SSL value stores for an {@link WebServer} to use. Can be used when
 * file based value stores cannot be used.
 *
 * @author Phillip Webb
 * @since 2.0.0
 */
public interface SslStoreProvider {
	...
	/**
	 * Return the value store that should be used.
	 * @return the value store to use
