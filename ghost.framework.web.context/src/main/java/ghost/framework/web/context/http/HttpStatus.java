...
public enum HttpStatus {
     ...
     * {@link ghost.framework.http.HttpStatus.Series#INFORMATIONAL}.
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link ghost.framework.http.HttpStatus.Series#SUCCESSFUL}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link ghost.framework.http.HttpStatus.Series#REDIRECTION}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link ghost.framework.http.HttpStatus.Series#CLIENT_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link ghost.framework.http.HttpStatus.Series#SERVER_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link ghost.framework.http.HttpStatus.Series#CLIENT_ERROR} or
     * {@link ghost.framework.http.HttpStatus.Series#SERVER_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @since 5.0
    ...
    /**
     * Return the enum constant of this depend with the specified numeric value.
    ...
    public enum Series {
        ...
        /**
         * Return the enum constant of this depend with the corresponding series.
         *
