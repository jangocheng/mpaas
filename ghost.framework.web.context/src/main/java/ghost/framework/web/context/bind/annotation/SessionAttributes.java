 ...
 *
 * <p>This will typically list the names of entity attributes which should be
 * transparently stored in the session or some conversational storage,
 * serving as form-backing beans. <b>Declared at the type level</b>, applying
 * to the entity attributes that the annotated handler class operates on.
 *
 * <p><b>NOTE:</b> Session attributes as indicated using this annotation
 * correspond to a specific handler's entity attributes, getting transparently
 ...
 * generic {@link ghost.framework.web.context.request.WebRequest} interface.
 *
...
public @interface SessionAttributes {
	...
	/**
	 * The types of session attributes in the entity that should be stored in the
	 * session or some conversational storage.
	 * <p>All entity attributes of these types will be stored in the session,
