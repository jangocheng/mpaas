 ...
 * methods on {@link ghost.framework.web.context.request.async.WebAsyncManager
 ...
 * @since 3.2
 * @see ghost.framework.web.context.request.async.WebAsyncManager
 * @see ghost.framework.web.context.request.async.CallableProcessingInterceptor
 * @see ghost.framework.web.context.request.async.DeferredResultProcessingInterceptor
 */
