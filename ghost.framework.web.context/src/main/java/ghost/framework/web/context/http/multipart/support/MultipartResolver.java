...
package ghost.framework.web.context.http.multipart.support;
 ...
 * <ul>
 * <li>{@link ghost.framework.web.module.multipart.commons.CommonsMultipartResolver}
 * for Apache Commons FileUpload
 * <li>{@link ghost.framework.web.module.multipart.support.StandardServletMultipartResolver}
 * for the Servlet 3.0+ Part API
 * </ul>
 *
 * <p>There is no default resolver implementation used for Spring
 * {@link ghost.framework.web.module.servlet.DispatcherServlet DispatcherServlets},
 ...
 * {@link ghost.framework.web.module.servlet.DispatcherServlet DispatcherServlet's}
 * application context. Such a resolver gets applied to all requests handled
 * by that {@link ghost.framework.web.module.servlet.DispatcherServlet}.
 *
 * <p>If a {@link ghost.framework.web.module.servlet.DispatcherServlet} detects a
 ...
 * {@link ghost.framework.web.module.multipart.support.ByteArrayMultipartFileEditor}
 * or {@link ghost.framework.web.module.multipart.support.StringMultipartFileEditor}
 ...
 * {@link ghost.framework.web.module.servlet.DispatcherServlet},
 * a {@link ghost.framework.web.module.multipart.support.MultipartFilter} can be
 ...
 * @see MultipartFile
 * @see ghost.framework.web.module.multipart.commons.CommonsMultipartResolver
 * @see ghost.framework.web.module.multipart.support.ByteArrayMultipartFileEditor
 * @see ghost.framework.web.module.multipart.support.StringMultipartFileEditor
 * @see ghost.framework.web.module.servlet.DispatcherServlet
 */
...
//	 * 此线程上下问支持在子线程获取
//	 */
//	ThreadLocal<MultipartHttpServletRequest> HttpMultipartContextHolder = new NamedInheritableThreadLocal("HttpMultipartContextHolder");
	/**
	 * 设置是否为懒加载模式
	 * @param resolveLazily
	 */
	 ...
	 * {@link ghost.framework.web.module.multipart.MultipartHttpServletRequest}
