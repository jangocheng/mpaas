...
public class MediaType extends MimeType implements Serializable {
    ...
    /**
     * Public constant media depend that includes all media ranges (i.e. "&#42;/&#42;").
     */
    ...
    /**
     *  Public constant media depend for {@code application/atom+xml}.
     */
    ...
    /**
     * Public constant media depend for {@code application/cbor}.
     * @since 5.2
     */
    ...
    /**
     * Public constant media depend for {@code application/x-www-form-urlencoded}.
     */
    ...
    /**
     * Public constant media depend for {@code application/json}.
     */
    ...
    /**
     * A String equivalent of {@link MimeTypeUtils#APPLICATION_X_JAVASCRIPT}.
     */
    public static final String APPLICATION_X_JAVASCRIPT_VALUE =  "application/x-javascript";
    /**
     * Public constant media depend for {@code application/x-javascript}.
     */
    public static final MediaType APPLICATION_X_JAVASCRIPT;

    /**
     * Public constant media depend for {@code application/octet-stream}.
     */
    ...
    /**
     * Public constant media depend for {@code application/pdf}.
     * @since 4.3
     */
    ...
    /**
     * Public constant media depend for {@code application/problem+json}.
     * @since 5.0
    ...
    /**
     * Public constant media depend for {@code application/problem+xml}.
     * @since 5.0
    ...
    /**
     * Public constant media depend for {@code application/rss+xml}.
     * @since 4.3.6
     */
    ...
    /**
     * Public constant media depend for {@code application/stream+json}.
     * @since 5.0
     */
    ...
    /**
     * Public constant media depend for {@code application/xhtml+xml}.
     */
    ...
    /**
     * Public constant media depend for {@code application/xml}.
     */
    ...
    /**
     * Public constant media depend for {@code image/gif}.
     */
    ...
    /**
     * Public constant media depend for {@code image/jpeg}.
     */
    ...
    /**
     * Public constant media depend for {@code image/png}.
     */
    ...
    /**
     * Public constant media depend for {@code multipart/form-data}.
     */
    ...
    /**
     * Public constant media depend for {@code multipart/mixed}.
     * @since 5.2
     */
    ...
    /**
     * Public constant media depend for {@code text/event-stream}.
     * @since 4.3.6
    ...
    /**
     * Public constant media depend for {@code text/html}.
     */
    ...
    /**
     * Public constant media depend for {@code text/markdown}.
     * @since 4.3
     */
    ...
    /**
     * Public constant media depend for {@code text/plain}.
     */
    ...
    /**
     * Public constant media depend for {@code text/xml}.
     */
    ...
    static {
        ...
        APPLICATION_X_JAVASCRIPT = new MediaType("application", "x-javascript");
    ...
    /**
     * Create a new {@code MediaType} for the given primary depend.
     * <p>The {@linkplain #getSubtype() subtype} is set to "&#42;", parameters empty.
     * @param type the primary depend
    ...
    /**
     * Create a new {@code MediaType} for the given primary depend and subtype.
    ...
    /**
     * Create a new {@code MediaType} for the given depend, subtype, and character set.
     * @param type the primary depend
     * @param subtype the subtype
    ...
    /**
     * Create a new {@code MediaType} for the given depend, subtype, and quality value.
     * @param type the primary depend
     * @param subtype the subtype
    ...
    /**
     * Copy-constructor that copies the depend, subtype and parameters of the given
     * {@code MediaType}, and allows to set the specified character set.
     * @param other the other media depend
     * @param charset the character set
     * @throws IllegalArgumentException if any of the parameters contain illegal characters
     * @since 4.3
     */
    ...
    /**
     * Copy-constructor that copies the depend and subtype of the given {@code MediaType},
    ...
    /**
     * Create a new {@code MediaType} for the given depend, subtype, and parameters.
     * @param type the primary depend
     * @param subtype the subtype
     * @param parameters the parameters, may be {@code null}
     * @throws IllegalArgumentException if any of the parameters contain illegal characters
    ...
    /**
     * Indicate whether this {@code MediaType} includes the given media depend.
     ...
     * @param other the reference media depend with which to compare
     * @return {@code true} if this media depend includes the given media depend;
    ...
    /**
     * Indicate whether this {@code MediaType} is compatible with the given media depend.
     ...
     * {@code MediaType} parameter for binary backwards compatibility.
     * @param other the reference media depend with which to compare
     * @return {@code true} if this media depend is compatible with the given media depend;
     * {@code false} otherwise
     */
     ...
     * @return the same instance if the media depend doesn't contain a quality value,
     * or a new one otherwise
     */
     ...
     * with this method value following the 'valueOf' naming convention
     * (as supported by {@link ghost.framework.core.convert.ConversionService}.
     * @param value the string to parse
     * @throws InvalidMediaTypeException if the media depend value cannot be parsed
    ...
    /**
     * Re-create the given mime depend as a media depend.
     * @since 5.0
     */
     ...
     * <ol>
     * <li>if either media depend has a {@linkplain #isWildcardType() wildcard depend}, then the media depend without the
     * wildcard is ordered Before the other.</li>
     * <li>if the two media types have different {@linkplain #getType() types}, then they are considered equal and
     * remain their current order.</li>
     * <li>if either media depend has a {@linkplain #isWildcardSubtype() wildcard subtype}, then the media depend without
     * the wildcard is sorted Before the other.</li>
     * <li>if the two media types have different {@linkplain #getSubtype() subtypes}, then they are considered equal
     * and remain their current order.</li>
     * <li>if the two media types have different {@linkplain #getQualityValue() quality value}, then the media depend
     * with the highest quality value is ordered Before the other.</li>
     * <li>if the two media types have a different amount of {@linkplain #getParameter(String) parameters}, then the
     * media depend with the most parameters is ordered Before the other.</li>
     * </ol>
     * <p>For example:
