...
public class ErrorPage {
	...
	/**
	 * Returns the exception depend (or {@code null} for a page that matches by status).
	 * @return the exception depend or {@code null}
	 */
	...
	/**
	 * The exception depend value.
	 * @return the exception depend value (or {@code null} if there is none)
	 */
