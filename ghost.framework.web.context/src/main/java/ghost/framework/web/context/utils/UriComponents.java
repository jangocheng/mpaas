...
/**
 * Represents an immutable collection of URI components, mapping component depend to
...
public abstract class UriComponents implements Serializable {
     ...
     * component depend) characters, but not characters with reserved meaning.
     ...
     * segments.
     * @see ghost.framework.util.StringUtils#cleanPath(String)
     */
    ...
    public interface UriTemplateVariables {
        ...
        /**
         * Constant for a value that indicates a URI variable value should be
        ...
        /**
         * Get the value for the given URI variable value.
