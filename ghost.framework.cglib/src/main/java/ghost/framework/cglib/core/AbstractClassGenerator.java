...
package ghost.framework.cglib.core;

//import ghost.framework.asm.ClassReader;
//import ghost.framework.cglib.core.internal.Function;
//import ghost.framework.cglib.core.internal.LoadingCache;
...
public abstract class AbstractClassGenerator<T> implements ClassGenerator {
	...
	protected static class ClassLoaderData {
		...
		/**
		 * {@link AbstractClassGenerator} here holds "cache key" (e.g. {@link ghost.framework.cglib.proxy.Enhancer}
	...
	protected Class generate(ClassLoaderData data) {
		...
		try {
			...
			String className = null;//ClassNameReader.getClassName(new ClassReader(b));
