 ...
 * {@link ghost.framework.data.redis.core.StreamOperations#acknowledge(Object, String, String...)} acknowledge}</li>
 ...
 * @see ErrorHandler
 * @see ghost.framework.data.redis.core.StreamOperations
...
public interface StreamMessageListenerContainer<K, V extends Record<K, ?>> extends SmartLifecycle {
	...
	static StreamMessageListenerContainer<String, MapRecord<String, String, String>> create(
		...
		return create(connectionFactory,
				StreamMessageListenerContainerOptions.builder().serializer(new StringRedisSerializer()).build());
	}
	 ...
	 * <p/>
	 * Errors during {@link ghost.framework.data.redis.connection.RedisStreamCommands.StreamMessage} retrieval lead to
	 ...
	 * {@link ghost.framework.data.redis.core.StreamOperations#acknowledge(Object, String, String...)} after
	 * processing.
	 * <p/>
	...
	class StreamMessageListenerContainerOptions<K, V extends Record<K, ?>> {
		...
		public static StreamMessageListenerContainerOptionsBuilder<String, MapRecord<String, String, String>> builder() {
			return new StreamMessageListenerContainerOptionsBuilder<>().serializer(new StringRedisSerializer());
		}
