...
class DefaultReactiveStreamOperations<K, HK, HV> implements ReactiveStreamOperations<K, HK, HV> {
	...
	DefaultReactiveStreamOperations(ReactiveRedisTemplate<?, ?> template,
		...
		this.objectMapper = new StreamObjectMapper(hashMapper) {
			...
			@Override
			protected HashMapper<?, ?, ?> doGetHashMapper(ConverterContainer conversionService, Class<?> targetType) {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveStreamOperations#acknowledge(java.lang.Object, java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveStreamOperations#add(java.lang.Object, java.util.Map)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveStreamOperations#delete(java.lang.Object, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveStreamOperations#consumers(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveStreamOperations#info(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveStreamOperations#groups(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveStreamOperations#size(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveStreamOperations#range(java.lang.Object, ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	public Flux<MapRecord<K, HK, HV>> range(K key, Range<String> range, RedisZSetCommands.Limit limit) {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveStreamOperations#read(ghost.framework.data.redis.connection.RedisStreamCommands.StreamReadOptions, ghost.framework.data.redis.connection.RedisStreamCommands.StreamOffset[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveStreamOperations#read(ghost.framework.data.redis.connection.RedisStreamCommands.Consumer, ghost.framework.data.redis.connection.RedisStreamCommands.StreamReadOptions, ghost.framework.data.redis.connection.RedisStreamCommands.StreamOffset[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveStreamOperations#reverseRange(java.lang.Object, ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	public Flux<MapRecord<K, HK, HV>> reverseRange(K key, Range<String> range, RedisZSetCommands.Limit limit) {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveStreamOperations#trim(java.lang.Object, long)
	 */
	@Override
	...
	private ByteBuffer rawHashKey(HK key) {
		...
		return ByteBuffer.wrap(( byte[])objectMapper.getConversionService().convert(key, byte[].class));
	}
	...
	private ByteBuffer rawValue(HV value) {
		...
		return ByteBuffer.wrap(( byte[])objectMapper.getConversionService().convert(value, byte[].class));
	}
