 ...
 * @since 2.0
 */
public interface ReactiveHashOperations<H, HK, HV> extends Operations{
	 ...
	 *
	 * @param key must not be {@literal null}.
	 * @return the {@link Flux} emitting the {@link Map.Entry entries} on by one or an {@link Flux#empty() empty
