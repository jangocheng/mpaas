 ...
 * @since 2.0
 */
public interface ReactiveGeoOperations<K, M> extends Operations{
	 ...
	 * @see <a href="https://redis.io/commands/geoadd">Redis Documentation: GEOADD</a>
	 */
	Mono<Long> add(K key, RedisGeoCommands.GeoLocation<M> location);
	/**
	 ...
	 * @see <a href="https://redis.io/commands/geoadd">Redis Documentation: GEOADD</a>
	 */
	Mono<Long> add(K key, Iterable<RedisGeoCommands.GeoLocation<M>> locations);
	 ...
	 * @see <a href="https://redis.io/commands/geoadd">Redis Documentation: GEOADD</a>
	 */
	Flux<Long> add(K key, Publisher<? extends Collection<RedisGeoCommands.GeoLocation<M>>> locations);
	 ...
	 */
	Flux<GeoResult<RedisGeoCommands.GeoLocation<M>>> radius(K key, Circle within);
	 ...
	 * @see <a href="https://redis.io/commands/georadius">Redis Documentation: GEORADIUS</a>
	 */
	Flux<GeoResult<RedisGeoCommands.GeoLocation<M>>> radius(K key, Circle within, RedisGeoCommands.GeoRadiusCommandArgs args);
	/**
	 ...
	 */
	Flux<GeoResult<RedisGeoCommands.GeoLocation<M>>> radius(K key, M member, double radius);
	 ...
	 * @see <a href="https://redis.io/commands/georadiusbymember">Redis Documentation: GEORADIUSBYMEMBER</a>
	 */
	Flux<GeoResult<RedisGeoCommands.GeoLocation<M>>> radius(K key, M member, Distance distance);
	/**
	 * Get the {@literal member}s within the circle defined by the {@literal members} coordinates and given
	 ...
	 * @see <a href="https://redis.io/commands/georadiusbymember">Redis Documentation: GEORADIUSBYMEMBER</a>
	 */
	Flux<GeoResult<RedisGeoCommands.GeoLocation<M>>> radius(K key, M member, Distance distance, RedisGeoCommands.GeoRadiusCommandArgs args);
	/**
