...
public interface DefaultedRedisClusterConnection extends RedisClusterConnection, DefaultedRedisConnection {
	...
	/** @deprecated in favor of {@link RedisClusterConnection#serverCommands()}. */
	@Override
	@Deprecated
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterConnection#execute(String, byte[], Collection)
	 */
	@Nullable
	@Override
