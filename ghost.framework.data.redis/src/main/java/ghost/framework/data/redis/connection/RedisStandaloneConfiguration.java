...
public class RedisStandaloneConfiguration
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisConfiguration.WithHostAndPort#getHostName()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisConfiguration.WithHostAndPort#getPort()
	 */
	@Override
	public int getPort() {
		return port;
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisConfiguration.WithHostAndPort#setHostName(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisConfiguration.WithHostAndPort#setPort(int)
	 */
