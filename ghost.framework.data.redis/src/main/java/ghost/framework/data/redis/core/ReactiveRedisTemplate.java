...
import ghost.framework.data.redis.core.script.DefaultReactiveScriptExecutor;
import ghost.framework.data.redis.core.script.ReactiveScriptExecutor;
import ghost.framework.data.redis.core.script.RedisScript;
import ghost.framework.data.redis.listener.ReactiveRedisMessageListenerContainer;
import ghost.framework.data.redis.serializer.RedisElementReader;
import ghost.framework.data.redis.serializer.RedisElementWriter;
...
public class ReactiveRedisTemplate<K, V> implements ReactiveRedisOperations<K, V> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#convertAndSend(java.lang.String, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#listenTo(ghost.framework.data.redis.listener.Topic[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#hasKey(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#type(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#keys(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#scan(ghost.framework.data.redis.core.ScanOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#randomKey()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#rename(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#renameIfAbsent(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#delete(java.lang.Object[])
	 */
	@Override
	@SafeVarargs
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#delete(org.reactivestreams.Publisher)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#unlink(java.lang.Object[])
	 */
	@Override
	@SafeVarargs
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#unlink(org.reactivestreams.Publisher)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#expire(java.lang.Object, java.time.Duration)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#expireAt(java.lang.Object, java.time.Instant)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#persist(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#getExpire(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#move(java.lang.Object, int)
	 */
	@Override
	...
	/*
	 *(non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#execute(ghost.framework.data.redis.core.script.RedisScript, java.util.List, java.util.List)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#execute(ghost.framework.data.redis.core.script.RedisScript, java.util.List, java.util.List, ghost.framework.data.redis.serializer.RedisElementWriter, ghost.framework.data.redis.serializer.RedisElementReader)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForGeo()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForGeo(ghost.framework.data.redis.serializer.RedisSerializationContext)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForHash()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForHash(ghost.framework.data.redis.serializer.RedisSerializationContext)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForHyperLogLog()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForHyperLogLog(ghost.framework.data.redis.serializer.RedisSerializationContext)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForList()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForList(ghost.framework.data.redis.serializer.RedisSerializationContext)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForSet()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForSet(ghost.framework.data.redis.serializer.RedisSerializationContext)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForStream()
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForStream(HashMapper)
	 */
	@Override
	public <HK, HV> ReactiveStreamOperations<K, HK, HV> opsForStream(
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForStream(ghost.framework.data.redis.serializer.RedisSerializationContext)
	 */
	@SuppressWarnings("unchecked")
	public <HK, HV> ReactiveStreamOperations<K, HK, HV> opsForStream(
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForValue()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForValue(ghost.framework.data.redis.serializer.RedisSerializationContext)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForZSet()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#opsForZSet(ghost.framework.data.redis.serializer.RedisSerializationContext)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveRedisOperations#serialization()
	 */
	@Override
