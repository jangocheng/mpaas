...
public abstract class RedisIndexDefinition implements IndexDefinition {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.index.IndexDefinition#getKeyspace()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.index.IndexDefinition#getConditions()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.index.IndexDefinition#valueTransformer()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.index.IndexDefinition#getIndexName()
	 */
	@Override
	...
	public static class OrCondition<T> implements Condition<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.core.index.IndexDefinition.Condition#matches(java.lang.Object, ghost.framework.data.redis.core.index.IndexDefinition.IndexingContext)
		 */
		@Override
