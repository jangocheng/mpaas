...
import ghost.framework.data.redis.serializer.SerializationUtils;
...
abstract class AbstractOperations<K, V> {
	...
	/**
	 * Deserialize {@link RedisGeoCommands.GeoLocation} of {@link GeoResults}.
	 *
	...
	GeoResults<RedisGeoCommands.GeoLocation<V>> deserializeGeoResults(GeoResults<RedisGeoCommands.GeoLocation<byte[]>> source) {
		...
		if (valueSerializer() == null) {
			return (GeoResults<RedisGeoCommands.GeoLocation<V>>) (Object) source;
		}
