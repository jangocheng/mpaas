...
public class BitFieldSubCommands implements Iterable<BitFieldSubCommands.BitFieldSubCommand> {
	...
	public static abstract class AbstractBitFieldSubCommand implements BitFieldSubCommand {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.StringRedisConnection.BitFieldSubCommand#getType()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.StringRedisConnection.BitFieldSubCommand#getOffset()
		 */
		@Override
	...
	public static class BitFieldSet extends AbstractBitFieldSubCommand {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.StringRedisConnection.BitFieldSubCommand#getCommand()
		 */
		@Override
