...
import ghost.framework.context.scripting.support.ResourceScriptSource;
import ghost.framework.context.scripting.support.ScriptSource;
import ghost.framework.context.scripting.support.StaticScriptSource;
...
public class DefaultRedisScript<T> implements RedisScript<T> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.script.RedisScript#getSha1()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.script.RedisScript#getResultType()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.script.RedisScript#getScriptAsString()
	 */
	 ...
	 */
	public void setLocation(IResource scriptLocation) {
