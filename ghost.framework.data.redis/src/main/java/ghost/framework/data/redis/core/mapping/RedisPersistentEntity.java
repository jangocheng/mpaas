...
public interface RedisPersistentEntity<T> extends KeyValuePersistentEntity<T, RedisPersistentProperty> {
	...
	/**
	 * @return {@literal true} when a property is annotated with {@link ghost.framework.data.redis.core.TimeToLive}.
	 * @since 1.8
	 */
	boolean hasExplictTimeToLiveProperty();

	/**
	 * Get the {@link PersistentProperty} that is annotated with {@link ghost.framework.data.redis.core.TimeToLive}.
	 *
