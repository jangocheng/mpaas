...
import ghost.framework.data.commons.mapping.context.BasicKeyValuePersistentEntity;
...
public class BasicRedisPersistentEntity<T> extends BasicKeyValuePersistentEntity<T, RedisPersistentProperty>
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.mapping.RedisPersistentEntity#getTimeToLiveAccessor()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.mapping.RedisPersistentEntity#hasExplictTimeToLiveProperty()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.mapping.RedisPersistentEntity#getExplicitTimeToLiveProperty()
	 */
	@Override
	@Nullable
