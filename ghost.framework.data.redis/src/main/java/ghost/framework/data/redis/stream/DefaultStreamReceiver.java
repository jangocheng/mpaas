...
import ghost.framework.data.redis.core.ReactiveStreamOperations;
...
class DefaultStreamReceiver<K, V extends Record<K, ?>> implements StreamReceiver<K, V> {
	 ...
	 * {@link ghost.framework.data.redis.stream.StreamReceiver.StreamReceiverOptions}.
	 *
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.stream.StreamReceiver#receive(ghost.framework.data.redis.connection.RedisStreamCommands.StreamOffset)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.stream.StreamReceiver#receiveAutoAck(ghost.framework.data.redis.connection.RedisStreamCommands.Consumer, ghost.framework.data.redis.connection.RedisStreamCommands.StreamOffset)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.stream.StreamReceiver#receive(ghost.framework.data.redis.connection.RedisStreamCommands.Consumer, ghost.framework.data.redis.connection.RedisStreamCommands.StreamOffset)
	 */
	@Override
	@SuppressWarnings("unchecked")
