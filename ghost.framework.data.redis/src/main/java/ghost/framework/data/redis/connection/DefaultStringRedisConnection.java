...
import ghost.framework.data.redis.connection.convert.MapConverter;
import ghost.framework.data.redis.connection.convert.SetConverter;
...
import ghost.framework.data.redis.core.ConvertingCursor;
...
public class DefaultStringRedisConnection implements StringRedisConnection, DecoratedRedisConnection {
	...
	private SetConverter<RedisZSetCommands.Tuple, StringTuple> tupleToStringTuple = new SetConverter<>(new TupleConverter());
	private SetConverter<StringTuple, RedisZSetCommands.Tuple> stringTupleToTuple = new SetConverter<>(new StringTupleConverter());
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#append(byte[], byte[])
	 */
	@Override
	public Long append(byte[] key, byte[] value) {
		return convertAndReturn(this.delegate.append(key, value), identityConverter);
	}
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#bLPop(int, byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#bRPop(int, byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#bRPopLPush(int, byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisConnection#close()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#decr(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#decrBy(byte[], long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#del(byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#unlink(byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisTxCommands#discard()
	 */
	@Override
	public void discard() {
		try {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisConnectionCommands#echo(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisTxCommands#exec()
	 */
	@Override
	@SuppressWarnings("rawtypes")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#exists(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#exists(String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#expire(byte[], long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#expireAt(byte[], long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#get(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#getBit(byte[], long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#getRange(byte[], long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#getSet(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.message.RedisPubSubCommands#getSubscription()
	 */
	@Override
	public ghost.framework.data.redis.stream.Subscription getSubscription() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#incr(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#incrBy(byte[], long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#incrBy(byte[], double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.message.RedisPubSubCommands#isSubscribed()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#keys(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#lIndex(byte[], long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#lInsert(byte[], ghost.framework.data.redis.connection.RedisListCommands.Position, byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#lLen(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#lPop(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#lPush(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#lPushX(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#lRange(byte[], long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#lRem(byte[], long, byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#lSet(byte[], long, byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#lTrim(byte[], long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#mGet(byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#mSet(java.util.Map)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#mSetNX(java.util.Map)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisTxCommands#multi()
	 */
	@Override
	public void multi() {
		delegate.multi();
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#persist(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#move(byte[], int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisConnectionCommands#ping()
	 */
	@Override
	public String ping() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.message.RedisPubSubCommands#pSubscribe(ghost.framework.data.redis.connection.MessageListener, byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.message.RedisPubSubCommands#publish(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#randomKey()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#rename(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#renameNX(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#rPop(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#rPopLPush(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#rPush(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisListCommands#rPushX(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sAdd(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sCard(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sDiff(byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sDiffStore(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisConnectionCommands#select(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#set(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#set(byte[], byte[], ghost.framework.data.redis.core.types.Expiration, ghost.framework.data.redis.connection.RedisStringCommands.SetOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#setBit(byte[], long, boolean)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#setEx(byte[], long, byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#pSetEx(byte[], long, byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#setNX(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#setRange(byte[], byte[], long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sInter(byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sInterStore(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sIsMember(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sMembers(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sMove(byte[], byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#sort(byte[], ghost.framework.data.redis.connection.SortParameters, byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#sort(byte[], ghost.framework.data.redis.connection.SortParameters)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#encoding(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#idletime(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#refcount(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sPop(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sPop(byte[], long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sRandMember(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sRandMember(byte[], long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sRem(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#strLen(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#bitCount(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#bitCount(byte[], long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#bitOp(ghost.framework.data.redis.connection.RedisStringCommands.BitOperation, byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#bitPos(byte[], boolean, ghost.framework.data.domain.Range)
	 */
	@Nullable
	@Override
	public Long bitPos(byte[] key, boolean bit, ghost.framework.data.domain.Range<Long> range) {
		return convertAndReturn(delegate.bitPos(key, bit, range), identityConverter);
	}

	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.message.RedisPubSubCommands#subscribe(ghost.framework.data.redis.connection.MessageListener, byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sUnion(byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#sUnionStore(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#ttl(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#ttl(byte[], java.util.concurrent.TimeUnit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#type(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#touch(byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisTxCommands#unwatch()
	 */
	@Override
	public void unwatch() {
		delegate.unwatch();
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisTxCommands#watch(byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zAdd(byte[], double, byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zAdd(byte[], java.util.Set)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zCard(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zCount(byte[], double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zCount(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zIncrBy(byte[], double, byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zInterStore(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Aggregate, ghost.framework.data.redis.connection.RedisZSetCommands.Weights, byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zInterStore(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRange(byte[], long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeByScore(byte[], double, double, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeByScore(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeByScore(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeByScoreWithScores(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeByScore(byte[], double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeByScoreWithScores(byte[], double, double, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeByScoreWithScores(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeByScoreWithScores(byte[], double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeWithScores(byte[], long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRevRangeByScore(byte[], double, double, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRevRangeByScore(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRevRangeByScore(byte[], double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRevRangeByScore(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRevRangeByScoreWithScores(byte[], double, double, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRevRangeByScoreWithScores(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRevRangeByScoreWithScores(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRevRangeByScoreWithScores(byte[], double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRank(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRem(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRemRange(byte[], long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRemRangeByScore(byte[], double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRemRangeByScore(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRevRange(byte[], long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRevRangeWithScores(byte[], long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRevRank(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zScore(byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zUnionStore(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Aggregate, ghost.framework.data.redis.connection.RedisZSetCommands.Weights, byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zUnionStore(byte[], byte[][])
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#pExpire(byte[], long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#pExpireAt(byte[], long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#pTtl(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#pTtl(byte[], java.util.concurrent.TimeUnit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#dump(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#restore(byte[], long, byte[], boolean)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisScriptingCommands#scriptFlush()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisScriptingCommands#scriptKill()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisScriptingCommands#scriptLoad(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisScriptingCommands#scriptExists(java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisScriptingCommands#eval(byte[], ghost.framework.data.redis.connection.ReturnType, int, byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisScriptingCommands#evalSha(java.lang.String, ghost.framework.data.redis.connection.ReturnType, int, byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisScriptingCommands#evalSha(byte[], ghost.framework.data.redis.connection.ReturnType, int, byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#append(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#bLPop(int, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#bRPop(int, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#bRPopLPush(int, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#decr(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#decrBy(java.lang.String, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#del(java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#unlink(java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#echo(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#exists(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#expire(java.lang.String, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#expireAt(java.lang.String, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#get(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#getBit(java.lang.String, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#getRange(java.lang.String, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#getSet(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hDel(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hExists(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hGet(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hGetAll(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hIncrBy(java.lang.String, java.lang.String, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hIncrBy(java.lang.String, java.lang.String, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hKeys(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hLen(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hMGet(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hMSet(java.lang.String, java.util.Map)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hSet(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hSetNX(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hVals(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#incr(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#incrBy(java.lang.String, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#incrBy(java.lang.String, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#keys(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#lIndex(java.lang.String, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#lInsert(java.lang.String, ghost.framework.data.redis.connection.RedisListCommands.Position, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#lLen(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#lPop(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#lPush(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#lPushX(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#lRange(java.lang.String, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#lRem(java.lang.String, long, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#lSet(java.lang.String, long, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#lTrim(java.lang.String, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#mGet(java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#mSetNXString(java.util.Map)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#mSetString(java.util.Map)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#persist(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#move(java.lang.String, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#pSubscribe(ghost.framework.data.redis.connection.MessageListener, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#publish(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#rename(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#renameNX(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#rPop(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#rPopLPush(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#rPush(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#rPushX(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sAdd(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sCard(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sDiff(java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sDiffStore(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#set(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#set(java.lang.String, java.lang.String, ghost.framework.data.redis.core.types.Expiration, ghost.framework.data.redis.connection.RedisStringCommands.SetOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#setBit(java.lang.String, long, boolean)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#setEx(java.lang.String, long, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#pSetEx(java.lang.String, long, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#setNX(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#setRange(java.lang.String, java.lang.String, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sInter(java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sInterStore(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sIsMember(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sMembers(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sMove(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sort(java.lang.String, ghost.framework.data.redis.connection.SortParameters, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sort(java.lang.String, ghost.framework.data.redis.connection.SortParameters)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#encoding(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#idletime(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#refcount(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sPop(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sPop(java.lang.String, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sRandMember(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sRandMember(java.lang.String, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sRem(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#strLen(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#bitCount(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#bitCount(java.lang.String, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#bitOp(ghost.framework.data.redis.connection.RedisStringCommands.BitOperation, java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#bitPos(java.lang.String, boolean, ghost.framework.data.domain.Range)
	 */
	@Nullable
	@Override
	public Long bitPos(String key, boolean bit, ghost.framework.data.domain.Range<Long> range) {
		return bitPos(serialize(key), bit, range);
	}

	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#subscribe(ghost.framework.data.redis.connection.MessageListener, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sUnion(java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sUnionStore(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#ttl(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#ttl(java.lang.String, java.util.concurrent.TimeUnit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#type(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#touch(java.lang.String[])
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zAdd(java.lang.String, double, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zAdd(java.lang.String, java.util.Set)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zCard(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zCount(java.lang.String, double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zIncrBy(java.lang.String, double, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zInterStore(java.lang.String, ghost.framework.data.redis.connection.RedisZSetCommands.Aggregate, int[], java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zInterStore(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRange(java.lang.String, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRangeByScore(java.lang.String, double, double, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRangeByScore(java.lang.String, double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRangeByScoreWithScores(java.lang.String, double, double, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRangeByScoreWithScores(java.lang.String, double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRangeWithScores(java.lang.String, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRank(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRem(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRemRange(java.lang.String, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRemRangeByScore(java.lang.String, double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRevRange(java.lang.String, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRevRangeWithScores(java.lang.String, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRevRangeByScore(java.lang.String, double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRevRangeByScoreWithScores(java.lang.String, double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRevRangeByScore(java.lang.String, double, double, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRevRangeByScoreWithScores(java.lang.String, double, double, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRevRank(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zScore(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zUnionStore(java.lang.String, ghost.framework.data.redis.connection.RedisZSetCommands.Aggregate, int[], java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zUnionStore(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoAdd(byte[], ghost.framework.data.geo.Point, byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoAdd(byte[], ghost.framework.data.redis.connection.RedisGeoCommands.GeoLocation)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoAdd(java.lang.String, ghost.framework.data.geo.Point, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoAdd(java.lang.String, ghost.framework.data.redis.connection.RedisGeoCommands.GeoLocation)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoAdd(byte[], java.util.Map)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoAdd(byte[], java.lang.Iterable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoAdd(java.lang.String, java.util.Map)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoAdd(java.lang.String, java.lang.Iterable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoDist(byte[], byte[], byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoDist(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoDist(byte[], byte[], byte[], ghost.framework.data.geo.Metric)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoDist(java.lang.String, java.lang.String, java.lang.String, ghost.framework.data.redis.connection.RedisGeoCommands.DistanceUnit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoHash(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoHash(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoPos(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoPos(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoRadius(java.lang.String, ghost.framework.data.geo.Circle)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoRadius(java.lang.String, ghost.framework.data.geo.Circle, ghost.framework.data.redis.core.GeoRadiusCommandArgs)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoRadiusByMember(java.lang.String, java.lang.String, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoRadiusByMember(java.lang.String, java.lang.String, ghost.framework.data.geo.Distance)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoRadiusByMember(java.lang.String, java.lang.String, ghost.framework.data.geo.Distance, ghost.framework.data.redis.core.GeoRadiusCommandArgs)
	 */
	@Override
	public GeoResults<GeoLocation<String>> geoRadiusByMember(String key, String member, Distance radius,
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoRadius(byte[], ghost.framework.data.geo.Circle)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoRadius(byte[], ghost.framework.data.geo.Circle, ghost.framework.data.redis.core.GeoRadiusCommandArgs)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoRadiusByMember(byte[], byte[], double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoRadiusByMember(byte[], byte[], ghost.framework.data.geo.Distance)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoRadiusByMember(byte[], byte[], ghost.framework.data.geo.Distance, ghost.framework.data.redis.core.GeoRadiusCommandArgs)
	 */
	@Override
	public GeoResults<GeoLocation<byte[]>> geoRadiusByMember(byte[] key, byte[] member, Distance radius,
															 GeoRadiusCommandArgs args) {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoRemove(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#geoRemove(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#execute(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisCommands#execute(java.lang.String, byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#execute(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#pExpire(java.lang.String, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#pExpireAt(java.lang.String, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#pTtl(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#pTtl(java.lang.String, java.util.concurrent.TimeUnit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#scriptLoad(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#getClientList()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#scan(ghost.framework.data.redis.core.ScanOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zScan(byte[], ghost.framework.data.redis.core.ScanOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#scan(byte[], ghost.framework.data.redis.core.ScanOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisSetCommands#hStrLen(byte[], byte[])
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisServerCommands#setClientName(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#setClientName(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisServerCommands#killClient(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hScan(java.lang.String, ghost.framework.data.redis.core.ScanOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#hStrLen(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#sScan(java.lang.String, ghost.framework.data.redis.core.ScanOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zScan(java.lang.String, ghost.framework.data.redis.core.ScanOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisConnection#getSentinelConnection()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRangeByScore(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRangeByScore(java.lang.String, java.lang.String, java.lang.String, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeByScore(byte[], java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeByScore(byte[], java.lang.String, java.lang.String, long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisHyperLogLogCommands#pfAdd(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#pfAdd(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisHyperLogLogCommands#pfCount(byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#pfCount(java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisHyperLogLogCommands#pfMerge(byte[], byte[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#pfMerge(java.lang.String, java.lang.String[][])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeByLex(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeByLex(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands#zRangeByLex(byte[], ghost.framework.data.redis.connection.RedisZSetCommands.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRangeByLex(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRangeByLex(java.lang.String, ghost.framework.data.redis.connection.RedisZSetCommands.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#zRangeByLex(java.lang.String, ghost.framework.data.redis.connection.RedisZSetCommands.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xAck(java.lang.String, java.lang.String, RecordId[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xAdd(StringRecord, XAddOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xClaimJustId(java.lang.String, java.lang.String, java.lang.String, ghost.framework.data.redis.connection.RedisStreamCommands.XClaimOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xClaim(java.lang.String, java.lang.String, java.lang.String, ghost.framework.data.redis.connection.RedisStreamCommands.XClaimOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xDel(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xGroupCreate(java.lang.String, ghost.framework.data.redis.connection.RedisStreamCommands.ReadOffset, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xGroupCreate(java.lang.String, ghost.framework.data.redis.connection.RedisStreamCommands.ReadOffset, java.lang.String, boolean)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xGroupDelConsumer(java.lang.String, ghost.framework.data.redis.connection.RedisStreamCommands.Consumer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xGroupDestroy(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xInfo(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xInfoGroups(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xInfoConsumers(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xLen(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xPending(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xPending(java.lang.String, java.lang.String, java.lang.String, ghost.framework.data.domain.Range, java.lang.Long)
	 */
	@Override
	public PendingMessages xPending(String key, String groupName, String consumer,
									ghost.framework.data.domain.Range<String> range, Long count) {
		return convertAndReturn(delegate.xPending(serialize(key), groupName, consumer, range, count), identityConverter);
	}

	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xPending(java.lang.String, java.lang.String, ghost.framework.data.domain.Range, java.lang.Long)
	 */
	@Override
	public PendingMessages xPending(String key, String groupName, ghost.framework.data.domain.Range<String> range,
									Long count) {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xPending(java.lang.String, ghost.framework.data.redis.connection.RedisStreamCommands.XPendingOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xRange(java.lang.String, ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	public List<StringRecord> xRange(String key, ghost.framework.data.domain.Range<String> range, Limit limit) {
		return convertAndReturn(delegate.xRange(serialize(key), range, limit), listByteMapRecordToStringMapRecordConverter);
	}

	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xReadAsString(ghost.framework.data.redis.connection.RedisStreamCommands.StreamReadOptions, ghost.framework.data.redis.connection.RedisStreamCommands.StreamOffset[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xReadGroupAsString(ghost.framework.data.redis.connection.RedisStreamCommands.Consumer, ghost.framework.data.redis.connection.RedisStreamCommands.StreamReadOptions, ghost.framework.data.redis.connection.RedisStreamCommands.StreamOffset[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xRevRange(java.lang.String, ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	public List<StringRecord> xRevRange(String key, ghost.framework.data.domain.Range<String> range, Limit limit) {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#xTrim(java.lang.String, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xAck(byte[], java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xAdd(MapRecord, XAddOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xClaimJustId(byte[], java.lang.String, java.lag.String, ghost.framework.data.redis.connection.RedisStreamCommands.XCLaimOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xClaim(byte[], java.lang.String, java.lag.String, ghost.framework.data.redis.connection.RedisStreamCommands.XCLaimOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xDel(byte[], RecordId)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xGroupCreate(byte[], ghost.framework.data.redis.connection.RedisStreamCommands.ReadOffset, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xGroupCreate(byte[], ghost.framework.data.redis.connection.RedisStreamCommands.ReadOffset, java.lang.String, boolean)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xGroupDelConsumer(byte[], ghost.framework.data.redis.connection.RedisStreamCommands.Consumer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xGroupDestroy(byte[], java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xInfo(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xInfoGroups(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xInfoConsumers(byte[], java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xLen(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xPending(byte[], java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xRange(byte[], ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	public List<ByteRecord> xRange(byte[] key, ghost.framework.data.domain.Range<String> range, Limit limit) {
		return delegate.xRange(key, range, limit);
	}

	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xRead(ghost.framework.data.redis.connection.RedisStreamCommands.StreamReadOptions, ghost.framework.data.redis.connection.RedisStreamCommands.StreamOffset[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xReadGroup(ghost.framework.data.redis.connection.RedisStreamCommands.Consumer, ghost.framework.data.redis.connection.RedisStreamCommands.StreamReadOptions, ghost.framework.data.redis.connection.RedisStreamCommands.StreamOffset[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xRevRange(byte[], ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	public List<ByteRecord> xRevRange(byte[] key, ghost.framework.data.domain.Range<String> range, Limit limit) {
		return delegate.xRevRange(key, range, limit);
	}

	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStreamCommands#xTrim(byte[], long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisStringCommands#bitfield(byte[], BitfieldCommand)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.StringRedisConnection#bitfield(byte[], BitfieldCommand)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.DecoratedRedisConnection#getDelegate()
	 */
	@Override
