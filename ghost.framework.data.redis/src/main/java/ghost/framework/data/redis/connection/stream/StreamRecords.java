...
public class StreamRecords {
	...
	public static class MapBackedRecord<S, K, V> implements MapRecord<S, K, V> {
		...
		public MapBackedRecord(@Nullable S stream, RecordId recordId, Map<K, V> kvMap) {
	 ...
	 */
	public static class StringMapBackedRecord extends MapBackedRecord<String, String, String> implements StringRecord {

		public StringMapBackedRecord(String stream, RecordId recordId, Map<String, String> stringStringMap) {
