...
import ghost.framework.data.redis.connection.ReactiveListCommands;
import ghost.framework.data.redis.connection.RedisListCommands;
...
class DefaultReactiveListOperations<K, V> implements ReactiveListOperations<K, V> {
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#range(java.lang.Object, long, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#trim(java.lang.Object, long, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#size(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#leftPush(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#leftPushAll(java.lang.Object, java.lang.Object[])
	 */
	@Override
	@SafeVarargs
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#leftPushAll(java.lang.Object, java.util.Collection)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#leftPushIfPresent(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#leftPush(java.lang.Object, java.lang.Object, java.lang.Object)
	 */
	@Override
	public Mono<Long> leftPush(K key, V pivot, V value) {

		Assert.notNull(key, "Key must not be null!");
		return createMono(connection -> connection.lInsert(rawKey(key), RedisListCommands.Position.BEFORE, rawValue(pivot), rawValue(value)));
	}

	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#rightPush(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#rightPushAll(java.lang.Object, java.lang.Object[])
	 */
	@Override
	@SafeVarargs
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#rightPushAll(java.lang.Object, java.util.Collection)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#rightPushIfPresent(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#rightPush(java.lang.Object, java.lang.Object, java.lang.Object)
	 */
	@Override
	public Mono<Long> rightPush(K key, V pivot, V value) {
		...
		return createMono(connection -> connection.lInsert(rawKey(key), RedisListCommands.Position.AFTER, rawValue(pivot), rawValue(value)));
	}

	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#set(java.lang.Object, long, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#remove(java.lang.Object, long, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#index(java.lang.Object, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#leftPop(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#leftPop(java.lang.Object, java.time.Duration)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#rightPop(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#rightPop(java.lang.Object, java.time.Duration)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#rightPopAndLeftPush(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#rightPopAndLeftPush(java.lang.Object, java.lang.Object, java.time.Duration)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveListOperations#delete(java.lang.Object)
	 */
	@Override
