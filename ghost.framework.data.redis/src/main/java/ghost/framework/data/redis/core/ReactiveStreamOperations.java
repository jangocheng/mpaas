 ...
 * @since 2.2
 */
public interface ReactiveStreamOperations<K, HK, HV> extends HashMapperProvider<HK, HV>, Operations{
	 ...
	 * @since 2.3
	 */
	Flux<StreamInfo.XInfoConsumer> consumers(K key, String group);
	 ...
	 * @since 2.3
	 */
	Flux<StreamInfo.XInfoGroup> groups(K key);
	 ...
	 * @since 2.3
	 */
	Mono<StreamInfo.XInfoStream> info(K key);
	 ...
	 * @see <a href="https://redis.io/commands/xrange">Redis Documentation: XRANGE</a>
	 */
	Flux<MapRecord<K, HK, HV>> range(K key, Range<String> range, RedisZSetCommands.Limit limit);
	/**
	 ...
	 * @see <a href="https://redis.io/commands/xrange">Redis Documentation: XRANGE</a>
	 */
	default <V> Flux<ObjectRecord<K, V>> range(Class<V> targetType, K key, Range<String> range, RedisZSetCommands.Limit limit) {
	 ...
	 * @see <a href="https://redis.io/commands/xrevrange">Redis Documentation: XREVRANGE</a>
	 */
	Flux<MapRecord<K, HK, HV>> reverseRange(K key, Range<String> range, RedisZSetCommands.Limit limit);
	 ...
	 * @see <a href="https://redis.io/commands/xrevrange">Redis Documentation: XREVRANGE</a>
	 */
	default <V> Flux<ObjectRecord<K, V>> reverseRange(Class<V> targetType, K key, Range<String> range, RedisZSetCommands.Limit limit) {
		Assert.notNull(targetType, "Target type must not be null");
