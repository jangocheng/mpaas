...
public class GenericToStringSerializer<T> implements RedisSerializer<T> {
	...
	private Converter converter = null;//new Converter(new DefaultConversionService());
	...
	public void setConversionService(ConverterContainer converterContainer) {

		Assert.notNull(converterContainer, "non null conversion service required");
//		converter = new Converter(converterContainer);
	}
...
//	}
	...
	private class Converter {
		...
		public Converter(ConverterContainer conversionService) {
			this.converterContainer = conversionService;
			this.typeConverter = null;
		}

		public Converter(TypeConverter typeConverter) {
			this.converterContainer = null;
			this.typeConverter = typeConverter;
		}

		<E> E convert(Object value, Class<E> targetType) {
			if (converterContainer != null) {
//				return converterContainer.convert(value, targetType);
			}
			return null;//typeConverter.convertIfNecessary(value, targetType);
		}
	}
}
