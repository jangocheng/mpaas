...
public class RedisSocketConfiguration implements RedisConfiguration, RedisConfiguration.DomainSocketConfiguration {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisConfiguration.WithDomainSocket#getSocket()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisConfiguration.WithDomainSocket#setSocket(java.lang.String)
	 */
	@Override
