...
public class IndexConfiguration implements ConfigurableIndexDefinitionProvider {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.index.IndexDefinitionProvider#hasIndexFor(java.io.Serializable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.index.IndexDefinitionProvider#hasIndexFor(java.io.Serializable, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.index.IndexDefinitionProvider#getIndexDefinitionsFor(java.io.Serializable, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.index.IndexDefinitionProvider#getIndexDefinitionsFor(java.io.Serializable)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.index.IndexDefinitionRegistry#addIndexDefinition(ghost.framework.data.redis.core.index.IndexDefinition)
	 */
