...
public interface ReactiveSubscription {
	...
	class ChannelMessage<C, M> implements Message<C, M> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.ReactiveSubscription.Message#getChannel()
		 */
		@Override
		public C getChannel() {
			return channel;
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.ReactiveSubscription.Message#getMessage()
		 */
		@Override
		public M getMessage() {
			return message;
