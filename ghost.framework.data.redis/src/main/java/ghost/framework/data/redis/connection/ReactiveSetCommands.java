...
public interface ReactiveSetCommands {
	 ...
	 */
	class SAddCommand extends ReactiveRedisConnection.KeyCommand {
	...
	default Mono<Long> sAdd(ByteBuffer key, Collection<ByteBuffer> values) {
		...
		return sAdd(Mono.just(SAddCommand.values(values).to(key))).next().map(ReactiveRedisConnection.NumericResponse::getOutput);
	}
	 ...
	 * @see <a href="https://redis.io/commands/sadd">Redis Documentation: SADD</a>
	 */
	Flux<ReactiveRedisConnection.NumericResponse<SAddCommand, Long>> sAdd(Publisher<SAddCommand> commands);
	 ...
	 */
	class SRemCommand extends ReactiveRedisConnection.KeyCommand {
	...
	default Mono<Long> sRem(ByteBuffer key, Collection<ByteBuffer> values) {
		...
		return sRem(Mono.just(SRemCommand.values(values).from(key))).next().map(ReactiveRedisConnection.NumericResponse::getOutput);
	}
	 ...
	 * @see <a href="https://redis.io/commands/srem">Redis Documentation: SREM</a>
	 */
	Flux<ReactiveRedisConnection.NumericResponse<SRemCommand, Long>> sRem(Publisher<SRemCommand> commands);
	 ...
	 */
	class SPopCommand extends ReactiveRedisConnection.KeyCommand {
	...
	default Mono<ByteBuffer> sPop(ByteBuffer key) {
		...
		return sPop(Mono.just(SPopCommand.one().from(key))).next().map(ReactiveRedisConnection.ByteBufferResponse::getOutput);
	}
	...
	/**
	 * Remove and return a random member from set at {@link ReactiveRedisConnection.KeyCommand#getKey()}
	 *
	 * @param commands
	 * @return
	 * @see <a href="https://redis.io/commands/spop">Redis Documentation: SPOP</a>
	 */
	Flux<ReactiveRedisConnection.ByteBufferResponse<ReactiveRedisConnection.KeyCommand>> sPop(Publisher<ReactiveRedisConnection.KeyCommand> commands);
	 ...
	 */
	class SMoveCommand extends ReactiveRedisConnection.KeyCommand {
	 ...
	 * @see <a href="https://redis.io/commands/smove">Redis Documentation: SMOVE</a>
	 */
	Flux<ReactiveRedisConnection.BooleanResponse<SMoveCommand>> sMove(Publisher<SMoveCommand> commands);
	...
	default Mono<Long> sCard(ByteBuffer key) {
		...
		return sCard(Mono.just(new ReactiveRedisConnection.KeyCommand(key))).next().map(ReactiveRedisConnection.NumericResponse::getOutput);
	}

	/**
	 * Get size of set at {@link ReactiveRedisConnection.KeyCommand#getKey()}.
	 *
	 * @param commands must not be {@literal null}.
	 * @return
	 * @see <a href="https://redis.io/commands/scard">Redis Documentation: SCARD</a>
	 */
	Flux<ReactiveRedisConnection.NumericResponse<ReactiveRedisConnection.KeyCommand, Long>> sCard(Publisher<ReactiveRedisConnection.KeyCommand> commands);
	 ...
	 */
	class SIsMemberCommand extends ReactiveRedisConnection.KeyCommand {
	...
	default Mono<Boolean> sIsMember(ByteBuffer key, ByteBuffer value) {
		...
		Assert.notNull(key, "Key must not be null!");
		Assert.notNull(value, "Value must not be null!");
		return sIsMember(Mono.just(SIsMemberCommand.value(value).of(key))).next().map(ReactiveRedisConnection.BooleanResponse::getOutput);
	}
	 ...
	 * @see <a href="https://redis.io/commands/sismember">Redis Documentation: SISMEMBER</a>
	 */
	Flux<ReactiveRedisConnection.BooleanResponse<SIsMemberCommand>> sIsMember(Publisher<SIsMemberCommand> commands);
	 ...
	 */
	class SInterCommand implements ReactiveRedisConnection.Command {
	...
	default Flux<ByteBuffer> sInter(Collection<ByteBuffer> keys) {
		...
		return sInter(Mono.just(SInterCommand.keys(keys))).flatMap(ReactiveRedisConnection.CommandResponse::getOutput);
	}
	 ...
	 * @see <a href="https://redis.io/commands/sinter">Redis Documentation: SINTER</a>
	 */
	Flux<ReactiveRedisConnection.CommandResponse<SInterCommand, Flux<ByteBuffer>>> sInter(Publisher<SInterCommand> commands);
	 ...
	 */
	class SInterStoreCommand extends ReactiveRedisConnection.KeyCommand {
	 ...
	 * @see <a href="https://redis.io/commands/sinterstore">Redis Documentation: SINTERSTORE</a>
	 */
	Flux<ReactiveRedisConnection.NumericResponse<SInterStoreCommand, Long>> sInterStore(Publisher<SInterStoreCommand> commands);
	 ...
	 */
	class SUnionCommand implements ReactiveRedisConnection.Command {
	...
	default Flux<ByteBuffer> sUnion(Collection<ByteBuffer> keys) {
		...
		return sUnion(Mono.just(SUnionCommand.keys(keys))).flatMap(ReactiveRedisConnection.CommandResponse::getOutput);
	}
	 ...
	 * @see <a href="https://redis.io/commands/sunion">Redis Documentation: SUNION</a>
	 */
	Flux<ReactiveRedisConnection.CommandResponse<SUnionCommand, Flux<ByteBuffer>>> sUnion(Publisher<SUnionCommand> commands);
	 ...
	 */
	class SUnionStoreCommand extends ReactiveRedisConnection.KeyCommand {
	 ...
	 * @see <a href="https://redis.io/commands/sunionstore">Redis Documentation: SUNIONSTORE</a>
	 */
	Flux<ReactiveRedisConnection.NumericResponse<SUnionStoreCommand, Long>> sUnionStore(Publisher<SUnionStoreCommand> commands);
	 ...
	 */
	class SDiffCommand implements ReactiveRedisConnection.Command {
	...
	default Flux<ByteBuffer> sDiff(Collection<ByteBuffer> keys) {
		...
		return sDiff(Mono.just(SDiffCommand.keys(keys))).flatMap(ReactiveRedisConnection.CommandResponse::getOutput);
	}
	 ...
	 * @see <a href="https://redis.io/commands/sdiff">Redis Documentation: SDIFF</a>
	 */
	Flux<ReactiveRedisConnection.CommandResponse<SDiffCommand, Flux<ByteBuffer>>> sDiff(Publisher<SDiffCommand> commands);
	 ...
	 */
	class SDiffStoreCommand extends ReactiveRedisConnection.KeyCommand {
	 ...
	 * @see <a href="https://redis.io/commands/sdiffstore">Redis Documentation: SDIFFSTORE</a>
	 */
	Flux<ReactiveRedisConnection.NumericResponse<SDiffStoreCommand, Long>> sDiffStore(Publisher<SDiffStoreCommand> commands);
	...
	default Flux<ByteBuffer> sMembers(ByteBuffer key) {
		...
		return sMembers(Mono.just(new ReactiveRedisConnection.KeyCommand(key))).flatMap(ReactiveRedisConnection.CommandResponse::getOutput);
	}

	/**
	 * Get all elements of set at {@link ReactiveRedisConnection.KeyCommand#getKey()}.
	 *
	 * @param commands must not be {@literal null}.
	 * @return
	 * @see <a href="https://redis.io/commands/smembers">Redis Documentation: SMEMBERS</a>
	 */
	Flux<ReactiveRedisConnection.CommandResponse<ReactiveRedisConnection.KeyCommand, Flux<ByteBuffer>>> sMembers(Publisher<ReactiveRedisConnection.KeyCommand> commands);
	...
	default Flux<ByteBuffer> sScan(ByteBuffer key, ScanOptions options) {
		...
		return sScan(Mono.just(ReactiveRedisConnection.KeyScanCommand.key(key).withOptions(options))).map(ReactiveRedisConnection.CommandResponse::getOutput)
				.flatMap(it -> it);
	}
	 ...
	 * @since 2.1
	 */
	Flux<ReactiveRedisConnection.CommandResponse<ReactiveRedisConnection.KeyCommand, Flux<ByteBuffer>>> sScan(Publisher<ReactiveRedisConnection.KeyScanCommand> commands);
	 ...
	 */
	class SRandMembersCommand extends ReactiveRedisConnection.KeyCommand {
	...
	default Flux<ByteBuffer> sRandMember(ByteBuffer key, Long count) {
		...
		return sRandMember(Mono.just(SRandMembersCommand.valueCount(count).from(key))).flatMap(ReactiveRedisConnection.CommandResponse::getOutput);
	}
	 ...
	 * @see <a href="https://redis.io/commands/srandmember">Redis Documentation: SRANDMEMBER</a>
	 */
	Flux<ReactiveRedisConnection.CommandResponse<SRandMembersCommand, Flux<ByteBuffer>>> sRandMember(Publisher<SRandMembersCommand> commands);
}
