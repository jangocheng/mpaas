...
import ghost.framework.data.redis.connection.BitFieldSubCommands;
import ghost.framework.data.redis.connection.ReactiveStringCommands;
import ghost.framework.data.redis.connection.RedisStringCommands;
...
class DefaultReactiveValueOperations<K, V> implements ReactiveValueOperations<K, V> {
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#set(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#set(java.lang.Object, java.lang.Object, long, java.util.concurrent.TimeUnit)
	 */
	@Override
	public Mono<Boolean> set(K key, V value, Duration timeout) {
		...
		return createMono(
				connection -> connection.set(rawKey(key), rawValue(value), Expiration.from(timeout), RedisStringCommands.SetOption.UPSERT));
	}

	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#setIfAbsent(java.lang.Object, java.lang.Object)
	 */
	@Override
	public Mono<Boolean> setIfAbsent(K key, V value) {
		...
		return createMono(
				connection -> connection.set(rawKey(key), rawValue(value), Expiration.persistent(), RedisStringCommands.SetOption.SET_IF_ABSENT));
	}

	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#setIfAbsent(java.lang.Object, java.lang.Object, java.time.Duration)
	 */
	@Override
	public Mono<Boolean> setIfAbsent(K key, V value, Duration timeout) {
		...
		return createMono(
				connection -> connection.set(rawKey(key), rawValue(value), Expiration.from(timeout), RedisStringCommands.SetOption.SET_IF_ABSENT));
	}

	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#setIfPresent(java.lang.Object, java.lang.Object)
	 */
	@Override
	public Mono<Boolean> setIfPresent(K key, V value) {
		...
		return createMono(
				connection -> connection.set(rawKey(key), rawValue(value), Expiration.persistent(), RedisStringCommands.SetOption.SET_IF_PRESENT));
	}

	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#setIfPresent(java.lang.Object, java.lang.Object, java.time.Duration)
	 */
	@Override
	public Mono<Boolean> setIfPresent(K key, V value, Duration timeout) {
		...
		return createMono(
				connection -> connection.set(rawKey(key), rawValue(value), Expiration.from(timeout), RedisStringCommands.SetOption.SET_IF_PRESENT));
	}
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#multiSet(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#multiSetIfAbsent(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#get(java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#getAndSet(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#multiGet(java.util.Collection)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#increment(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#increment(java.lang.Object, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#increment(java.lang.Object, double)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#decrement(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#decrement(java.lang.Object, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#append(java.lang.Object, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#get(java.lang.Object, long, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#set(java.lang.Object, java.lang.Object, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#size(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#setBit(java.lang.Object, long, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#getBit(java.lang.Object, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#bitField(java.lang.Object, ghost.framework.data.redis.connection.BitFieldSubCommands)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveValueOperations#delete(java.lang.Object)
	 */
	@Override
