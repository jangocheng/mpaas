...
class DefaultBoundStreamOperations<K, HK, HV> extends DefaultBoundKeyOperations<K>
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundStreamOperations#acknowledge(java.lang.String, java.lang.String[])
	 */
	@Nullable
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundStreamOperations#add(java.util.Map)
	 */
	@Nullable
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundStreamOperations#delete(java.lang.String[])
	 */
	@Nullable
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundStreamOperations#createGroup(ghost.framework.data.redis.connection.RedisStreamCommands.ReadOffset, java.lang.String)
	 */
	@Nullable
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundStreamOperations#deleteConsumer(ghost.framework.data.redis.connection.RedisStreamCommands.Consumer)
	 */
	@Nullable
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundStreamOperations#destroyGroup(java.lang.String)
	 */
	@Nullable
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundStreamOperations#size()
	 */
	@Nullable
	@Override
	public Long size() {
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundStreamOperations#range(ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Nullable
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundStreamOperations#read(ghost.framework.data.redis.connection.RedisStreamCommands.StreamReadOptions, ghost.framework.data.redis.connection.RedisStreamCommands.ReadOffset)
	 */
	@Nullable
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundStreamOperations#read(ghost.framework.data.redis.connection.RedisStreamCommands.Consumer, ghost.framework.data.redis.connection.RedisStreamCommands.StreamReadOptions, ghost.framework.data.redis.connection.RedisStreamCommands.ReadOffset)
	 */
	@Nullable
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundStreamOperations#reverseRange(ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Nullable
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundStreamOperations#trim(long)
	 */
	@Nullable
	@Override
