 ...
 */
package ghost.framework.data.redis.util;

import ghost.framework.beans.annotation.constraints.Nullable;
import ghost.framework.data.redis.connection.MessageListener;
import ghost.framework.data.redis.connection.RedisInvalidSubscriptionException;
import ghost.framework.data.redis.connection.Subscription;
...
public abstract class AbstractSubscription implements Subscription {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.Subscription#close()
	 */
	@Override
	public void close() {
		doClose();
