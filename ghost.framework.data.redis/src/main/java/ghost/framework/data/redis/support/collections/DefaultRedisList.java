...
import ghost.framework.data.redis.core.BoundListOperations;
...
public class DefaultRedisList<E> extends AbstractRedisCollection<E> implements RedisList<E> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisList#range(long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisList#trim(int, int)
	 */
	@Override
