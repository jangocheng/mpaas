 ...
 */
package ghost.framework.data.redis.core.script;
...
import ghost.framework.data.redis.connection.RedisSystemException;
import ghost.framework.data.redis.connection.ReturnType;
import ghost.framework.data.redis.core.ReactiveRedisCallback;
...
public class DefaultReactiveScriptExecutor<K> implements ReactiveScriptExecutor<K> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.script.ReactiveScriptExecutor#execute(ghost.framework.data.redis.core.script.RedisScript, java.util.List, java.util.List)
	 */
	@Override
	...
	public <T> Flux<T> execute(RedisScript<T> script, List<K> keys, List<?> args) {
		...
		RedisSerializationContext.SerializationPair<?> serializationPair = serializationContext.getValueSerializationPair();
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.script.ReactiveScriptExecutor#execute(ghost.framework.data.redis.core.script.RedisScript, java.util.List, java.util.List, ghost.framework.data.redis.serializer.RedisElementWriter, ghost.framework.data.redis.serializer.RedisElementReader)
	 */
	@Override
	@SuppressWarnings("unchecked")
