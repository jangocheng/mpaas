...
public interface DefaultedRedisConnection extends RedisConnection {
	...
	@Override
	@Deprecated
	default Long bitPos(byte[] key, boolean bit, ghost.framework.data.domain.Range<Long> range) {
	...
	@Override
	@Deprecated
	default StreamInfo.XInfoStream xInfo(byte[] key) {
	...
	@Override
	@Deprecated
	default StreamInfo.XInfoGroups xInfoGroups(byte[] key) {
	...
	@Override
	@Deprecated
	default StreamInfo.XInfoConsumers xInfoConsumers(byte[] key, String groupName) {
	...
	@Override
	@Deprecated
	default List<ByteRecord> xRange(byte[] key, ghost.framework.data.domain.Range<String> range) {
	...
	@Override
	@Deprecated
	default List<ByteRecord> xRange(byte[] key, ghost.framework.data.domain.Range<String> range, Limit limit) {
	...
	@Override
	@Deprecated
	default List<ByteRecord> xRevRange(byte[] key, ghost.framework.data.domain.Range<String> range) {
	...
	@Override
	@Deprecated
	default List<ByteRecord> xRevRange(byte[] key, ghost.framework.data.domain.Range<String> range, Limit limit) {
