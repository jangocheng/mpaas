...
class DefaultRedisSerializationContext<K, V> implements RedisSerializationContext<K, V> {
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.serializer.RedisSerializationContext#getKeySerializationPair()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.serializer.RedisSerializationContext#getValueSerializationPair()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.serializer.RedisSerializationContext#getHashKeySerializationPair()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.serializer.RedisSerializationContext#getHashValueSerializationPair()
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.serializer.RedisSerializationContext#getStringSerializationPair()
	 */
	@Override
	...
	static class DefaultRedisSerializationContextBuilder<K, V> implements RedisSerializationContextBuilder<K, V> {
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.redis.serializer.RedisSerializationContextBuilder#key(SerializationPair)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.redis.serializer.RedisSerializationContextBuilder#value(SerializationPair)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.redis.serializer.RedisSerializationContextBuilder#hashKey(SerializationPair)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.redis.serializer.RedisSerializationContextBuilder#hashValue(SerializationPair)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.redis.serializer.RedisSerializationContextBuilder#string(SerializationPair)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.redis.serializer.RedisSerializationContextBuilder#build()
		 */
		@Override
