...
public interface BoundZSetOperations<K, V> extends BoundKeyOperations<K> {
	 ...
	 */
	@Nullable
	Long unionAndStore(Collection<K> otherKeys, K destKey, RedisZSetCommands.Aggregate aggregate);
	 ...
	 */
	@Nullable
	Long unionAndStore(Collection<K> otherKeys, K destKey, RedisZSetCommands.Aggregate aggregate, RedisZSetCommands.Weights weights);
	 ...
	 */
	@Nullable
	Long intersectAndStore(Collection<K> otherKeys, K destKey, RedisZSetCommands.Aggregate aggregate);
	 ...
	 */
	@Nullable
	Long intersectAndStore(Collection<K> otherKeys, K destKey, RedisZSetCommands.Aggregate aggregate, RedisZSetCommands.Weights weights);
	 ...
	 */
	@Nullable
	Set<V> rangeByLex(Range range, RedisZSetCommands.Limit limit);
