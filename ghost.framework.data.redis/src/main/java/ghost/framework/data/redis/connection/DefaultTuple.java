...
/**
 * Default implementation for {@link RedisZSetCommands.Tuple} interface.
 *
 * @author Costin Leau
...
public class DefaultTuple implements RedisZSetCommands.Tuple {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands.Tuple#getScore()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisZSetCommands.Tuple#getValue()
	 */
