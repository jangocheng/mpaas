 ...
 */
package ghost.framework.data.redis.connection.core;
...
public abstract class ScanCursor<T> implements Cursor<T> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.Cursor#getCursorId()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.Cursor#isClosed()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.Cursor#getPosition()
	 */
	@Override
