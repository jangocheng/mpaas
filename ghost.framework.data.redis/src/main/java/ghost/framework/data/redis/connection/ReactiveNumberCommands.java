...
public interface ReactiveNumberCommands {
	...
	default Mono<Long> incr(ByteBuffer key) {
		...
		return incr(Mono.just(new ReactiveRedisConnection.KeyCommand(key))).next().map(ReactiveRedisConnection.NumericResponse::getOutput);
	}
	 ...
	 * @see <a href="https://redis.io/commands/incr">Redis Documentation: INCR</a>
	 */
	Flux<ReactiveRedisConnection.NumericResponse<ReactiveRedisConnection.KeyCommand, Long>> incr(Publisher<ReactiveRedisConnection.KeyCommand> keys);
	 ...
	 */
	class IncrByCommand<T extends Number> extends ReactiveRedisConnection.KeyCommand {
	...
	default <T extends Number> Mono<T> incrBy(ByteBuffer key, T value) {
		...
		return incrBy(Mono.just(IncrByCommand.<T> incr(key).by(value))).next().map(ReactiveRedisConnection.NumericResponse::getOutput);
	}
	 ...
	 * @see <a href="https://redis.io/commands/incrbyfloat">Redis Documentation: INCRBYFLOAT</a>
	 */
	<T extends Number> Flux<ReactiveRedisConnection.NumericResponse<IncrByCommand<T>, T>> incrBy(
	 ...
	 */
	class DecrByCommand<T extends Number> extends ReactiveRedisConnection.KeyCommand {
	...
	default Mono<Long> decr(ByteBuffer key) {
		...
		return decr(Mono.just(new ReactiveRedisConnection.KeyCommand(key))).next().map(ReactiveRedisConnection.NumericResponse::getOutput);
	}
	 ...
	 * @see <a href="https://redis.io/commands/decr">Redis Documentation: DECR</a>
	 */
	Flux<ReactiveRedisConnection.NumericResponse<ReactiveRedisConnection.KeyCommand, Long>> decr(Publisher<ReactiveRedisConnection.KeyCommand> keys);
	...
	default <T extends Number> Mono<T> decrBy(ByteBuffer key, T value) {
		...
		return decrBy(Mono.just(DecrByCommand.<T> decr(key).by(value))).next().map(ReactiveRedisConnection.NumericResponse::getOutput);
	}
	 ...
	 * @return
	 */
	<T extends Number> Flux<ReactiveRedisConnection.NumericResponse<DecrByCommand<T>, T>> decrBy(Publisher<DecrByCommand<T>> commands);
	 ...
	 */
	class HIncrByCommand<T extends Number> extends ReactiveRedisConnection.KeyCommand {
	 ...
	 * @see <a href="https://redis.io/commands/hincrby">Redis Documentation: HINCRBY</a>
	 */
	<T extends Number> Flux<ReactiveRedisConnection.NumericResponse<HIncrByCommand<T>, T>> hIncrBy(Publisher<HIncrByCommand<T>> commands);
