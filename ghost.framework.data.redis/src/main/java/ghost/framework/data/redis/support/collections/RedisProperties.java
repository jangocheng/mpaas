...
import ghost.framework.data.redis.core.BoundHashOperations;
 ...
 * {@link ghost.framework.beans.factory.config.PropertiesFactoryBean}.
 * <p/>
 * Note that this implementation only accepts Strings - objects of other type are not supported.
 *
 * @see Properties
 * @see ghost.framework.core.io.support.PropertiesLoaderSupport
 * @author Costin Leau
 */
public class RedisProperties extends Properties implements RedisMap<Object, Object> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisMap#increment(java.lang.Object, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisMap#increment(java.lang.Object, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisStore#getOperations()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundKeyOperations#expire(long, java.util.concurrent.TimeUnit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundKeyOperations#expireAt(java.util.Date)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundKeyOperations#getExpire()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundKeyOperations#getKey()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundKeyOperations#persist()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundKeyOperations#rename(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisMap#scan()
	 */
	@Override
	public Iterator<Entry<Object, Object>> scan() {
		throw new UnsupportedOperationException();
	}
}
