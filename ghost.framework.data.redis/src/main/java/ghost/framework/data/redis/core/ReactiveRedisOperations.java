 ...
 * @since 2.0
 */
public interface ReactiveRedisOperations<K, V> extends Operations {
	...
	/**
	 * Subscribe to the given Redis {@code channels} and emit {@link ReactiveSubscription.Message messages} received for those.
	 *
	 * @param channels must not be {@literal null}.
	 * @return a hot sequence of {@link ReactiveSubscription.Message messages}.
	 * @since 2.1
	 */
	default Flux<? extends ReactiveSubscription.Message<String, V>> listenToChannel(String... channels) {
	...
	/**
	 * Subscribe to the Redis channels matching the given {@code pattern} and emit {@link ReactiveSubscription.Message messages} received for
	 * those.
	 *
	 ...
	 * @since 2.1
	 */
	default Flux<? extends ReactiveSubscription.Message<String, V>> listenToPattern(String... patterns) {
	...
	/**
	 * Subscribe to the Redis channels for the given {@link Topic topics} and emit {@link ReactiveSubscription.Message messages} received for
	 * those.
	 *
	 ...
	 * @since 2.1
	 */
	Flux<? extends ReactiveSubscription.Message<String, V>> listenTo(Topic... topics);
