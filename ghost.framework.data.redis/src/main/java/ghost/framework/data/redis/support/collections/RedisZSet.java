...
public interface RedisZSet<E> extends RedisCollection<E>, Set<E> {
	...
	/**
	 * Get all elements with lexicographical ordering with a value between {@link RedisZSetCommands.Range#getMin()} and
	 * {@link RedisZSetCommands.Range#getMax()}.
	 *
	 * @param range must not be {@literal null}.
	 * @return
	 * @see BoundZSetOperations#rangeByLex(RedisZSetCommands.Range)
	 * @since 1.7
	 */
	 ...
	 * {@link RedisZSetCommands.Limit#getOffset()} with lexicographical ordering having a value between {@link RedisZSetCommands.Range#getMin()} and
	 * {@link RedisZSetCommands.Range#getMax()}.
	 *
	 * @param range must not be {@literal null}.
	 * @param limit can be {@literal null}.
	 * @return
	 * @see BoundZSetOperations#rangeByLex(RedisZSetCommands.Range, RedisZSetCommands.Limit)
	 * @since 1.7
	 */
