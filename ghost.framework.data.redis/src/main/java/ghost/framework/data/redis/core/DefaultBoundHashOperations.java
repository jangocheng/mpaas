...
class DefaultBoundHashOperations<H, HK, HV> extends DefaultBoundKeyOperations<H>
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#delete(java.lang.Object[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#get(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#multiGet(java.util.Collection)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#getOperations()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#hasKey(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#increment(java.lang.Object, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#increment(java.lang.Object, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#keys()
	 */
	@Override
	public Set<HK> keys() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#lengthOfValue(java.lang.Object, java.lang.Object)
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#size()
	 */
	@Override
	public Long size() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#putAll(java.util.Map)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#put(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#putIfAbsent(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#values()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#entries()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.BoundHashOperations#scan(ghost.framework.data.redis.core.ScanOptions)
	 */
	@Override
