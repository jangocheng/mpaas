...
import ghost.framework.data.redis.core.BoundSetOperations;
...
public class DefaultRedisSet<E> extends AbstractRedisCollection<E> implements RedisSet<E> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#diff(ghost.framework.data.redis.support.collections.RedisSet)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#diff(java.util.Collection)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#diffAndStore(ghost.framework.data.redis.support.collections.RedisSet, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#diffAndStore(java.util.Collection, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#intersect(ghost.framework.data.redis.support.collections.RedisSet)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#intersect(java.util.Collection)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#intersectAndStore(ghost.framework.data.redis.support.collections.RedisSet, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#intersectAndStore(java.util.Collection, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#union(ghost.framework.data.redis.support.collections.RedisSet)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#union(java.util.Collection)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#unionAndStore(ghost.framework.data.redis.support.collections.RedisSet, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#unionAndStore(java.util.Collection, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#scan()
	 */
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisSet#scan()
