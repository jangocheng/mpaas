 ...
 * @since 2.2
 */
public interface BoundStreamOperations<K, HK, HV> extends Operations{
	...
	default List<MapRecord<K, HK, HV>> range(Range<String> range) {
		return range(range, RedisZSetCommands.Limit.unlimited());
	}
	 ...
	 */
	@Nullable
	List<MapRecord<K, HK, HV>> range(Range<String> range, RedisZSetCommands.Limit limit);
	...
	default List<MapRecord<K, HK, HV>> reverseRange(Range<String> range) {
		return reverseRange(range, RedisZSetCommands.Limit.unlimited());
	}
	 ...
	 */
	@Nullable
	List<MapRecord<K, HK, HV>> reverseRange(Range<String> range, RedisZSetCommands.Limit limit);
