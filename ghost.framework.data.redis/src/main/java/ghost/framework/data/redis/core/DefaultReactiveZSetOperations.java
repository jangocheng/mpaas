...
import ghost.framework.data.redis.connection.DefaultTuple;
import ghost.framework.data.redis.connection.ReactiveZSetCommands;
...
class DefaultReactiveZSetOperations<K, V> implements ReactiveZSetOperations<K, V> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#add(java.lang.Object, java.lang.Object, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#add(java.lang.Object, java.util.Collection)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#remove(java.lang.Object, java.lang.Object[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#incrementScore(java.lang.Object, java.lang.Object, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#rank(java.lang.Object, java.lang.Object)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#reverseRank(java.lang.Object, java.lang.Object)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#range(java.lang.Object, ghost.framework.data.domain.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#rangeWithScores(java.lang.Object, ghost.framework.data.domain.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#rangeByScore(java.lang.Object, ghost.framework.data.domain.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#rangeByScoreWithScores(java.lang.Object, ghost.framework.data.domain.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#rangeByScore(java.lang.Object, ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#rangeByScoreWithScores(java.lang.Object, ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#reverseRange(java.lang.Object, ghost.framework.data.domain.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#reverseRangeWithScores(java.lang.Object, ghost.framework.data.domain.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#reverseRangeByScore(java.lang.Object, ghost.framework.data.domain.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#reverseRangeByScoreWithScores(java.lang.Object, ghost.framework.data.domain.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#reverseRangeByScore(java.lang.Object, ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#reverseRangeByScoreWithScores(java.lang.Object, ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#scan(java.lang.Object, ghost.framework.data.redis.core.ScanOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#count(java.lang.Object, ghost.framework.data.domain.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#size(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#score(java.lang.Object, java.lang.Object)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#removeRange(java.lang.Object, ghost.framework.data.domain.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#removeRangeByScore(java.lang.Object, ghost.framework.data.domain.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#unionAndStore(java.lang.Object, java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#unionAndStore(java.lang.Object, java.util.Collection, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#unionAndStore(java.lang.Object, java.util.Collection, java.lang.Object, ghost.framework.data.redis.connection.RedisZSetCommands.Aggregate, ghost.framework.data.redis.connection.RedisZSetCommands.Weights)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#intersectAndStore(java.lang.Object, java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#intersectAndStore(java.lang.Object, java.util.Collection, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#intersectAndStore(java.lang.Object, java.util.Collection, java.lang.Object, ghost.framework.data.redis.connection.RedisZSetCommands.Aggregate, ghost.framework.data.redis.connection.RedisZSetCommands.Weights)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#rangeByLex(java.lang.Object, ghost.framework.data.domain.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#rangeByLex(java.lang.Object, ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#reverseRangeByLex(java.lang.Object, ghost.framework.data.domain.Range)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#reverseRangeByLex(java.lang.Object, ghost.framework.data.domain.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.core.ReactiveZSetOperations#delete(java.lang.Object)
	 */
	@Override
