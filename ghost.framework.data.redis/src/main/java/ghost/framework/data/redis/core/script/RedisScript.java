...
public interface RedisScript<T> {
	...
	/**
	 * Creates new {@link RedisScript} (with throw away result) from the given {@link IResource}.
	 *
	 ...
	 * @since 2.2
	 */
	static <T> RedisScript<T> of(IResource resource) {
	...
	/**
	 * Creates new {@link RedisScript} from {@link IResource}.
	 *
	 * @param resource must not be {@literal null}.
	 * @param resultType must not be {@literal null}.
	 * @return new instance of {@link RedisScript}.
	 ...
	 * @since 2.2
	 */
	static <T> RedisScript<T> of(IResource resource, Class<T> resultType) {
