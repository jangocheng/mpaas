...
public class RedisClusterNode extends RedisNode {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisNode#toString()
	 */
	@Override
	...
	public static class RedisClusterNodeBuilder extends RedisNodeBuilder {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.RedisNode.RedisNodeBuilder#listeningAt(java.lang.String, int)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.RedisNode.RedisNodeBuilder#withName(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.RedisNode.RedisNodeBuilder#withId(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.RedisNode.RedisNodeBuilder#promotedAs(ghost.framework.data.redis.connection.RedisNode.NodeType)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.RedisNode.RedisNodeBuilder#slaveOf(java.lang.String)
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.RedisNode.RedisNodeBuilder#replicaOf(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.RedisNode.RedisNodeBuilder#build()
		 */
		@Override
