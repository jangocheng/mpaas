...
import ghost.framework.data.redis.core.BoundZSetOperations;
import ghost.framework.data.redis.core.ConvertingCursor;
import ghost.framework.data.redis.core.RedisOperations;
import ghost.framework.data.redis.core.ZSetOperations;
...
public class DefaultRedisZSet<E> extends AbstractRedisCollection<E> implements RedisZSet<E> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#intersectAndStore(ghost.framework.data.redis.support.collections.RedisZSet, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#intersectAndStore(java.util.Collection, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#range(long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#reverseRange(long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#rangeByLex(ghost.framework.data.redis.connection.RedisZSetCommands.Range)
	 */
//	@Override
	public Set<E> rangeByLex(ghost.framework.data.domain.Range range) {
		return boundZSetOps.rangeByLex(range);
	}

	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#rangeByLex(ghost.framework.data.redis.connection.RedisZSetCommands.Range, ghost.framework.data.redis.connection.RedisZSetCommands.Limit)
	 */
//	@Override
	public Set<E> rangeByLex(ghost.framework.data.domain.Range range, RedisZSetCommands.Limit limit) {
		return boundZSetOps.rangeByLex(range, limit);
	}

	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#rangeByScore(double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#reverseRangeByScore(double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#rangeByScoreWithScores(double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#rangeWithScores(long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#reverseRangeByScoreWithScores(double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#reverseRangeWithScores(long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#remove(long, long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#removeByScore(double, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#unionAndStore(ghost.framework.data.redis.support.collections.RedisZSet, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#unionAndStore(java.util.Collection, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#add(java.lang.Object, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#getDefaultScore()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#first()
	 */
	@Override
	public E first() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#last()
	 */
	@Override
	public E last() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#rank(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#reverseRank(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#score(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.support.collections.RedisZSet#scan()
	 */
	@Override
	public Cursor<E> scan() {
		return new ConvertingCursor<>(scan(ScanOptions.NONE), ZSetOperations.TypedTuple::getValue);
	}
	/**
	 * @since 1.4
	 * @param options
