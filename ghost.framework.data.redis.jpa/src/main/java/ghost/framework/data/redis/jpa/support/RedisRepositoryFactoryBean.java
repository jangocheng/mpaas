...
public class RedisRepositoryFactoryBean<T extends Repository<S, ID>, S, ID>
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.repository.support.KeyValueRepositoryFactoryBean#createRepositoryFactory(ghost.framework.data.keyvalue.core.KeyValueOperations, java.lang.Class, java.lang.Class)
	 */
	@Override
