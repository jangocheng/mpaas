...
import ghost.framework.data.redis.core.convert.IndexResolver;
import ghost.framework.data.redis.core.convert.IndexedData;
...
import ghost.framework.data.domain.ExampleMatcher.MatchMode;
import ghost.framework.data.domain.ExampleMatcher.PropertyValueTransformer;
import ghost.framework.data.domain.ExampleMatcher.StringMatcher;
