...
package ghost.framework.web.module.http.converter.smile;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.smile.SmileFactory;
import ghost.framework.util.Assert;
import ghost.framework.web.context.http.MediaType;
import ghost.framework.web.module.http.converter.json.AbstractJackson2HttpMessageConverter;
import ghost.framework.web.module.http.converter.json.Jackson2ObjectMapperBuilder;

/**
 * Implementation of {@link ghost.framework.http.converter.HttpMessageConverter HttpMessageConverter}
