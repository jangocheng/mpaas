...
import ghost.framework.web.context.http.request.ServletWebRequest;
import ghost.framework.web.module.servlet.support.RequestContextUtils;
 ...
 * {@link ghost.framework.web.servlet.DispatcherServlet}'s
 * request context, such as the Locale determined by the configured
 * {@link ghost.framework.web.servlet.LocaleResolver}.
 *
 * @author Juergen Hoeller
 * @since 2.0
 * @see #getLocale()
 * @see ghost.framework.web.servlet.LocaleResolver
 */
