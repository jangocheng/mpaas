 ...
 *
 * <pre class="code">
 * &lt;bean class="ghost.framework.http.converter.ObjectToStringHttpMessageConverter">
 *   &lt;constructor-arg>
 *     &lt;bean class="ghost.framework.context.support.ConversionServiceFactoryBean"/>
 *   &lt;/constructor-arg>
 * &lt;/bean>
 * </pre>
 *
...
public class ObjectToStringHttpMessageConverter extends AbstractHttpMessageConverter<Object> {
	 ...
	 */
	public ObjectToStringHttpMessageConverter(Object conversionService) {
	 ...
	 */
	public ObjectToStringHttpMessageConverter(Object conversionService, Charset defaultCharset) {
	...
	protected Object readInternal(Class<?> clazz, HttpInputMessage inputMessage)
		...
		Object result = null;//this.conversionService.convert(value, clazz);
		if (result == null) {
	...
	protected void writeInternal(Object obj, HttpOutputMessage outputMessage) throws IOException {
		String value = null;//this.conversionService.convert(obj, String.class);
		if (value != null) {
