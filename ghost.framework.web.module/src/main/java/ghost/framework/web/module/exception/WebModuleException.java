...
public class WebModuleException extends ModuleException {
    private static final long serialVersionUID = 6128247667210485307L;
     ...
     * @since  1.4
     */
    public WebModuleException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected WebModuleException(String message, Throwable cause,
