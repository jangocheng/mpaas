...
import ghost.framework.web.module.EscapedErrors;
...
import ghost.framework.web.module.servlet.WebApplicationContext;
import ghost.framework.web.module.servlet.locale.LocaleContext;
import ghost.framework.web.module.servlet.locale.SimpleTimeZoneLocaleContext;
import ghost.framework.web.module.servlet.locale.LocaleTimeZoneContext;
import ghost.framework.web.module.util.UriTemplate;
import ghost.framework.web.context.utils.UrlPathHelper;
import ghost.framework.web.context.utils.WebUtils;
import ghost.framework.web.module.validation.BindException;
import ghost.framework.web.module.validation.BindingResult;
import ghost.framework.web.module.validation.Errors;
 ...
 *
 * <p>Can be instantiated manually, or automatically exposed to views as entity attribute via AbstractView's
 ...
 * @see ghost.framework.web.servlet.view.AbstractView#setRequestContextAttribute
 * @see ghost.framework.web.servlet.view.UrlBasedViewResolver#setRequestContextAttribute
 */
public class RequestContext {
	 ...
	 * @see ghost.framework.web.servlet.theme.AbstractThemeResolver#ORIGINAL_DEFAULT_THEME_NAME
	 */
	...
	protected static final boolean jstlPresent = false;//ClassUtils.isPresent("javax.servlet.jsp.jstl.core.Config", RequestContext.class.getClassLoader());
...
//	private RequestDataValueProcessor requestDataValueProcessor;
	 ...
	 * <p>This only works with InternalResourceViews, as Errors instances are part of the entity and not
	 ...
	 * @see ghost.framework.web.context.WebApplicationContext
	 * @see ghost.framework.web.servlet.DispatcherServlet
	 */
	...
	/**
	 * Create a new RequestContext for the given request, using the given entity attributes for Errors retrieval.
	 * <p>This works with all View implementations. It will typically be used by View implementations.
	 * <p><b>Will only work within a DispatcherServlet request.</b>
	 * Pass in a ServletContext to be able to fallback to the root WebApplicationContext.
	 * @param request current HTTP request
	 * @param model the entity attributes for the current view (can be {@code null},
	 ...
	 * @param model the entity attributes for the current view (can be {@code null}, using the request attributes
...
//	}
	...
	/**
	 * Return the entity Map that this RequestContext encapsulates, if any.
	 * @return the populated entity Map, or {@code null} if none available
	 */
	@Nullable
	 ...
	 * @see ghost.framework.context.i18n.SimpleTimeZoneAwareLocaleContext
	 */
	public void changeLocale(Locale locale, TimeZone timeZone) {
		...
		((LocaleContextResolver) localeResolver).setLocaleContext(this.request, this.response,
				new SimpleTimeZoneLocaleContext(locale, timeZone));
		this.locale = locale;
		this.timeZone = timeZone;
	}
//
...
//	}
	 ...
	 * @see ghost.framework.web.util.WebUtils#getDefaultHtmlEscape
	 */
...
//	}
	 ...
	 * <p>Delegates to the UrlPathHelper for decoding.
	 * @see #getQueryString
	 * @see ghost.framework.web.util.UrlPathHelper#getOriginatingRequestUri
	 * @see #getUrlPathHelper
	 */
	 ...
	 * <p>Delegates to the UrlPathHelper for decoding.
	 * @see #getRequestUri
	 * @see ghost.framework.web.util.UrlPathHelper#getOriginatingQueryString
	 * @see #getUrlPathHelper
	 */
...
//	 * @param code code of the message
//	 * @return the message
//	 * @throws ghost.framework.context.NoSuchMessageException if not found
//	 */
...
//	}
	...
	/**
	 * Retrieve the entity object for the given entity name, either from the entity
	 * or from the request attributes.
	 * @param modelName the name of the entity object
	...
	private static class JstlLocaleResolver {
		...
		public static Locale getJstlLocale(HttpServletRequest request, @Nullable ServletContext servletContext) {
			Object localeObject = null;//Config.get(request, Config.FMT_LOCALE);
...
//			}
		...
		public static TimeZone getJstlTimeZone(HttpServletRequest request, @Nullable ServletContext servletContext) {
			Object timeZoneObject = null;//Config.get(request, Config.FMT_TIME_ZONE);
