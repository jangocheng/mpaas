...
import ghost.framework.web.context.utils.UriComponents;
 ...
 * set by the {@link ghost.framework.web.servlet.DispatcherServlet}.
 *
...
//		}
	 ...
	 * <p>Consider using {@link ghost.framework.context.i18n.LocaleContextHolder#getLocale()}
	 ...
	 * @see ghost.framework.context.i18n.LocaleContextHolder#getLocale()
	 */
	 ...
	 * <p>Consider using {@link ghost.framework.context.i18n.LocaleContextHolder#getTimeZone()}
	 ...
	 * @see #getLocaleResolver
	 * @see ghost.framework.context.i18n.LocaleContextHolder#getTimeZone()
	 */
	@Nullable
	public static TimeZone getTimeZone(HttpServletRequest request) {
		...
		if (localeResolver instanceof LocaleContextResolver) {
			...
			if (localeContext instanceof LocaleTimeZoneContext) {
				return ((LocaleTimeZoneContext) localeContext).getTimeZone();
			}
		}
		return null;
	}
