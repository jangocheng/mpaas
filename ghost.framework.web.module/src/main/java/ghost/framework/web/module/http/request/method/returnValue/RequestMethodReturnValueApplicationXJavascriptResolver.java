 ...
 * @Description: {@link MediaType#APPLICATION_X_JAVASCRIPT_VALUE}格式解析器
 * @Date: 2020/3/14:11:30
 */
@HandlerMethodReturnValueResolver
public class RequestMethodReturnValueApplicationXJavascriptResolver
    ...
    private final String[] produces = new String[]{
            MediaType.APPLICATION_X_JAVASCRIPT_VALUE,
    };
    ...
    public void handleReturnValue(@NotNull HttpServletRequest request, @NotNull HttpServletResponse response,
        ...
        response.setContentType(MediaType.APPLICATION_X_JAVASCRIPT_VALUE + WebUtils.CONTENT_TYPE_CHARSET_PREFIX + response.getCharacterEncoding());
        try {
            //设置默认返回值解析格式
