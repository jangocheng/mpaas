...
package ghost.framework.web.module.validation;
 ...
 * binding-specific analysis and entity building.
 *
...
public interface BindingResult extends Errors {
	...
	/**
	 * Prefix for the name of the BindingResult instance in a entity,
	...
	/**
	 * Return a entity Map for the obtained state, exposing a BindingResult
	 ...
	 * <p>The attributes in the entity Map returned by this method are usually
	 * included in the {@link ghost.framework.web.servlet.ModelAndView}
	 ...
	 * the attributes from the entity Map returned by this method.
	 * @see #getObjectName()
	 * @see #MODEL_KEY_PREFIX
	 * @see ghost.framework.web.servlet.ModelAndView
	 * @see ghost.framework.web.servlet.tags.BindTag
	 */
