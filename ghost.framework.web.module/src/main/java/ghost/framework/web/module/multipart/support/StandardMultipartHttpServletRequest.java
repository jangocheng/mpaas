...
import ghost.framework.web.context.http.ContentDisposition;
import ghost.framework.web.context.http.HttpHeaders;
import ghost.framework.web.module.exception.WebHttpException;
...
public class StandardMultipartHttpServletRequest extends AbstractMultipartHttpServletRequest {
	...
	private static class StandardMultipartFile implements MultipartFile, Serializable {
		...
		@Override
		public void transferTo(Path dest) throws IllegalStateException {
			try {
