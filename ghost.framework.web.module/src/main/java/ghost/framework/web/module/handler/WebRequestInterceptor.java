...
import ghost.framework.web.context.http.request.WebRequest;
 ...
 * exposes a set of entity objects, then a view gets rendered based on that entity.
 ...
 * proceed with rendering the entity and all methods of this contract are invoked
 * again. For further options and comments see
 * {@code ghost.framework.web.context.request.async.AsyncWebRequestInterceptor}
 *
 ...
 * @see ghost.framework.web.servlet.handler.AbstractHandlerMapping#setInterceptors
...
public interface WebRequestInterceptor {
	 ...
	 * @param request the current web request
	 * @param model the map of entity objects that will be exposed to the view
	 * (may be {@code null}). Can be used to analyze the exposed entity
	 * and/or to add further entity attributes, if desired.
	 * @throws Exception in case of errors
	 */
	void postHandle(WebRequest request, @Nullable Object model) throws Exception;
