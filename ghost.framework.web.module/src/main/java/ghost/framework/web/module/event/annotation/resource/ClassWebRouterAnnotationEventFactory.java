...
//public class ClassWebRouterAnnotationEventFactory
//        <
...
//     * @param app 设置应用接口
//     */
//    public ClassWebRouterAnnotationEventFactory(@Autowired IApplication app) {
//        this.app = app;
//    }
//
//    /**
...
//     * 注释类型
//     */
//    private final Class<? extends Annotation> annotation = WebRouter.class;
//
//    /**
//     * 重写获取注释类型
//     *
...
//        //获取注入注释对象
//        WebRouter resource = this.getAnnotation(event);
//        //获取web路由容器接口
//        IWebRouterContainer routerContainer = this.module.getBean(IWebRouterContainer.class);
//
//        //获取web资源容器接口
////        IWebResourceContainer resourceContainer = this.module.getBean(IWebResourceContainer.class);
////        for (String path : resource.value()) {
////            if (path.startsWith("/")) {
////                resourceContainer.put(path, new WebResourceItem(resource, resource.getClass().getProtectionDomain().getCodeSource().getLocation(), path));
////            } else {
////                resourceContainer.put("/" + path, new WebResourceItem(resource, resource.getClass().getProtectionDomain().getCodeSource().getLocation(), "/" + path));
////            }
////        }
