 ...
 * @since 1.2
 * @see LocaleContext
 * @see ghost.framework.context.support.MessageSourceAccessor
...
public final class LocaleContextHolder {
	 ...
	 * <p>The given LocaleContext may be a {@link LocaleTimeZoneContext},
	 * containing a locale with associated time zone information.
	 * @param localeContext the current LocaleContext,
	 * or {@code null} to reset the thread-bound context
	 * @see SimpleLocaleContext
	 * @see SimpleTimeZoneLocaleContext
	 */
	...
	public static void setLocale(@Nullable Locale locale, boolean inheritable) {
		...
		TimeZone timeZone = (localeContext instanceof LocaleTimeZoneContext ? ((LocaleTimeZoneContext) localeContext).getTimeZone() : null);
		if (timeZone != null) {
			localeContext = new SimpleTimeZoneLocaleContext(locale, timeZone);
		}
		else if (locale != null) {
	 ...
	 * @see SimpleTimeZoneLocaleContext#SimpleTimeZoneLocaleContext(Locale, TimeZone)
	 */
	 ...
	 * {@link #getLocaleContext()} and call {@link LocaleTimeZoneContext#getTimeZone()}
	 * after downcasting to {@link LocaleTimeZoneContext}.
	 ...
	 * @see #getLocaleContext()
	 * @see LocaleTimeZoneContext#getTimeZone()
	...
	public static TimeZone getTimeZone(@Nullable LocaleContext localeContext) {
		if (localeContext instanceof LocaleTimeZoneContext) {
			TimeZone timeZone = ((LocaleTimeZoneContext) localeContext).getTimeZone();
			if (timeZone != null) {
				return timeZone;
			}
		}
