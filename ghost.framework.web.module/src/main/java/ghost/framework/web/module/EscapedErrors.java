...
import ghost.framework.web.module.validation.FieldError;
 ...
 * @since 01.03.2003
 * @see ghost.framework.web.servlet.support.RequestContext#getErrors
...
public class EscapedErrors implements Errors {
	...
	private <T extends ObjectError> T escapeObjectError(@Nullable T source) {
		...
		String defaultMessage = null;//source.getDefaultMessage();
