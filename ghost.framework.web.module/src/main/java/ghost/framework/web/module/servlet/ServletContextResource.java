...
//
///**
// * {@link ghost.framework.core.io.Resource} implementation for
...
//	 * @see ghost.framework.util.StringUtils#applyRelativePath(String, String)
//	 */
////	@Override
//	public Resource createRelative(String relativePath) {
//		String pathToUse = StringUtils.applyRelativePath(this.path, relativePath);
//		return null;//new ServletContextResource(this.servletContext, pathToUse);
//	}
//
//	/**
//	 * This implementation returns the name of the file that this ServletContext
//	 * resource refers to.
//	 * @see ghost.framework.util.StringUtils#getFilename(String)
//	 */
////	@Override
//	@Nullable
