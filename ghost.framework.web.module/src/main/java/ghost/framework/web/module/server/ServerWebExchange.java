...
//	 * {@link ghost.framework.web.server.i18n.LocaleContextResolver}.
//	 */
...
////	 * {@link ghost.framework.web.server.adapter.WebHttpHandlerBuilder#applicationContext(ApplicationContext)}.
////	 * @since 5.0.3
////	 * @see ghost.framework.web.server.adapter.WebHttpHandlerBuilder#applicationContext(ApplicationContext)
////	 */
////	@Nullable
...
//		 * @see ghost.framework.http.server.reactive.ServerHttpRequestDecorator
//		 */
//		Builder request(ServerHttpRequest request);
//
//		/**
//		 * Set the response to use.
//		 * @see ghost.framework.http.server.reactive.ServerHttpResponseDecorator
//		 */
