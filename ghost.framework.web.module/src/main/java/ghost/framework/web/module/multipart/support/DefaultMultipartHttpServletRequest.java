 ...
 * {@link ghost.framework.web.multipart.MultipartHttpServletRequest}
 * interface. Provides management of pre-generated parameter values.
 *
 * <p>Used by {@link ghost.framework.web.multipart.commons.CommonsMultipartResolver}.
 *
 * @author Trevor D. Cook
 * @author Juergen Hoeller
 * @author Arjen Poutsma
 * @since 29.09.2003
 * @see ghost.framework.web.multipart.MultipartResolver
 */
public class DefaultMultipartHttpServletRequest extends AbstractMultipartHttpServletRequest {
	...
	public DefaultMultipartHttpServletRequest(
		...
		//设置线程上下文内容
//		MultipartResolver.HttpMultipartContextHolder.set(mpFiles);
	}
