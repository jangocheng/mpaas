...
// *
// * <p>As of 4.2, there is a {@link ghost.framework.core.annotation.SynthesizingMethodParameter}
...
// * @author Phillip Webb
// * @since 2.0
// * @see ghost.framework.core.annotation.SynthesizingMethodParameter
// */
...
//						ReflectUtil.isInnerClass(this.executable.getDeclaringClass()) &&
...
//		Assert.isFalse(parameterIndex >= -1 && parameterIndex < count,
