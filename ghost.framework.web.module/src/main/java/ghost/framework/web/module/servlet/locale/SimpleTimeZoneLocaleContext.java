...
/**
 * Simple implementation of the {@link LocaleTimeZoneContext} interface,
 ...
 */
public class SimpleTimeZoneLocaleContext extends SimpleLocaleContext implements LocaleTimeZoneContext {
	 ...
	 */
	public SimpleTimeZoneLocaleContext(@Nullable Locale locale, @Nullable TimeZone timeZone) {
		super(locale);
