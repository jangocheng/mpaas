...
// */
//
//package ghost.framework.web.module.handler.servlet;
//
...
//import ghost.framework.web.module.SerializableTypeWrapper.SerializableTypeWrapper;
//import ghost.framework.core.SerializableTypeWrapper.FieldTypeProvider;
//import ghost.framework.core.SerializableTypeWrapper.MethodParameterTypeProvider;
//import ghost.framework.core.SerializableTypeWrapper.TypeProvider;
//
...
//			Type type, @Nullable SerializableTypeWrapper.TypeProvider typeProvider, @Nullable VariableResolver variableResolver) {
//
//		this.type = type;
...
//			@Override
//			public boolean isAssignableFrom(Class<?> other) {
//				return (clazz == null || clazz.equals(other));
//			}
//			@Override
//			public boolean isAssignableFrom(ResolvableType other) {
//				Class<?> otherClass = other.resolve();
//				return (otherClass != null && (clazz == null || (clazz.equals(otherClass));
//			}
//		};
//	}
//
...
//		return null;//forType(null, new FieldTypeProvider(field), null);
//	}
//
//	/**
...
//		return null;//forType(null, new FieldTypeProvider(field), owner.asVariableResolver());
//	}
//
//	/**
//	 * Return a {@link ResolvableType} for the specified {@link Field} with a given
...
//		Assert.notNull(field, "Field must not be null");
//		return null;//forType(null, new FieldTypeProvider(field), null).getNested(nestingLevel);
//	}
//
//	/**
//	 * Return a {@link ResolvableType} for the specified {@link Field} with a given
...
//		Assert.notNull(field, "Field must not be null");
//		ResolvableType owner = forType(implementationClass).as(field.getDeclaringClass());
//		return null;//forType(null, new FieldTypeProvider(field), owner.asVariableResolver()).getNested(nestingLevel);
//	}
//
//	/**
...
//		return null;//forType(null, new MethodParameterTypeProvider(methodParameter), owner.asVariableResolver()).getNested(methodParameter.getNestingLevel(), methodParameter.typeIndexesPerLevel);
//	}
//
//	/**
//	 * Return a {@link ResolvableType} for the specified {@link MethodParameter},
...
//		return null;//forType(targetType, new MethodParameterTypeProvider(methodParameter), owner.asVariableResolver()).getNested(nestingLevel, methodParameter.typeIndexesPerLevel);
//	}
//
//	/**
