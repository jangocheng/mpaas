...
import ghost.framework.web.context.bind.annotation.SessionAttributes;
 ...
 * @Description:解析 {@link SessionAttributes} 注释参数
 * @Date: 2020/2/29:0:16
 */
@FirstOrder
@Order(Integer.MAX_VALUE)
@HandlerMethodArgumentResolver
public class RequestMethodArgumentSessionAttributesAnnotationResolver
        extends AbstractRequestMethodArgumentAnnotationConverterResolver {
    private final Class<? extends Annotation> annotation = SessionAttributes.class;
