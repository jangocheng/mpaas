...
class HtmlCharacterEntityReferences {
	 ...
	 * html编码配置文件
	 */
	private static final String PROPERTIES_FILE = "/ghost/framework/web/modul/util/HtmlCharacterEntityReferences.properties";
	...
	public HtmlCharacterEntityReferences() {
		...
		while (keys.hasMoreElements()) {
			...
			Assert.isFalse((referredChar < 1000 || (referredChar >= 8000 && referredChar < 10000)),
