...
import ghost.framework.web.module.http.converter.AbstractGenericHttpMessageConverter;
...
import ghost.framework.web.module.util.TypeUtils;
...
//	@Override
	...
	protected JavaType getJavaType(Type type, @Nullable Class<?> contextClass) {
		...
		return null;//typeFactory.constructType(GenericTypeResolver.resolveType(type, contextClass));
	}
