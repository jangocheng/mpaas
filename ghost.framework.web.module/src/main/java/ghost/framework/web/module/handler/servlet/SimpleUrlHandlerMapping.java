...
//import ghost.framework.web.module.handler.BeanNameUrlHandlerMapping;
//import ghost.framework.web.module.servlet.IHandlerMappingContainer;
//
//import java.util.*;
//
///**
// * Implementation of the {@link ghost.framework.web.servlet.HandlerMapping}
...
// * pattern options, see the {@link ghost.framework.util.AntPathMatcher} javadoc.
//
// * @author Rod Johnson
...
// */
//@Component
//@BeanMapContainer(IHandlerMappingContainer.class)
...
//	 * details, see the {@link ghost.framework.util.AntPathMatcher} javadoc.
...
////	 */
////	@Override
////	public void initApplicationContext() throws BeanException {
...
//	 * @throws BeanException if a handler couldn't be registered
