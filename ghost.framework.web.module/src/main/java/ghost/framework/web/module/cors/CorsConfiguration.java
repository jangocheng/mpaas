 ...
 * initialization entity to start with open defaults that permit all cross-origin
 ...
 */
public class CorsConfiguration implements ICorsConfiguration {
	...
	@Override
	@Nullable
	public ICorsConfiguration combine(@Nullable ICorsConfiguration other) {
		if (other == null) {
			return this;
		}
