 ...
 * @author Rob Harrop
 * @since 2.0
 * @see ghost.framework.beans.factory.support.ManagedSet
 * @see ghost.framework.beans.factory.support.ManagedList
 * @see ghost.framework.beans.factory.support.ManagedMap
 * @see ghost.framework.beans.factory.support.ManagedProperties
 */
