...
package ghost.framework.web.module.http.converter.protobuf;
...
import static ghost.framework.web.context.http.MediaType.*;
...
public class ProtobufHttpMessageConverter extends AbstractHttpMessageConverter<Message> {
	...
	ProtobufHttpMessageConverter(@Nullable ProtobufFormatSupport formatSupport,
		...
		else if (this.module.isPresent("com.googlecode.protobuf.format.FormatFactory")) {
			this.protobufFormatSupport = new ProtobufJavaFormatSupport();
		}
		else if (this.module.isPresent("com.google.protobuf.util.JsonFormat")) {
