...
package ghost.framework.web.context.event;
 ...
 * @see ghost.framework.web.servlet.FrameworkServlet
 * @see ghost.framework.context.ApplicationContext#publishEvent
 */
@SuppressWarnings("serial")
public class RequestHandledEvent extends AbstractApplicationEvent {
