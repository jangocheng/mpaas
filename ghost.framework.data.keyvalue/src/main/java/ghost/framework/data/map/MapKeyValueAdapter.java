...
public class MapKeyValueAdapter extends AbstractKeyValueAdapter {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueAdapter#clear()
	 */
	@Override
	public void clear() {
		store.clear();
