...
/**
 * {@link ghost.framework.beans.factory.FactoryBean} to create {@link KeyValueRepository}.
 *
...
public class KeyValueRepositoryFactoryBean<T extends Repository<S, ID>, S, ID>
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.core.support.RepositoryFactoryBeanSupport#createRepositoryFactory()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.core.support.RepositoryFactoryBeanSupport#afterPropertiesSet()
	 */
	@Override
