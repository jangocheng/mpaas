...
import ghost.framework.data.dao.DuplicateKeyException;
import ghost.framework.data.dao.InvalidDataAccessApiUsageException;
import ghost.framework.data.domain.Sort;
import ghost.framework.data.keyvalue.core.event.KeyValueEvent;
import ghost.framework.data.keyvalue.core.mapping.KeyValuePersistentEntity;
import ghost.framework.data.keyvalue.core.mapping.KeyValuePersistentProperty;
...
public class KeyValueTemplate implements KeyValueOperations, ApplicationEventPublisherAware {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#insert(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#insert(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#update(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#update(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#findAllOf(java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#findById(java.lang.Object, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#delete(java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#delete(java.lang.Object)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#delete(java.lang.Object, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#count(java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#execute(ghost.framework.data.keyvalue.core.KeyValueCallback)
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#find(ghost.framework.data.keyvalue.core.query.KeyValueQuery, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#findAllOf(ghost.framework.data.domain.Sort, java.lang.Class)
	 */
	@SuppressWarnings("rawtypes")
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#findInRange(long, int, java.lang.Class)
	 */
	@SuppressWarnings("rawtypes")
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#findInRange(long, int, ghost.framework.data.domain.Sort, java.lang.Class)
	 */
	@SuppressWarnings("rawtypes")
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#count(ghost.framework.data.keyvalue.core.query.KeyValueQuery, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueOperations#getMappingContext()
	 */
	@Override
