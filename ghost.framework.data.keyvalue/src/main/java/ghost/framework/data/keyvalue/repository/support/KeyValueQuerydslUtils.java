...
abstract class KeyValueQuerydslUtils {
	...
	/**
	 * Converts the given {@link ghost.framework.data.domain.Sort.NullHandling} to the appropriate Querydsl
	 * {@link NullHandling}.
	 *
	 * @param nullHandling must not be {@literal null}.
	 * @return
	 */
	private static NullHandling toQueryDslNullHandling(ghost.framework.data.domain.Sort.NullHandling nullHandling) {
