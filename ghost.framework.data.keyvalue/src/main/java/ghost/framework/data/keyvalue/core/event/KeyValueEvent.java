 ...
 */
package ghost.framework.data.keyvalue.core.event;
 ...
 * {@link ghost.framework.data.keyvalue.core.KeyValueTemplate}. Use the {@link #getType()} to determine which event
 * has been emitted.
 *
 ...
 * @param <T>
 */
public class KeyValueEvent<T> extends AbstractApplicationEvent {
