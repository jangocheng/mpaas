...
public abstract class AbstractKeyValueAdapter implements KeyValueAdapter {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueAdapter#delete(java.lang.Object, java.lang.String, java.lang.Class)
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueAdapter#find(ghost.framework.data.keyvalue.core.query.KeyValueQuery, java.lang.String, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueAdapter#find(ghost.framework.data.keyvalue.core.query.KeyValueQuery, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.KeyValueAdapter#count(ghost.framework.data.keyvalue.core.query.KeyValueQuery, java.lang.String)
	 */
	@Override
