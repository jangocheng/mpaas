 ...
 * the {@link ghost.framework.data.mapping.PersistentProperty}'s name.
 *
 * @since 1.9
...
public class CamelCaseAbbreviatingFieldNamingStrategy extends CamelCaseSplittingFieldNamingStrategy {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.CamelCaseSplittingFieldNamingStrategy#preparePart(java.lang.String)
	 */
	@Override
