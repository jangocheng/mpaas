...
import static ghost.framework.data.commons.util.StreamUtils.toMultiMap;
 ...
 * {@link ghost.framework.expression.EvaluationContext}.
 *
...
class EvaluationContextExtensionInformation {
	...
	public EvaluationContextExtensionInformation(Class<? extends EvaluationContextExtension> type) {
		...
		Class<?> rootObjectType = ghost.framework.data.commons.util.ReflectionUtils.findRequiredMethod(type, "getRootObject")
				.getReturnType();
	...
	public static class ExtensionTypeInformation {
		...
		public static class PublicMethodAndFieldFilter implements ghost.framework.util.ReflectionUtils.MethodFilter, ReflectionUtils.FieldFilter {
			...
			/*
			 * (non-Javadoc)
			 * @see ghost.framework.util.ReflectionUtils.MethodFilter#matches(java.lang.reflect.Method)
			 */
			@Override
	...
	static class RootObjectInformation {
		...
		public RootObjectInformation(Class<?> type) {
			...
			Streamable<PropertyDescriptor> descriptors = null;//Streamable.of(BeanUtils.getPropertyDescriptors(type));
