...
public class ClassGeneratingEntityInstantiator implements EntityInstantiator {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.convert.EntityInstantiator#createInstance(ghost.framework.data.mapping.PersistentEntity, ghost.framework.data.mapping.entity.ParameterValueProvider)
	 */
	@Override
	...
	static class ObjectInstantiatorClassGenerator {
		 ...
		 * <p>
		 * Taken from Spring Expression 4.1.2 {@code ghost.framework.expression.spel.CodeFlow#insertUnboxInsns}.
		 *
		 * @param mv the method visitor into which instructions should be inserted
