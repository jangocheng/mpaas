...
class TypedExampleMatcher implements ExampleMatcher {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.commons.ExampleMatcher#withIgnorePaths(java.lang.String...)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.commons.ExampleMatcher#withStringMatcher(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.commons.ExampleMatcher#withIgnoreCase(boolean)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.commons.ExampleMatcher#withMatcher(java.lang.String, ghost.framework.data.commons.ExampleMatcher.MatcherConfigurer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.commons.ExampleMatcher#withTransformer(java.lang.String, ghost.framework.data.commons.ExampleMatcher.PropertyValueTransformer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.commons.ExampleMatcher#withIgnoreCase(java.lang.String...)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.commons.ExampleMatcher#withNullHandler(ghost.framework.data.commons.ExampleMatcher.NullHandler)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.commons.ExampleMatcher#getNullHandler()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.commons.ExampleMatcher#getDefaultStringMatcher()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.commons.ExampleMatcher#isIgnoreCaseEnabled()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.commons.ExampleMatcher#getIgnoredPaths()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.commons.ExampleMatcher#getPropertySpecifiers()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.commons.ExampleMatcher#getMatchMode()
	 */
	@Override
