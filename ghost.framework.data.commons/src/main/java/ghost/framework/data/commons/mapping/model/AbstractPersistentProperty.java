...
import ghost.framework.data.commons.annotation.Reference;
...
public abstract class AbstractPersistentProperty<P extends PersistentProperty<P>> implements PersistentProperty<P> {
	...
	static {
		CAUSE_FIELD =  ghost.framework.data.commons.util.ReflectionUtils.findRequiredField(Throwable.class, "cause");
	}
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getOwner()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getName()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getType()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getRawType()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getTypeInformation()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getGetter()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getSetter()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getWither()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getField()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getSpelExpression()
	 */
	@Override
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#isWritable()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#isImmutable()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#isAssociation()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getAssociation()
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#isCollectionLike()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#isMap()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#isArray()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#isEntity()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getComponentType()
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getMapValueType()
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentProperty#getActualType()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.mapping.MongoPersistentProperty#usePropertyAccess()
	 */
