...
public interface RepositoryConfigurationSource {
	...
	/**
	 * Returns the source {@link IBeanDefinition}s of the repository interfaces to create repository instances for.
	 *
	 * @param loader
	 * @return
	 */
	Streamable<IBeanDefinition> getCandidates(IResourceLoader loader);
	 ...
	 * @since 2.0
	 */
	String generateBeanName(IBeanDefinition beanDefinition);
