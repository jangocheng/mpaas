...
import ghost.framework.data.commons.repository.query.DefaultParameters;
...
import static ghost.framework.data.commons.util.ClassUtils.getNumberOfOccurences;
import static ghost.framework.data.commons.util.ClassUtils.hasParameterOfType;

//import ghost.framework.data.jdbc.jpa.plugin.repository.query.Parameters;
//import ghost.framework.data.jdbc.jpa.plugin.repository.utils.QueryExecutionConverters;
