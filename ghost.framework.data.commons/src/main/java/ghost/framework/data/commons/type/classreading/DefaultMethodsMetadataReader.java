...
import ghost.framework.context.core.type.classreading.AnnotationMetadataReadingVisitor;
import ghost.framework.context.core.type.classreading.MethodMetadataReadingVisitor;
...
/**
 * {@link MethodsMetadataReader} implementation based on an ASM {@link ghost.framework.asm.ClassReader}.
 *
 * @author Mark Paluch
...
class DefaultMethodsMetadataReader implements MethodsMetadataReader {
	...
	DefaultMethodsMetadataReader(IResource resource, @Nullable ClassLoader classLoader) throws IOException {
	...
	private static ClassReader createClassReader(IResource resource) throws IOException {
	...
	private static class MethodsMetadataReadingVisitor extends AnnotationMetadataReadingVisitor
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.core.type.classreading.AnnotationMetadataReadingVisitor#visitMethod(int, java.lang.String, java.lang.String, java.lang.String, java.lang.String[])
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.util.MethodsMetadata#getMethods()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.util.MethodsMetadata#getMethods(String)
		 */
		@Override
