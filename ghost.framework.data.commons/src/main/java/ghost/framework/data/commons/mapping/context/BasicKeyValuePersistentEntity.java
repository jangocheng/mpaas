...
import ghost.framework.data.commons.mapping.ClassNameKeySpaceResolver;
...
public class BasicKeyValuePersistentEntity<T, P extends KeyValuePersistentProperty<P>>
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.keyvalue.core.mapping.KeyValuePersistentEntity#getKeySpace()
	 */
	@Override
