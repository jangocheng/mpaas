...
public abstract class ParentTypeAwareTypeInformation<S> extends TypeDiscoverer<S> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeDiscoverer#createInfo(java.lang.reflect.Type)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeDiscoverer#equals(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeDiscoverer#hashCode()
	 */
	@Override
	public int hashCode() {
