...
public class DefaultTypeMapper<S> implements TypeMapper<S> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.convert.TypeMapper#readType(java.lang.Object)
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.convert.TypeMapper#readType(java.lang.Object, ghost.framework.data.util.TypeInformation)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.convert.TypeMapper#writeType(java.lang.Class, java.lang.Object)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.convert.TypeMapper#writeType(ghost.framework.data.util.TypeInformation, java.lang.Object)
	 */
