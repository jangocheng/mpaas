...
import ghost.framework.data.commons.annotation.CreatedBy;
import ghost.framework.data.commons.annotation.CreatedDate;
import ghost.framework.data.commons.annotation.LastModifiedBy;
import ghost.framework.data.commons.annotation.LastModifiedDate;
import ghost.framework.data.commons.mapping.*;
import ghost.framework.data.commons.mapping.context.MappingContext;
import ghost.framework.data.commons.mapping.context.PersistentEntities;
...
public class MappingAuditableBeanWrapperFactory extends DefaultAuditableBeanWrapperFactory {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.auditing.AuditableBeanWrapperFactory#getBeanWrapperFor(java.lang.Object)
	 */
	@Override
		...
		return Optional.of(source).flatMap(it -> {
			...
			return entities.mapOnContext(it.getClass(), (context, entity) -> {
				...
				return Optional.<AuditableBeanWrapper<T>> ofNullable(metadata.isAuditable() //
						? new MappingMetadataAuditableBeanWrapper<>(getConverterContainer(), entity.getPropertyPathAccessor(it),
								metadata)
						: null);
	...
	static class MappingMetadataAuditableBeanWrapper<T> extends DateConvertingAuditableBeanWrapper<T> {
		...
		public MappingMetadataAuditableBeanWrapper(
				ConverterContainer conversionService,
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.auditing.AuditableBeanWrapper#setCreatedBy(java.lang.Object)
		 */
		@Override
