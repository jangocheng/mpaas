...
import ghost.framework.data.commons.repository.PersistenceExceptionTranslationRepositoryProxyPostProcessor;
import ghost.framework.data.commons.repository.Repository;
import ghost.framework.data.commons.repository.utils.TxUtils;
...
public abstract class TransactionalRepositoryFactoryBeanSupport<T extends Repository<S, ID>, S, ID>
	...
	protected TransactionalRepositoryFactoryBeanSupport(ICoreInterface coreInterface, Class<? extends T> repositoryInterface) {
