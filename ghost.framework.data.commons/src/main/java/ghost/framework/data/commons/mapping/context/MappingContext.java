...
public interface MappingContext<E extends PersistentEntity<?, P>, P extends PersistentProperty<P>> {
	 ...
	 *
	 * @see ghost.framework.data.commons.mapping.model.SimpleTypeHolder#isSimpleType(Class)
	 ...
	 *         {@link ghost.framework.data.commons.mapping.model.SimpleTypeHolder#isSimpleType(Class)}).
	 */
	@Nullable
