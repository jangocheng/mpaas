...
//import ghost.framework.transaction.annotation.AnnotationTransactionAttributeSource;
//import ghost.framework.transaction.interceptor.TransactionAttribute;
//import ghost.framework.transaction.interceptor.TransactionInterceptor;
...
import ghost.framework.data.transaction.TransactionInterceptor;
import ghost.framework.transaction.interceptor.TransactionAttribute;
...
//import ghost.framework.transaction.AnnotationTransactionAttributeSource;
//import ghost.framework.transaction.TransactionAttribute;
...
public class TransactionalRepositoryProxyPostProcessor implements RepositoryProxyPostProcessor {
	...
	static class RepositoryAnnotationTransactionAttributeSource extends AnnotationTransactionAttributeSource {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.transaction.interceptor.AbstractFallbackTransactionAttributeSource#computeTransactionAttribute(java.lang.reflect.Method, java.lang.Class)
		 */
		@Override
		@Nullable
