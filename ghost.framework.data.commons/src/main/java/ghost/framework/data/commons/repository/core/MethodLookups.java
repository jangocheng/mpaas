...
//import ghost.framework.data.repository.core.support.MethodLookup.MethodPredicate;
...
import static ghost.framework.context.core.GenericTypeResolver.resolveParameterType;
...
//import static ghost.framework.core.GenericTypeResolver.*;
//import static ghost.framework.core.GenericTypeResolver.resolveParameterType;
...
interface MethodLookups {
	...
	class RepositoryAwareMethodLookup implements MethodLookup {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.core.support.MethodLookup#getLookups()
		 */
		@Override
	...
	class ReactiveTypeInteropMethodLookup extends RepositoryAwareMethodLookup {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.core.support.MethodLookups.RepositoryAwareMethodLookup#getLookups()
		 */
		@Override
		public List<MethodPredicate> getLookups() {
