...
class TypeDiscoverer<S> implements TypeInformation<S> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#getParameterTypes(java.lang.reflect.Constructor)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#getProperty(java.lang.String)
	 */
	@Nullable
	...
	private static Optional<PropertyDescriptor> findPropertyDescriptor(Class<?> type, String fieldname) {
		...
		PropertyDescriptor descriptor = null;//BeanUtils.getPropertyDescriptor(type, fieldname);
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#getType()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#getRawTypeInformation()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#getActualType()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#isMap()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#getMapValueType()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#isCollectionLike()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#getComponentType()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#getReturnType(java.lang.reflect.Method)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#getMethodParameterTypes(java.lang.reflect.Method)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#getSuperTypeInformation(java.lang.Class)
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#getTypeParameters()
	 */
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#isAssignableFrom(ghost.framework.data.util.TypeInformation)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeInformation#specialize(ghost.framework.data.util.ClassTypeInformation)
	 */
	@Override
	...
	private static class SyntheticParamterizedType implements ParameterizedType {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.util.ParentTypeAwareTypeInformation#equals(java.lang.Object)
		 */
		@Override
