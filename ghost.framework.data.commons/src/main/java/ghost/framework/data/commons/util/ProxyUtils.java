...
public abstract class ProxyUtils {
	...
	private static final List<ProxyDetector> DETECTORS = null;//GhostFactoriesLoader.loadFactories(ProxyDetector.class, ProxyUtils.class.getClassLoader());
	...
	public static Class<?> getUserClass(Object source) {
		...
		return null;// getUserClass(AopUtils.getTargetClass(source));
	}
