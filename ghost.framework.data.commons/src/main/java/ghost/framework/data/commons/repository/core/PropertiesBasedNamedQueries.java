...
public class PropertiesBasedNamedQueries implements NamedQueries {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.core.NamedQueries#hasNamedQuery(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.core.NamedQueries#getNamedQuery(java.lang.String)
	 */
