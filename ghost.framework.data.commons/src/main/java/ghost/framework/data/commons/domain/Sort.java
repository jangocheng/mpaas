...
import ghost.framework.data.commons.util.MethodInvocationRecorder;
...
public class Sort implements Streamable<Sort.Order>, Serializable {
	...
	public static class TypedSort<T> extends Sort {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.commons.domain.Sort#iterator()
		 */
		@Override
		public Iterator<Order> iterator() {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.commons.domain.Sort#toString()
		 */
		@Override
		public String toString() {
