...
//import ghost.framework.data.jdbc.jpa.plugin.repository.config.RepositoryConfigurationExtensionSupport;
...
public interface RepositoryConfigurationExtension {
	...
	/**
	 * Callback to post process the {@link IBeanDefinition} and tweak the configuration if necessary.
	 *
	...
	/**
	 * Callback to post process the {@link IBeanDefinition} built from annotations and tweak the configuration if
	 * necessary.
	 *
	 * @param builder will never be {@literal null}.
	 * @param config will never be {@literal null}.
	...
	/**
	 * Callback to post process the {@link IBeanDefinition} built from XML and tweak the configuration if necessary.
	 *
	 * @param builder will never be {@literal null}.
	 * @param config will never be {@literal null}.
	 */
