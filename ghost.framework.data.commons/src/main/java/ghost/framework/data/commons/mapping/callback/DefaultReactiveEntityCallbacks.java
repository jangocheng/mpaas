...
class DefaultReactiveEntityCallbacks implements ReactiveEntityCallbacks {
	 ...
	 * within the given {@link ghost.framework.context.base.ICoreInterface}.
	 *
	 * @param beanFactory must not be {@literal null}.
	 */
	DefaultReactiveEntityCallbacks(ICoreInterface beanFactory) {
		this.callbackDiscoverer = new EntityCallbackDiscoverer(beanFactory);
	}

	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.callback.ReactiveEntityCallbacks#callback(java.lang.Class, java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.callback.EntityCallbacks#addEntityCallback(ghost.framework.data.mapping.callback.EntityCallback)
	 */
	@Override
