 ...
 */
package ghost.framework.data.commons.support;
...
public class ExampleMatcherAccessor {
	...
	/**
	 * Returns the {@link ExampleMatcher.PropertySpecifier}s of the underlying {@link ExampleMatcher}.
	 *
	...
	/**
	 * Returns whether the underlying {@link ExampleMatcher} contains a {@link ExampleMatcher.PropertySpecifier} for the given path.
	 *
