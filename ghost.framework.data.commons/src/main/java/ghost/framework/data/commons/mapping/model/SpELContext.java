...
import ghost.framework.expression.ExpressionParser;
...
public class SpELContext {
	 ...
	 * @param factory
	 */
	public SpELContext(SpELContext source, Object factory) {
	 ...
	 * @param factory
	 */
	private SpELContext(PropertyAccessor accessor, @Nullable SpelExpressionParser parser, @Nullable Object factory) {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.entity.SpELContext#getParser()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.entity.SpELContext#getEvaluationContext(java.lang.Object)
	 */
