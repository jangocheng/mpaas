...
import ghost.framework.data.commons.repository.annotation.QueryAnnotation;
import ghost.framework.data.commons.repository.utils.JapClassUtils;
...
//import ghost.framework.data.jdbc.jpa.plugin.annotation.QueryAnnotation;

//import static ghost.framework.data.repository.util.ClassUtils.*;
//import static ghost.framework.data.repository.util.ClassUtils.isGenericRepositoryInterface;
...
class DefaultRepositoryInformation implements RepositoryInformation {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.support.RepositoryMetadata#getDomainClass()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.support.RepositoryMetadata#getIdClass()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.support.RepositoryInformation#getRepositoryBaseClass()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.support.RepositoryInformation#getTargetClassMethod(java.lang.reflect.Method)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.support.RepositoryInformation#getQueryMethods()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.support.RepositoryInformation#isCustomMethod(java.lang.reflect.Method)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.core.RepositoryInformation#isQueryMethod(java.lang.reflect.Method)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.core.RepositoryInformation#isBaseClassMethod(java.lang.reflect.Method)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.support.RepositoryInformation#hasCustomMethod()
	 */
	@Override
	public boolean hasCustomMethod() {
		...
		if (JapClassUtils.isGenericRepositoryInterface(repositoryInterface)) {
			return false;
		}
