 ...
 * so, add Spring's common {@link ghost.framework.core.annotation.Order @Order} annotation or implement
 * {@link ghost.framework.core.Ordered}.
 ...
 * {@link ghost.framework.context.ApplicationContext}, callbacks are filtered accordingly, with the callback getting
 * invoked for assignable domain objects only.
 * <p/>
 * Typically, entity callbacks are invoked after publishing {@link ghost.framework.context.ApplicationEvent events}.
 * <p/>
