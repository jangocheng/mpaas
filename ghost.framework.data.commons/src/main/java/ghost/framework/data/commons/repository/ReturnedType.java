...
//import ghost.framework.data.mapping.PreferredConstructor;
//import ghost.framework.data.mapping.entity.PreferredConstructorDiscoverer;
...
import ghost.framework.data.commons.mapping.model.PreferredConstructorDiscoverer;
...
public abstract class ReturnedType {
	...
	private static final class ReturnedInterface extends ReturnedType {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.query.ReturnedType#getReturnedType()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.query.ReturnedType#needsCustomConstruction()
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.query.ReturnedType#isProjecting()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.query.ReturnedType#getTypeToRead()
		 */
		@Nullable
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.query.ReturnedType#getInputProperties()
		 */
		@Override
	...
	private static final class ReturnedClass extends ReturnedType {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.query.ResultFactory.ReturnedTypeInformation#getReturnedType()
		 */
		@Override
		public Class<?> getReturnedType() {
			return type;
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.query.ResultFactory.ReturnedType#getTypeToRead()
		 */
		@Nonnull
		public Class<?> getTypeToRead() {
			return type;
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.query.ResultFactory.ReturnedType#isProjecting()
		 */
		@Override
		public boolean isProjecting() {
			return isDto();
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.query.ResultFactory.ReturnedType#needsCustomConstruction()
		 */
		public boolean needsCustomConstruction() {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.query.ResultFactory.ReturnedTypeInformation#getInputProperties()
		 */
		@Override
		public List<String> getInputProperties() {
