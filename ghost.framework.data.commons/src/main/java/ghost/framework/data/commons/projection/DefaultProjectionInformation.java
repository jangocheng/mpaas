...
import ghost.framework.data.commons.type.classreading.MethodsMetadataReader;
import ghost.framework.data.commons.type.classreading.MethodsMetadataReaderFactory;
...
class DefaultProjectionInformation implements ProjectionInformation {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.projection.ProjectionInformation#getType()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.projection.ProjectionInformation#getInputProperties()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.projection.ProjectionInformation#isDynamic()
	 */
	@Override
	...
	private static class PropertyDescriptorSource {
		...
		private Stream<PropertyDescriptor> collectDescriptors() {
			...
			Stream<PropertyDescriptor> allButDefaultGetters = null;//Arrays.stream(/*BeanUtils.getPropertyDescriptors(type)*/ ).filter(it -> !hasDefaultGetter(it));
