...
import ghost.framework.data.commons.geo.Distance;
import ghost.framework.data.commons.geo.Metric;
import ghost.framework.data.commons.geo.Metrics;
...
/**
 * TypeConverter to create {@link Distance} instances from {@link String} representations. The supported format is a decimal
 ...
 */
public enum DistanceFormatter implements TypeConverter<String, Distance>, Formatter<Distance> {
	INSTANCE;
