...
public interface PersistentPropertyPath<P extends PersistentProperty<P>> extends Streamable<P> {
	...
	/**
	 * Returns the dot based path notation using the given {@link TypeConverter} to translate individual
	 ...
	 */
	@Nullable
	String toDotPath(TypeConverter<? super P, String> typeConverter);
	...
	/**
	 * Returns a {@link String} path with the given delimiter using the given {@link TypeConverter} for
	 ...
	 */
	@Nullable
	String toPath(String delimiter, TypeConverter<? super P, String> typeConverter);
