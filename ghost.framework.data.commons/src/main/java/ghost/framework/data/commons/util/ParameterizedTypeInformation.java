...
class ParameterizedTypeInformation<T> extends ParentTypeAwareTypeInformation<T> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeDiscoverer#doGetMapValueType()
	 */
	@Override
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeDiscoverer#getTypeParameters()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.TypeDiscoverer#doGetComponentType()
	 */
	@Override
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.util.ParentTypeAwareTypeInformation#hashCode()
	 */
	@Override
	public int hashCode() {
