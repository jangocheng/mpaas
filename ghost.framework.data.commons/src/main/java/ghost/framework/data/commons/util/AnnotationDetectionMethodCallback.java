...
/**
 * {@link ReflectionUtils.MethodCallback} to find annotations of a given type.
 *
...
public class AnnotationDetectionMethodCallback<A extends Annotation> implements ReflectionUtils.MethodCallback {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.util.ReflectionUtils.MethodCallback#doWith(java.lang.reflect.Method)
	 */
	@Override
