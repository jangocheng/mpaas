...
public interface RepositoryFragment<T> {
	...
	class StructuralRepositoryFragment<T> implements RepositoryFragment<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.core.support.RepositoryFragment#getSignatureContributor()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.core.support.RepositoryFragment#withImplementation(java.lang.Object)
		 */
		@Override
	...
	class ImplementedRepositoryFragment<T> implements RepositoryFragment<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.core.support.RepositoryFragment#getImplementation()
		 */
		@Override
