 ...
 */
package ghost.framework.data.commons.geo;
...
public class CustomMetric implements Metric {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mongodb.core.geo.Metric#getMultiplier()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.geo.Metric#getAbbreviation()
	 */
	@Override
