...
class ProxyProjectionFactory implements ProjectionFactory {
	...
	protected ProxyProjectionFactory() {
		...
		this.converterContainer = null;// DefaultConverterContainer.getSharedInstance();
	}
...
//	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.rest.core.projection.ProjectionFactory#createProjection(java.lang.Object, java.lang.Class)
	 */
	@Override
...
/*
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.projection.ProjectionFactory#createProjection(java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.projection.ProjectionFactory#getProjectionInformation(java.lang.Class)
	 */
	@Override
	...
	private MethodInterceptor getMethodInterceptor(Object source, Class<?> projectionType) {
		...
		return new ProjectingMethodInterceptor(this,
				postProcessAccessorInterceptor(propertyInvocationInterceptor, source, projectionType), converterContainer);
	}
	/**
	...
	private static enum MapAccessingMethodInterceptorFactory implements MethodInterceptorFactory {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.projection.MethodInterceptorFactory#createMethodInterceptor(java.lang.Object, java.lang.Class)
		 */
		@Override
		@SuppressWarnings("unchecked")
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.projection.MethodInterceptorFactory#supports(java.lang.Object, java.lang.Class)
		 */
		@Override
