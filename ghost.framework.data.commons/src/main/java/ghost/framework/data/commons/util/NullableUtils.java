...
//import ghost.framework.lang.NonNullApi;
 ...
 * {@link Nonnull} annotations. By default (no annotation use), a package and its types are considered
 ...
 *
 * <pre class="code">
 * &#64;ghost.framework.lang.NonNullApi
 * package com.example;
 * </pre>
 *
 ...
 * </pre>
 * <p/>
 * {@link Nonnull} is suitable for composition of meta-annotations and expresses via
...
public abstract class NullableUtils {
	...
	private static final Set<Class<?>> NON_NULLABLE_ANNOTATIONS = findClasses("reactor.util.lang.NonNullApi", Object.class.getName());
	 ...
	 * {@link Nonnull} is set to {@link javax.annotation.meta.When#ALWAYS}.
	 *
	 ...
	 * This method determines default {@link Nonnull nullability} rules from the annotated element
	 *
	 ...
	 * {@link Nonnull} is set to one of {@link javax.annotation.meta.When#UNKNOWN},
...
//		try {
			return Optional.of(null/*(Class) ClassUtils.forName(className, NullableUtils.class.getClassLoader())*/);
