...
public class SpELExpressionParameterValueProvider<P extends PersistentProperty<P>>
	...
	public SpELExpressionParameterValueProvider(SpELExpressionEvaluator evaluator, ConverterContainer converterContainer,
	 ...
	 * leverage the configured {@link ConverterContainer} to massage the value into the parameter type.
	 *
	 * @param object    the value to massage, will never be {@literal null}.
	 * @param parameter the {@link PreferredConstructor.Parameter} we create the value for
	 * @return
	 */
	@Nullable
	protected <T> T potentiallyConvertSpelValue(Object object, PreferredConstructor.Parameter<T, P> parameter) {
		return (T) converterContainer.convert(object, parameter.getRawType());
	}
}