...
public final class ReflectionUtils {
	...
	public static <T> T createInstanceIfPresent(String classname, T defaultInstance) {
		...
		try {
			...
			return null;//(T) BeanUtils.instantiateClass(type);
		} catch (Exception e) {
	...
	/**
	 * A {@link ghost.framework.util.ReflectionUtils.FieldFilter} that has a description.
	 *
	 * @author Oliver Gierke
	 */
	public interface DescribedFieldFilter extends ghost.framework.util.ReflectionUtils.FieldFilter {
	...
	/**
	 * A {@link ghost.framework.util.ReflectionUtils.FieldFilter} for a given annotation.
	 *
	 * @author Oliver Gierke
	 */
	public static class AnnotationFieldFilter implements DescribedFieldFilter {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.util.ReflectionUtils.DescribedFieldFilter#getDescription()
		 */
	...
	/**
	 * Finds the first field on the given class matching the given {@link ghost.framework.util.ReflectionUtils.FieldFilter}.
	 *
	 ...
	 */
	@Nullable
	public static Field findField(Class<?> type, ghost.framework.util.ReflectionUtils.FieldFilter filter) {
	...
	public static Field findRequiredField(Class<?> type, String name) {
		...
		Field result = ghost.framework.util.ReflectionUtils.findField(type, name);
	...
	public static void setField(Field field, Object target, @Nullable Object value) {
		...
		ghost.framework.util.ReflectionUtils.makeAccessible(field);
		ghost.framework.util.ReflectionUtils.setField(field, target, value);
	}
	...
	public static Method findRequiredMethod(Class<?> type, String name, Class<?>... parameterTypes) {
		...
		Method result = ghost.framework.util.ReflectionUtils.findMethod(type, name, parameterTypes);
	...
	public static Optional<Method> getMethod(Class<?> type, String name, ResolvableType... parameterTypes) {
		...
		Method method = ghost.framework.util.ReflectionUtils.findMethod(type, name,
