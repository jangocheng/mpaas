 ...
 * EntityCallbacks} from a {@link ICoreInterface}.
 * 
 * @author Mark Paluch
...
class DefaultEntityCallbacks implements EntityCallbacks {
	 ...
	 * the given {@link ICoreInterface}.
	 * 
	 * @param beanFactory must not be {@literal null}.
	 */
	DefaultEntityCallbacks(ICoreInterface beanFactory) {
		this.callbackDiscoverer = new EntityCallbackDiscoverer(beanFactory);
	}

	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.callback.EntityCallbacks#callback(java.lang.Class, java.lang.Object, java.lang.Object)
	 */
	@Override
