...
import ghost.framework.data.commons.annotation.Immutable;
import ghost.framework.data.commons.annotation.TypeAlias;
import ghost.framework.data.commons.mapping.*;
import ghost.framework.data.commons.spel.EvaluationContextProvider;
import ghost.framework.data.commons.support.IsNewStrategy;
import ghost.framework.data.commons.support.PersistableIsNewStrategy;
...
public class BasicPersistentEntity<T, P extends PersistentProperty<P>> implements MutablePersistentEntity<T, P> {
	...
	PreferredConstructor<T, P> constructor;
	...
	public BasicPersistentEntity(TypeInformation<T> information, @Nullable Comparator<P> comparator) {
		...
		this.constructor = null;//PreferredConstructorDiscoverer.discover(this);
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#getPersistenceConstructor()
	 */
//	@Nullable
...
//	}
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#isConstructorArgument(ghost.framework.data.mapping.PersistentProperty)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#isIdProperty(ghost.framework.data.mapping.PersistentProperty)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#isVersionProperty(ghost.framework.data.mapping.PersistentProperty)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#getName()
	 */
	...
	@Override
	public ghost.framework.data.commons.mapping.PreferredConstructor<T, P> getPersistenceConstructor() {
		return null;
	}

	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#getIdProperty()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#getVersionProperty()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#hasIdProperty()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#hasVersionProperty()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.entity.MutablePersistentEntity#addPersistentProperty(P)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.entity.MutablePersistentEntity#setEvaluationContextProvider(ghost.framework.data.spel.EvaluationContextProvider)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.entity.MutablePersistentEntity#addAssociation(ghost.framework.data.mapping.entity.Association)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#getPersistentProperty(java.lang.String)
	 */
	@Override
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#getPersistentProperties(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#getType()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#getTypeAlias()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#getTypeInformation()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#doWithProperties(ghost.framework.data.mapping.PropertyHandler)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#doWithProperties(ghost.framework.data.mapping.PropertyHandler.Simple)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#doWithAssociations(ghost.framework.data.mapping.AssociationHandler)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#doWithAssociations(ghost.framework.data.mapping.SimpleAssociationHandler)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#findAnnotation(java.lang.Class)
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#isAnnotationPresent(java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.entity.MutablePersistentEntity#verify()
	 */
	public void verify() {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.entity.MutablePersistentEntity#setPersistentPropertyAccessorFactory(ghost.framework.data.mapping.entity.PersistentPropertyAccessorFactory)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#getPropertyAccessor(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#getPropertyPathAccessor(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#getIdentifierAccessor(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#isNew(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#isImmutable()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentEntity#requiresPropertyPopulation()
	 */
	@Override
	...
	private static class AbsentIdentifierAccessor extends TargetAwareIdentifierAccessor {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mapping.IdentifierAccessor#getIdentifier()
		 */
		@Override
		@Nullable
