...
public abstract class AbstractMappingContext<E extends MutablePersistentEntity<?, P>, P extends PersistentProperty<P>>
		implements MappingContext<E, P>, ApplicationEventPublisher {
...
//	}
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.entity.MappingContext#getPersistentEntities()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.entity.MappingContext#getPersistentEntity(java.lang.Class)
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.context.MappingContext#hasPersistentEntityFor(java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.entity.MappingContext#getPersistentEntity(ghost.framework.data.util.TypeInformation)
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.context.MappingContext#getPersistentEntity(ghost.framework.data.mapping.PersistentProperty)
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.context.MappingContext#getPersistentPropertyPath(java.lang.Class, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.context.MappingContext#getPersistentPropertyPath(java.lang.String, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.context.MappingContext#findPersistentPropertyPath(java.lang.Class, java.util.function.Predicate)
	 */
	@Override
	...
	protected Optional<E> addPersistentEntity(TypeInformation<?> typeInformation) {
		...
		try {
			...
			PropertyDescriptor[] pds =null;// BeanUtils.getPropertyDescriptors(type);
...
//			applicationEventPublisher.publishEvent(new MappingContextEvent<>(this, entity));
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.context.PersistentEntityAware#getManagedTypes()
	 */
	@Override
	...
	protected boolean shouldCreatePersistentEntityFor(TypeInformation<?> type) {
		...
		return true;//!KotlinDetector.isKotlinType(type.getType()) || KotlinReflectionUtils.isSupportedKotlinClass(type.getType());
	}
	...
	private final class PersistentPropertyCreator implements ReflectionUtils.FieldCallback {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.util.ReflectionUtils.FieldCallback#doWith(java.lang.reflect.Field)
		 */
	...
	static enum PersistentPropertyFilter implements ReflectionUtils.FieldFilter {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.util.ReflectionUtils.FieldFilter#matches(java.lang.reflect.Field)
		 */
