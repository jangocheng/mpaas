...
import static ghost.framework.data.commons.mapping.AccessOptions.SetOptions.SetNulls.SKIP;
...
class SimplePersistentPropertyPathAccessor<T> implements PersistentPropertyPathAccessor<T> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentPropertyPathAccessor#getProperty(ghost.framework.data.mapping.PersistentPropertyPath)
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentPropertyPathAccessor#getProperty(ghost.framework.data.mapping.PersistentPropertyPath, ghost.framework.data.mapping.PersistentPropertyPathAccessor.Options)
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.PersistentPropertyPathAccessor#setProperty(ghost.framework.data.mapping.PersistentPropertyPath, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.entity.ConvertingPropertyAccessor#setProperty(ghost.framework.data.mapping.PersistentPropertyPath, java.lang.Object)
	 */
