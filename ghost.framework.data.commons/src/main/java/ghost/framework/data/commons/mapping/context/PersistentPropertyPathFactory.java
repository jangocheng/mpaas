...
class PersistentPropertyPathFactory<E extends PersistentEntity<?, P>, P extends PersistentProperty<P>> {
	...
	public PersistentPropertyPath<P> getPersistentPropertyPath(TypeInformation<?> type, String propertyPath) {
	...
	public <T> Collection<PersistentPropertyPath<P>> from(TypeInformation<T> type, Predicate<? super P> filter,
	...
	static class DefaultPersistentPropertyPaths<T, P extends PersistentProperty<P>>
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mapping.PersistentPropertyPaths#getFirst()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mapping.PersistentPropertyPaths#contains(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mapping.PersistentPropertyPaths#contains(ghost.framework.data.mapping.PropertyPath)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.mapping.PersistentPropertyPaths#dropPathIfSegmentMatches(java.util.function.Predicate)
		 */
		@Override
