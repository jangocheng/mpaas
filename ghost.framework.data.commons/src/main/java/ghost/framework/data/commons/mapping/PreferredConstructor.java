...
public class PreferredConstructor<T, P extends PersistentProperty<P>> {
	...
	/**
	 * Returns whether the constructor was explicitly selected (by {@link ghost.framework.beans.annotation.constructor.Constructor}).
	 *
	 * @return
	 */
	public boolean isExplicitlyAnnotated() {
		return constructor.isAnnotationPresent(ghost.framework.beans.annotation.constructor.Constructor.class);
	}
