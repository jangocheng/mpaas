 ...
 */
@Entity
@Table(name="a1eb50000f15409d98be97205f09f491",
        indexes = {
                @Index(name = "uk", columnList = "id", unique = true),
                @Index(name = "pk", columnList = "id,status,description,version_id")
        })
@Cacheable
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class SoftwareInstallExecuteEntity implements Serializable {
    private static final long serialVersionUID = -5184644294795087914L;
    /**
     * 主键id
     */
    @Id
