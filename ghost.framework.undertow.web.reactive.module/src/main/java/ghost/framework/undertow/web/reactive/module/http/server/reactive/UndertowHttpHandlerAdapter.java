...
import ghost.framework.web.context.http.HttpLogging;
import ghost.framework.web.context.http.HttpMethod;
import ghost.framework.web.context.http.reactive.HttpHeadResponseDecorator;
import ghost.framework.web.context.http.server.reactive.HttpHandler;
...
public class UndertowHttpHandlerAdapter implements io.undertow.server.HttpHandler {
	...
	private final ghost.framework.web.context.server.reactive.HttpHandler httpHandler;

	private DataBufferFactory bufferFactory = new DefaultDataBufferFactory(false);


	public UndertowHttpHandlerAdapter(ghost.framework.web.context.server.reactive.HttpHandler httpHandler) {
