package ghost.framework.maven.aether.localrepo;
  ...
  public Properties update(File file, Map<String, String> updates) {
    ...
    synchronized (getLock(file)) {
      ...
      try {
        ...
        props.store(stream, "NOTE: This is an Aether internal implementation file" + ", its format can be changed without prior notice.");
        raf.seek(0);
