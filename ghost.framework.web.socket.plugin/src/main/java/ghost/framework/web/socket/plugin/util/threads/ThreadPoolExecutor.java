 ...
 */
package ghost.framework.web.socket.plugin.util.threads;
        ...
        if (currentThreadShouldBeStopped()) {
            ...
            if (lastTime + threadRenewalDelay < System.currentTimeMillis()) {
                if (lastTimeThreadKilledItself.compareAndSet(lastTime,
                    ...
                    final String msg = UpgradeUtil.getLocalContainer().getString(
            ...
            if (super.getQueue() instanceof TaskQueue) {
                ...
                try {
                    if (!queue.force(command, timeout, unit)) {
                        submittedCount.decrementAndGet();
                        throw new RejectedExecutionException(UpgradeUtil.getLocalContainer().getString("threadPoolExecutor.queueFull"));
                    }
