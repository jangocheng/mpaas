 ...
 */
package ghost.framework.web.socket.plugin.security;
...
public class ConcurrentMessageDigest {
    ...
    static {
        try {
            ...
            throw new IllegalArgumentException(UpgradeUtil.getLocalContainer().getString("concurrentMessageDigest.noDigest"), e);
        }
    }
    ...
    public static byte[] digest(String algorithm, int iterations, byte[]... input) {
        ...
        if (queue == null) {
            throw new IllegalStateException(UpgradeUtil.getLocalContainer().getString("concurrentMessageDigest.noDigest"));
        }
        ...
        if (md == null) {
            try {
                ...
                // first.
                throw new IllegalStateException(UpgradeUtil.getLocalContainer().getString("concurrentMessageDigest.noDigest"), e);
            }
        }
