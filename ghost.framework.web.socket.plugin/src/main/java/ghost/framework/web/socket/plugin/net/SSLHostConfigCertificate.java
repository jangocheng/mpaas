...
import ghost.framework.web.socket.plugin.net.openssl.ciphers.Authentication;
...
public class SSLHostConfigCertificate implements Serializable {
    ...
    private void setStoreType(String name, StoreType type) {
        if (storeType == null) {
            ...
            log.warn(UpgradeUtil.getLocalContainer().getString("sslHostConfigCertificate.mismatch",
