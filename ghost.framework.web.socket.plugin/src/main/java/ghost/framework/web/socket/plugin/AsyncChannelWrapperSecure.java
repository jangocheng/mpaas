...
public class AsyncChannelWrapperSecure implements AsyncChannelWrapper {
    ...
    public Future<Integer> read(ByteBuffer dst) {
        ...
        if (!reading.compareAndSet(false, true)) {
            throw new IllegalStateException(UpgradeUtil.getLocalContainer().getString(
    ...
    public void close() {
        try {
            ...
            log.info(UpgradeUtil.getLocalContainer().getString("asyncChannelWrapperSecure.closeFail"));
        }
        ...
        public void run() {
            ...
            try {
                ...
                if (writing.compareAndSet(true, false)) {
                    ...
                    future.fail(new IllegalStateException(UpgradeUtil.getLocalContainer().getString(
                ...
                while (read == 0) {
                    ...
                    if (forceRead) {
                        ...
                        if (socketRead.intValue() == -1) {
                            throw new EOFException(UpgradeUtil.getLocalContainer().getString("asyncChannelWrapperSecure.eof"));
                        }
                    }
    ...
    private class WebSocketSslHandshakeThread extends Thread {
                    ...
                    switch (handshakeStatus) {
                        ...
                        case NOT_HANDSHAKING: {
                            throw new SSLException(
                                    UpgradeUtil.getLocalContainer().getString("asyncChannelWrapperSecure.notHandshaking"));
                        }
                    }
                }
            } catch (Exception e) {
        ...
        private void checkResult(SSLEngineResult result, boolean wrap)
            ...
            if (resultStatus != Status.OK &&
                ...
                throw new SSLException(
                        UpgradeUtil.getLocalContainer().getString("asyncChannelWrapperSecure.check.notOk", resultStatus));
            }
            if (wrap && result.bytesConsumed() != 0) {
                throw new SSLException(UpgradeUtil.getLocalContainer().getString("asyncChannelWrapperSecure.check.wrap"));
            }
            if (!wrap && result.bytesProduced() != 0) {
                throw new SSLException(UpgradeUtil.getLocalContainer().getString("asyncChannelWrapperSecure.check.unwrap"));
            }
        }
    }
    ...
    private static final class LongToIntegerFuture implements Future<Integer> {
        ...
        public Integer get() throws InterruptedException, ExecutionException {
            ...
            if (result.longValue() > Integer.MAX_VALUE) {
                throw new ExecutionException(UpgradeUtil.getLocalContainer().getString(
