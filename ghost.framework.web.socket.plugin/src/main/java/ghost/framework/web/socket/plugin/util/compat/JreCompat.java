...
public class JreCompat {
    ...
    public void setApplicationProtocols(SSLParameters sslParameters, String[] protocols) {
        throw new UnsupportedOperationException(UpgradeUtil.getLocalContainer().getString("jreCompat.noApplicationProtocols"));
    }
    ...
    public String getApplicationProtocol(SSLEngine sslEngine) {
        throw new UnsupportedOperationException(UpgradeUtil.getLocalContainer().getString("jreCompat.noApplicationProtocol"));
    }
