 ...
 */
package ghost.framework.web.socket.plugin.util.compat;
...
class Jre9Compat extends JreCompat {
    ...
    static {
        ...
        try {
            ...
            if (c1 == null) {
                // Must be pre-Java 9
                log.debug(UpgradeUtil.getLocalContainer().getString("jre9Compat.javaPre9"), e);
            } else {
                // Should never happen - signature error in lookup?
                log.error(UpgradeUtil.getLocalContainer().getString("jre9Compat.unexpected"), e);
            }
            ...
            for (Object resolvedModule : resolvedModules) {
                ...
                if (isPresent.booleanValue()) {
                    ...
                    try {
                        ...
                        log.warn(UpgradeUtil.getLocalContainer().getString("jre9Compat.invalidModuleUri", uri), e);
                    }
                }
            }
