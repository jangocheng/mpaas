 ...
 * explicitly configured as the {@link WsFilter} performs all the necessary
 * bootstrap and installs this listener in the {@link ServletContext}. If the
 * {@link WsFilter} is disabled, this listener must be added manually to every
 * {@link ServletContext} that uses WebSocket to bootstrap the
 * {@link WsServerContainer} correctly.
 */
public final class WsContextListener implements ServletContextListener {
