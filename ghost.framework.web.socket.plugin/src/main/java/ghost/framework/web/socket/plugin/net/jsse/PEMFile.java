...
import ghost.framework.web.socket.plugin.util.buf.Asn1Parser;
import ghost.framework.web.socket.plugin.util.buf.Asn1Writer;
...
public class PEMFile {
    ...
    private class Part {
        ...
        public PrivateKey toPrivateKey(String password, String keyAlgorithm, Format format)
            ...
            InvalidKeyException exception = new InvalidKeyException(UpgradeUtil.getLocalContainer().getString("jsse.pemParseError", filename));
        ...
        private byte[] rfc5915ToPkcs8(byte[] source) {
            ...
            if (version.intValue() != 1) {
                throw new IllegalArgumentException(UpgradeUtil.getLocalContainer().getString("pemFile.notValidRFC5915"));
            }
        ...
        private RSAPrivateCrtKeySpec parsePKCS1(byte[] source) {
            ...
            if (version.intValue() == 1) {
                ...
                // keys
                throw new IllegalArgumentException(UpgradeUtil.getLocalContainer().getString("pemFile.noMultiPrimes"));
            }
