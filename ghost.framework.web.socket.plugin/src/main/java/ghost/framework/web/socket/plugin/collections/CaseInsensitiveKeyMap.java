 ...
 */
package ghost.framework.web.socket.plugin.collections;
...
public class CaseInsensitiveKeyMap<V> extends AbstractMap<String,V> {
    ...
    public V put(String key, V value) {
        ...
        if (caseInsensitiveKey == null) {
            throw new NullPointerException(UpgradeUtil.getLocalContainer().getString("caseInsensitiveKeyMap.nullKey"));
        }
