...
public abstract class PojoMessageHandlerWholeBase<T>
    ...
    /**
     *
     * @param pojo 注释{@link ServerEndpoint}类型构建的对象
     * @param method 引发{@link OnMessage}注释的函数接收消息
     * @param session 会话对象
     * @param params
    ...
    public PojoMessageHandlerWholeBase(Object pojo, Method method,
                                       ...
                                       boolean defaultConverter, int indexSession, long maxMessageSize) {
    ...
    /**
     * 接收消息
     * 引发{@link ServerEndpoint}注释构建类型的消息接收函数
     * 引发{@link OnMessage}注释的函数接收消息
     * @param message
     */
    @Override
