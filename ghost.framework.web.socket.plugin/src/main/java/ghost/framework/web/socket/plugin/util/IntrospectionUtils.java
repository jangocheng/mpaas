 ...
 */
package ghost.framework.web.socket.plugin.util;

import ghost.framework.web.socket.plugin.security.PermissionCheck;
...
public final class IntrospectionUtils {
    ...
    public static boolean setProperty(Object o, String name, String value,
        ...
        try {
            ...
            log.warn(UpgradeUtil.getLocalContainer().getString("introspectionUtils.setPropertyError", name, value, o.getClass()), e);
    ...
    public static Object getProperty(Object o, String name) {
        ...
        try {
            ...
            log.warn(UpgradeUtil.getLocalContainer().getString("introspectionUtils.getPropertyError", name, o.getClass()), e);
        } catch (InvocationTargetException e) {
    ...
    public static Object callMethod1(Object target, String methodN,
        ...
        if (target == null || methodN == null || param1 == null) {
            throw new IllegalArgumentException(UpgradeUtil.getLocalContainer().getString("introspectionUtils.nullParameter"));
        }
        if (log.isDebugEnabled())
    ...
    public static Object convert(String object, Class<?> paramType) {
        ...
        if (result == null) {
            throw new IllegalArgumentException(UpgradeUtil.getLocalContainer().getString("introspectionUtils.conversionError", object, paramType.getName()));
        }
        return result;
    }
