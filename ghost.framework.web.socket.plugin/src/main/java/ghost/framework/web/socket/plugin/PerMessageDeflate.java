    ...
    public TransformationResult getMoreData(byte opCode, boolean fin, int rsv, ByteBuffer dest)
        ...
        while (dest.remaining() > 0) {
            ...
            try {
                ...
                throw new IOException(UpgradeUtil.getLocalContainer().getString("perMessageDeflate.deflateFailed"), e);
            } catch (NullPointerException e) {
                throw new IOException(UpgradeUtil.getLocalContainer().getString("perMessageDeflate.alreadyClosed"), e);
            }
            ...
            if (Util.isControl(opCode)) {
                ...
                while (deflateRequired) {
                    ...
                    if (fin && !full && needsInput) {
                        ...
                        throw new IllegalStateException(UpgradeUtil.getLocalContainer().getString("perMessageDeflate.invalidState"));
                    }
