...
import ghost.framework.web.socket.plugin.util.threads.ThreadPoolExecutor;
    ...
    private static AsynchronousChannelGroup createAsynchronousChannelGroup() {
        ...
        try {
            ...
            try {
                ...
                throw new IllegalStateException(UpgradeUtil.getLocalContainer().getString("asyncChannelGroup.createFail"));
            }
        } finally {
