...
import ghost.framework.web.socket.plugin.net.SSLSessionManager;
...
public class JSSESupport implements SSLSupport, SSLSessionManager {
    ...
    public java.security.cert.X509Certificate[] getPeerCertificateChain() throws IOException {
        ...
        try {
            ...
            log.debug(UpgradeUtil.getLocalContainer().getString("jsseSupport.clientCertError"), t);
            return null;
        }
        ...
        for(int i=0; i < certs.length; i++) {
            if (certs[i] instanceof java.security.cert.X509Certificate ) {
                ...
                try {
                    ...
                    log.info(UpgradeUtil.getLocalContainer().getString(
