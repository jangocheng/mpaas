 ...
 */
package ghost.framework.data.transaction;

import ghost.framework.beans.annotation.constraints.Nullable;
import ghost.framework.beans.annotation.invoke.Loader;
import ghost.framework.context.annotation.BeanFactoryAnnotationUtils;
import ghost.framework.context.core.ReactiveAdapter;
import ghost.framework.context.core.ReactiveAdapterRegistry;
...
import ghost.framework.data.transaction.reactive.support.ReactiveTransactionContextManager;
import ghost.framework.data.transaction.reactive.support.ReactiveTransactionInfo;
import ghost.framework.transaction.*;
...
import ghost.framework.transaction.interceptor.TransactionAttributeEditor;
import ghost.framework.transaction.support.*;
...
//import ghost.framework.data.transaction.support.CallbackPreferringPlatformTransactionManager;
//import ghost.framework.data.transaction.support.TransactionManager;
//import ghost.framework.data.transaction.support.TransactionStatus;
...
//import ghost.framework.beans.factory.annotation.BeanFactoryAnnotationUtils;
...
//import ghost.framework.transaction.ReactiveTransaction;
//import ghost.framework.transaction.ReactiveTransactionManager;
//import ghost.framework.transaction.TransactionManager;
//import ghost.framework.transaction.TransactionStatus;
//import ghost.framework.transaction.reactive.ReactiveTransactionContextManager;
//import ghost.framework.transaction.support.CallbackPreferringPlatformTransactionManager;
//import ghost.framework.util.Assert;
//import ghost.framework.util.ClassUtils;
//import ghost.framework.util.ConcurrentReferenceHashMap;
//import ghost.framework.util.StringUtils;
...
public abstract class TransactionAspectSupport /*implements BeanFactoryAware*/ {
	 ...
	 * ReactiveTransactionSynchronizationManager's {@code isSynchronizationActive()}
	 * and/or {@code isActualTransactionActive()} methods.
	 * @return the TransactionInfo bound to this thread, or {@code null} if none
	 * @see TransactionInfo#hasTransaction()
	 * @see ghost.framework.transaction.support.TransactionSynchronizationManager#isSynchronizationActive()
	 * @see ghost.framework.transaction.support.TransactionSynchronizationManager#isActualTransactionActive()
	 */
	@Nullable
	 ...
	 * @see NameMatchTransactionAttributeSource
	 * @see ghost.framework.transaction.annotation.AnnotationTransactionAttributeSource
	 */
...
//	@Override
	...
	protected Object invokeWithinTransaction(Method method, @Nullable Class<?> targetClass,
		...
		if (txAttr == null || !(ptm instanceof CallbackPreferringPlatformTransactionManager)) {
			...
			// It's a CallbackPreferringPlatformTransactionManager: pass a ReactiveTransactionCallback in.
			try {
				/*
...
*/
	 ...
	 * @see ghost.framework.util.ClassUtils#getQualifiedMethodName
	 */
	@Nullable
...
//				status = tm.getTransaction(txAttr);
	...
	protected static final class TransactionInfo {
		...
		public String toString() {
			return null;//(this.transactionAttribute != null ? this.transactionAttribute.toString() : "No transaction");
		}
	}
	...
	/**
	 * Internal holder class for a Throwable in a callback transaction entity.
	 */
	 ...
	 * thrown from a ReactiveTransactionCallback (and subsequently unwrapped again).
	 */
	@SuppressWarnings("serial")
	...
	private class ReactiveTransactionSupport {
		...
		public Object invokeWithinTransaction(Method method, @Nullable Class<?> targetClass,
			...
			if (Mono.class.isAssignableFrom(method.getReturnType())) {
				return ReactiveTransactionContextManager.currentContext().flatMap(context ->
						...
						})).subscriberContext(ReactiveTransactionContextManager.getOrCreateContext())
						.subscriberContext(ReactiveTransactionContextManager.getOrCreateContextHolder());
			}

			// Any other reactive type, typically a Flux
			return this.adapter.fromPublisher(ReactiveTransactionContextManager.currentContext().flatMapMany(context ->
