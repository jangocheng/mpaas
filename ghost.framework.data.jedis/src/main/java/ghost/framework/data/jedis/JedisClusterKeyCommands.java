...
class JedisClusterKeyCommands implements RedisKeyCommands {
	...
	public Long del(byte[]... keys) {
		...
		return (long) connection.getClusterCommandExecutor()
				.executeMultiKeyCommand((JedisClusterConnection.JedisMultiKeyClusterCommandCallback<Long>) (client, key) -> client.del(key),
						Arrays.asList(keys))
				.resultsAsList().size();
	}
	...
	public Set<byte[]> keys(byte[] pattern) {
		...
		Collection<Set<byte[]>> keysPerNode = connection.getClusterCommandExecutor()
				.executeCommandOnAllNodes((JedisClusterConnection.JedisClusterCommandCallback<Set<byte[]>>) client -> client.keys(pattern))
				.resultsAsList();
	...
	public Set<byte[]> keys(RedisClusterNode node, byte[] pattern) {
		...
		return connection.getClusterCommandExecutor()
				.executeCommandOnSingleNode((JedisClusterConnection.JedisClusterCommandCallback<Set<byte[]>>) client -> client.keys(pattern), node)
				.getValue();
	}
	...
	Cursor<byte[]> scan(RedisClusterNode node, ScanOptions options) {
		...
		return connection.getClusterCommandExecutor()
				.executeCommandOnSingleNode((JedisClusterConnection.JedisClusterCommandCallback<Cursor<byte[]>>) client -> {
	...
	public byte[] randomKey(RedisClusterNode node) {
		...
		return connection.getClusterCommandExecutor()
				.executeCommandOnSingleNode((JedisClusterConnection.JedisClusterCommandCallback<byte[]>) client -> client.randomBinaryKey(), node)
				.getValue();
	}
	...
	public Long pTtl(byte[] key) {
		...
		return connection.getClusterCommandExecutor()
				.executeCommandOnSingleNode((JedisClusterConnection.JedisClusterCommandCallback<Long>) client -> client.pttl(key),
	...
	public Long pTtl(byte[] key, TimeUnit timeUnit) {
		...
		return connection.getClusterCommandExecutor()
				.executeCommandOnSingleNode(
						(JedisClusterConnection.JedisClusterCommandCallback<Long>) client -> Converters.millisecondsToTimeUnit(client.pttl(key), timeUnit),
						connection.getTopologyProvider().getTopology().getKeyServingMasterNode(key))
				.getValue();
	}
	...
	public byte[] dump(byte[] key) {
		...
		return connection.getClusterCommandExecutor()
				.executeCommandOnSingleNode((JedisClusterConnection.JedisClusterCommandCallback<byte[]>) client -> client.dump(key),
						connection.getTopologyProvider().getTopology().getKeyServingMasterNode(key))
				.getValue();
	}
	...
	public void restore(byte[] key, long ttlInMillis, byte[] serializedValue, boolean replace) {
		...
		connection.getClusterCommandExecutor().executeCommandOnSingleNode((JedisClusterConnection.JedisClusterCommandCallback<String>) client -> {
			if (!replace) {
	...
	public Long exists(byte[]... keys) {
		...
		return connection.getClusterCommandExecutor()
				.executeMultiKeyCommand((JedisClusterConnection.JedisMultiKeyClusterCommandCallback<Boolean>) BinaryJedis::exists, Arrays.asList(keys))
				.resultsAsList().stream().mapToLong(val -> ObjectUtils.nullSafeEquals(val, Boolean.TRUE) ? 1 : 0).sum();
	}

	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#encoding(byte[])
	 */
	@Nullable
	@Override
	public ValueEncoding encodingOf(byte[] key) {
		...
		return connection.getClusterCommandExecutor()
				.executeCommandOnSingleNode((JedisClusterConnection.JedisClusterCommandCallback<byte[]>) client -> client.objectEncoding(key),
						connection.clusterGetNodeForKey(key))
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#idletime(byte[])
	 */
	@Nullable
	@Override
	public Duration idletime(byte[] key) {
		...
		return connection.getClusterCommandExecutor()
				.executeCommandOnSingleNode((JedisClusterConnection.JedisClusterCommandCallback<Long>) client -> client.objectIdletime(key),
						connection.clusterGetNodeForKey(key))
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisKeyCommands#refcount(byte[])
	 */
	@Nullable
	@Override
	public Long refcount(byte[] key) {
		...
		return connection.getClusterCommandExecutor()
				.executeCommandOnSingleNode((JedisClusterConnection.JedisClusterCommandCallback<Long>) client -> client.objectRefcount(key),
						connection.clusterGetNodeForKey(key))
				.getValue();
