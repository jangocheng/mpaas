...
class JedisGeoCommands implements RedisGeoCommands {
	...
	public GeoResults<GeoLocation<byte[]>> geoRadius(byte[] key, Circle within) {
		...
		Converter<List<GeoRadiusResponse>, GeoResults<GeoLocation<byte[]>>> converter = JedisConverters
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisGeoCommands#geoRadiusByMember(byte[], byte[], ghost.framework.data.geo.Distance, ghost.framework.data.redis.connection.RedisGeoCommands.GeoRadiusCommandArgs)
	 */
	@Override
	public GeoResults<GeoLocation<byte[]>> geoRadiusByMember(byte[] key, byte[] member, Distance radius,
