...
import ghost.framework.data.dao.InvalidDataAccessResourceUsageException;
 ...
 * @see Jedis
 */
public class JedisConnectionFactory implements AutoCloseable, RedisConnectionFactory {
	 ...
	 * {@link JedisClusterConnection.JedisClusterTopologyProvider} by default.
	 *
	 * @param cluster the {@link JedisCluster}, must not be {@literal null}.
	 * @return the {@link ClusterTopologyProvider}.
	 * @see JedisClusterConnection.JedisClusterTopologyProvider
	 * @see 2.2
	 */
	...
	/* (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisConnectionFactory#getSentinelConnection()
	 */
	@Override
	...
	private Jedis getActiveSentinel() {
		...
		for (RedisNode node : ((RedisConfiguration.SentinelConfiguration) configuration).getSentinels()) {
	...
	static class MutableJedisClientConfiguration implements JedisClientConfiguration {
		...
		/* (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.jedis.JedisClientConfiguration#isUseSsl()
		 */
		@Override
		public boolean isUseSsl() {
			return useSsl;
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.jedis.JedisClientConfiguration#getSslSocketFactory()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.jedis.JedisClientConfiguration#getSslParameters()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.jedis.JedisClientConfiguration#getHostnameVerifier()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.jedis.JedisClientConfiguration#isUsePooling()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.jedis.JedisClientConfiguration#getPoolConfig()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.jedis.JedisClientConfiguration#getClientName()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.jedis.JedisClientConfiguration#getReadTimeout()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.jedis.JedisClientConfiguration#getConnectTimeout()
		 */
		@Override
