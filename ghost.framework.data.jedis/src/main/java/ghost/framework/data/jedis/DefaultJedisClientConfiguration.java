...
class DefaultJedisClientConfiguration implements JedisClientConfiguration {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.jedis.JedisClientConfiguration#useSsl()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.jedis.JedisClientConfiguration#usePooling()
	 */
	@Override
