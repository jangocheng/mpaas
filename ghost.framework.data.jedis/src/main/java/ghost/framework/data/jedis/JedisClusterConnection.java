...
import ghost.framework.data.dao.DataAccessResourceFailureException;
...
public class JedisClusterConnection implements DefaultedRedisClusterConnection {
	...
	public JedisClusterConnection(JedisCluster cluster) {
		...
		clusterCommandExecutor = new ClusterCommandExecutor(topologyProvider, new JedisClusterNodeResourceProvider(cluster, topologyProvider), EXCEPTION_TRANSLATION);
		disposeClusterCommandExecutorOnClose = true;

		try {
			Object f = ReflectUtil.findField(cluster, "maxRedirections");
			if (f != null) {
				clusterCommandExecutor.setMaxRedirects((Integer) f);
			}
		} catch (Exception e) {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterConnection#execute(String, byte[], java.util.Collection)
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterConnection#serverCommands()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterConnection#keys(ghost.framework.data.redis.connection.RedisClusterNode, byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterConnection#scan(ghost.framework.data.redis.connection.RedisClusterNode, ghost.framework.data.redis.core.ScanOptions)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterConnection#randomKey(ghost.framework.data.redis.connection.RedisClusterNode)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterConnection#ping(ghost.framework.data.redis.connection.RedisClusterNode)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterSetSlot(ghost.framework.data.redis.connection.RedisClusterNode, int, ghost.framework.data.redis.connection.RedisClusterCommands.AddSlots)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterGetKeysInSlot(int, java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterAddSlots(ghost.framework.data.redis.connection.RedisClusterNode, int[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterAddSlots(ghost.framework.data.redis.connection.RedisClusterNode, ghost.framework.data.redis.connection.RedisClusterNode.SlotRange)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterCountKeysInSlot(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterDeleteSlots(ghost.framework.data.redis.connection.RedisClusterNode, int[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterDeleteSlotsInRange(ghost.framework.data.redis.connection.RedisClusterNode, ghost.framework.data.redis.connection.RedisClusterNode.SlotRange)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterForget(ghost.framework.data.redis.connection.RedisClusterNode)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterMeet(ghost.framework.data.redis.connection.RedisClusterNode)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterReplicate(ghost.framework.data.redis.connection.RedisClusterNode, ghost.framework.data.redis.connection.RedisClusterNode)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#getClusterSlotForKey(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterGetNodeForSlot(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterGetNodes()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterGetSlaves(ghost.framework.data.redis.connection.RedisClusterNode)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterGetMasterSlaveMap()
	 */
	@Override
	public Map<RedisClusterNode, Collection<RedisClusterNode>> clusterGetMasterSlaveMap() {

		List<ClusterCommandExecutor.NodeResult<Collection<RedisClusterNode>>> nodeResults = clusterCommandExecutor
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterGetNodeForKey(byte[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.redis.connection.RedisClusterCommands#clusterGetClusterInfo()
	 */
	@Override
	...
	/**
	 * {@link Jedis} specific {@link ClusterCommandExecutor.ClusterCommandCallback}.
	 *
	 * @author Christoph Strobl
	 * @param <T>
	 * @since 1.7
	...
	/**
	 * {@link Jedis} specific {@link ClusterCommandExecutor.MultiKeyClusterCommandCallback}.
	 *
	 * @author Christoph Strobl
	 * @param <T>
	 * @since 1.7
	...
	static class JedisClusterNodeResourceProvider implements ClusterNodeResourceProvider {
		...
		JedisClusterNodeResourceProvider(JedisCluster cluster, ClusterTopologyProvider topologyProvider) {
			...
			if (cluster != null) {
				Object f = ReflectUtil.findField(cluster, "connectionHandler");
				if (f != null) {
					this.connectionHandler = (JedisClusterConnectionHandler) f;
				}
			} else {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.ClusterNodeResourceProvider#getResourceForSpecificNode(ghost.framework.data.redis.connection.RedisClusterNode)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.redis.connection.ClusterNodeResourceProvider#returnResourceForSpecificNode(ghost.framework.data.redis.connection.RedisClusterNode, java.lang.Object)
		 */
		@Override
