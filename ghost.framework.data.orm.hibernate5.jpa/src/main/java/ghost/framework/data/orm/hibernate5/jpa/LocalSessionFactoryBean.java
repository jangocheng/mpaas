...
//import ghost.framework.core.io.ClassPathResource;
 ...
 * to {@link LocalContainerEntityManagerFactoryBean} for common
...
public class LocalSessionFactoryBean extends HibernateExceptionTranslator
		implements FactoryBean<SessionFactory>/*, ResourceLoaderAware*//*, BeanFactoryAware*/, AutoCloseable/*, InitializingBean, DisposableBean*/ {

	@Nullable
	private DataSource dataSource;

	@Nullable
	private IResource[] configLocations;

	@Nullable
	private String[] mappingResources;

	@Nullable
	private IResource[] mappingLocations;

	@Nullable
	private IResource[] cacheableMappingLocations;

	@Nullable
	private IResource[] mappingJarLocations;

	@Nullable
	private IResource[] mappingDirectoryLocations;
	 ...
	 */
	public void setConfigLocation(IResource configLocation) {
		this.configLocations = new IResource[] {configLocation};
	}
	 ...
	 * @see Configuration#configure(java.net.URL)
	 */
	public void setConfigLocations(IResource... configLocations) {
	 ...
	 */
	public void setMappingLocations(IResource... mappingLocations) {
	 ...
	 */
	public void setCacheableMappingLocations(IResource... cacheableMappingLocations) {
	 ...
	 */
	public void setMappingJarLocations(IResource... mappingJarLocations) {
	 ...
	 */
	public void setMappingDirectoryLocations(IResource... mappingDirectoryLocations) {
	...
	/**
	 * Set the Spring {@link JtaTransactionManager}
	 ...
	 * e.g. a {@link SimpleAsyncTaskExecutor}.
	 ...
	 * @since 4.3
	 * @see LocalSessionFactoryBuilder#LocalSessionFactoryBuilder(DataSource, IResourceLoader, MetadataSources)
	 */
	...
	/**
	 * Specify a Spring {@link IResourceLoader} to use for Hibernate metadata.
	 * @param IResourceLoader the IResourceLoader to use (never {@code null})
	 */
//	@Override
	...
	/**
	 * Determine the Spring {@link IResourceLoader} to use for Hibernate metadata.
	 * @return the IResourceLoader to use (never {@code null})
	 * @since 4.3
	 */
...
//	@Override
	...
	public void afterPropertiesSet() throws IOException {
		...
		if (this.configLocations != null) {
			for (IResource resource : this.configLocations) {
		...
		if (this.mappingResources != null) {
			...
			for (String mapping : this.mappingResources) {
				IResource mr = new ClassPathResource(mapping.trim(), getResourceLoader().getClassLoader());
		...
		if (this.mappingLocations != null) {
			// Register given Hibernate mapping definitions, contained in resource files.
			for (IResource resource : this.mappingLocations) {
		...
		if (this.cacheableMappingLocations != null) {
			...
			for (IResource resource : this.cacheableMappingLocations) {
		...
		if (this.mappingJarLocations != null) {
			...
			for (IResource resource : this.mappingJarLocations) {
		...
		if (this.mappingDirectoryLocations != null) {
			...
			for (IResource resource : this.mappingDirectoryLocations) {
