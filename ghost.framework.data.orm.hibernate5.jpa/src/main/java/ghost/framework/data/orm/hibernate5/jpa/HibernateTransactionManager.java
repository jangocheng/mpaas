...
import ghost.framework.data.jdbc.datasource.ConnectionHolder;
import ghost.framework.data.jdbc.datasource.DataSourceUtils;
import ghost.framework.data.jdbc.datasource.JdbcTransactionObjectSupport;
import ghost.framework.data.jdbc.datasource.TransactionAwareDataSourceProxy;
import ghost.framework.transaction.*;
import ghost.framework.transaction.support.AbstractPlatformTransactionManager;
import ghost.framework.transaction.support.DefaultTransactionStatus;
import ghost.framework.transaction.support.ResourceTransactionManager;
...
//import ghost.framework.jdbc.datasource.ConnectionHolder;
//import ghost.framework.jdbc.datasource.DataSourceUtils;
//import ghost.framework.jdbc.datasource.JdbcTransactionObjectSupport;
//import ghost.framework.jdbc.datasource.TransactionAwareDataSourceProxy;
...
/**
 * {@link ghost.framework.transaction.PlatformTransactionManager}
 ...
 * with {@link ghost.framework.jdbc.datasource.DataSourceTransactionManager}
 * (i.e. {@link ghost.framework.jdbc.datasource.DataSourceUtils#getConnection}
 * or going through a
 * {@link ghost.framework.jdbc.datasource.TransactionAwareDataSourceProxy}).
 *
 * <p>Note: To be able to register a DataSource's Connection for plain JDBC code,
 * this instance needs to be aware of the DataSource ({@link #setDataSource}).
 * The given DataSource should obviously match the one used by the given SessionFactory.
 *
 * <p>JTA (usually through {@link ghost.framework.transaction.jta.JtaTransactionManager})
 ...
 * @see ghost.framework.jdbc.core.JdbcTemplate
...
public class HibernateTransactionManager extends AbstractPlatformTransactionManager
	 ...
	 * a {@link ghost.framework.jdbc.datasource.LazyConnectionDataSourceProxy}
	 ...
	 * @see ghost.framework.jdbc.datasource.LazyConnectionDataSourceProxy
	 * @see ghost.framework.jdbc.core.JdbcTemplate
	 */
	 ...
	 * Sessions in a place other than Spring's ReactiveTransactionSynchronizationManager.
	 ...
	 * @throws BeanException if bean name resolution via the bean factory failed
	 * @see #setEntityInterceptor
	 * @see #setEntityInterceptorBeanName
	 * @see #setBeanFactory
	 */
	@Nullable
	public Interceptor getEntityInterceptor() throws IllegalStateException, BeanException {
...
//	@Override
	 ...
	 * from the {@code ghost.framework.dao} hierarchy.
