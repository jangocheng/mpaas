 ...
 *
 * <pre class="code">
 * &lt;bean id="entityManagerFactory" class="ghost.framework.orm.jpa.LocalContainerEntityManagerFactoryBean"&gt;
 *   ...
 *   &lt;property name="jpaPropertyMap"&gt;
 * 	   &lt;map>
 *       &lt;entry key="hibernate.resource.beans.container"&gt;
 * 	       &lt;bean class="ghost.framework.orm.hibernate5.SpringBeanContainer"/&gt;
 * 	     &lt;/entry&gt;
 * 	   &lt;/map&gt;
 *   &lt;/property&gt;
 * &lt;/bean&gt;</pre>
 ...
 * to {@link ghost.framework.orm.jpa.LocalContainerEntityManagerFactoryBean} for common
 ...
 * @see ghost.framework.orm.jpa.LocalContainerEntityManagerFactoryBean#setJpaPropertyMap
