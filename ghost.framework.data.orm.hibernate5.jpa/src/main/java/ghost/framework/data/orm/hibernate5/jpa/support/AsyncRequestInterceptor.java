...
// */
//
//package ghost.framework.data.orm.hibernate5.jpa.support;
//
//import ghost.framework.data.orm.hibernate5.jpa.SessionFactoryUtils;
//import ghost.framework.data.orm.hibernate5.jpa.SessionHolder;
...
//
////import ghost.framework.orm.hibernate5.SessionFactoryUtils;
////import ghost.framework.orm.hibernate5.SessionHolder;
////import ghost.framework.transaction.support.TransactionSynchronizationManager;
////import ghost.framework.web.context.request.NativeWebRequest;
////import ghost.framework.web.context.request.async.CallableProcessingInterceptor;
////import ghost.framework.web.context.request.async.DeferredResult;
////import ghost.framework.web.context.request.async.DeferredResultProcessingInterceptor;
//
///**
