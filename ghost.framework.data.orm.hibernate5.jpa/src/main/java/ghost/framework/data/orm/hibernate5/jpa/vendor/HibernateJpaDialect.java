...
package ghost.framework.data.orm.hibernate5.jpa.vendor;
...
import ghost.framework.data.jdbc.support.SQLExceptionTranslator;
import ghost.framework.data.orm.ObjectOptimisticLockingFailureException;
import ghost.framework.data.orm.ObjectRetrievalFailureException;
import ghost.framework.data.orm.jpa.DefaultJpaDialect;
import ghost.framework.data.orm.jpa.EntityManagerFactoryUtils;
import ghost.framework.data.orm.jpa.JpaSystemException;
import ghost.framework.transaction.InvalidIsolationLevelException;
import ghost.framework.transaction.ResourceTransactionDefinition;
...
//import ghost.framework.jdbc.support.SQLExceptionTranslator;
//import ghost.framework.lang.Nullable;
//import ghost.framework.orm.ObjectOptimisticLockingFailureException;
//import ghost.framework.orm.ObjectRetrievalFailureException;
//import ghost.framework.orm.jpa.DefaultJpaDialect;
//import ghost.framework.orm.jpa.EntityManagerFactoryUtils;
//import ghost.framework.orm.jpa.JpaSystemException;
//import ghost.framework.transaction.InvalidIsolationLevelException;
//import ghost.framework.transaction.TransactionDefinition;
//import ghost.framework.transaction.TransactionException;
//import ghost.framework.transaction.support.ResourceTransactionDefinition;

/**
 * {@link ghost.framework.data.orm.jpa.JpaDialect} implementation for
...
public class HibernateJpaDialect extends DefaultJpaDialect {
	 ...
	 * @see ghost.framework.data.jdbc.support.SQLErrorCodeSQLExceptionTranslator
	 * @see ghost.framework.data.jdbc.support.SQLStateSQLExceptionTranslator
	 */
	...
	protected DataAccessException convertHibernateAccessException(HibernateException ex) {
		...
		if (ex instanceof QueryTimeoutException) {
			...
			return new ghost.framework.data.dao.QueryTimeoutException(ex.getMessage() + "; SQL [" + jdbcEx.getSQL() + "]", ex);
		}
