...
public interface HibernateOperations {
	 ...
	 * @throws ghost.framework.orm.ObjectRetrievalFailureException if not found
	 * @throws DataAccessException in case of Hibernate errors
	 ...
	 * @param lockMode the lock mode to obtain
	 * @throws ghost.framework.orm.ObjectOptimisticLockingFailureException if not found
	 * @throws DataAccessException in case of Hibernate errors
