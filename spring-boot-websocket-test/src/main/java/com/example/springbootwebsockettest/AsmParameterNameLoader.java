...
// * class byte code.
// *
// * This wonderful piece of code was taken from ghost.framework.core.LocalVariableTableParameterNameDiscover
// */
...
//        Map<Method, List<String>> listMap = loader.getAllMethodParameters(VLInterfaceTest.class, "test");
