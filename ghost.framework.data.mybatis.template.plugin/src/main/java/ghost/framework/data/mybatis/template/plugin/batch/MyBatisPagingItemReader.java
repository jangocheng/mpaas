 ...
 */
package ghost.framework.data.mybatis.template.plugin.batch;

import org.apache.ibatis.session.ExecutorType;
import org.apache.ibatis.session.SqlSession;
import org.apache.ibatis.session.SqlSessionFactory;
import org.mybatis.spring.SqlSessionTemplate;
import ghost.framework.batch.item.database.AbstractPagingItemReader;
...
import static ghost.framework.util.ClassUtils.getShortName;

/**
 * {@code ghost.framework.batch.item.ItemReader} for reading database records using MyBatis in a paging fashion.
 * <p>
