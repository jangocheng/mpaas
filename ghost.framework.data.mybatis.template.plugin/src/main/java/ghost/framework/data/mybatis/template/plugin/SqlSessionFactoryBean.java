 ...
 */
package ghost.framework.data.mybatis.template.plugin;
...
import ghost.framework.core.NestedIOException;
import ghost.framework.core.io.Resource;
import ghost.framework.core.io.support.PathMatchingResourcePatternResolver;
import ghost.framework.core.io.support.ResourcePatternResolver;
...
import static ghost.framework.util.Assert.state;
import static ghost.framework.util.ObjectUtils.isEmpty;
import static ghost.framework.util.StringUtils.hasLength;
import static ghost.framework.util.StringUtils.tokenizeToStringArray;
...
public class SqlSessionFactoryBean
   ...
   *
   * <p>
   * Since 2.0.1, allow to specify a wildcard such as {@code com.example.*.entity}.
   *
   * @since 1.0.1
   *
