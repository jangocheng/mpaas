...
public class SqlSessionTemplate implements SqlSession, DisposableBean {
   ...
   * @see "ghost.framework.beans.factory.support.DisposableBeanAdapter#inferDestroyMethodIfNecessary(Object, RootBeanDefinition)"
   * @see "ghost.framework.beans.factory.support.DisposableBeanAdapter#CLOSE_METHOD_NAME"
   */
  @Override
