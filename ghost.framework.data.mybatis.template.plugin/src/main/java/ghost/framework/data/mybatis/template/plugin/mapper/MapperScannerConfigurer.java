 ...
 */
package ghost.framework.data.mybatis.template.plugin.mapper;
...
import ghost.framework.beans.factory.config.PropertyResourceConfigurer;
...
public class MapperScannerConfigurer
  ...
  private void processPropertyPlaceHolders() {
    ...
    if (!prcs.isEmpty() && applicationContext instanceof ConfigurableApplicationContext) {
      IBeanDefinition mapperScannerBean = ((ConfigurableApplicationContext) applicationContext).getBeanFactory()
