 ...
 */
package ghost.framework.data.mybatis.template.plugin.batch.builder;
...
public class MyBatisPagingItemReaderBuilder<T> {
   ...
   *          number of items
   * @return this instance for method chaining
   * @see ghost.framework.batch.item.database.AbstractPagingItemReader#setPageSize(int)
   */
  ...
  /**
   * Configure if the state of the {@link ghost.framework.batch.item.ItemStreamSupport} should be persisted within
   * the {@link ghost.framework.batch.item.ExecutionContext} for restart purposes.
   *
   * @param saveState
   *          defaults to true
   * @return The current instance of the builder.
   * @see ghost.framework.batch.item.support.AbstractItemCountingItemStreamItemReader#setSaveState(boolean)
   */
   ...
   * @return The current instance of the builder.
   * @see ghost.framework.batch.item.support.AbstractItemCountingItemStreamItemReader#setMaxItemCount(int)
   */
