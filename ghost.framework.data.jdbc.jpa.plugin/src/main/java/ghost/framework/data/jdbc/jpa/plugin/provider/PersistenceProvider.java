 ...
 */
package ghost.framework.data.jdbc.jpa.plugin.provider;
...
import static ghost.framework.data.jdbc.jpa.plugin.provider.JpaClassUtils.isEntityManagerOfType;
import static ghost.framework.data.jdbc.jpa.plugin.provider.JpaClassUtils.isMetamodelOfType;
import static ghost.framework.data.jdbc.jpa.plugin.provider.PersistenceProvider.Constants.*;
...
//import static ghost.framework.data.jpa.provider.JpaClassUtils.*;
//import static ghost.framework.data.jpa.provider.JpaClassUtils.isEntityManagerOfType;
//import static ghost.framework.data.jpa.provider.JpaClassUtils.isMetamodelOfType;
//import static ghost.framework.data.jpa.provider.PersistenceProvider.Constants.*;
...
public enum PersistenceProvider implements QueryExtractor, ProxyIdAccessor {
	...
	HIBERNATE(//
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.jpa.repository.support.ProxyIdAccessor#isProxy(java.lang.Object)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.jpa.repository.support.ProxyIdAccessor#getIdentifierFrom(java.lang.Object)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.jpa.provider.PersistenceProvider#executeQueryWithResultStream(javax.persistence.Query)
		 */
		@Override
	...
	GENERIC_JPA(Collections.singleton(GENERIC_JPA_ENTITY_MANAGER_INTERFACE), Collections.emptySet()) {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.jpa.repository.query.QueryExtractor#extractQueryString(javax.persistence.Query)
		 */
		@Nullable
		@Override
		public String extractQueryString(Query query) {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.jpa.repository.support.PersistenceProvider#canExtractQuery()
		 */
		@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.query.QueryExtractor#canExtractQuery()
	 */
	@Override
	public boolean canExtractQuery() {
		return true;
	...
	private static class HibernateScrollableResultsIterator implements CloseableIterator<Object> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.util.CloseableIterator#close()
		 */
		@Override
		public void close() {
