...
import ghost.framework.data.commons.domain.*;
...
import ghost.framework.data.jdbc.jpa.plugin.convert.QueryByExamplePredicateBuilder;
import ghost.framework.data.jdbc.jpa.plugin.domain.Specification;
...
import ghost.framework.data.jdbc.jpa.plugin.repository.query.QueryUtils;
import ghost.framework.data.transaction.Transactional;
...
import static ghost.framework.data.jdbc.jpa.plugin.repository.query.QueryUtils.*;

//import ghost.framework.data.jdbc.jpa.plugin.annotation.Repository;

//import javax.transaction.Transactional;

//import ghost.framework.data.jpa.convert.QueryByExamplePredicateBuilder;
//import ghost.framework.data.jpa.domain.Specification;
...
//import ghost.framework.data.jpa.repository.query.QueryUtils;
//import ghost.framework.data.jpa.repository.support.QueryHints.NoHints;
//import ghost.framework.data.repository.support.PageableExecutionUtils;
//import ghost.framework.data.util.ProxyUtils;
//import ghost.framework.stereotype.Repository;
//import ghost.framework.transaction.annotation.Transactional;

//import static ghost.framework.data.jpa.repository.query.QueryUtils.*;

/**
 * Default implementation of the {@link ghost.framework.data.repository.CrudRepository} interface. This will offer
...
public class SimpleJpaRepository<T, ID> implements JpaRepositoryImplementation<T, ID> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.CrudRepository#delete(java.io.Serializable)
	 */
	@Transactional
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaRepository#deleteInBatch(java.lang.Iterable)
	 */
	@Transactional
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.Repository#deleteAll()
	 */
	@Transactional
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaRepository#deleteAllInBatch()
	 */
	@Transactional
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaRepository#getOne(java.io.Serializable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.CrudRepository#existsById(java.io.Serializable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaRepository#findAll()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaRepository#findAll(ghost.framework.data.commons.domain.Sort)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.PagingAndSortingRepository#findAll(ghost.framework.data.commons.domain.Pageable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaSpecificationExecutor#findOne(ghost.framework.data.jpa.domain.Specification)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaSpecificationExecutor#findAll(ghost.framework.data.jpa.domain.Specification)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaSpecificationExecutor#findAll(ghost.framework.data.jpa.domain.Specification, ghost.framework.data.commons.domain.Pageable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaSpecificationExecutor#findAll(ghost.framework.data.jpa.domain.Specification, ghost.framework.data.commons.domain.Sort)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.query.QueryByExampleExecutor#findAll(ghost.framework.data.domain.Example, ghost.framework.data.commons.domain.Pageable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaSpecificationExecutor#count(ghost.framework.data.jpa.domain.Specification)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaRepository#saveAndFlush(java.lang.Object)
	 */
	@Transactional
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaRepository#save(java.lang.Iterable)
	 */
	@Transactional
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaRepository#flush()
	 */
	@Transactional
	@Override
	public void flush() {
	...
	private static final class ByIdsSpecification<T> implements Specification<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.jpa.domain.Specification#toPredicate(javax.persistence.criteria.Root, javax.persistence.criteria.CriteriaQuery, javax.persistence.criteria.CriteriaBuilder)
		 */
		@Override
