...
//import ghost.framework.data.repository.cdi.CdiRepositoryExtensionSupport;
...
public class JpaRepositoryExtension extends CdiRepositoryExtensionSupport {
	...
	private final ICoreInterface coreInterface = null;
	...
	private <T> CdiRepositoryBean<T> createRepositoryBean(Class<T> repositoryType, Set<Annotation> qualifiers,
		...
		return new JpaRepositoryBean<T>(beanManager, entityManagerBean, qualifiers, repositoryType,
				Optional.of(getCustomImplementationDetector()), this.coreInterface);
	}
}
