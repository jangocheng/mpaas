...
//import ghost.framework.data.jpa.repository.JpaContext;

import ghost.framework.data.jdbc.jpa.plugin.repository.JpaContext;
...
public class DefaultJpaContext implements JpaContext {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.JpaContext#getByManagedType(java.lang.Class)
	 */
	@Override
