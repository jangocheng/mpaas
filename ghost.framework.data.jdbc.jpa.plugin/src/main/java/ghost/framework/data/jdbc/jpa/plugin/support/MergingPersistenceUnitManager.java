...
public class MergingPersistenceUnitManager extends DefaultPersistenceUnitManager {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.orm.jpa.persistenceunit.DefaultPersistenceUnitManager#postProcessPersistenceUnitInfo(ghost.framework.orm.jpa.persistenceunit.MutablePersistenceUnitInfo)
	 */
//	@Override
...
//		super.postProcessPersistenceUnitInfo(pui);
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.orm.jpa.persistenceunit.DefaultPersistenceUnitManager#isPersistenceUnitOverrideAllowed()
	 */
	@Override
