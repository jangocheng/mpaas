...
/**
 * {@link RepositoryQuery} implementation that inspects a {@link ghost.framework.data.repository.query.QueryMethod}
 * for the existence of an {@link ghost.framework.data.jpa.repository.Query} annotation and creates a JPA native
 * {@link Query} from it.
 *
...
final class NativeJpaQuery extends AbstractStringBasedJpaQuery {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.query.AbstractStringBasedJpaQuery#createJpaQuery(java.lang.String)
	 */
	@Override
