...
public class QuerydslJpaRepository<T, ID extends Serializable> extends SimpleJpaRepository<T, ID>
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jdbc.jpa.plugin.querydsl.QuerydslPredicateExecutor#findOne(com.mysema.query.types.Predicate)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jdbc.jpa.plugin.querydsl.QuerydslPredicateExecutor#findAll(com.mysema.query.types.Predicate)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jdbc.jpa.plugin.querydsl.QuerydslPredicateExecutor#findAll(com.mysema.query.types.Predicate, com.mysema.query.types.OrderSpecifier<?>[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jdbc.jpa.plugin.querydsl.QuerydslPredicateExecutor#findAll(com.mysema.query.types.Predicate, ghost.framework.data.commons.domain.Sort)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jdbc.jpa.plugin.querydsl.QuerydslPredicateExecutor#findAll(com.mysema.query.types.OrderSpecifier[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jdbc.jpa.plugin.querydsl.QuerydslPredicateExecutor#findAll(com.querydsl.core.types.Predicate, ghost.framework.data.commons.domain.Pageable)
	 */
	@Override
