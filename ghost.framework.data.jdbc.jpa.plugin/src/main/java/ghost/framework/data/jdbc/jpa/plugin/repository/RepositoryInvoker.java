...
public interface RepositoryInvoker extends RepositoryInvocationInformation {
	/**
	 * Invokes the method equivalent to {@link ghost.framework.data.repository.CrudRepository#save(Object)} on the
	 * repository.
	 *
	 * @param object
	...
	/**
	 * Invokes the method equivalent to {@link ghost.framework.data.repository.CrudRepository#findById(Object)}.
	 *
	 ...
	 * {@link ghost.framework.data.repository.PagingAndSortingRepository#findAll(Pageable)}), using the method taking
	 * a {@link Sort} if available (i.e. the equivalent to
	 * {@link ghost.framework.data.repository.PagingAndSortingRepository#findAll(Sort)} by extracting the {@link Sort}
	 * contained in the given {@link Pageable}) or the plain equivalent to
	 * {@link ghost.framework.data.repository.CrudRepository#findAll()}.
	 *
	 ...
	 * available (i.e. the equivalent to
	 * {@link ghost.framework.data.repository.PagingAndSortingRepository#findAll(Sort)}) or the plain equivalent to
	 * {@link ghost.framework.data.repository.CrudRepository#findAll()}.
	 *
	 * @param pageable can be {@literal null}.
	 * @return the result of the invocation of the find-all method.
	...
	/**
	 * Invokes the method equivalent to {@link ghost.framework.data.repository.CrudRepository#deleteById(Object)}. The
