...
//import ghost.framework.data.jpa.repository.Temporal;
...
import ghost.framework.data.jdbc.jpa.plugin.repository.Temporal;
...
public class JpaParameters extends Parameters<JpaParameters, JpaParameters.JpaParameter> {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.query.Parameters#createParameter(ghost.framework.core.MethodParameter)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.query.Parameters#createFrom(java.util.List)
	 */
	@Override
	...
	public static class JpaParameter extends Parameter {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.repository.query.Parameter#isBindable()
		 */
		@Override
