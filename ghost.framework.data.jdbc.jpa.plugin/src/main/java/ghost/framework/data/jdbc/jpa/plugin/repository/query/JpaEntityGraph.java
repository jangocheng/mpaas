...
//import ghost.framework.data.jpa.repository.EntityGraph.EntityGraphType;
...
public class JpaEntityGraph {
	...
	/**
	 * Creates an {@link JpaEntityGraph} with the given name, {@link EntityGraph.EntityGraphType} and attribute paths.
	 *
	 ...
	 * @since 1.9
	 */
	public JpaEntityGraph(String name, EntityGraph.EntityGraphType type, @Nullable String[] attributePaths) {
	...
	/**
	 * Returns the {@link EntityGraph.EntityGraphType} of the {@link EntityGraph} to use.
	 *
	 * @return
	 */
