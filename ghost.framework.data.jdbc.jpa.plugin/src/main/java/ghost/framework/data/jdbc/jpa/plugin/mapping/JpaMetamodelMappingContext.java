...
import ghost.framework.data.commons.mapping.PersistentPropertyPaths;
...
//import ghost.framework.data.mapping.PersistentPropertyPaths;
...
public class JpaMetamodelMappingContext
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.context.AbstractMappingContext#createPersistentEntity(ghost.framework.data.util.TypeInformation)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.context.AbstractMappingContext#createPersistentProperty(java.lang.reflect.Field, java.beans.PropertyDescriptor, ghost.framework.data.mapping.entity.MutablePersistentEntity, ghost.framework.data.mapping.entity.SimpleTypeHolder)
	 */
	@Override
	 ...
	 * 
	 * @see ghost.framework.data.mapping.context.AbstractMappingContext#findPersistentPropertyPaths(Class,
	 *      Predicate)
	 */
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.context.AbstractMappingContext#hasPersistentEntityFor(java.lang.Class)
	 */
	@Override
