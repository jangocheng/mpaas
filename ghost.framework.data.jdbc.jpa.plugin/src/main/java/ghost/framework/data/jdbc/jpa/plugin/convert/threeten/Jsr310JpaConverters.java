...
// */
//package ghost.framework.data.jdbc.jpa.plugin.convert.threeten;
//
...
// * can simply register the package of this class (i.e. {@code ghost.framework.data.jpa.convert.threeten}) as package
