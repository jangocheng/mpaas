...
//import ghost.framework.data.repository.config.RepositoryFragmentConfiguration;
...
public abstract class CdiRepositoryBean<T> implements Bean<T>, PassivationCapable {
	...
	/**
	 * Try to lookup a custom implementation for a {@link ghost.framework.data.repository.Repository}. Can only be
