...
import ghost.framework.transaction.support.ResourceHolderSynchronization;
...
public abstract class EntityManagerFactoryUtils {
	...
	/**
	 * Order value for ReactiveTransactionSynchronization objects that clean up JPA
	 ...
	 * @see ghost.framework.jdbc.datasource.DataSourceUtils#CONNECTION_SYNCHRONIZATION_ORDER
	 */
	 ...
	 * {@code ghost.framework.dao} hierarchy.
