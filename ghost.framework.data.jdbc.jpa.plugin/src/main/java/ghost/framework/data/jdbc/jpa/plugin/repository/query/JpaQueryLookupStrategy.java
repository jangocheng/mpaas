...
public final class JpaQueryLookupStrategy {
	...
	private static class DeclaredQueryLookupStrategy extends AbstractQueryLookupStrategy {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.jpa.repository.query.JpaQueryLookupStrategy.AbstractQueryLookupStrategy#resolveQuery(ghost.framework.data.jpa.repository.query.JpaQueryMethod, javax.persistence.EntityManager, ghost.framework.data.repository.core.NamedQueries)
		 */
		@Override
		protected RepositoryQuery resolveQuery(JpaQueryMethod method, EntityManager em, NamedQueries namedQueries) {
	 ...
	 * {@link ghost.framework.data.jpa.repository.Query}, JPA named query). In case none is found we fall back on
	 * query creation.
	 *
	 * @author Oliver Gierke
	 * @author Thomas Darimont
