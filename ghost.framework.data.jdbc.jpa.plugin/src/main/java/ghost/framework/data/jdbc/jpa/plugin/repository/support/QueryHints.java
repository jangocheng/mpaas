...
interface QueryHints extends Iterable<Entry<String, Object>> {
	...
	static enum NoHints implements QueryHints {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.jpa.repository.support.QueryHints#withFetchGraphs(javax.persistence.EntityManager)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.jpa.repository.support.QueryHints#forCounts(javax.persistence.EntityManager)
		 */
		@Override
