...
//import ghost.framework.data.dao.support.PersistenceExceptionTranslator;
...
public interface JpaDialect extends PersistenceExceptionTranslator {
	 ...
	 * {@link ghost.framework.transaction.SavepointManager} interface.
	 ...
	 * @throws ghost.framework.transaction.TransactionException in case of invalid arguments
	 * @see #cleanupTransaction
	 * @see javax.persistence.EntityTransaction#begin
	 * @see ghost.framework.jdbc.datasource.DataSourceUtils#prepareConnectionForTransaction
	 */
	@Nullable
	 ...
	 * @see ghost.framework.jdbc.datasource.DataSourceUtils#resetConnectionAfterTransaction
	 */
	 ...
	 * @see ghost.framework.jdbc.datasource.ConnectionHandle#getConnection
	 * @see ghost.framework.jdbc.datasource.SimpleConnectionHandle
