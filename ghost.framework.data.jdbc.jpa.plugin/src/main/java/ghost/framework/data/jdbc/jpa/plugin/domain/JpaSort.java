...
/**
 * Sort option for queries that wraps JPA meta-entity {@link Attribute}s for sorting.
 *
...
public class JpaSort extends Sort {
	...
	public static class JpaOrder extends Order {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.commons.domain.Sort.Order#with(ghost.framework.data.commons.domain.Sort.Direction)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.commons.domain.Sort.Order#with(ghost.framework.data.commons.domain.Sort.NullHandling)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.commons.domain.Sort.Order#ignoreCase()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.commons.domain.Sort.Order#isIgnoreCase()
		 */
		@Override
