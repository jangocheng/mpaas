...
//import ghost.framework.data.repository.query.SpelQueryContext;
...
import ghost.framework.data.jdbc.jpa.plugin.repository.Part;
...
class StringQuery implements DeclaredQuery {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.query.DeclaredQuery#getParameterBindings()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.query.DeclaredQuery#deriveCountQuery(java.lang.String, java.lang.String)
	 */
	@Override
	@SuppressWarnings("deprecation")
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.query.DeclaredQuery#usesJdbcStyleParameters()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.query.DeclaredQuery#getQueryString()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.query.DeclaredQuery#getAlias()
	 */
	@Override
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.query.DeclaredQuery#hasConstructorExpression()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.query.DeclaredQuery#isDefaultProjection()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.query.DeclaredQuery#hasNamedParameter()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.jpa.repository.query.DeclaredQuery#usesPaging()
	 */
	@Override
	...
	enum ParameterBindingParser {
		...
		private String parseParameterBindingsOfQueryIntoBindingsAndReturnCleanedQuery(String query,
			...
			SpelQueryContext.SpelExtractor spelExtractor = createSpelExtractor(query, parametersShouldBeAccessedByIndex, greatestParameterIndex);
		...
		private static SpelQueryContext.SpelExtractor createSpelExtractor(String queryWithSpel, boolean parametersShouldBeAccessedByIndex,
	...
	static class InParameterBinding extends ParameterBinding {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.jpa.repository.query.StringQuery.ParameterBinding#prepare(java.lang.Object)
		 */
		@Override
