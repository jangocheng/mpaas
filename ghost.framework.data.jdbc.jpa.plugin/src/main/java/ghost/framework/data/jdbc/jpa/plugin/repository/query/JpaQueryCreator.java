...
import ghost.framework.data.jdbc.jpa.plugin.repository.AbstractQueryCreator;
...
import static ghost.framework.data.jdbc.jpa.plugin.repository.Part.Type.*;
import static ghost.framework.data.jdbc.jpa.plugin.repository.query.QueryUtils.toExpressionRecursively;
...
//import static ghost.framework.data.jpa.repository.query.QueryUtils.toExpressionRecursively;
//import static ghost.framework.data.repository.query.parser.Part.Type.*;
//import static ghost.framework.data.repository.query.parser.Part.Type.IS_NOT_EMPTY;
//import static ghost.framework.data.repository.query.parser.Part.Type.NOT_CONTAINING;
//import static ghost.framework.data.repository.query.parser.Part.Type.NOT_LIKE;
