...
//import ghost.framework.data.jpa.repository.*;
...
import ghost.framework.data.jdbc.jpa.plugin.repository.*;
...
public class JpaQueryMethod extends QueryMethod {
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.query.QueryMethod#getNamedQueryName()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.repository.query.QueryMethod#createParameters(java.lang.reflect.Method)
	 */
	@Override
