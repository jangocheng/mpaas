...
//import static ghost.framework.data.jpa.repository.query.QueryParameterSetter.ErrorHandling.*;
...
interface QueryParameterSetter {
	...
	class NamedOrIndexedQueryParameterSetter implements QueryParameterSetter {
		...
		/*
		 * (non-Javadoc)
		 * @see ghost.framework.data.jpa.repository.query.QueryParameterSetter#setParameter(javax.persistence.Query, java.lang.Object[])
		 */
	...
	class QueryMetadata {
		 ...
		 * {@link ghost.framework.orm.jpa.SharedEntityManagerCreator.DeferredQueryInvocationHandler}.
		 *
