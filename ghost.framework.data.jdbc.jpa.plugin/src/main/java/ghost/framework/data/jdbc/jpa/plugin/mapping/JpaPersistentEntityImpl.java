...
//import ghost.framework.data.annotation.Version;
//import ghost.framework.data.jpa.provider.ProxyIdAccessor;
//import ghost.framework.data.jpa.util.JpaMetamodel;
//import ghost.framework.data.mapping.IdentifierAccessor;
//import ghost.framework.data.mapping.entity.BasicPersistentEntity;
//import ghost.framework.data.mapping.entity.IdPropertyIdentifierAccessor;
...
import ghost.framework.data.commons.mapping.model.IdPropertyIdentifierAccessor;
import ghost.framework.data.commons.util.TypeInformation;
import ghost.framework.data.commons.util.Version;
import ghost.framework.data.jdbc.jpa.plugin.provider.ProxyIdAccessor;
...
class JpaPersistentEntityImpl<T> extends BasicPersistentEntity<T, JpaPersistentProperty>
	...
	private static final String INVALID_VERSION_ANNOTATION = "%s is annotated with "
			+ Version.class.getName() + " but needs to use "
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.entity.BasicPersistentEntity#returnPropertyIfBetterIdPropertyCandidateOrNull(ghost.framework.data.mapping.PersistentProperty)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ghost.framework.data.mapping.entity.BasicPersistentEntity#getIdentifierAccessor(java.lang.Object)
	 */
	@Override
