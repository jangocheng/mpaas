...
<bean id="customizableTraceInterceptor" class="
  ghost.framework.aop.interceptor.CustomizableTraceInterceptor">
...
<aop:config>
  <aop:advisor advice-ref="customizableTraceInterceptor"
    pointcut="execution(public * ghost.framework.data.jpa.repository.JpaRepository+.*(..))"/>
</aop:config>
----
...
[source, xml]
----
<bean id="sessionFactory" class="ghost.framework.orm.jpa.vendor.HibernateJpaSessionFactoryBean">
