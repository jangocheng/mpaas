...
import ghost.framework.data.jdbc.jpa.plugin.EntityManagerFactoryAccessor;
import ghost.framework.data.jdbc.jpa.plugin.EntityManagerFactoryInfo;
import ghost.framework.data.jdbc.jpa.plugin.SharedEntityManagerCreator;
 ...
 * created by {@link ghost.framework.orm.jpa.LocalContainerEntityManagerFactoryBean},
 ...
 * EntityManagerFactory. Note that Spring's {@link ghost.framework.orm.jpa.JpaTransactionManager}
 ...
 * @see ghost.framework.orm.jpa.LocalEntityManagerFactoryBean
...
public class SharedEntityManagerBean extends EntityManagerFactoryAccessor
	 ...
	 * @see ghost.framework.orm.jpa.EntityManagerFactoryInfo#getEntityManagerInterface()
