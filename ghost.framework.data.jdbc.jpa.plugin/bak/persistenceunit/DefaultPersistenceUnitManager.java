...
import ghost.framework.data.jdbc.jpa.plugin.persistenceunit.dad.PersistenceUnitReader;
...
public class DefaultPersistenceUnitManager
	 ...
	 * {@link ghost.framework.orm.jpa.JpaVendorAdapter} (e.g. for Hibernate).
	 ...
	 * @see ghost.framework.jdbc.datasource.lookup.MapDataSourceLookup
	 */
	 ...
	 * @see ghost.framework.jdbc.datasource.lookup.JndiDataSourceLookup
	 * @see ghost.framework.jdbc.datasource.lookup.BeanFactoryDataSourceLookup
	 * @see #setDataSources
