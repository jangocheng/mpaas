...
import ghost.framework.web.reactive.handler.AbstractUrlHandlerMapping;
import ghost.framework.web.reactive.handler.SimpleUrlHandlerMapping;
import ghost.framework.web.reactive.resource.ResourceTransformerSupport;
import ghost.framework.web.reactive.resource.ResourceUrlProvider;
import ghost.framework.web.reactive.resource.ResourceWebHandler;
...
public class ResourceHandlerRegistry {
	 ...
	 */
	public ResourceHandlerRegistry(IResourceLoader resourceLoader) {
		this.resourceLoader = resourceLoader;
	}

	/**
	 * Configure the {@link ResourceUrlProvider} that can be used by
	 * {@link ghost.framework.web.reactive.resource.ResourceTransformer} instances.
	 ...
	 * are allowed. See {@link ghost.framework.web.util.pattern.PathPattern}
