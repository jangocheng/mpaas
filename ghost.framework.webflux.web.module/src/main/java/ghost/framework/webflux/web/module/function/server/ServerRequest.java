...
import ghost.framework.web.reactive.function.BodyExtractor;
import ghost.framework.web.server.ServerWebExchange;
import ghost.framework.web.server.WebSession;
import ghost.framework.web.util.UriBuilder;
...
public interface ServerRequest {
	...
	interface Builder {
		 ...
		 * {@linkplain ghost.framework.core.io.buffer.DataBufferUtils#release(DataBuffer) release}
