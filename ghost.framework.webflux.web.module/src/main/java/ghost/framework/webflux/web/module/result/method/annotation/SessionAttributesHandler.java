...
import ghost.framework.web.bind.annotation.SessionAttributes;
...
/**
 * Package-private class to assist {@link ModelInitializer} with managing entity
 * attributes in the {@link WebSession} based on entity attribute names and types
...
class SessionAttributesHandler {
	 ...
	 * in the entity that matched by type.
