...
import ghost.framework.webflux.web.module.socket.server.WebSocketService;
...
public class HandshakeWebSocketService implements WebSocketService, Lifecycle {
	...
	private static RequestUpgradeStrategy initUpgradeStrategy() {
		...
		try {
			className = "ghost.framework.web.reactive.socket.server.upgrade." + className;
	 ...
	 * {@link ghost.framework.web.server.WebSession WebSession} attributes
