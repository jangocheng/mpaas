...
package ghost.framework.webflux.web.module.function;

import org.reactivestreams.Publisher;
import ghost.framework.core.ParameterizedTypeReference;
...
import ghost.framework.http.ReactiveHttpOutputMessage;
import ghost.framework.http.client.MultipartBodyBuilder;
import ghost.framework.http.client.reactive.ClientHttpRequest;
import ghost.framework.http.codec.HttpMessageWriter;
import ghost.framework.http.codec.ServerSentEvent;
import ghost.framework.http.server.reactive.ServerHttpResponse;
...
public abstract class BodyInserters {
	 ...
	 * {@link ghost.framework.web.reactive.function.client.WebClient WebClient} and
	 * {@link ghost.framework.web.reactive.function.server.ServerResponse ServerResponse}.
