...
import ghost.framework.context.support.ApplicationObjectSupport;
...
import ghost.framework.web.cors.reactive.*;
...
import ghost.framework.web.util.pattern.PathPatternParser;
import reactor.core.publisher.Mono;

import java.util.Map;

/**
 * Abstract base class for {@link ghost.framework.web.reactive.HandlerMapping}
 * implementations.
 *
