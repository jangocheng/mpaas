...
import ghost.framework.http.*;
import ghost.framework.http.codec.HttpMessageWriter;
import ghost.framework.http.codec.json.Jackson2CodecSupport;
import ghost.framework.http.server.reactive.ServerHttpResponse;
import ghost.framework.util.MultiValueMap;
import ghost.framework.web.reactive.function.BodyInserter;
import ghost.framework.web.reactive.function.BodyInserters;
...
public interface ServerResponse {
	...
	interface BodyBuilder extends HeadersBuilder<BodyBuilder> {
		 ...
		 * The entity attributes are mapped under a
		...
		/**
		 * Render the template with the given {@code name} using the given {@code entity}.
		 * @param name the name of the template to be rendered
		 * @param model the entity used to render the template
		 * @return the built response
		 */
