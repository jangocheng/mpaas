...
/**
 * Implementation of the {@link ghost.framework.web.reactive.HandlerMapping}
...
public class SimpleUrlHandlerMapping extends AbstractUrlHandlerMapping {
	 ...
	 * see the {@link ghost.framework.web.util.pattern.PathPattern} javadoc.
	 ...
	 */
	protected void registerHandlers(Map<String, Object> urlMap) throws BeanException {
		if (urlMap.isEmpty()) {
