...
import ghost.framework.web.reactive.result.view.HttpMessageWriterView;
import ghost.framework.web.reactive.result.view.UrlBasedViewResolver;
import ghost.framework.web.reactive.result.view.View;
import ghost.framework.web.reactive.result.view.ViewResolver;
import ghost.framework.web.reactive.result.view.freemarker.FreeMarkerConfigurer;
import ghost.framework.web.reactive.result.view.freemarker.FreeMarkerViewResolver;
import ghost.framework.web.reactive.result.view.script.ScriptTemplateConfigurer;
import ghost.framework.web.reactive.result.view.script.ScriptTemplateViewResolver;
...
public class ViewResolverRegistry {
	 ...
	 * {@link ghost.framework.web.reactive.result.view.ViewResolutionResultHandler
