 ...
 *
 * <p>In contrast to an {@link ghost.framework.core.codec.Encoder Encoder}
 ...
 * may render based on multiple attributes contained in the entity.
 *
 * <p>A {@code View} can also choose to select an attribute from the entity use
...
public interface View {
	 ...
	 * {@link ghost.framework.web.reactive.BindingContext BindingContext}
	 * for the request which can be used to create
	 * {@link ghost.framework.validation.BindingResult BindingResult}
	 * instances for objects in to the entity.
	 ...
	 * can access and use the entity or only a specific attribute in it.
