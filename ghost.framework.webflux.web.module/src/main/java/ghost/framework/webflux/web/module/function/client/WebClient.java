...
package ghost.framework.webflux.web.module.function.client;
...
public interface WebClient {
	...
	interface Builder {
		 ...
		 * {@link ghost.framework.http.client.reactive.ReactorClientHttpConnector
	...
	interface RequestBodySpec extends RequestHeadersSpec<RequestBodySpec> {
		 ...
		 * {@link ghost.framework.util.MultiValueMap MultiValueMap} prepared
		 * with {@link ghost.framework.http.client.MultipartBodyBuilder
		 ...
		 * @return this builder
		 * @see ghost.framework.web.reactive.function.BodyInserters
		 */
