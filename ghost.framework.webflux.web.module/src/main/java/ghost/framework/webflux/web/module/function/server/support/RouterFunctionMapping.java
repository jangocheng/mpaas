...
import ghost.framework.webflux.web.module.function.server.RouterFunction;
...
import static ghost.framework.webflux.web.module.HandlerMapping.BEST_MATCHING_HANDLER_ATTRIBUTE;
import static ghost.framework.webflux.web.module.HandlerMapping.BEST_MATCHING_PATTERN_ATTRIBUTE;
import static ghost.framework.webflux.web.module.function.server.RouterFunctions.URI_TEMPLATE_VARIABLES_ATTRIBUTE;
 ...
 * {@linkplain ghost.framework.core.annotation.Order order}.
 *
...
public class RouterFunctionMapping extends AbstractHandlerMapping {
	...
	private void setAttributes(
		...
		Map<String, String> uriVariables =
				(Map<String, String>) attributes.get(URI_TEMPLATE_VARIABLES_ATTRIBUTE);
