...
import ghost.framework.web.reactive.HandlerResultHandler;
import ghost.framework.web.reactive.accept.RequestedContentTypeResolver;
import ghost.framework.web.reactive.result.HandlerResultHandlerSupport;
import ghost.framework.web.server.NotAcceptableStatusException;
 ...
 * <li>{@link Model} -- attributes to add to the entity
 * <li>{@link Map} -- attributes to add to the entity
 * <li>{@link Rendering} -- use case driven API for view resolution</li>
 * <li>{@link ModelAttribute @ModelAttribute} -- attribute for the entity
 * <li>Non-simple value -- attribute for the entity
 * </ul>
 *
 ...
 * entity-related return value), a default view name is selected.
 *
 ...
 * return value as a view name or any non-simple value type as a entity attribute
