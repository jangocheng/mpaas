...
import ghost.framework.web.bind.annotation.CrossOrigin;
import ghost.framework.web.bind.annotation.RequestBody;
import ghost.framework.web.bind.annotation.RequestMapping;
import ghost.framework.web.bind.annotation.RequestMethod;
import ghost.framework.web.cors.CorsConfiguration;
import ghost.framework.web.method.HandlerMethod;
import ghost.framework.web.reactive.accept.RequestedContentTypeResolver;
import ghost.framework.web.reactive.accept.RequestedContentTypeResolverBuilder;
import ghost.framework.web.reactive.result.condition.ConsumesRequestCondition;
import ghost.framework.web.reactive.result.condition.ProducesRequestCondition;
import ghost.framework.web.reactive.result.condition.RequestCondition;
import ghost.framework.web.reactive.result.method.RequestMappingInfo;
import ghost.framework.web.reactive.result.method.RequestMappingInfoHandlerMapping;
...
public class RequestMappingHandlerMapping extends RequestMappingInfoHandlerMapping
	 ...
	 * <p>Consider using {@link ghost.framework.web.method.HandlerTypePredicate
	 * HandlerTypePredicate} to group controllers.
	 * @param prefixes a map with path prefixes as key
	 * @since 5.1
	 * @see ghost.framework.web.method.HandlerTypePredicate
	 */
	 ...
	 * {@link ghost.framework.web.reactive.result.condition.AbstractRequestCondition
	 * AbstractRequestCondition} for custom condition types and using
	 * {@link ghost.framework.web.reactive.result.condition.CompositeRequestCondition
