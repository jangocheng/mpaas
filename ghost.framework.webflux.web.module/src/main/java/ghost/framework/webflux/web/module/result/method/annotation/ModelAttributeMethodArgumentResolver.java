...
import ghost.framework.validation.annotation.Validated;
import ghost.framework.web.bind.WebDataBinder;
import ghost.framework.web.bind.annotation.ModelAttribute;
import ghost.framework.web.bind.support.WebExchangeBindException;
 ...
 *
 * <p>Model attributes are sourced from the entity, or created using a default
 * constructor and then added to the entity. Once created the attribute is
 ...
 * {@code @ghost.framework.validation.annotation.Validated}.
 *
 * <p>When this handler is created with {@code useDefaultResolution=true}
 * any non-simple type argument and return value is regarded as a entity
...
public class ModelAttributeMethodArgumentResolver extends HandlerMethodArgumentResolverSupport {
	 ...
	 * return values are considered entity attributes with or without a
