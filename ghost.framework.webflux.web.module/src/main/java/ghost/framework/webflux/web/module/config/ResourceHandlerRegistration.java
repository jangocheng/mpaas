...
public class ResourceHandlerRegistration {
	 ...
	 */
	public ResourceHandlerRegistration(IResourceLoader resourceLoader, String... pathPatterns) {
		Assert.notNull(resourceLoader, "IResourceLoader is required");
	 ...
	 * by default a {@link ghost.framework.cache.concurrent.ConcurrentMapCache}
