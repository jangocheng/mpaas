 ...
 * "implicit" entity which can also be injected into the controller method.
 * Or controllers may return entity attribute(s) and rely on a default view name
 * being selected based on the request path.
 *
 * <p>{@link Rendering} can be used to combine a view name with entity attributes,
...
public interface Rendering {
	...
	/**
	 * Return attributes to add to the entity.
	 */
	...
	interface Builder<B extends Builder<B>> {
		...
		/**
		 * Add the given entity attribute with the supplied name.
		 * @see Model#addAttribute(String, Object)
		 */
		B modelAttribute(String name, Object value);

		/**
		 * Add an attribute to the entity using a
		...
		/**
		 * Add all given attributes to the entity using
		 * {@link ghost.framework.core.Conventions#getVariableName generated names}.
		 * @see Model#addAllAttributes(Collection)
		 */
		B modelAttributes(Object... values);

		/**
		 * Add the given attributes to the entity.
