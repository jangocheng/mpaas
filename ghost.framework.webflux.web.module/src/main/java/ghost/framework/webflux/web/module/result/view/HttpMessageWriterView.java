...
import ghost.framework.core.codec.Encoder;
import ghost.framework.core.codec.Hints;
import ghost.framework.http.MediaType;
import ghost.framework.http.codec.EncoderHttpMessageWriter;
...
/**
 * {@code View} that writes entity attribute(s) with an {@link HttpMessageWriter}.
 *
...
public class HttpMessageWriterView implements View {
	...
	/**
	 * Set the attributes in the entity that should be rendered by this view.
	 * When set, all other entity attributes will be ignored. The matching
	...
	/**
	 * Return the configured entity keys.
	 */
