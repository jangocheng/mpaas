...
import ghost.framework.http.server.reactive.HttpHandler;
...
import ghost.framework.web.server.adapter.WebHttpHandlerBuilder;
...
public abstract class RouterFunctions {
	 ...
	 * contains the matching pattern, as a {@link ghost.framework.web.util.pattern.PathPattern}.
	 */
	 ...
	 * {@link ghost.framework.http.server.reactive.ServletHttpHandlerAdapter},</li>
	 * <li>Reactor using the
	 * {@link ghost.framework.http.server.reactive.ReactorHttpHandlerAdapter},</li>
	 * <li>Undertow using the
	 * {@link ghost.framework.http.server.reactive.UndertowHttpHandlerAdapter}.</li>
	 * </ul>
