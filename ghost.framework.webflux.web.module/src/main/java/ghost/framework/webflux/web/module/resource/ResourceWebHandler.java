...
import ghost.framework.core.codec.Hints;
import ghost.framework.core.io.Resource;
import ghost.framework.core.io.IResourceLoader;
import ghost.framework.http.*;
import ghost.framework.http.codec.ResourceHttpMessageWriter;
import ghost.framework.http.server.PathContainer;
import ghost.framework.beans.annotation.constraints.Nullable;
import ghost.framework.util.*;
import ghost.framework.web.reactive.HandlerMapping;
import ghost.framework.web.server.MethodNotAllowedException;
import ghost.framework.web.server.ResponseStatusException;
...
public class ResourceWebHandler implements WebHandler, InitializingBean {
	...
	/**
	 * Set the {@link ghost.framework.http.CacheControl} instance to build
	...
	/**
	 * Return the {@link ghost.framework.http.CacheControl} instance to build
	 * the Cache-Control HTTP response header.
	 */
	@Nullable
	...
	/**
	 * Provide the IResourceLoader to load {@link #setLocationValues(List)
	...
	private void resolveResourceLocations() {
		...
		Assert.notNull(this.resourceLoader,
				"IResourceLoader is required when \"locationValues\" are configured.");
