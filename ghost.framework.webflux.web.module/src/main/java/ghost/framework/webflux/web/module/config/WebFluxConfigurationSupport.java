...
import ghost.framework.webflux.web.module.DispatcherHandler;
import ghost.framework.webflux.web.module.HandlerMapping;
import ghost.framework.webflux.web.module.accept.RequestedContentTypeResolver;
import ghost.framework.webflux.web.module.accept.RequestedContentTypeResolverBuilder;
import ghost.framework.webflux.web.module.function.server.support.HandlerFunctionAdapter;
import ghost.framework.webflux.web.module.function.server.support.RouterFunctionMapping;
import ghost.framework.webflux.web.module.function.server.support.ServerResponseResultHandler;
import ghost.framework.webflux.web.module.handler.AbstractHandlerMapping;
import ghost.framework.webflux.web.module.handler.WebFluxResponseStatusExceptionHandler;
import ghost.framework.webflux.web.module.resource.ResourceUrlProvider;
import ghost.framework.webflux.web.module.result.SimpleHandlerAdapter;
import ghost.framework.webflux.web.module.result.method.annotation.*;
import ghost.framework.webflux.web.module.result.view.ViewResolutionResultHandler;
...
public class WebFluxConfigurationSupport {
	...
	public HandlerMapping resourceHandlerMapping(ResourceUrlProvider resourceUrlProvider) {
		IResourceLoader resourceLoader = this.applicationContext;
	...
	public Validator webFluxValidator() {
		...
		if (validator == null) {
			if (ClassUtils.isPresent("javax.validation.Validator", getClass().getClassLoader())) {
				Class<?> clazz;
				try {
					String name = "ghost.framework.validation.beanvalidation.OptionalValidatorFactoryBean";
