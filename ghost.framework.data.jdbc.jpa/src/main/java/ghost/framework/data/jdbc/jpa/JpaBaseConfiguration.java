...
package ghost.framework.data.jdbc.jpa;
...
import ghost.framework.context.domain.EntityScanPackages;
...
import ghost.framework.data.orm.jpa.EntityManagerFactoryBuilder;
import ghost.framework.data.orm.jpa.JpaTransactionManager;
